...
/**
 * DoubanFill icon from the Remix Icon library, Logos category.
 */
case class DoubanFillProps(
  size: Int = 24,
...
/**
 * DoubanFill icon component.
 *
 * @example DoubanFill <> DoubanFillProps(size = 24, color = "blue")
 */
def DoubanFill = (props: DoubanFillProps) => {
  svg(
    viewBox := "0 0 24 24",
