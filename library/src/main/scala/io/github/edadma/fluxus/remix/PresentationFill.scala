...
/**
 * PresentationFill icon from the Remix Icon library, Business category.
 */
case class PresentationFillProps(
  size: Int = 24,
 ...
 *
 * @example PresentationFill <> PresentationFillProps(size = 24, color = "blue")
 */
def PresentationFill = (props: PresentationFillProps) => {
  svg(
    viewBox := "0 0 24 24",
