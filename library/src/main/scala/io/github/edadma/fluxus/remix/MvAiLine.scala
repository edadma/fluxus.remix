...
/**
 * MvAiLine icon from the Remix Icon library, Media category.
 */
case class MvAiLineProps(
  size: Int = 24,
...
/**
 * MvAiLine icon component.
 *
 * @example MvAiLine <> MvAiLineProps(size = 24, color = "blue")
 */
def MvAiLine = (props: MvAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
