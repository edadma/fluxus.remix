...
/**
 * VipDiamondFill icon from the Remix Icon library, Finance category.
 */
case class VipDiamondFillProps(
  size: Int = 24,
...
/**
 * VipDiamondFill icon component.
 *
 * @example VipDiamondFill <> VipDiamondFillProps(size = 24, color = "blue")
 */
def VipDiamondFill = (props: VipDiamondFillProps) => {
  svg(
    viewBox := "0 0 24 24",
