...
/**
 * Dice5Fill icon from the Remix Icon library, Others category.
 */
case class Dice5FillProps(
  size: Int = 24,
...
/**
 * Dice5Fill icon component.
 *
 * @example Dice5Fill <> Dice5FillProps(size = 24, color = "blue")
 */
def Dice5Fill = (props: Dice5FillProps) => {
  svg(
    viewBox := "0 0 24 24",
