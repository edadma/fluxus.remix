...
/**
 * FileCloudLine icon from the Remix Icon library, Document category.
 */
case class FileCloudLineProps(
  size: Int = 24,
...
/**
 * FileCloudLine icon component.
 *
 * @example FileCloudLine <> FileCloudLineProps(size = 24, color = "blue")
 */
def FileCloudLine = (props: FileCloudLineProps) => {
  svg(
    viewBox := "0 0 24 24",
