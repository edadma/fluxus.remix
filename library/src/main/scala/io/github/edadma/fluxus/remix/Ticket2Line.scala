...
/**
 * Ticket2Line icon from the Remix Icon library, Finance category.
 */
case class Ticket2LineProps(
  size: Int = 24,
...
/**
 * Ticket2Line icon component.
 *
 * @example Ticket2Line <> Ticket2LineProps(size = 24, color = "blue")
 */
def Ticket2Line = (props: Ticket2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
