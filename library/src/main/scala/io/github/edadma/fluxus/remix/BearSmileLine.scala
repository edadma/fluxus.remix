...
/**
 * BearSmileLine icon from the Remix Icon library, User & Faces category.
 */
case class BearSmileLineProps(
  size: Int = 24,
...
/**
 * BearSmileLine icon component.
 *
 * @example BearSmileLine <> BearSmileLineProps(size = 24, color = "blue")
 */
def BearSmileLine = (props: BearSmileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
