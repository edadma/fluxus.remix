...
/**
 * BikeLine icon from the Remix Icon library, Map category.
 */
case class BikeLineProps(
  size: Int = 24,
...
/**
 * BikeLine icon component.
 *
 * @example BikeLine <> BikeLineProps(size = 24, color = "blue")
 */
def BikeLine = (props: BikeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
