...
/**
 * Number5 icon from the Remix Icon library, Editor category.
 */
case class Number5Props(
  size: Int = 24,
...
/**
 * Number5 icon component.
 *
 * @example Number5 <> Number5Props(size = 24, color = "blue")
 */
def Number5 = (props: Number5Props) => {
  svg(
    viewBox := "0 0 24 24",
