...
/**
 * ArrowLeftBoxLine icon from the Remix Icon library, Arrows category.
 */
case class ArrowLeftBoxLineProps(
  size: Int = 24,
...
/**
 * ArrowLeftBoxLine icon component.
 *
 * @example ArrowLeftBoxLine <> ArrowLeftBoxLineProps(size = 24, color = "blue")
 */
def ArrowLeftBoxLine = (props: ArrowLeftBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
