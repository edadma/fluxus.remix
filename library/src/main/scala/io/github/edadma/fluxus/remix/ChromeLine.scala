...
/**
 * ChromeLine icon from the Remix Icon library, Logos category.
 */
case class ChromeLineProps(
  size: Int = 24,
...
/**
 * ChromeLine icon component.
 *
 * @example ChromeLine <> ChromeLineProps(size = 24, color = "blue")
 */
def ChromeLine = (props: ChromeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
