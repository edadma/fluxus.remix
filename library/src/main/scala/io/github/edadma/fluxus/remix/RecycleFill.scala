...
/**
 * RecycleFill icon from the Remix Icon library, Others category.
 */
case class RecycleFillProps(
  size: Int = 24,
 ...
 *
 * @example RecycleFill <> RecycleFillProps(size = 24, color = "blue")
 */
def RecycleFill = (props: RecycleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
