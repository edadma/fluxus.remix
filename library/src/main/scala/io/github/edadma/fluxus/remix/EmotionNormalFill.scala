...
/**
 * EmotionNormalFill icon from the Remix Icon library, User & Faces category.
 */
case class EmotionNormalFillProps(
  size: Int = 24,
...
/**
 * EmotionNormalFill icon component.
 *
 * @example EmotionNormalFill <> EmotionNormalFillProps(size = 24, color = "blue")
 */
def EmotionNormalFill = (props: EmotionNormalFillProps) => {
  svg(
    viewBox := "0 0 24 24",
