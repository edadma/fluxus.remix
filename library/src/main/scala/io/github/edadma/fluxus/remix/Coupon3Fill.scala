...
/**
 * Coupon3Fill icon from the Remix Icon library, Finance category.
 */
case class Coupon3FillProps(
  size: Int = 24,
...
/**
 * Coupon3Fill icon component.
 *
 * @example Coupon3Fill <> Coupon3FillProps(size = 24, color = "blue")
 */
def Coupon3Fill = (props: Coupon3FillProps) => {
  svg(
    viewBox := "0 0 24 24",
