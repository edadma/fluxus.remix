...
/**
 * BikeFill icon from the Remix Icon library, Map category.
 */
case class BikeFillProps(
  size: Int = 24,
...
/**
 * BikeFill icon component.
 *
 * @example BikeFill <> BikeFillProps(size = 24, color = "blue")
 */
def BikeFill = (props: BikeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
