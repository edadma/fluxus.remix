...
/**
 * DonutChartFill icon from the Remix Icon library, Business category.
 */
case class DonutChartFillProps(
  size: Int = 24,
...
/**
 * DonutChartFill icon component.
 *
 * @example DonutChartFill <> DonutChartFillProps(size = 24, color = "blue")
 */
def DonutChartFill = (props: DonutChartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
