...
/**
 * KeyLine icon from the Remix Icon library, Others category.
 */
case class KeyLineProps(
  size: Int = 24,
...
/**
 * KeyLine icon component.
 *
 * @example KeyLine <> KeyLineProps(size = 24, color = "blue")
 */
def KeyLine = (props: KeyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
