...
/**
 * SortNumberAsc icon from the Remix Icon library, Editor category.
 */
case class SortNumberAscProps(
  size: Int = 24,
...
/**
 * SortNumberAsc icon component.
 *
 * @example SortNumberAsc <> SortNumberAscProps(size = 24, color = "blue")
 */
def SortNumberAsc = (props: SortNumberAscProps) => {
  svg(
    viewBox := "0 0 24 24",
