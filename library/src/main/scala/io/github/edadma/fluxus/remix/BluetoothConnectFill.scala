...
/**
 * BluetoothConnectFill icon from the Remix Icon library, Device category.
 */
case class BluetoothConnectFillProps(
  size: Int = 24,
...
/**
 * BluetoothConnectFill icon component.
 *
 * @example BluetoothConnectFill <> BluetoothConnectFillProps(size = 24, color = "blue")
 */
def BluetoothConnectFill = (props: BluetoothConnectFillProps) => {
  svg(
    viewBox := "0 0 24 24",
