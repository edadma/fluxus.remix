...
/**
 * TranslateAi2 icon from the Remix Icon library, Editor category.
 */
case class TranslateAi2Props(
  size: Int = 24,
...
/**
 * TranslateAi2 icon component.
 *
 * @example TranslateAi2 <> TranslateAi2Props(size = 24, color = "blue")
 */
def TranslateAi2 = (props: TranslateAi2Props) => {
  svg(
    viewBox := "0 0 24 24",
