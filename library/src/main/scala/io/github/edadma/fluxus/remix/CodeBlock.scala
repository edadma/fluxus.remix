...
/**
 * CodeBlock icon from the Remix Icon library, Editor category.
 */
case class CodeBlockProps(
  size: Int = 24,
 ...
 *
 * @example CodeBlock <> CodeBlockProps(size = 24, color = "blue")
 */
def CodeBlock = (props: CodeBlockProps) => {
  svg(
    viewBox := "0 0 24 24",
