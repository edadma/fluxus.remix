...
/**
 * HonorOfKingsFill icon from the Remix Icon library, Logos category.
 */
case class HonorOfKingsFillProps(
  size: Int = 24,
...
/**
 * HonorOfKingsFill icon component.
 *
 * @example HonorOfKingsFill <> HonorOfKingsFillProps(size = 24, color = "blue")
 */
def HonorOfKingsFill = (props: HonorOfKingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
