...
/**
 * Ship2Fill icon from the Remix Icon library, Map category.
 */
case class Ship2FillProps(
  size: Int = 24,
...
/**
 * Ship2Fill icon component.
 *
 * @example Ship2Fill <> Ship2FillProps(size = 24, color = "blue")
 */
def Ship2Fill = (props: Ship2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
