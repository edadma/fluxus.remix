...
/**
 * LinkUnlinkM icon from the Remix Icon library, Editor category.
 */
case class LinkUnlinkMProps(
  size: Int = 24,
...
/**
 * LinkUnlinkM icon component.
 *
 * @example LinkUnlinkM <> LinkUnlinkMProps(size = 24, color = "blue")
 */
def LinkUnlinkM = (props: LinkUnlinkMProps) => {
  svg(
    viewBox := "0 0 24 24",
