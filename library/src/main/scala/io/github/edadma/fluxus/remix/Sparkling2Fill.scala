...
/**
 * Sparkling2Fill icon from the Remix Icon library, Weather category.
 */
case class Sparkling2FillProps(
  size: Int = 24,
...
/**
 * Sparkling2Fill icon component.
 *
 * @example Sparkling2Fill <> Sparkling2FillProps(size = 24, color = "blue")
 */
def Sparkling2Fill = (props: Sparkling2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
