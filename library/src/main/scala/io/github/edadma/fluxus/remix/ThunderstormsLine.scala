...
/**
 * ThunderstormsLine icon from the Remix Icon library, Weather category.
 */
case class ThunderstormsLineProps(
  size: Int = 24,
...
/**
 * ThunderstormsLine icon component.
 *
 * @example ThunderstormsLine <> ThunderstormsLineProps(size = 24, color = "blue")
 */
def ThunderstormsLine = (props: ThunderstormsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
