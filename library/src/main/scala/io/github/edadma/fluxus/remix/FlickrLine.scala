...
/**
 * FlickrLine icon from the Remix Icon library, Logos category.
 */
case class FlickrLineProps(
  size: Int = 24,
...
/**
 * FlickrLine icon component.
 *
 * @example FlickrLine <> FlickrLineProps(size = 24, color = "blue")
 */
def FlickrLine = (props: FlickrLineProps) => {
  svg(
    viewBox := "0 0 24 24",
