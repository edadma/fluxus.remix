...
/**
 * Coupon3Line icon from the Remix Icon library, Finance category.
 */
case class Coupon3LineProps(
  size: Int = 24,
...
/**
 * Coupon3Line icon component.
 *
 * @example Coupon3Line <> Coupon3LineProps(size = 24, color = "blue")
 */
def Coupon3Line = (props: Coupon3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
