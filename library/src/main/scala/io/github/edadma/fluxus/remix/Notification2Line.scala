...
/**
 * Notification2Line icon from the Remix Icon library, Media category.
 */
case class Notification2LineProps(
  size: Int = 24,
...
/**
 * Notification2Line icon component.
 *
 * @example Notification2Line <> Notification2LineProps(size = 24, color = "blue")
 */
def Notification2Line = (props: Notification2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
