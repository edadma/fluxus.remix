...
/**
 * HqFill icon from the Remix Icon library, Media category.
 */
case class HqFillProps(
  size: Int = 24,
...
/**
 * HqFill icon component.
 *
 * @example HqFill <> HqFillProps(size = 24, color = "blue")
 */
def HqFill = (props: HqFillProps) => {
  svg(
    viewBox := "0 0 24 24",
