...
/**
 * ShieldStarLine icon from the Remix Icon library, System category.
 */
case class ShieldStarLineProps(
  size: Int = 24,
...
/**
 * ShieldStarLine icon component.
 *
 * @example ShieldStarLine <> ShieldStarLineProps(size = 24, color = "blue")
 */
def ShieldStarLine = (props: ShieldStarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
