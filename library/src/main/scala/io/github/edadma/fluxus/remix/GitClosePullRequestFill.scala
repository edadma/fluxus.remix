...
/**
 * GitClosePullRequestFill icon from the Remix Icon library, Development category.
 */
case class GitClosePullRequestFillProps(
  size: Int = 24,
...
/**
 * GitClosePullRequestFill icon component.
 *
 * @example GitClosePullRequestFill <> GitClosePullRequestFillProps(size = 24, color = "blue")
 */
def GitClosePullRequestFill = (props: GitClosePullRequestFillProps) => {
  svg(
    viewBox := "0 0 24 24",
