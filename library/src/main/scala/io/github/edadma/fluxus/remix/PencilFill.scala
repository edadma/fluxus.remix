...
/**
 * PencilFill icon from the Remix Icon library, Design category.
 */
case class PencilFillProps(
  size: Int = 24,
 ...
 *
 * @example PencilFill <> PencilFillProps(size = 24, color = "blue")
 */
def PencilFill = (props: PencilFillProps) => {
  svg(
    viewBox := "0 0 24 24",
