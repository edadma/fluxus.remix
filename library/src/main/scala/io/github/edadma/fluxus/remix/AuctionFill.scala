...
/**
 * AuctionFill icon from the Remix Icon library, Finance category.
 */
case class AuctionFillProps(
  size: Int = 24,
...
/**
 * AuctionFill icon component.
 *
 * @example AuctionFill <> AuctionFillProps(size = 24, color = "blue")
 */
def AuctionFill = (props: AuctionFillProps) => {
  svg(
    viewBox := "0 0 24 24",
