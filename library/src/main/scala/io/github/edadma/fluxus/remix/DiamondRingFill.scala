...
/**
 * DiamondRingFill icon from the Remix Icon library, Finance category.
 */
case class DiamondRingFillProps(
  size: Int = 24,
...
/**
 * DiamondRingFill icon component.
 *
 * @example DiamondRingFill <> DiamondRingFillProps(size = 24, color = "blue")
 */
def DiamondRingFill = (props: DiamondRingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
