...
/**
 * CrosshairLine icon from the Remix Icon library, Design category.
 */
case class CrosshairLineProps(
  size: Int = 24,
...
/**
 * CrosshairLine icon component.
 *
 * @example CrosshairLine <> CrosshairLineProps(size = 24, color = "blue")
 */
def CrosshairLine = (props: CrosshairLineProps) => {
  svg(
    viewBox := "0 0 24 24",
