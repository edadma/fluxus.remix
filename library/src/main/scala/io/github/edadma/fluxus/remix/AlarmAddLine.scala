...
/**
 * AlarmAddLine icon from the Remix Icon library, System category.
 */
case class AlarmAddLineProps(
  size: Int = 24,
...
/**
 * AlarmAddLine icon component.
 *
 * @example AlarmAddLine <> AlarmAddLineProps(size = 24, color = "blue")
 */
def AlarmAddLine = (props: AlarmAddLineProps) => {
  svg(
    viewBox := "0 0 24 24",
