...
/**
 * Polaroid2Fill icon from the Remix Icon library, Media category.
 */
case class Polaroid2FillProps(
  size: Int = 24,
...
/**
 * Polaroid2Fill icon component.
 *
 * @example Polaroid2Fill <> Polaroid2FillProps(size = 24, color = "blue")
 */
def Polaroid2Fill = (props: Polaroid2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
