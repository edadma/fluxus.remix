...
/**
 * Mic2Fill icon from the Remix Icon library, Media category.
 */
case class Mic2FillProps(
  size: Int = 24,
...
/**
 * Mic2Fill icon component.
 *
 * @example Mic2Fill <> Mic2FillProps(size = 24, color = "blue")
 */
def Mic2Fill = (props: Mic2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
