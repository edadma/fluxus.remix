...
/**
 * PolaroidFill icon from the Remix Icon library, Media category.
 */
case class PolaroidFillProps(
  size: Int = 24,
...
/**
 * PolaroidFill icon component.
 *
 * @example PolaroidFill <> PolaroidFillProps(size = 24, color = "blue")
 */
def PolaroidFill = (props: PolaroidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
