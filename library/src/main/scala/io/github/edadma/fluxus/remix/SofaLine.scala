...
/**
 * SofaLine icon from the Remix Icon library, Others category.
 */
case class SofaLineProps(
  size: Int = 24,
...
/**
 * SofaLine icon component.
 *
 * @example SofaLine <> SofaLineProps(size = 24, color = "blue")
 */
def SofaLine = (props: SofaLineProps) => {
  svg(
    viewBox := "0 0 24 24",
