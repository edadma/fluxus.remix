...
/**
 * HomeOfficeLine icon from the Remix Icon library, Buildings category.
 */
case class HomeOfficeLineProps(
  size: Int = 24,
...
/**
 * HomeOfficeLine icon component.
 *
 * @example HomeOfficeLine <> HomeOfficeLineProps(size = 24, color = "blue")
 */
def HomeOfficeLine = (props: HomeOfficeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
