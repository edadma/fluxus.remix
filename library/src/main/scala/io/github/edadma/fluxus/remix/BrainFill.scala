...
/**
 * BrainFill icon from the Remix Icon library, Health & Medical category.
 */
case class BrainFillProps(
  size: Int = 24,
 ...
 *
 * @example BrainFill <> BrainFillProps(size = 24, color = "blue")
 */
def BrainFill = (props: BrainFillProps) => {
  svg(
    viewBox := "0 0 24 24",
