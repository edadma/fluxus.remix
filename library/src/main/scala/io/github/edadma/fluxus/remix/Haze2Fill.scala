...
/**
 * Haze2Fill icon from the Remix Icon library, Weather category.
 */
case class Haze2FillProps(
  size: Int = 24,
...
/**
 * Haze2Fill icon component.
 *
 * @example Haze2Fill <> Haze2FillProps(size = 24, color = "blue")
 */
def Haze2Fill = (props: Haze2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
