...
/**
 * RedPacketFill icon from the Remix Icon library, Finance category.
 */
case class RedPacketFillProps(
  size: Int = 24,
...
/**
 * RedPacketFill icon component.
 *
 * @example RedPacketFill <> RedPacketFillProps(size = 24, color = "blue")
 */
def RedPacketFill = (props: RedPacketFillProps) => {
  svg(
    viewBox := "0 0 24 24",
