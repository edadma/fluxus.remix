...
/**
 * MagicFill icon from the Remix Icon library, Design category.
 */
case class MagicFillProps(
  size: Int = 24,
...
/**
 * MagicFill icon component.
 *
 * @example MagicFill <> MagicFillProps(size = 24, color = "blue")
 */
def MagicFill = (props: MagicFillProps) => {
  svg(
    viewBox := "0 0 24 24",
