...
/**
 * Speaker3Fill icon from the Remix Icon library, Media category.
 */
case class Speaker3FillProps(
  size: Int = 24,
...
/**
 * Speaker3Fill icon component.
 *
 * @example Speaker3Fill <> Speaker3FillProps(size = 24, color = "blue")
 */
def Speaker3Fill = (props: Speaker3FillProps) => {
  svg(
    viewBox := "0 0 24 24",
