...
/**
 * MemoriesLine icon from the Remix Icon library, Media category.
 */
case class MemoriesLineProps(
  size: Int = 24,
...
/**
 * MemoriesLine icon component.
 *
 * @example MemoriesLine <> MemoriesLineProps(size = 24, color = "blue")
 */
def MemoriesLine = (props: MemoriesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
