...
/**
 * TaxiFill icon from the Remix Icon library, Map category.
 */
case class TaxiFillProps(
  size: Int = 24,
 ...
 *
 * @example TaxiFill <> TaxiFillProps(size = 24, color = "blue")
 */
def TaxiFill = (props: TaxiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
