...
/**
 * FileForbidFill icon from the Remix Icon library, Document category.
 */
case class FileForbidFillProps(
  size: Int = 24,
...
/**
 * FileForbidFill icon component.
 *
 * @example FileForbidFill <> FileForbidFillProps(size = 24, color = "blue")
 */
def FileForbidFill = (props: FileForbidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
