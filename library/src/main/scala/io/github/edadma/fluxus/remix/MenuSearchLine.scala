...
/**
 * MenuSearchLine icon from the Remix Icon library, System category.
 */
case class MenuSearchLineProps(
  size: Int = 24,
...
/**
 * MenuSearchLine icon component.
 *
 * @example MenuSearchLine <> MenuSearchLineProps(size = 24, color = "blue")
 */
def MenuSearchLine = (props: MenuSearchLineProps) => {
  svg(
    viewBox := "0 0 24 24",
