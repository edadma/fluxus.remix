...
/**
 * RainbowLine icon from the Remix Icon library, Weather category.
 */
case class RainbowLineProps(
  size: Int = 24,
...
/**
 * RainbowLine icon component.
 *
 * @example RainbowLine <> RainbowLineProps(size = 24, color = "blue")
 */
def RainbowLine = (props: RainbowLineProps) => {
  svg(
    viewBox := "0 0 24 24",
