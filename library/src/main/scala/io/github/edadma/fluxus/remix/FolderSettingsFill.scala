...
/**
 * FolderSettingsFill icon from the Remix Icon library, Document category.
 */
case class FolderSettingsFillProps(
  size: Int = 24,
...
/**
 * FolderSettingsFill icon component.
 *
 * @example FolderSettingsFill <> FolderSettingsFillProps(size = 24, color = "blue")
 */
def FolderSettingsFill = (props: FolderSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
