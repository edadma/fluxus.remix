...
/**
 * RunFill icon from the Remix Icon library, Map category.
 */
case class RunFillProps(
  size: Int = 24,
...
/**
 * RunFill icon component.
 *
 * @example RunFill <> RunFillProps(size = 24, color = "blue")
 */
def RunFill = (props: RunFillProps) => {
  svg(
    viewBox := "0 0 24 24",
