...
/**
 * SpotifyLine icon from the Remix Icon library, Logos category.
 */
case class SpotifyLineProps(
  size: Int = 24,
...
/**
 * SpotifyLine icon component.
 *
 * @example SpotifyLine <> SpotifyLineProps(size = 24, color = "blue")
 */
def SpotifyLine = (props: SpotifyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
