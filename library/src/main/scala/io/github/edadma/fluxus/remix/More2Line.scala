...
/**
 * More2Line icon from the Remix Icon library, System category.
 */
case class More2LineProps(
  size: Int = 24,
...
/**
 * More2Line icon component.
 *
 * @example More2Line <> More2LineProps(size = 24, color = "blue")
 */
def More2Line = (props: More2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
