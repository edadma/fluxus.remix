...
/**
 * PsychotherapyLine icon from the Remix Icon library, Health & Medical category.
 */
case class PsychotherapyLineProps(
  size: Int = 24,
...
/**
 * PsychotherapyLine icon component.
 *
 * @example PsychotherapyLine <> PsychotherapyLineProps(size = 24, color = "blue")
 */
def PsychotherapyLine = (props: PsychotherapyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
