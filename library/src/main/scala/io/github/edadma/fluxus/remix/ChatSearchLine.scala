...
/**
 * ChatSearchLine icon from the Remix Icon library, Communication category.
 */
case class ChatSearchLineProps(
  size: Int = 24,
...
/**
 * ChatSearchLine icon component.
 *
 * @example ChatSearchLine <> ChatSearchLineProps(size = 24, color = "blue")
 */
def ChatSearchLine = (props: ChatSearchLineProps) => {
  svg(
    viewBox := "0 0 24 24",
