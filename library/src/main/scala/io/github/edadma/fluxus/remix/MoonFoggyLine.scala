...
/**
 * MoonFoggyLine icon from the Remix Icon library, Weather category.
 */
case class MoonFoggyLineProps(
  size: Int = 24,
...
/**
 * MoonFoggyLine icon component.
 *
 * @example MoonFoggyLine <> MoonFoggyLineProps(size = 24, color = "blue")
 */
def MoonFoggyLine = (props: MoonFoggyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
