...
/**
 * Scales3Line icon from the Remix Icon library, Others category.
 */
case class Scales3LineProps(
  size: Int = 24,
...
/**
 * Scales3Line icon component.
 *
 * @example Scales3Line <> Scales3LineProps(size = 24, color = "blue")
 */
def Scales3Line = (props: Scales3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
