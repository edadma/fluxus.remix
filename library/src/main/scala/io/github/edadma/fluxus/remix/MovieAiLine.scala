...
/**
 * MovieAiLine icon from the Remix Icon library, Media category.
 */
case class MovieAiLineProps(
  size: Int = 24,
...
/**
 * MovieAiLine icon component.
 *
 * @example MovieAiLine <> MovieAiLineProps(size = 24, color = "blue")
 */
def MovieAiLine = (props: MovieAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
