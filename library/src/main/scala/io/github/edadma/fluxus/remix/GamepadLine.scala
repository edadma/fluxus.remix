...
/**
 * GamepadLine icon from the Remix Icon library, Device category.
 */
case class GamepadLineProps(
  size: Int = 24,
...
/**
 * GamepadLine icon component.
 *
 * @example GamepadLine <> GamepadLineProps(size = 24, color = "blue")
 */
def GamepadLine = (props: GamepadLineProps) => {
  svg(
    viewBox := "0 0 24 24",
