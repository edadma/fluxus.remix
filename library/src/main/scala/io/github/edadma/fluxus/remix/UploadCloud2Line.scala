...
/**
 * UploadCloud2Line icon from the Remix Icon library, System category.
 */
case class UploadCloud2LineProps(
  size: Int = 24,
...
/**
 * UploadCloud2Line icon component.
 *
 * @example UploadCloud2Line <> UploadCloud2LineProps(size = 24, color = "blue")
 */
def UploadCloud2Line = (props: UploadCloud2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
