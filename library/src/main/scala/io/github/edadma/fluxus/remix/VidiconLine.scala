...
/**
 * VidiconLine icon from the Remix Icon library, Media category.
 */
case class VidiconLineProps(
  size: Int = 24,
...
/**
 * VidiconLine icon component.
 *
 * @example VidiconLine <> VidiconLineProps(size = 24, color = "blue")
 */
def VidiconLine = (props: VidiconLineProps) => {
  svg(
    viewBox := "0 0 24 24",
