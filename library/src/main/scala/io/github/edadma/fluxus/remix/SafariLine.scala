...
/**
 * SafariLine icon from the Remix Icon library, Logos category.
 */
case class SafariLineProps(
  size: Int = 24,
...
/**
 * SafariLine icon component.
 *
 * @example SafariLine <> SafariLineProps(size = 24, color = "blue")
 */
def SafariLine = (props: SafariLineProps) => {
  svg(
    viewBox := "0 0 24 24",
