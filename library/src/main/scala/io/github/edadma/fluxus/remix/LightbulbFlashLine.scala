...
/**
 * LightbulbFlashLine icon from the Remix Icon library, Others category.
 */
case class LightbulbFlashLineProps(
  size: Int = 24,
...
/**
 * LightbulbFlashLine icon component.
 *
 * @example LightbulbFlashLine <> LightbulbFlashLineProps(size = 24, color = "blue")
 */
def LightbulbFlashLine = (props: LightbulbFlashLineProps) => {
  svg(
    viewBox := "0 0 24 24",
