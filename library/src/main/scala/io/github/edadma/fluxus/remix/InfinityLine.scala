...
/**
 * InfinityLine icon from the Remix Icon library, Others category.
 */
case class InfinityLineProps(
  size: Int = 24,
...
/**
 * InfinityLine icon component.
 *
 * @example InfinityLine <> InfinityLineProps(size = 24, color = "blue")
 */
def InfinityLine = (props: InfinityLineProps) => {
  svg(
    viewBox := "0 0 24 24",
