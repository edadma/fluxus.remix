...
/**
 * Safe2Fill icon from the Remix Icon library, Finance category.
 */
case class Safe2FillProps(
  size: Int = 24,
...
/**
 * Safe2Fill icon component.
 *
 * @example Safe2Fill <> Safe2FillProps(size = 24, color = "blue")
 */
def Safe2Fill = (props: Safe2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
