...
/**
 * CodeAiFill icon from the Remix Icon library, Development category.
 */
case class CodeAiFillProps(
  size: Int = 24,
...
/**
 * CodeAiFill icon component.
 *
 * @example CodeAiFill <> CodeAiFillProps(size = 24, color = "blue")
 */
def CodeAiFill = (props: CodeAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
