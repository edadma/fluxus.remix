...
/**
 * AlarmSnoozeFill icon from the Remix Icon library, System category.
 */
case class AlarmSnoozeFillProps(
  size: Int = 24,
...
/**
 * AlarmSnoozeFill icon component.
 *
 * @example AlarmSnoozeFill <> AlarmSnoozeFillProps(size = 24, color = "blue")
 */
def AlarmSnoozeFill = (props: AlarmSnoozeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
