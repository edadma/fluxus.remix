...
/**
 * FloodFill icon from the Remix Icon library, Weather category.
 */
case class FloodFillProps(
  size: Int = 24,
...
/**
 * FloodFill icon component.
 *
 * @example FloodFill <> FloodFillProps(size = 24, color = "blue")
 */
def FloodFill = (props: FloodFillProps) => {
  svg(
    viewBox := "0 0 24 24",
