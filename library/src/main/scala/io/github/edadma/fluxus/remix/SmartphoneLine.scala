...
/**
 * SmartphoneLine icon from the Remix Icon library, Device category.
 */
case class SmartphoneLineProps(
  size: Int = 24,
...
/**
 * SmartphoneLine icon component.
 *
 * @example SmartphoneLine <> SmartphoneLineProps(size = 24, color = "blue")
 */
def SmartphoneLine = (props: SmartphoneLineProps) => {
  svg(
    viewBox := "0 0 24 24",
