...
/**
 * Save2Fill icon from the Remix Icon library, Device category.
 */
case class Save2FillProps(
  size: Int = 24,
...
/**
 * Save2Fill icon component.
 *
 * @example Save2Fill <> Save2FillProps(size = 24, color = "blue")
 */
def Save2Fill = (props: Save2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
