...
/**
 * MicOffFill icon from the Remix Icon library, Media category.
 */
case class MicOffFillProps(
  size: Int = 24,
...
/**
 * MicOffFill icon component.
 *
 * @example MicOffFill <> MicOffFillProps(size = 24, color = "blue")
 */
def MicOffFill = (props: MicOffFillProps) => {
  svg(
    viewBox := "0 0 24 24",
