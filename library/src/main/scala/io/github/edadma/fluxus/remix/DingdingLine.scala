...
/**
 * DingdingLine icon from the Remix Icon library, Logos category.
 */
case class DingdingLineProps(
  size: Int = 24,
...
/**
 * DingdingLine icon component.
 *
 * @example DingdingLine <> DingdingLineProps(size = 24, color = "blue")
 */
def DingdingLine = (props: DingdingLineProps) => {
  svg(
    viewBox := "0 0 24 24",
