...
/**
 * VolumeUpLine icon from the Remix Icon library, Media category.
 */
case class VolumeUpLineProps(
  size: Int = 24,
...
/**
 * VolumeUpLine icon component.
 *
 * @example VolumeUpLine <> VolumeUpLineProps(size = 24, color = "blue")
 */
def VolumeUpLine = (props: VolumeUpLineProps) => {
  svg(
    viewBox := "0 0 24 24",
