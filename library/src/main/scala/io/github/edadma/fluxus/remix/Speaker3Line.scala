...
/**
 * Speaker3Line icon from the Remix Icon library, Media category.
 */
case class Speaker3LineProps(
  size: Int = 24,
...
/**
 * Speaker3Line icon component.
 *
 * @example Speaker3Line <> Speaker3LineProps(size = 24, color = "blue")
 */
def Speaker3Line = (props: Speaker3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
