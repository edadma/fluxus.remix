...
/**
 * BoxingLine icon from the Remix Icon library, Others category.
 */
case class BoxingLineProps(
  size: Int = 24,
...
/**
 * BoxingLine icon component.
 *
 * @example BoxingLine <> BoxingLineProps(size = 24, color = "blue")
 */
def BoxingLine = (props: BoxingLineProps) => {
  svg(
    viewBox := "0 0 24 24",
