...
/**
 * EmotionHappyLine icon from the Remix Icon library, User & Faces category.
 */
case class EmotionHappyLineProps(
  size: Int = 24,
...
/**
 * EmotionHappyLine icon component.
 *
 * @example EmotionHappyLine <> EmotionHappyLineProps(size = 24, color = "blue")
 */
def EmotionHappyLine = (props: EmotionHappyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
