...
/**
 * ArrowGoForwardLine icon from the Remix Icon library, Arrows category.
 */
case class ArrowGoForwardLineProps(
  size: Int = 24,
...
/**
 * ArrowGoForwardLine icon component.
 *
 * @example ArrowGoForwardLine <> ArrowGoForwardLineProps(size = 24, color = "blue")
 */
def ArrowGoForwardLine = (props: ArrowGoForwardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
