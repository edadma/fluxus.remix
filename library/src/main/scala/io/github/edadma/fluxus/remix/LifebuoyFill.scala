...
/**
 * LifebuoyFill icon from the Remix Icon library, Map category.
 */
case class LifebuoyFillProps(
  size: Int = 24,
 ...
 *
 * @example LifebuoyFill <> LifebuoyFillProps(size = 24, color = "blue")
 */
def LifebuoyFill = (props: LifebuoyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
