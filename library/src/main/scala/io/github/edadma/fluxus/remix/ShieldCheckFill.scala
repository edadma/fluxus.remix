...
/**
 * ShieldCheckFill icon from the Remix Icon library, System category.
 */
case class ShieldCheckFillProps(
  size: Int = 24,
 ...
 *
 * @example ShieldCheckFill <> ShieldCheckFillProps(size = 24, color = "blue")
 */
def ShieldCheckFill = (props: ShieldCheckFillProps) => {
  svg(
    viewBox := "0 0 24 24",
