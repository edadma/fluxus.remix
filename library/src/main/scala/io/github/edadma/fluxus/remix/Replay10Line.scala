...
/**
 * Replay10Line icon from the Remix Icon library, Media category.
 */
case class Replay10LineProps(
  size: Int = 24,
...
/**
 * Replay10Line icon component.
 *
 * @example Replay10Line <> Replay10LineProps(size = 24, color = "blue")
 */
def Replay10Line = (props: Replay10LineProps) => {
  svg(
    viewBox := "0 0 24 24",
