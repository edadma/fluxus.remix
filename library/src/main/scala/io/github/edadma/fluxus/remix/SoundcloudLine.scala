...
/**
 * SoundcloudLine icon from the Remix Icon library, Logos category.
 */
case class SoundcloudLineProps(
  size: Int = 24,
...
/**
 * SoundcloudLine icon component.
 *
 * @example SoundcloudLine <> SoundcloudLineProps(size = 24, color = "blue")
 */
def SoundcloudLine = (props: SoundcloudLineProps) => {
  svg(
    viewBox := "0 0 24 24",
