...
/**
 * BreadFill icon from the Remix Icon library, Food category.
 */
case class BreadFillProps(
  size: Int = 24,
...
/**
 * BreadFill icon component.
 *
 * @example BreadFill <> BreadFillProps(size = 24, color = "blue")
 */
def BreadFill = (props: BreadFillProps) => {
  svg(
    viewBox := "0 0 24 24",
