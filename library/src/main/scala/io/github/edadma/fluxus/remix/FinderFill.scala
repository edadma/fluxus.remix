...
/**
 * FinderFill icon from the Remix Icon library, Logos category.
 */
case class FinderFillProps(
  size: Int = 24,
...
/**
 * FinderFill icon component.
 *
 * @example FinderFill <> FinderFillProps(size = 24, color = "blue")
 */
def FinderFill = (props: FinderFillProps) => {
  svg(
    viewBox := "0 0 24 24",
