...
/**
 * FileUnknowLine icon from the Remix Icon library, Document category.
 */
case class FileUnknowLineProps(
  size: Int = 24,
...
/**
 * FileUnknowLine icon component.
 *
 * @example FileUnknowLine <> FileUnknowLineProps(size = 24, color = "blue")
 */
def FileUnknowLine = (props: FileUnknowLineProps) => {
  svg(
    viewBox := "0 0 24 24",
