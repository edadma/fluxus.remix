...
/**
 * HandbagLine icon from the Remix Icon library, Others category.
 */
case class HandbagLineProps(
  size: Int = 24,
...
/**
 * HandbagLine icon component.
 *
 * @example HandbagLine <> HandbagLineProps(size = 24, color = "blue")
 */
def HandbagLine = (props: HandbagLineProps) => {
  svg(
    viewBox := "0 0 24 24",
