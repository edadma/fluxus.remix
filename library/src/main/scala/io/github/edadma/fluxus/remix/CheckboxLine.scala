...
/**
 * CheckboxLine icon from the Remix Icon library, System category.
 */
case class CheckboxLineProps(
  size: Int = 24,
...
/**
 * CheckboxLine icon component.
 *
 * @example CheckboxLine <> CheckboxLineProps(size = 24, color = "blue")
 */
def CheckboxLine = (props: CheckboxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
