...
/**
 * PassPendingLine icon from the Remix Icon library, Business category.
 */
case class PassPendingLineProps(
  size: Int = 24,
...
/**
 * PassPendingLine icon component.
 *
 * @example PassPendingLine <> PassPendingLineProps(size = 24, color = "blue")
 */
def PassPendingLine = (props: PassPendingLineProps) => {
  svg(
    viewBox := "0 0 24 24",
