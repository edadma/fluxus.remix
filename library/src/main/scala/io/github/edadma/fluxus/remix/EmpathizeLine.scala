...
/**
 * EmpathizeLine icon from the Remix Icon library, Health & Medical category.
 */
case class EmpathizeLineProps(
  size: Int = 24,
...
/**
 * EmpathizeLine icon component.
 *
 * @example EmpathizeLine <> EmpathizeLineProps(size = 24, color = "blue")
 */
def EmpathizeLine = (props: EmpathizeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
