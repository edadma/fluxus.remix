...
/**
 * DivideFill icon from the Remix Icon library, System category.
 */
case class DivideFillProps(
  size: Int = 24,
...
/**
 * DivideFill icon component.
 *
 * @example DivideFill <> DivideFillProps(size = 24, color = "blue")
 */
def DivideFill = (props: DivideFillProps) => {
  svg(
    viewBox := "0 0 24 24",
