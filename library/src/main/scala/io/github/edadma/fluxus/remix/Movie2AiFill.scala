...
/**
 * Movie2AiFill icon from the Remix Icon library, Media category.
 */
case class Movie2AiFillProps(
  size: Int = 24,
...
/**
 * Movie2AiFill icon component.
 *
 * @example Movie2AiFill <> Movie2AiFillProps(size = 24, color = "blue")
 */
def Movie2AiFill = (props: Movie2AiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
