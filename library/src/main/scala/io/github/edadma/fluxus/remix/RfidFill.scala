...
/**
 * RfidFill icon from the Remix Icon library, Device category.
 */
case class RfidFillProps(
  size: Int = 24,
...
/**
 * RfidFill icon component.
 *
 * @example RfidFill <> RfidFillProps(size = 24, color = "blue")
 */
def RfidFill = (props: RfidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
