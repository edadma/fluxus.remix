...
/**
 * TailwindCssFill icon from the Remix Icon library, Logos category.
 */
case class TailwindCssFillProps(
  size: Int = 24,
...
/**
 * TailwindCssFill icon component.
 *
 * @example TailwindCssFill <> TailwindCssFillProps(size = 24, color = "blue")
 */
def TailwindCssFill = (props: TailwindCssFillProps) => {
  svg(
    viewBox := "0 0 24 24",
