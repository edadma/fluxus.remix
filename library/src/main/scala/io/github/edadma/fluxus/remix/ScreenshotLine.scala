...
/**
 * ScreenshotLine icon from the Remix Icon library, Design category.
 */
case class ScreenshotLineProps(
  size: Int = 24,
...
/**
 * ScreenshotLine icon component.
 *
 * @example ScreenshotLine <> ScreenshotLineProps(size = 24, color = "blue")
 */
def ScreenshotLine = (props: ScreenshotLineProps) => {
  svg(
    viewBox := "0 0 24 24",
