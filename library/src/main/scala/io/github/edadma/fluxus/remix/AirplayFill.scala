...
/**
 * AirplayFill icon from the Remix Icon library, Device category.
 */
case class AirplayFillProps(
  size: Int = 24,
 ...
 *
 * @example AirplayFill <> AirplayFillProps(size = 24, color = "blue")
 */
def AirplayFill = (props: AirplayFillProps) => {
  svg(
    viewBox := "0 0 24 24",
