...
/**
 * GlobeFill icon from the Remix Icon library, Map category.
 */
case class GlobeFillProps(
  size: Int = 24,
 ...
 *
 * @example GlobeFill <> GlobeFillProps(size = 24, color = "blue")
 */
def GlobeFill = (props: GlobeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
