...
/**
 * FunctionFill icon from the Remix Icon library, System category.
 */
case class FunctionFillProps(
  size: Int = 24,
 ...
 *
 * @example FunctionFill <> FunctionFillProps(size = 24, color = "blue")
 */
def FunctionFill = (props: FunctionFillProps) => {
  svg(
    viewBox := "0 0 24 24",
