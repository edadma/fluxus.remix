...
/**
 * PassPendingFill icon from the Remix Icon library, Business category.
 */
case class PassPendingFillProps(
  size: Int = 24,
...
/**
 * PassPendingFill icon component.
 *
 * @example PassPendingFill <> PassPendingFillProps(size = 24, color = "blue")
 */
def PassPendingFill = (props: PassPendingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
