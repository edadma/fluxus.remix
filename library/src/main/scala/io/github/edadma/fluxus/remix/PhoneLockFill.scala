...
/**
 * PhoneLockFill icon from the Remix Icon library, Device category.
 */
case class PhoneLockFillProps(
  size: Int = 24,
...
/**
 * PhoneLockFill icon component.
 *
 * @example PhoneLockFill <> PhoneLockFillProps(size = 24, color = "blue")
 */
def PhoneLockFill = (props: PhoneLockFillProps) => {
  svg(
    viewBox := "0 0 24 24",
