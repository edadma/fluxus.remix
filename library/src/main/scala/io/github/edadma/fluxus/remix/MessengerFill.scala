...
/**
 * MessengerFill icon from the Remix Icon library, Logos category.
 */
case class MessengerFillProps(
  size: Int = 24,
...
/**
 * MessengerFill icon component.
 *
 * @example MessengerFill <> MessengerFillProps(size = 24, color = "blue")
 */
def MessengerFill = (props: MessengerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
