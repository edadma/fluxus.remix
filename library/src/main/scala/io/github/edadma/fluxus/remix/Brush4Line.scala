...
/**
 * Brush4Line icon from the Remix Icon library, Design category.
 */
case class Brush4LineProps(
  size: Int = 24,
...
/**
 * Brush4Line icon component.
 *
 * @example Brush4Line <> Brush4LineProps(size = 24, color = "blue")
 */
def Brush4Line = (props: Brush4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
