...
/**
 * PantoneLine icon from the Remix Icon library, Design category.
 */
case class PantoneLineProps(
  size: Int = 24,
...
/**
 * PantoneLine icon component.
 *
 * @example PantoneLine <> PantoneLineProps(size = 24, color = "blue")
 */
def PantoneLine = (props: PantoneLineProps) => {
  svg(
    viewBox := "0 0 24 24",
