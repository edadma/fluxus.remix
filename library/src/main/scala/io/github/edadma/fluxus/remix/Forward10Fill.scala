...
/**
 * Forward10Fill icon from the Remix Icon library, Media category.
 */
case class Forward10FillProps(
  size: Int = 24,
...
/**
 * Forward10Fill icon component.
 *
 * @example Forward10Fill <> Forward10FillProps(size = 24, color = "blue")
 */
def Forward10Fill = (props: Forward10FillProps) => {
  svg(
    viewBox := "0 0 24 24",
