...
/**
 * MentalHealthFill icon from the Remix Icon library, Health & Medical category.
 */
case class MentalHealthFillProps(
  size: Int = 24,
...
/**
 * MentalHealthFill icon component.
 *
 * @example MentalHealthFill <> MentalHealthFillProps(size = 24, color = "blue")
 */
def MentalHealthFill = (props: MentalHealthFillProps) => {
  svg(
    viewBox := "0 0 24 24",
