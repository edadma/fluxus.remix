...
/**
 * ChargingPile2Fill icon from the Remix Icon library, Map category.
 */
case class ChargingPile2FillProps(
  size: Int = 24,
...
/**
 * ChargingPile2Fill icon component.
 *
 * @example ChargingPile2Fill <> ChargingPile2FillProps(size = 24, color = "blue")
 */
def ChargingPile2Fill = (props: ChargingPile2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
