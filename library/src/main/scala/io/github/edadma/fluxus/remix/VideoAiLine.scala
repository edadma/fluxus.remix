...
/**
 * VideoAiLine icon from the Remix Icon library, Media category.
 */
case class VideoAiLineProps(
  size: Int = 24,
...
/**
 * VideoAiLine icon component.
 *
 * @example VideoAiLine <> VideoAiLineProps(size = 24, color = "blue")
 */
def VideoAiLine = (props: VideoAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
