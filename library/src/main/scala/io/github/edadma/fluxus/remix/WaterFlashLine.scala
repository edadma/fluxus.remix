...
/**
 * WaterFlashLine icon from the Remix Icon library, Finance category.
 */
case class WaterFlashLineProps(
  size: Int = 24,
...
/**
 * WaterFlashLine icon component.
 *
 * @example WaterFlashLine <> WaterFlashLineProps(size = 24, color = "blue")
 */
def WaterFlashLine = (props: WaterFlashLineProps) => {
  svg(
    viewBox := "0 0 24 24",
