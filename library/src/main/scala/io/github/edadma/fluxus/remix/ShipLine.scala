...
/**
 * ShipLine icon from the Remix Icon library, Map category.
 */
case class ShipLineProps(
  size: Int = 24,
...
/**
 * ShipLine icon component.
 *
 * @example ShipLine <> ShipLineProps(size = 24, color = "blue")
 */
def ShipLine = (props: ShipLineProps) => {
  svg(
    viewBox := "0 0 24 24",
