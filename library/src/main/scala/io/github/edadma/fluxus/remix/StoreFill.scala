...
/**
 * StoreFill icon from the Remix Icon library, Buildings category.
 */
case class StoreFillProps(
  size: Int = 24,
...
/**
 * StoreFill icon component.
 *
 * @example StoreFill <> StoreFillProps(size = 24, color = "blue")
 */
def StoreFill = (props: StoreFillProps) => {
  svg(
    viewBox := "0 0 24 24",
