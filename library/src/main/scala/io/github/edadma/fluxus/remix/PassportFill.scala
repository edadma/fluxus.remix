...
/**
 * PassportFill icon from the Remix Icon library, Map category.
 */
case class PassportFillProps(
  size: Int = 24,
...
/**
 * PassportFill icon component.
 *
 * @example PassportFill <> PassportFillProps(size = 24, color = "blue")
 */
def PassportFill = (props: PassportFillProps) => {
  svg(
    viewBox := "0 0 24 24",
