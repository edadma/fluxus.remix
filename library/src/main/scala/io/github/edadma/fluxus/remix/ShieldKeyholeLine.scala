...
/**
 * ShieldKeyholeLine icon from the Remix Icon library, System category.
 */
case class ShieldKeyholeLineProps(
  size: Int = 24,
...
/**
 * ShieldKeyholeLine icon component.
 *
 * @example ShieldKeyholeLine <> ShieldKeyholeLineProps(size = 24, color = "blue")
 */
def ShieldKeyholeLine = (props: ShieldKeyholeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
