...
/**
 * SignalTowerLine icon from the Remix Icon library, Map category.
 */
case class SignalTowerLineProps(
  size: Int = 24,
...
/**
 * SignalTowerLine icon component.
 *
 * @example SignalTowerLine <> SignalTowerLineProps(size = 24, color = "blue")
 */
def SignalTowerLine = (props: SignalTowerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
