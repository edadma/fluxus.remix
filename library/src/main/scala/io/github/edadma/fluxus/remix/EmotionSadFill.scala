...
/**
 * EmotionSadFill icon from the Remix Icon library, User & Faces category.
 */
case class EmotionSadFillProps(
  size: Int = 24,
...
/**
 * EmotionSadFill icon component.
 *
 * @example EmotionSadFill <> EmotionSadFillProps(size = 24, color = "blue")
 */
def EmotionSadFill = (props: EmotionSadFillProps) => {
  svg(
    viewBox := "0 0 24 24",
