...
/**
 * FileWord2Fill icon from the Remix Icon library, Document category.
 */
case class FileWord2FillProps(
  size: Int = 24,
...
/**
 * FileWord2Fill icon component.
 *
 * @example FileWord2Fill <> FileWord2FillProps(size = 24, color = "blue")
 */
def FileWord2Fill = (props: FileWord2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
