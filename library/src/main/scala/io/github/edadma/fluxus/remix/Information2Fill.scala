...
/**
 * Information2Fill icon from the Remix Icon library, System category.
 */
case class Information2FillProps(
  size: Int = 24,
...
/**
 * Information2Fill icon component.
 *
 * @example Information2Fill <> Information2FillProps(size = 24, color = "blue")
 */
def Information2Fill = (props: Information2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
