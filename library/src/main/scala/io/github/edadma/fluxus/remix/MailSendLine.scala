...
/**
 * MailSendLine icon from the Remix Icon library, Business category.
 */
case class MailSendLineProps(
  size: Int = 24,
...
/**
 * MailSendLine icon component.
 *
 * @example MailSendLine <> MailSendLineProps(size = 24, color = "blue")
 */
def MailSendLine = (props: MailSendLineProps) => {
  svg(
    viewBox := "0 0 24 24",
