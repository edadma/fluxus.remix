...
/**
 * CalendarScheduleFill icon from the Remix Icon library, Business category.
 */
case class CalendarScheduleFillProps(
  size: Int = 24,
...
/**
 * CalendarScheduleFill icon component.
 *
 * @example CalendarScheduleFill <> CalendarScheduleFillProps(size = 24, color = "blue")
 */
def CalendarScheduleFill = (props: CalendarScheduleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
