...
/**
 * BlueskyFill icon from the Remix Icon library, Logos category.
 */
case class BlueskyFillProps(
  size: Int = 24,
...
/**
 * BlueskyFill icon component.
 *
 * @example BlueskyFill <> BlueskyFillProps(size = 24, color = "blue")
 */
def BlueskyFill = (props: BlueskyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
