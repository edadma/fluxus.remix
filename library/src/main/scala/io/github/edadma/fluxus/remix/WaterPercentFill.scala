...
/**
 * WaterPercentFill icon from the Remix Icon library, Weather category.
 */
case class WaterPercentFillProps(
  size: Int = 24,
...
/**
 * WaterPercentFill icon component.
 *
 * @example WaterPercentFill <> WaterPercentFillProps(size = 24, color = "blue")
 */
def WaterPercentFill = (props: WaterPercentFillProps) => {
  svg(
    viewBox := "0 0 24 24",
