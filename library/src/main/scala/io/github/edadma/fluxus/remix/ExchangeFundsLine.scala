...
/**
 * ExchangeFundsLine icon from the Remix Icon library, Finance category.
 */
case class ExchangeFundsLineProps(
  size: Int = 24,
...
/**
 * ExchangeFundsLine icon component.
 *
 * @example ExchangeFundsLine <> ExchangeFundsLineProps(size = 24, color = "blue")
 */
def ExchangeFundsLine = (props: ExchangeFundsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
