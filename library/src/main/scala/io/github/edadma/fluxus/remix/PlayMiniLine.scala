...
/**
 * PlayMiniLine icon from the Remix Icon library, Media category.
 */
case class PlayMiniLineProps(
  size: Int = 24,
...
/**
 * PlayMiniLine icon component.
 *
 * @example PlayMiniLine <> PlayMiniLineProps(size = 24, color = "blue")
 */
def PlayMiniLine = (props: PlayMiniLineProps) => {
  svg(
    viewBox := "0 0 24 24",
