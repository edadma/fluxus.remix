...
/**
 * ClaudeFill icon from the Remix Icon library, Logos category.
 */
case class ClaudeFillProps(
  size: Int = 24,
...
/**
 * ClaudeFill icon component.
 *
 * @example ClaudeFill <> ClaudeFillProps(size = 24, color = "blue")
 */
def ClaudeFill = (props: ClaudeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
