...
/**
 * UserStarLine icon from the Remix Icon library, User & Faces category.
 */
case class UserStarLineProps(
  size: Int = 24,
...
/**
 * UserStarLine icon component.
 *
 * @example UserStarLine <> UserStarLineProps(size = 24, color = "blue")
 */
def UserStarLine = (props: UserStarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
