...
/**
 * WifiOffLine icon from the Remix Icon library, Device category.
 */
case class WifiOffLineProps(
  size: Int = 24,
...
/**
 * WifiOffLine icon component.
 *
 * @example WifiOffLine <> WifiOffLineProps(size = 24, color = "blue")
 */
def WifiOffLine = (props: WifiOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
