...
/**
 * Fingerprint2Fill icon from the Remix Icon library, Device category.
 */
case class Fingerprint2FillProps(
  size: Int = 24,
...
/**
 * Fingerprint2Fill icon component.
 *
 * @example Fingerprint2Fill <> Fingerprint2FillProps(size = 24, color = "blue")
 */
def Fingerprint2Fill = (props: Fingerprint2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
