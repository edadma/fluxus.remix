...
/**
 * MoonCloudyLine icon from the Remix Icon library, Weather category.
 */
case class MoonCloudyLineProps(
  size: Int = 24,
...
/**
 * MoonCloudyLine icon component.
 *
 * @example MoonCloudyLine <> MoonCloudyLineProps(size = 24, color = "blue")
 */
def MoonCloudyLine = (props: MoonCloudyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
