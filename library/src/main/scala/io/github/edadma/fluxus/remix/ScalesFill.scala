...
/**
 * ScalesFill icon from the Remix Icon library, Others category.
 */
case class ScalesFillProps(
  size: Int = 24,
 ...
 *
 * @example ScalesFill <> ScalesFillProps(size = 24, color = "blue")
 */
def ScalesFill = (props: ScalesFillProps) => {
  svg(
    viewBox := "0 0 24 24",
