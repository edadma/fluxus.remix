...
/**
 * Apps2AddFill icon from the Remix Icon library, System category.
 */
case class Apps2AddFillProps(
  size: Int = 24,
...
/**
 * Apps2AddFill icon component.
 *
 * @example Apps2AddFill <> Apps2AddFillProps(size = 24, color = "blue")
 */
def Apps2AddFill = (props: Apps2AddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
