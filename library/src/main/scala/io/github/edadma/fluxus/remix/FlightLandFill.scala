...
/**
 * FlightLandFill icon from the Remix Icon library, Map category.
 */
case class FlightLandFillProps(
  size: Int = 24,
...
/**
 * FlightLandFill icon component.
 *
 * @example FlightLandFill <> FlightLandFillProps(size = 24, color = "blue")
 */
def FlightLandFill = (props: FlightLandFillProps) => {
  svg(
    viewBox := "0 0 24 24",
