...
/**
 * ErrorWarningLine icon from the Remix Icon library, System category.
 */
case class ErrorWarningLineProps(
  size: Int = 24,
...
/**
 * ErrorWarningLine icon component.
 *
 * @example ErrorWarningLine <> ErrorWarningLineProps(size = 24, color = "blue")
 */
def ErrorWarningLine = (props: ErrorWarningLineProps) => {
  svg(
    viewBox := "0 0 24 24",
