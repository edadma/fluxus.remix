...
/**
 * TakeawayLine icon from the Remix Icon library, Map category.
 */
case class TakeawayLineProps(
  size: Int = 24,
...
/**
 * TakeawayLine icon component.
 *
 * @example TakeawayLine <> TakeawayLineProps(size = 24, color = "blue")
 */
def TakeawayLine = (props: TakeawayLineProps) => {
  svg(
    viewBox := "0 0 24 24",
