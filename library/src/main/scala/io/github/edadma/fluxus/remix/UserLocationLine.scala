...
/**
 * UserLocationLine icon from the Remix Icon library, User & Faces category.
 */
case class UserLocationLineProps(
  size: Int = 24,
...
/**
 * UserLocationLine icon component.
 *
 * @example UserLocationLine <> UserLocationLineProps(size = 24, color = "blue")
 */
def UserLocationLine = (props: UserLocationLineProps) => {
  svg(
    viewBox := "0 0 24 24",
