...
/**
 * EmphasisCn icon from the Remix Icon library, Editor category.
 */
case class EmphasisCnProps(
  size: Int = 24,
...
/**
 * EmphasisCn icon component.
 *
 * @example EmphasisCn <> EmphasisCnProps(size = 24, color = "blue")
 */
def EmphasisCn = (props: EmphasisCnProps) => {
  svg(
    viewBox := "0 0 24 24",
