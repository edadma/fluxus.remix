...
/**
 * GitlabFill icon from the Remix Icon library, Logos category.
 */
case class GitlabFillProps(
  size: Int = 24,
...
/**
 * GitlabFill icon component.
 *
 * @example GitlabFill <> GitlabFillProps(size = 24, color = "blue")
 */
def GitlabFill = (props: GitlabFillProps) => {
  svg(
    viewBox := "0 0 24 24",
