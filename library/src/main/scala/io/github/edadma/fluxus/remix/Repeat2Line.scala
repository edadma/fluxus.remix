...
/**
 * Repeat2Line icon from the Remix Icon library, Media category.
 */
case class Repeat2LineProps(
  size: Int = 24,
...
/**
 * Repeat2Line icon component.
 *
 * @example Repeat2Line <> Repeat2LineProps(size = 24, color = "blue")
 */
def Repeat2Line = (props: Repeat2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
