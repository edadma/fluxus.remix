...
/**
 * AccountPinCircleFill icon from the Remix Icon library, User & Faces category.
 */
case class AccountPinCircleFillProps(
  size: Int = 24,
...
/**
 * AccountPinCircleFill icon component.
 *
 * @example AccountPinCircleFill <> AccountPinCircleFillProps(size = 24, color = "blue")
 */
def AccountPinCircleFill = (props: AccountPinCircleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
