...
/**
 * DashboardHorizontalFill icon from the Remix Icon library, System category.
 */
case class DashboardHorizontalFillProps(
  size: Int = 24,
...
/**
 * DashboardHorizontalFill icon component.
 *
 * @example DashboardHorizontalFill <> DashboardHorizontalFillProps(size = 24, color = "blue")
 */
def DashboardHorizontalFill = (props: DashboardHorizontalFillProps) => {
  svg(
    viewBox := "0 0 24 24",
