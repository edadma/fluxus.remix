...
/**
 * ListRadio icon from the Remix Icon library, Editor category.
 */
case class ListRadioProps(
  size: Int = 24,
...
/**
 * ListRadio icon component.
 *
 * @example ListRadio <> ListRadioProps(size = 24, color = "blue")
 */
def ListRadio = (props: ListRadioProps) => {
  svg(
    viewBox := "0 0 24 24",
