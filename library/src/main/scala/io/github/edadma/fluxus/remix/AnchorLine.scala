...
/**
 * AnchorLine icon from the Remix Icon library, Map category.
 */
case class AnchorLineProps(
  size: Int = 24,
...
/**
 * AnchorLine icon component.
 *
 * @example AnchorLine <> AnchorLineProps(size = 24, color = "blue")
 */
def AnchorLine = (props: AnchorLineProps) => {
  svg(
    viewBox := "0 0 24 24",
