...
/**
 * Progress1Line icon from the Remix Icon library, System category.
 */
case class Progress1LineProps(
  size: Int = 24,
...
/**
 * Progress1Line icon component.
 *
 * @example Progress1Line <> Progress1LineProps(size = 24, color = "blue")
 */
def Progress1Line = (props: Progress1LineProps) => {
  svg(
    viewBox := "0 0 24 24",
