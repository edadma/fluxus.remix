...
/**
 * CreativeCommonsSaLine icon from the Remix Icon library, Business category.
 */
case class CreativeCommonsSaLineProps(
  size: Int = 24,
...
/**
 * CreativeCommonsSaLine icon component.
 *
 * @example CreativeCommonsSaLine <> CreativeCommonsSaLineProps(size = 24, color = "blue")
 */
def CreativeCommonsSaLine = (props: CreativeCommonsSaLineProps) => {
  svg(
    viewBox := "0 0 24 24",
