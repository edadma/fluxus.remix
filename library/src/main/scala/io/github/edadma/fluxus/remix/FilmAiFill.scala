...
/**
 * FilmAiFill icon from the Remix Icon library, Media category.
 */
case class FilmAiFillProps(
  size: Int = 24,
...
/**
 * FilmAiFill icon component.
 *
 * @example FilmAiFill <> FilmAiFillProps(size = 24, color = "blue")
 */
def FilmAiFill = (props: FilmAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
