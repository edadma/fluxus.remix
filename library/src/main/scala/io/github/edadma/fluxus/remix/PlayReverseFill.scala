...
/**
 * PlayReverseFill icon from the Remix Icon library, Media category.
 */
case class PlayReverseFillProps(
  size: Int = 24,
...
/**
 * PlayReverseFill icon component.
 *
 * @example PlayReverseFill <> PlayReverseFillProps(size = 24, color = "blue")
 */
def PlayReverseFill = (props: PlayReverseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
