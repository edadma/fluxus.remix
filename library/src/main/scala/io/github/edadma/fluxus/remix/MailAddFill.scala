...
/**
 * MailAddFill icon from the Remix Icon library, Business category.
 */
case class MailAddFillProps(
  size: Int = 24,
...
/**
 * MailAddFill icon component.
 *
 * @example MailAddFill <> MailAddFillProps(size = 24, color = "blue")
 */
def MailAddFill = (props: MailAddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
