...
/**
 * SurveyLine icon from the Remix Icon library, Document category.
 */
case class SurveyLineProps(
  size: Int = 24,
...
/**
 * SurveyLine icon component.
 *
 * @example SurveyLine <> SurveyLineProps(size = 24, color = "blue")
 */
def SurveyLine = (props: SurveyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
