...
/**
 * PhpLine icon from the Remix Icon library, Development category.
 */
case class PhpLineProps(
  size: Int = 24,
...
/**
 * PhpLine icon component.
 *
 * @example PhpLine <> PhpLineProps(size = 24, color = "blue")
 */
def PhpLine = (props: PhpLineProps) => {
  svg(
    viewBox := "0 0 24 24",
