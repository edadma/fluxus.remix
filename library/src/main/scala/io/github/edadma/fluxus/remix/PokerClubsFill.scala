...
/**
 * PokerClubsFill icon from the Remix Icon library, Others category.
 */
case class PokerClubsFillProps(
  size: Int = 24,
...
/**
 * PokerClubsFill icon component.
 *
 * @example PokerClubsFill <> PokerClubsFillProps(size = 24, color = "blue")
 */
def PokerClubsFill = (props: PokerClubsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
