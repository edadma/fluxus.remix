...
/**
 * SpeakerFill icon from the Remix Icon library, Media category.
 */
case class SpeakerFillProps(
  size: Int = 24,
...
/**
 * SpeakerFill icon component.
 *
 * @example SpeakerFill <> SpeakerFillProps(size = 24, color = "blue")
 */
def SpeakerFill = (props: SpeakerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
