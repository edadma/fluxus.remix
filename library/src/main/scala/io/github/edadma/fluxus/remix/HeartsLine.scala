...
/**
 * HeartsLine icon from the Remix Icon library, Health & Medical category.
 */
case class HeartsLineProps(
  size: Int = 24,
...
/**
 * HeartsLine icon component.
 *
 * @example HeartsLine <> HeartsLineProps(size = 24, color = "blue")
 */
def HeartsLine = (props: HeartsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
