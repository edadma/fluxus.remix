...
/**
 * ThumbUpFill icon from the Remix Icon library, System category.
 */
case class ThumbUpFillProps(
  size: Int = 24,
...
/**
 * ThumbUpFill icon component.
 *
 * @example ThumbUpFill <> ThumbUpFillProps(size = 24, color = "blue")
 */
def ThumbUpFill = (props: ThumbUpFillProps) => {
  svg(
    viewBox := "0 0 24 24",
