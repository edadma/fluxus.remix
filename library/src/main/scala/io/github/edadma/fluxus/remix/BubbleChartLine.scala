...
/**
 * BubbleChartLine icon from the Remix Icon library, Business category.
 */
case class BubbleChartLineProps(
  size: Int = 24,
...
/**
 * BubbleChartLine icon component.
 *
 * @example BubbleChartLine <> BubbleChartLineProps(size = 24, color = "blue")
 */
def BubbleChartLine = (props: BubbleChartLineProps) => {
  svg(
    viewBox := "0 0 24 24",
