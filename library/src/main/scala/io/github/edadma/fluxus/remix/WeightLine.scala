...
/**
 * WeightLine icon from the Remix Icon library, Others category.
 */
case class WeightLineProps(
  size: Int = 24,
...
/**
 * WeightLine icon component.
 *
 * @example WeightLine <> WeightLineProps(size = 24, color = "blue")
 */
def WeightLine = (props: WeightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
