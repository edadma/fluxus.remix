...
/**
 * LeafLine icon from the Remix Icon library, Others category.
 */
case class LeafLineProps(
  size: Int = 24,
...
/**
 * LeafLine icon component.
 *
 * @example LeafLine <> LeafLineProps(size = 24, color = "blue")
 */
def LeafLine = (props: LeafLineProps) => {
  svg(
    viewBox := "0 0 24 24",
