...
/**
 * FingerprintFill icon from the Remix Icon library, Device category.
 */
case class FingerprintFillProps(
  size: Int = 24,
...
/**
 * FingerprintFill icon component.
 *
 * @example FingerprintFill <> FingerprintFillProps(size = 24, color = "blue")
 */
def FingerprintFill = (props: FingerprintFillProps) => {
  svg(
    viewBox := "0 0 24 24",
