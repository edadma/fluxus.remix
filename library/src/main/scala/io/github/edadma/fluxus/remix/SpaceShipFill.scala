...
/**
 * SpaceShipFill icon from the Remix Icon library, Map category.
 */
case class SpaceShipFillProps(
  size: Int = 24,
...
/**
 * SpaceShipFill icon component.
 *
 * @example SpaceShipFill <> SpaceShipFillProps(size = 24, color = "blue")
 */
def SpaceShipFill = (props: SpaceShipFillProps) => {
  svg(
    viewBox := "0 0 24 24",
