...
/**
 * WindyLine icon from the Remix Icon library, Weather category.
 */
case class WindyLineProps(
  size: Int = 24,
...
/**
 * WindyLine icon component.
 *
 * @example WindyLine <> WindyLineProps(size = 24, color = "blue")
 */
def WindyLine = (props: WindyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
