...
/**
 * BilliardsLine icon from the Remix Icon library, Others category.
 */
case class BilliardsLineProps(
  size: Int = 24,
...
/**
 * BilliardsLine icon component.
 *
 * @example BilliardsLine <> BilliardsLineProps(size = 24, color = "blue")
 */
def BilliardsLine = (props: BilliardsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
