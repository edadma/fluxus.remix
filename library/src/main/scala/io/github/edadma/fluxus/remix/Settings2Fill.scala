...
/**
 * Settings2Fill icon from the Remix Icon library, System category.
 */
case class Settings2FillProps(
  size: Int = 24,
...
/**
 * Settings2Fill icon component.
 *
 * @example Settings2Fill <> Settings2FillProps(size = 24, color = "blue")
 */
def Settings2Fill = (props: Settings2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
