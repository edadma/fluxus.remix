...
/**
 * BookLine icon from the Remix Icon library, Document category.
 */
case class BookLineProps(
  size: Int = 24,
...
/**
 * BookLine icon component.
 *
 * @example BookLine <> BookLineProps(size = 24, color = "blue")
 */
def BookLine = (props: BookLineProps) => {
  svg(
    viewBox := "0 0 24 24",
