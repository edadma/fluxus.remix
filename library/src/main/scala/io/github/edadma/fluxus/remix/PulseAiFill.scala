...
/**
 * PulseAiFill icon from the Remix Icon library, Health & Medical category.
 */
case class PulseAiFillProps(
  size: Int = 24,
...
/**
 * PulseAiFill icon component.
 *
 * @example PulseAiFill <> PulseAiFillProps(size = 24, color = "blue")
 */
def PulseAiFill = (props: PulseAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
