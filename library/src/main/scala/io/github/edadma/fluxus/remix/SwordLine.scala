...
/**
 * SwordLine icon from the Remix Icon library, Others category.
 */
case class SwordLineProps(
  size: Int = 24,
...
/**
 * SwordLine icon component.
 *
 * @example SwordLine <> SwordLineProps(size = 24, color = "blue")
 */
def SwordLine = (props: SwordLineProps) => {
  svg(
    viewBox := "0 0 24 24",
