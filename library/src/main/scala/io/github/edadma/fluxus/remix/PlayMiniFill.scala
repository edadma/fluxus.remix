...
/**
 * PlayMiniFill icon from the Remix Icon library, Media category.
 */
case class PlayMiniFillProps(
  size: Int = 24,
...
/**
 * PlayMiniFill icon component.
 *
 * @example PlayMiniFill <> PlayMiniFillProps(size = 24, color = "blue")
 */
def PlayMiniFill = (props: PlayMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
