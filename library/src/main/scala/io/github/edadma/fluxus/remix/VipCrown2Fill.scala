...
/**
 * VipCrown2Fill icon from the Remix Icon library, Finance category.
 */
case class VipCrown2FillProps(
  size: Int = 24,
...
/**
 * VipCrown2Fill icon component.
 *
 * @example VipCrown2Fill <> VipCrown2FillProps(size = 24, color = "blue")
 */
def VipCrown2Fill = (props: VipCrown2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
