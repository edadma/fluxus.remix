...
/**
 * Compass3Line icon from the Remix Icon library, Map category.
 */
case class Compass3LineProps(
  size: Int = 24,
...
/**
 * Compass3Line icon component.
 *
 * @example Compass3Line <> Compass3LineProps(size = 24, color = "blue")
 */
def Compass3Line = (props: Compass3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
