...
/**
 * SteeringLine icon from the Remix Icon library, Map category.
 */
case class SteeringLineProps(
  size: Int = 24,
...
/**
 * SteeringLine icon component.
 *
 * @example SteeringLine <> SteeringLineProps(size = 24, color = "blue")
 */
def SteeringLine = (props: SteeringLineProps) => {
  svg(
    viewBox := "0 0 24 24",
