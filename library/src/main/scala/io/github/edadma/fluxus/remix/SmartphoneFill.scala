...
/**
 * SmartphoneFill icon from the Remix Icon library, Device category.
 */
case class SmartphoneFillProps(
  size: Int = 24,
...
/**
 * SmartphoneFill icon component.
 *
 * @example SmartphoneFill <> SmartphoneFillProps(size = 24, color = "blue")
 */
def SmartphoneFill = (props: SmartphoneFillProps) => {
  svg(
    viewBox := "0 0 24 24",
