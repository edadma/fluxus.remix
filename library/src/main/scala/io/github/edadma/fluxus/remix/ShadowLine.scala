...
/**
 * ShadowLine icon from the Remix Icon library, Design category.
 */
case class ShadowLineProps(
  size: Int = 24,
...
/**
 * ShadowLine icon component.
 *
 * @example ShadowLine <> ShadowLineProps(size = 24, color = "blue")
 */
def ShadowLine = (props: ShadowLineProps) => {
  svg(
    viewBox := "0 0 24 24",
