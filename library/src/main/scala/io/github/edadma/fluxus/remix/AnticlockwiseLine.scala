...
/**
 * AnticlockwiseLine icon from the Remix Icon library, Design category.
 */
case class AnticlockwiseLineProps(
  size: Int = 24,
...
/**
 * AnticlockwiseLine icon component.
 *
 * @example AnticlockwiseLine <> AnticlockwiseLineProps(size = 24, color = "blue")
 */
def AnticlockwiseLine = (props: AnticlockwiseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
