...
/**
 * PolaroidLine icon from the Remix Icon library, Media category.
 */
case class PolaroidLineProps(
  size: Int = 24,
...
/**
 * PolaroidLine icon component.
 *
 * @example PolaroidLine <> PolaroidLineProps(size = 24, color = "blue")
 */
def PolaroidLine = (props: PolaroidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
