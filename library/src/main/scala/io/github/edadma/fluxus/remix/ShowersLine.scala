...
/**
 * ShowersLine icon from the Remix Icon library, Weather category.
 */
case class ShowersLineProps(
  size: Int = 24,
...
/**
 * ShowersLine icon component.
 *
 * @example ShowersLine <> ShowersLineProps(size = 24, color = "blue")
 */
def ShowersLine = (props: ShowersLineProps) => {
  svg(
    viewBox := "0 0 24 24",
