...
/**
 * EmojiStickerLine icon from the Remix Icon library, Communication category.
 */
case class EmojiStickerLineProps(
  size: Int = 24,
...
/**
 * EmojiStickerLine icon component.
 *
 * @example EmojiStickerLine <> EmojiStickerLineProps(size = 24, color = "blue")
 */
def EmojiStickerLine = (props: EmojiStickerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
