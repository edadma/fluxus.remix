...
/**
 * UserVoiceLine icon from the Remix Icon library, User & Faces category.
 */
case class UserVoiceLineProps(
  size: Int = 24,
...
/**
 * UserVoiceLine icon component.
 *
 * @example UserVoiceLine <> UserVoiceLineProps(size = 24, color = "blue")
 */
def UserVoiceLine = (props: UserVoiceLineProps) => {
  svg(
    viewBox := "0 0 24 24",
