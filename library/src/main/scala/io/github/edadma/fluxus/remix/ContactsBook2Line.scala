...
/**
 * ContactsBook2Line icon from the Remix Icon library, Document category.
 */
case class ContactsBook2LineProps(
  size: Int = 24,
...
/**
 * ContactsBook2Line icon component.
 *
 * @example ContactsBook2Line <> ContactsBook2LineProps(size = 24, color = "blue")
 */
def ContactsBook2Line = (props: ContactsBook2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
