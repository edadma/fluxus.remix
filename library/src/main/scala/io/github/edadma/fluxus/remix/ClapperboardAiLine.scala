...
/**
 * ClapperboardAiLine icon from the Remix Icon library, Media category.
 */
case class ClapperboardAiLineProps(
  size: Int = 24,
...
/**
 * ClapperboardAiLine icon component.
 *
 * @example ClapperboardAiLine <> ClapperboardAiLineProps(size = 24, color = "blue")
 */
def ClapperboardAiLine = (props: ClapperboardAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
