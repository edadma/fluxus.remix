...
/**
 * BaseStationFill icon from the Remix Icon library, Device category.
 */
case class BaseStationFillProps(
  size: Int = 24,
...
/**
 * BaseStationFill icon component.
 *
 * @example BaseStationFill <> BaseStationFillProps(size = 24, color = "blue")
 */
def BaseStationFill = (props: BaseStationFillProps) => {
  svg(
    viewBox := "0 0 24 24",
