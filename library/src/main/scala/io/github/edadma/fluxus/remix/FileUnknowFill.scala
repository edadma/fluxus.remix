...
/**
 * FileUnknowFill icon from the Remix Icon library, Document category.
 */
case class FileUnknowFillProps(
  size: Int = 24,
...
/**
 * FileUnknowFill icon component.
 *
 * @example FileUnknowFill <> FileUnknowFillProps(size = 24, color = "blue")
 */
def FileUnknowFill = (props: FileUnknowFillProps) => {
  svg(
    viewBox := "0 0 24 24",
