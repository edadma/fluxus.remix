...
/**
 * ExchangeFundsFill icon from the Remix Icon library, Finance category.
 */
case class ExchangeFundsFillProps(
  size: Int = 24,
...
/**
 * ExchangeFundsFill icon component.
 *
 * @example ExchangeFundsFill <> ExchangeFundsFillProps(size = 24, color = "blue")
 */
def ExchangeFundsFill = (props: ExchangeFundsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
