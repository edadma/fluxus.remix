...
/**
 * FlightTakeoffLine icon from the Remix Icon library, Map category.
 */
case class FlightTakeoffLineProps(
  size: Int = 24,
...
/**
 * FlightTakeoffLine icon component.
 *
 * @example FlightTakeoffLine <> FlightTakeoffLineProps(size = 24, color = "blue")
 */
def FlightTakeoffLine = (props: FlightTakeoffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
