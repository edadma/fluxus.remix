...
/**
 * LinksFill icon from the Remix Icon library, Business category.
 */
case class LinksFillProps(
  size: Int = 24,
...
/**
 * LinksFill icon component.
 *
 * @example LinksFill <> LinksFillProps(size = 24, color = "blue")
 */
def LinksFill = (props: LinksFillProps) => {
  svg(
    viewBox := "0 0 24 24",
