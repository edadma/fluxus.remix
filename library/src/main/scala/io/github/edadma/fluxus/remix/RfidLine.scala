...
/**
 * RfidLine icon from the Remix Icon library, Device category.
 */
case class RfidLineProps(
  size: Int = 24,
...
/**
 * RfidLine icon component.
 *
 * @example RfidLine <> RfidLineProps(size = 24, color = "blue")
 */
def RfidLine = (props: RfidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
