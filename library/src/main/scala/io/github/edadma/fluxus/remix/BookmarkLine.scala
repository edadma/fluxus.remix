...
/**
 * BookmarkLine icon from the Remix Icon library, Business category.
 */
case class BookmarkLineProps(
  size: Int = 24,
...
/**
 * BookmarkLine icon component.
 *
 * @example BookmarkLine <> BookmarkLineProps(size = 24, color = "blue")
 */
def BookmarkLine = (props: BookmarkLineProps) => {
  svg(
    viewBox := "0 0 24 24",
