...
/**
 * QuestionnaireFill icon from the Remix Icon library, Communication category.
 */
case class QuestionnaireFillProps(
  size: Int = 24,
...
/**
 * QuestionnaireFill icon component.
 *
 * @example QuestionnaireFill <> QuestionnaireFillProps(size = 24, color = "blue")
 */
def QuestionnaireFill = (props: QuestionnaireFillProps) => {
  svg(
    viewBox := "0 0 24 24",
