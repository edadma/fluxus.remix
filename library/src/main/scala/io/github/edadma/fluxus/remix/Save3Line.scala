...
/**
 * Save3Line icon from the Remix Icon library, Device category.
 */
case class Save3LineProps(
  size: Int = 24,
...
/**
 * Save3Line icon component.
 *
 * @example Save3Line <> Save3LineProps(size = 24, color = "blue")
 */
def Save3Line = (props: Save3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
