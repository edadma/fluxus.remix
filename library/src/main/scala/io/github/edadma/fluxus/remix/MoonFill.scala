...
/**
 * MoonFill icon from the Remix Icon library, Weather category.
 */
case class MoonFillProps(
  size: Int = 24,
 ...
 *
 * @example MoonFill <> MoonFillProps(size = 24, color = "blue")
 */
def MoonFill = (props: MoonFillProps) => {
  svg(
    viewBox := "0 0 24 24",
