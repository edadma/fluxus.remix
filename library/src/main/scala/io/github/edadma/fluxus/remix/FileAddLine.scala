...
/**
 * FileAddLine icon from the Remix Icon library, Document category.
 */
case class FileAddLineProps(
  size: Int = 24,
...
/**
 * FileAddLine icon component.
 *
 * @example FileAddLine <> FileAddLineProps(size = 24, color = "blue")
 */
def FileAddLine = (props: FileAddLineProps) => {
  svg(
    viewBox := "0 0 24 24",
