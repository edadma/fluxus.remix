...
/**
 * RulerLine icon from the Remix Icon library, Design category.
 */
case class RulerLineProps(
  size: Int = 24,
...
/**
 * RulerLine icon component.
 *
 * @example RulerLine <> RulerLineProps(size = 24, color = "blue")
 */
def RulerLine = (props: RulerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
