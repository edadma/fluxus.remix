...
/**
 * TeamLine icon from the Remix Icon library, User & Faces category.
 */
case class TeamLineProps(
  size: Int = 24,
...
/**
 * TeamLine icon component.
 *
 * @example TeamLine <> TeamLineProps(size = 24, color = "blue")
 */
def TeamLine = (props: TeamLineProps) => {
  svg(
    viewBox := "0 0 24 24",
