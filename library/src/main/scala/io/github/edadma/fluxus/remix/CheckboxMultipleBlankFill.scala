...
/**
 * CheckboxMultipleBlankFill icon from the Remix Icon library, System category.
 */
case class CheckboxMultipleBlankFillProps(
  size: Int = 24,
...
/**
 * CheckboxMultipleBlankFill icon component.
 *
 * @example CheckboxMultipleBlankFill <> CheckboxMultipleBlankFillProps(size = 24, color = "blue")
 */
def CheckboxMultipleBlankFill = (props: CheckboxMultipleBlankFillProps) => {
  svg(
    viewBox := "0 0 24 24",
