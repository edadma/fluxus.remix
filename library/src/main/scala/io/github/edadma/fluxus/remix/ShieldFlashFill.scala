...
/**
 * ShieldFlashFill icon from the Remix Icon library, System category.
 */
case class ShieldFlashFillProps(
  size: Int = 24,
...
/**
 * ShieldFlashFill icon component.
 *
 * @example ShieldFlashFill <> ShieldFlashFillProps(size = 24, color = "blue")
 */
def ShieldFlashFill = (props: ShieldFlashFillProps) => {
  svg(
    viewBox := "0 0 24 24",
