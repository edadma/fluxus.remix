...
/**
 * AlarmSnoozeLine icon from the Remix Icon library, System category.
 */
case class AlarmSnoozeLineProps(
  size: Int = 24,
...
/**
 * AlarmSnoozeLine icon component.
 *
 * @example AlarmSnoozeLine <> AlarmSnoozeLineProps(size = 24, color = "blue")
 */
def AlarmSnoozeLine = (props: AlarmSnoozeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
