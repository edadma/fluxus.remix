...
/**
 * Safe2Line icon from the Remix Icon library, Finance category.
 */
case class Safe2LineProps(
  size: Int = 24,
...
/**
 * Safe2Line icon component.
 *
 * @example Safe2Line <> Safe2LineProps(size = 24, color = "blue")
 */
def Safe2Line = (props: Safe2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
