...
/**
 * GhostSmileLine icon from the Remix Icon library, User & Faces category.
 */
case class GhostSmileLineProps(
  size: Int = 24,
...
/**
 * GhostSmileLine icon component.
 *
 * @example GhostSmileLine <> GhostSmileLineProps(size = 24, color = "blue")
 */
def GhostSmileLine = (props: GhostSmileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
