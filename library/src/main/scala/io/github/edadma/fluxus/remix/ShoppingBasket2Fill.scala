...
/**
 * ShoppingBasket2Fill icon from the Remix Icon library, Finance category.
 */
case class ShoppingBasket2FillProps(
  size: Int = 24,
...
/**
 * ShoppingBasket2Fill icon component.
 *
 * @example ShoppingBasket2Fill <> ShoppingBasket2FillProps(size = 24, color = "blue")
 */
def ShoppingBasket2Fill = (props: ShoppingBasket2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
