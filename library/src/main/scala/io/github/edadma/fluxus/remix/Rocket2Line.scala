...
/**
 * Rocket2Line icon from the Remix Icon library, Map category.
 */
case class Rocket2LineProps(
  size: Int = 24,
...
/**
 * Rocket2Line icon component.
 *
 * @example Rocket2Line <> Rocket2LineProps(size = 24, color = "blue")
 */
def Rocket2Line = (props: Rocket2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
