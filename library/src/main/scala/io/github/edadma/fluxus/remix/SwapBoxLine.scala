...
/**
 * SwapBoxLine icon from the Remix Icon library, Finance category.
 */
case class SwapBoxLineProps(
  size: Int = 24,
...
/**
 * SwapBoxLine icon component.
 *
 * @example SwapBoxLine <> SwapBoxLineProps(size = 24, color = "blue")
 */
def SwapBoxLine = (props: SwapBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
