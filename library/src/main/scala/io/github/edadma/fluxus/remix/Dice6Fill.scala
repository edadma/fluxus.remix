...
/**
 * Dice6Fill icon from the Remix Icon library, Others category.
 */
case class Dice6FillProps(
  size: Int = 24,
...
/**
 * Dice6Fill icon component.
 *
 * @example Dice6Fill <> Dice6FillProps(size = 24, color = "blue")
 */
def Dice6Fill = (props: Dice6FillProps) => {
  svg(
    viewBox := "0 0 24 24",
