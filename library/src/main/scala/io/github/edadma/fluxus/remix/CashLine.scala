...
/**
 * CashLine icon from the Remix Icon library, Finance category.
 */
case class CashLineProps(
  size: Int = 24,
...
/**
 * CashLine icon component.
 *
 * @example CashLine <> CashLineProps(size = 24, color = "blue")
 */
def CashLine = (props: CashLineProps) => {
  svg(
    viewBox := "0 0 24 24",
