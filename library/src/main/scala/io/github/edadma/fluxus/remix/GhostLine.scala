...
/**
 * GhostLine icon from the Remix Icon library, User & Faces category.
 */
case class GhostLineProps(
  size: Int = 24,
...
/**
 * GhostLine icon component.
 *
 * @example GhostLine <> GhostLineProps(size = 24, color = "blue")
 */
def GhostLine = (props: GhostLineProps) => {
  svg(
    viewBox := "0 0 24 24",
