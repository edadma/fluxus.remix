...
/**
 * Polaroid2Line icon from the Remix Icon library, Media category.
 */
case class Polaroid2LineProps(
  size: Int = 24,
...
/**
 * Polaroid2Line icon component.
 *
 * @example Polaroid2Line <> Polaroid2LineProps(size = 24, color = "blue")
 */
def Polaroid2Line = (props: Polaroid2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
