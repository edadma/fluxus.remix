...
/**
 * GogglesLine icon from the Remix Icon library, Others category.
 */
case class GogglesLineProps(
  size: Int = 24,
...
/**
 * GogglesLine icon component.
 *
 * @example GogglesLine <> GogglesLineProps(size = 24, color = "blue")
 */
def GogglesLine = (props: GogglesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
