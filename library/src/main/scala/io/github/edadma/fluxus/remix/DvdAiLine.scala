...
/**
 * DvdAiLine icon from the Remix Icon library, Media category.
 */
case class DvdAiLineProps(
  size: Int = 24,
...
/**
 * DvdAiLine icon component.
 *
 * @example DvdAiLine <> DvdAiLineProps(size = 24, color = "blue")
 */
def DvdAiLine = (props: DvdAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
