...
/**
 * LockUnlockFill icon from the Remix Icon library, System category.
 */
case class LockUnlockFillProps(
  size: Int = 24,
...
/**
 * LockUnlockFill icon component.
 *
 * @example LockUnlockFill <> LockUnlockFillProps(size = 24, color = "blue")
 */
def LockUnlockFill = (props: LockUnlockFillProps) => {
  svg(
    viewBox := "0 0 24 24",
