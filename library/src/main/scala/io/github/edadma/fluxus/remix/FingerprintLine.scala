...
/**
 * FingerprintLine icon from the Remix Icon library, Device category.
 */
case class FingerprintLineProps(
  size: Int = 24,
...
/**
 * FingerprintLine icon component.
 *
 * @example FingerprintLine <> FingerprintLineProps(size = 24, color = "blue")
 */
def FingerprintLine = (props: FingerprintLineProps) => {
  svg(
    viewBox := "0 0 24 24",
