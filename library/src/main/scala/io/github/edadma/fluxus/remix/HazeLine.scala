...
/**
 * HazeLine icon from the Remix Icon library, Weather category.
 */
case class HazeLineProps(
  size: Int = 24,
...
/**
 * HazeLine icon component.
 *
 * @example HazeLine <> HazeLineProps(size = 24, color = "blue")
 */
def HazeLine = (props: HazeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
