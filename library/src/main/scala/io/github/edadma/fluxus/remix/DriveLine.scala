...
/**
 * DriveLine icon from the Remix Icon library, Logos category.
 */
case class DriveLineProps(
  size: Int = 24,
...
/**
 * DriveLine icon component.
 *
 * @example DriveLine <> DriveLineProps(size = 24, color = "blue")
 */
def DriveLine = (props: DriveLineProps) => {
  svg(
    viewBox := "0 0 24 24",
