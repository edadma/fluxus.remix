...
/**
 * SlowDownLine icon from the Remix Icon library, Media category.
 */
case class SlowDownLineProps(
  size: Int = 24,
...
/**
 * SlowDownLine icon component.
 *
 * @example SlowDownLine <> SlowDownLineProps(size = 24, color = "blue")
 */
def SlowDownLine = (props: SlowDownLineProps) => {
  svg(
    viewBox := "0 0 24 24",
