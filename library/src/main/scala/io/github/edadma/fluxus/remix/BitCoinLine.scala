...
/**
 * BitCoinLine icon from the Remix Icon library, Finance category.
 */
case class BitCoinLineProps(
  size: Int = 24,
...
/**
 * BitCoinLine icon component.
 *
 * @example BitCoinLine <> BitCoinLineProps(size = 24, color = "blue")
 */
def BitCoinLine = (props: BitCoinLineProps) => {
  svg(
    viewBox := "0 0 24 24",
