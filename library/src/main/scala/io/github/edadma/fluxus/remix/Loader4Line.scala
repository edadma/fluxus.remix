...
/**
 * Loader4Line icon from the Remix Icon library, System category.
 */
case class Loader4LineProps(
  size: Int = 24,
...
/**
 * Loader4Line icon component.
 *
 * @example Loader4Line <> Loader4LineProps(size = 24, color = "blue")
 */
def Loader4Line = (props: Loader4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
