...
/**
 * VideoOnAiLine icon from the Remix Icon library, Media category.
 */
case class VideoOnAiLineProps(
  size: Int = 24,
...
/**
 * VideoOnAiLine icon component.
 *
 * @example VideoOnAiLine <> VideoOnAiLineProps(size = 24, color = "blue")
 */
def VideoOnAiLine = (props: VideoOnAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
