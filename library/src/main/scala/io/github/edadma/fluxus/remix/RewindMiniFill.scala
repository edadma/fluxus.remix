...
/**
 * RewindMiniFill icon from the Remix Icon library, Media category.
 */
case class RewindMiniFillProps(
  size: Int = 24,
...
/**
 * RewindMiniFill icon component.
 *
 * @example RewindMiniFill <> RewindMiniFillProps(size = 24, color = "blue")
 */
def RewindMiniFill = (props: RewindMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
