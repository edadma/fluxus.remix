...
/**
 * ToolsFill icon from the Remix Icon library, Design category.
 */
case class ToolsFillProps(
  size: Int = 24,
...
/**
 * ToolsFill icon component.
 *
 * @example ToolsFill <> ToolsFillProps(size = 24, color = "blue")
 */
def ToolsFill = (props: ToolsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
