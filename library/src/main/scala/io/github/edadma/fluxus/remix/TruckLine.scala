...
/**
 * TruckLine icon from the Remix Icon library, Map category.
 */
case class TruckLineProps(
  size: Int = 24,
...
/**
 * TruckLine icon component.
 *
 * @example TruckLine <> TruckLineProps(size = 24, color = "blue")
 */
def TruckLine = (props: TruckLineProps) => {
  svg(
    viewBox := "0 0 24 24",
