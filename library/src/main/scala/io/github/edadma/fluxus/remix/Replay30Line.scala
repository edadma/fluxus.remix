...
/**
 * Replay30Line icon from the Remix Icon library, Media category.
 */
case class Replay30LineProps(
  size: Int = 24,
...
/**
 * Replay30Line icon component.
 *
 * @example Replay30Line <> Replay30LineProps(size = 24, color = "blue")
 */
def Replay30Line = (props: Replay30LineProps) => {
  svg(
    viewBox := "0 0 24 24",
