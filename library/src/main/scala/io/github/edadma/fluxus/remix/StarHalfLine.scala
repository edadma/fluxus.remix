...
/**
 * StarHalfLine icon from the Remix Icon library, System category.
 */
case class StarHalfLineProps(
  size: Int = 24,
...
/**
 * StarHalfLine icon component.
 *
 * @example StarHalfLine <> StarHalfLineProps(size = 24, color = "blue")
 */
def StarHalfLine = (props: StarHalfLineProps) => {
  svg(
    viewBox := "0 0 24 24",
