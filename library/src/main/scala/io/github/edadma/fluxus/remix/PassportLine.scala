...
/**
 * PassportLine icon from the Remix Icon library, Map category.
 */
case class PassportLineProps(
  size: Int = 24,
...
/**
 * PassportLine icon component.
 *
 * @example PassportLine <> PassportLineProps(size = 24, color = "blue")
 */
def PassportLine = (props: PassportLineProps) => {
  svg(
    viewBox := "0 0 24 24",
