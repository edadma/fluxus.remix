...
/**
 * Movie2Fill icon from the Remix Icon library, Media category.
 */
case class Movie2FillProps(
  size: Int = 24,
...
/**
 * Movie2Fill icon component.
 *
 * @example Movie2Fill <> Movie2FillProps(size = 24, color = "blue")
 */
def Movie2Fill = (props: Movie2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
