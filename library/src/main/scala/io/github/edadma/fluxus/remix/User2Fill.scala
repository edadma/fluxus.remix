...
/**
 * User2Fill icon from the Remix Icon library, User & Faces category.
 */
case class User2FillProps(
  size: Int = 24,
...
/**
 * User2Fill icon component.
 *
 * @example User2Fill <> User2FillProps(size = 24, color = "blue")
 */
def User2Fill = (props: User2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
