...
/**
 * BugFill icon from the Remix Icon library, Development category.
 */
case class BugFillProps(
  size: Int = 24,
 ...
 *
 * @example BugFill <> BugFillProps(size = 24, color = "blue")
 */
def BugFill = (props: BugFillProps) => {
  svg(
    viewBox := "0 0 24 24",
