...
/**
 * RemixiconFill icon from the Remix Icon library, Logos category.
 */
case class RemixiconFillProps(
  size: Int = 24,
...
/**
 * RemixiconFill icon component.
 *
 * @example RemixiconFill <> RemixiconFillProps(size = 24, color = "blue")
 */
def RemixiconFill = (props: RemixiconFillProps) => {
  svg(
    viewBox := "0 0 24 24",
