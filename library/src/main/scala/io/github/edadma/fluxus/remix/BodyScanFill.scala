...
/**
 * BodyScanFill icon from the Remix Icon library, User & Faces category.
 */
case class BodyScanFillProps(
  size: Int = 24,
...
/**
 * BodyScanFill icon component.
 *
 * @example BodyScanFill <> BodyScanFillProps(size = 24, color = "blue")
 */
def BodyScanFill = (props: BodyScanFillProps) => {
  svg(
    viewBox := "0 0 24 24",
