...
/**
 * NftFill icon from the Remix Icon library, Finance category.
 */
case class NftFillProps(
  size: Int = 24,
...
/**
 * NftFill icon component.
 *
 * @example NftFill <> NftFillProps(size = 24, color = "blue")
 */
def NftFill = (props: NftFillProps) => {
  svg(
    viewBox := "0 0 24 24",
