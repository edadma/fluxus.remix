...
/**
 * PokerSpadesFill icon from the Remix Icon library, Others category.
 */
case class PokerSpadesFillProps(
  size: Int = 24,
...
/**
 * PokerSpadesFill icon component.
 *
 * @example PokerSpadesFill <> PokerSpadesFillProps(size = 24, color = "blue")
 */
def PokerSpadesFill = (props: PokerSpadesFillProps) => {
  svg(
    viewBox := "0 0 24 24",
