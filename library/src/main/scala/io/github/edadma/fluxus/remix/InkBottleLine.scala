...
/**
 * InkBottleLine icon from the Remix Icon library, Design category.
 */
case class InkBottleLineProps(
  size: Int = 24,
...
/**
 * InkBottleLine icon component.
 *
 * @example InkBottleLine <> InkBottleLineProps(size = 24, color = "blue")
 */
def InkBottleLine = (props: InkBottleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
