...
/**
 * MicroscopeFill icon from the Remix Icon library, Health & Medical category.
 */
case class MicroscopeFillProps(
  size: Int = 24,
 ...
 *
 * @example MicroscopeFill <> MicroscopeFillProps(size = 24, color = "blue")
 */
def MicroscopeFill = (props: MicroscopeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
