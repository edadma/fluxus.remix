...
/**
 * MacFill icon from the Remix Icon library, Device category.
 */
case class MacFillProps(
  size: Int = 24,
...
/**
 * MacFill icon component.
 *
 * @example MacFill <> MacFillProps(size = 24, color = "blue")
 */
def MacFill = (props: MacFillProps) => {
  svg(
    viewBox := "0 0 24 24",
