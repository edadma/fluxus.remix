...
/**
 * FileExcelLine icon from the Remix Icon library, Document category.
 */
case class FileExcelLineProps(
  size: Int = 24,
...
/**
 * FileExcelLine icon component.
 *
 * @example FileExcelLine <> FileExcelLineProps(size = 24, color = "blue")
 */
def FileExcelLine = (props: FileExcelLineProps) => {
  svg(
    viewBox := "0 0 24 24",
