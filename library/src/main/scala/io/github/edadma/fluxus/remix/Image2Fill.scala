...
/**
 * Image2Fill icon from the Remix Icon library, Media category.
 */
case class Image2FillProps(
  size: Int = 24,
...
/**
 * Image2Fill icon component.
 *
 * @example Image2Fill <> Image2FillProps(size = 24, color = "blue")
 */
def Image2Fill = (props: Image2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
