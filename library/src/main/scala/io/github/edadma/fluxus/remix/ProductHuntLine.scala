...
/**
 * ProductHuntLine icon from the Remix Icon library, Logos category.
 */
case class ProductHuntLineProps(
  size: Int = 24,
...
/**
 * ProductHuntLine icon component.
 *
 * @example ProductHuntLine <> ProductHuntLineProps(size = 24, color = "blue")
 */
def ProductHuntLine = (props: ProductHuntLineProps) => {
  svg(
    viewBox := "0 0 24 24",
