...
/**
 * PaintLine icon from the Remix Icon library, Design category.
 */
case class PaintLineProps(
  size: Int = 24,
...
/**
 * PaintLine icon component.
 *
 * @example PaintLine <> PaintLineProps(size = 24, color = "blue")
 */
def PaintLine = (props: PaintLineProps) => {
  svg(
    viewBox := "0 0 24 24",
