...
/**
 * Drinks2Line icon from the Remix Icon library, Food category.
 */
case class Drinks2LineProps(
  size: Int = 24,
...
/**
 * Drinks2Line icon component.
 *
 * @example Drinks2Line <> Drinks2LineProps(size = 24, color = "blue")
 */
def Drinks2Line = (props: Drinks2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
