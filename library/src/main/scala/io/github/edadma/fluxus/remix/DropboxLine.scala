...
/**
 * DropboxLine icon from the Remix Icon library, Logos category.
 */
case class DropboxLineProps(
  size: Int = 24,
...
/**
 * DropboxLine icon component.
 *
 * @example DropboxLine <> DropboxLineProps(size = 24, color = "blue")
 */
def DropboxLine = (props: DropboxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
