...
/**
 * MoneyPoundCircleFill icon from the Remix Icon library, Finance category.
 */
case class MoneyPoundCircleFillProps(
  size: Int = 24,
...
/**
 * MoneyPoundCircleFill icon component.
 *
 * @example MoneyPoundCircleFill <> MoneyPoundCircleFillProps(size = 24, color = "blue")
 */
def MoneyPoundCircleFill = (props: MoneyPoundCircleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
