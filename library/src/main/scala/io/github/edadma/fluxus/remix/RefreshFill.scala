...
/**
 * RefreshFill icon from the Remix Icon library, System category.
 */
case class RefreshFillProps(
  size: Int = 24,
...
/**
 * RefreshFill icon component.
 *
 * @example RefreshFill <> RefreshFillProps(size = 24, color = "blue")
 */
def RefreshFill = (props: RefreshFillProps) => {
  svg(
    viewBox := "0 0 24 24",
