...
/**
 * PaintFill icon from the Remix Icon library, Design category.
 */
case class PaintFillProps(
  size: Int = 24,
...
/**
 * PaintFill icon component.
 *
 * @example PaintFill <> PaintFillProps(size = 24, color = "blue")
 */
def PaintFill = (props: PaintFillProps) => {
  svg(
    viewBox := "0 0 24 24",
