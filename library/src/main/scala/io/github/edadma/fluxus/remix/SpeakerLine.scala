...
/**
 * SpeakerLine icon from the Remix Icon library, Media category.
 */
case class SpeakerLineProps(
  size: Int = 24,
...
/**
 * SpeakerLine icon component.
 *
 * @example SpeakerLine <> SpeakerLineProps(size = 24, color = "blue")
 */
def SpeakerLine = (props: SpeakerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
