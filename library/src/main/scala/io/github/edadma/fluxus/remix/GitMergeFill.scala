...
/**
 * GitMergeFill icon from the Remix Icon library, Development category.
 */
case class GitMergeFillProps(
  size: Int = 24,
 ...
 *
 * @example GitMergeFill <> GitMergeFillProps(size = 24, color = "blue")
 */
def GitMergeFill = (props: GitMergeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
