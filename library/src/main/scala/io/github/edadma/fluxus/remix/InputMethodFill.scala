...
/**
 * InputMethodFill icon from the Remix Icon library, Design category.
 */
case class InputMethodFillProps(
  size: Int = 24,
...
/**
 * InputMethodFill icon component.
 *
 * @example InputMethodFill <> InputMethodFillProps(size = 24, color = "blue")
 */
def InputMethodFill = (props: InputMethodFillProps) => {
  svg(
    viewBox := "0 0 24 24",
