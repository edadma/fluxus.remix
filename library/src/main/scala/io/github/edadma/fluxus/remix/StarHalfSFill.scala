...
/**
 * StarHalfSFill icon from the Remix Icon library, System category.
 */
case class StarHalfSFillProps(
  size: Int = 24,
...
/**
 * StarHalfSFill icon component.
 *
 * @example StarHalfSFill <> StarHalfSFillProps(size = 24, color = "blue")
 */
def StarHalfSFill = (props: StarHalfSFillProps) => {
  svg(
    viewBox := "0 0 24 24",
