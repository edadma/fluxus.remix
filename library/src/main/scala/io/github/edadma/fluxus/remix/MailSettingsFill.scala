...
/**
 * MailSettingsFill icon from the Remix Icon library, Business category.
 */
case class MailSettingsFillProps(
  size: Int = 24,
...
/**
 * MailSettingsFill icon component.
 *
 * @example MailSettingsFill <> MailSettingsFillProps(size = 24, color = "blue")
 */
def MailSettingsFill = (props: MailSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
