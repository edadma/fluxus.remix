...
/**
 * FileGifFill icon from the Remix Icon library, Document category.
 */
case class FileGifFillProps(
  size: Int = 24,
...
/**
 * FileGifFill icon component.
 *
 * @example FileGifFill <> FileGifFillProps(size = 24, color = "blue")
 */
def FileGifFill = (props: FileGifFillProps) => {
  svg(
    viewBox := "0 0 24 24",
