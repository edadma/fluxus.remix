...
/**
 * Wallet3Line icon from the Remix Icon library, Finance category.
 */
case class Wallet3LineProps(
  size: Int = 24,
...
/**
 * Wallet3Line icon component.
 *
 * @example Wallet3Line <> Wallet3LineProps(size = 24, color = "blue")
 */
def Wallet3Line = (props: Wallet3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
