...
/**
 * TableLine icon from the Remix Icon library, Design category.
 */
case class TableLineProps(
  size: Int = 24,
...
/**
 * TableLine icon component.
 *
 * @example TableLine <> TableLineProps(size = 24, color = "blue")
 */
def TableLine = (props: TableLineProps) => {
  svg(
    viewBox := "0 0 24 24",
