...
/**
 * GitPrDraftLine icon from the Remix Icon library, Development category.
 */
case class GitPrDraftLineProps(
  size: Int = 24,
...
/**
 * GitPrDraftLine icon component.
 *
 * @example GitPrDraftLine <> GitPrDraftLineProps(size = 24, color = "blue")
 */
def GitPrDraftLine = (props: GitPrDraftLineProps) => {
  svg(
    viewBox := "0 0 24 24",
