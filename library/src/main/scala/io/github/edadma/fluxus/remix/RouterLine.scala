...
/**
 * RouterLine icon from the Remix Icon library, Device category.
 */
case class RouterLineProps(
  size: Int = 24,
...
/**
 * RouterLine icon component.
 *
 * @example RouterLine <> RouterLineProps(size = 24, color = "blue")
 */
def RouterLine = (props: RouterLineProps) => {
  svg(
    viewBox := "0 0 24 24",
