...
/**
 * Forward15Fill icon from the Remix Icon library, Media category.
 */
case class Forward15FillProps(
  size: Int = 24,
...
/**
 * Forward15Fill icon component.
 *
 * @example Forward15Fill <> Forward15FillProps(size = 24, color = "blue")
 */
def Forward15Fill = (props: Forward15FillProps) => {
  svg(
    viewBox := "0 0 24 24",
