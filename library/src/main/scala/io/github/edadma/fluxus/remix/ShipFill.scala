...
/**
 * ShipFill icon from the Remix Icon library, Map category.
 */
case class ShipFillProps(
  size: Int = 24,
...
/**
 * ShipFill icon component.
 *
 * @example ShipFill <> ShipFillProps(size = 24, color = "blue")
 */
def ShipFill = (props: ShipFillProps) => {
  svg(
    viewBox := "0 0 24 24",
