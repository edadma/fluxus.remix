...
/**
 * Dice1Line icon from the Remix Icon library, Others category.
 */
case class Dice1LineProps(
  size: Int = 24,
...
/**
 * Dice1Line icon component.
 *
 * @example Dice1Line <> Dice1LineProps(size = 24, color = "blue")
 */
def Dice1Line = (props: Dice1LineProps) => {
  svg(
    viewBox := "0 0 24 24",
