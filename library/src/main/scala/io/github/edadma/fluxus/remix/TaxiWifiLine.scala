...
/**
 * TaxiWifiLine icon from the Remix Icon library, Map category.
 */
case class TaxiWifiLineProps(
  size: Int = 24,
...
/**
 * TaxiWifiLine icon component.
 *
 * @example TaxiWifiLine <> TaxiWifiLineProps(size = 24, color = "blue")
 */
def TaxiWifiLine = (props: TaxiWifiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
