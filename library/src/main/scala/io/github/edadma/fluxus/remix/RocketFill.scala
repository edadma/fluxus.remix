...
/**
 * RocketFill icon from the Remix Icon library, Map category.
 */
case class RocketFillProps(
  size: Int = 24,
 ...
 *
 * @example RocketFill <> RocketFillProps(size = 24, color = "blue")
 */
def RocketFill = (props: RocketFillProps) => {
  svg(
    viewBox := "0 0 24 24",
