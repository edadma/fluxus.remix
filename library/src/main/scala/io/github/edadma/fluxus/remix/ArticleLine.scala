...
/**
 * ArticleLine icon from the Remix Icon library, Document category.
 */
case class ArticleLineProps(
  size: Int = 24,
...
/**
 * ArticleLine icon component.
 *
 * @example ArticleLine <> ArticleLineProps(size = 24, color = "blue")
 */
def ArticleLine = (props: ArticleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
