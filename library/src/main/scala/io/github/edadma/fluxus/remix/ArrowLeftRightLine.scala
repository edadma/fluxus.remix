...
/**
 * ArrowLeftRightLine icon from the Remix Icon library, Arrows category.
 */
case class ArrowLeftRightLineProps(
  size: Int = 24,
...
/**
 * ArrowLeftRightLine icon component.
 *
 * @example ArrowLeftRightLine <> ArrowLeftRightLineProps(size = 24, color = "blue")
 */
def ArrowLeftRightLine = (props: ArrowLeftRightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
