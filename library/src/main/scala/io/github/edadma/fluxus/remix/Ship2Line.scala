...
/**
 * Ship2Line icon from the Remix Icon library, Map category.
 */
case class Ship2LineProps(
  size: Int = 24,
...
/**
 * Ship2Line icon component.
 *
 * @example Ship2Line <> Ship2LineProps(size = 24, color = "blue")
 */
def Ship2Line = (props: Ship2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
