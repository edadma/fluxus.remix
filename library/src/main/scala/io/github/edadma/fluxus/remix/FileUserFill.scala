...
/**
 * FileUserFill icon from the Remix Icon library, Document category.
 */
case class FileUserFillProps(
  size: Int = 24,
...
/**
 * FileUserFill icon component.
 *
 * @example FileUserFill <> FileUserFillProps(size = 24, color = "blue")
 */
def FileUserFill = (props: FileUserFillProps) => {
  svg(
    viewBox := "0 0 24 24",
