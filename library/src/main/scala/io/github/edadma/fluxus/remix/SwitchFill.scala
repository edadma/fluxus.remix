...
/**
 * SwitchFill icon from the Remix Icon library, Logos category.
 */
case class SwitchFillProps(
  size: Int = 24,
...
/**
 * SwitchFill icon component.
 *
 * @example SwitchFill <> SwitchFillProps(size = 24, color = "blue")
 */
def SwitchFill = (props: SwitchFillProps) => {
  svg(
    viewBox := "0 0 24 24",
