...
/**
 * IncreaseDecreaseLine icon from the Remix Icon library, Finance category.
 */
case class IncreaseDecreaseLineProps(
  size: Int = 24,
...
/**
 * IncreaseDecreaseLine icon component.
 *
 * @example IncreaseDecreaseLine <> IncreaseDecreaseLineProps(size = 24, color = "blue")
 */
def IncreaseDecreaseLine = (props: IncreaseDecreaseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
