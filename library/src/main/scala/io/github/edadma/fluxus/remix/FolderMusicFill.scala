...
/**
 * FolderMusicFill icon from the Remix Icon library, Document category.
 */
case class FolderMusicFillProps(
  size: Int = 24,
...
/**
 * FolderMusicFill icon component.
 *
 * @example FolderMusicFill <> FolderMusicFillProps(size = 24, color = "blue")
 */
def FolderMusicFill = (props: FolderMusicFillProps) => {
  svg(
    viewBox := "0 0 24 24",
