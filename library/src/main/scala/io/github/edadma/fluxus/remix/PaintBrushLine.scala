...
/**
 * PaintBrushLine icon from the Remix Icon library, Design category.
 */
case class PaintBrushLineProps(
  size: Int = 24,
...
/**
 * PaintBrushLine icon component.
 *
 * @example PaintBrushLine <> PaintBrushLineProps(size = 24, color = "blue")
 */
def PaintBrushLine = (props: PaintBrushLineProps) => {
  svg(
    viewBox := "0 0 24 24",
