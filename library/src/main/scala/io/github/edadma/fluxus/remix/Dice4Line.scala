...
/**
 * Dice4Line icon from the Remix Icon library, Others category.
 */
case class Dice4LineProps(
  size: Int = 24,
...
/**
 * Dice4Line icon component.
 *
 * @example Dice4Line <> Dice4LineProps(size = 24, color = "blue")
 */
def Dice4Line = (props: Dice4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
