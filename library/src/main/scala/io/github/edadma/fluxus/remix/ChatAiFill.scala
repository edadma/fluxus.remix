...
/**
 * ChatAiFill icon from the Remix Icon library, Communication category.
 */
case class ChatAiFillProps(
  size: Int = 24,
...
/**
 * ChatAiFill icon component.
 *
 * @example ChatAiFill <> ChatAiFillProps(size = 24, color = "blue")
 */
def ChatAiFill = (props: ChatAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
