...
/**
 * Book2Line icon from the Remix Icon library, Document category.
 */
case class Book2LineProps(
  size: Int = 24,
...
/**
 * Book2Line icon component.
 *
 * @example Book2Line <> Book2LineProps(size = 24, color = "blue")
 */
def Book2Line = (props: Book2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
