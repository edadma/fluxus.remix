...
/**
 * ShoppingBasketFill icon from the Remix Icon library, Finance category.
 */
case class ShoppingBasketFillProps(
  size: Int = 24,
...
/**
 * ShoppingBasketFill icon component.
 *
 * @example ShoppingBasketFill <> ShoppingBasketFillProps(size = 24, color = "blue")
 */
def ShoppingBasketFill = (props: ShoppingBasketFillProps) => {
  svg(
    viewBox := "0 0 24 24",
