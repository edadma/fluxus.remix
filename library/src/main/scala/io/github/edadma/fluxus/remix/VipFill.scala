...
/**
 * VipFill icon from the Remix Icon library, Finance category.
 */
case class VipFillProps(
  size: Int = 24,
...
/**
 * VipFill icon component.
 *
 * @example VipFill <> VipFillProps(size = 24, color = "blue")
 */
def VipFill = (props: VipFillProps) => {
  svg(
    viewBox := "0 0 24 24",
