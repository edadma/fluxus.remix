...
/**
 * MusicAiLine icon from the Remix Icon library, Media category.
 */
case class MusicAiLineProps(
  size: Int = 24,
...
/**
 * MusicAiLine icon component.
 *
 * @example MusicAiLine <> MusicAiLineProps(size = 24, color = "blue")
 */
def MusicAiLine = (props: MusicAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
