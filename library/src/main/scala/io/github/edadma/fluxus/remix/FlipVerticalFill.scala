...
/**
 * FlipVerticalFill icon from the Remix Icon library, Design category.
 */
case class FlipVerticalFillProps(
  size: Int = 24,
 ...
 *
 * @example FlipVerticalFill <> FlipVerticalFillProps(size = 24, color = "blue")
 */
def FlipVerticalFill = (props: FlipVerticalFillProps) => {
  svg(
    viewBox := "0 0 24 24",
