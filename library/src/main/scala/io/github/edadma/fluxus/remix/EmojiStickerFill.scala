...
/**
 * EmojiStickerFill icon from the Remix Icon library, Communication category.
 */
case class EmojiStickerFillProps(
  size: Int = 24,
...
/**
 * EmojiStickerFill icon component.
 *
 * @example EmojiStickerFill <> EmojiStickerFillProps(size = 24, color = "blue")
 */
def EmojiStickerFill = (props: EmojiStickerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
