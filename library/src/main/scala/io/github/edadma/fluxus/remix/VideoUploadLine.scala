...
/**
 * VideoUploadLine icon from the Remix Icon library, Media category.
 */
case class VideoUploadLineProps(
  size: Int = 24,
...
/**
 * VideoUploadLine icon component.
 *
 * @example VideoUploadLine <> VideoUploadLineProps(size = 24, color = "blue")
 */
def VideoUploadLine = (props: VideoUploadLineProps) => {
  svg(
    viewBox := "0 0 24 24",
