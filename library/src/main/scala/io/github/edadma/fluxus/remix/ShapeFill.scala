...
/**
 * ShapeFill icon from the Remix Icon library, Design category.
 */
case class ShapeFillProps(
  size: Int = 24,
...
/**
 * ShapeFill icon component.
 *
 * @example ShapeFill <> ShapeFillProps(size = 24, color = "blue")
 */
def ShapeFill = (props: ShapeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
