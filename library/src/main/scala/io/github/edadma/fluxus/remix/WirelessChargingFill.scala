...
/**
 * WirelessChargingFill icon from the Remix Icon library, Device category.
 */
case class WirelessChargingFillProps(
  size: Int = 24,
...
/**
 * WirelessChargingFill icon component.
 *
 * @example WirelessChargingFill <> WirelessChargingFillProps(size = 24, color = "blue")
 */
def WirelessChargingFill = (props: WirelessChargingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
