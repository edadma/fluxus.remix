...
/**
 * HomeHeartLine icon from the Remix Icon library, Buildings category.
 */
case class HomeHeartLineProps(
  size: Int = 24,
...
/**
 * HomeHeartLine icon component.
 *
 * @example HomeHeartLine <> HomeHeartLineProps(size = 24, color = "blue")
 */
def HomeHeartLine = (props: HomeHeartLineProps) => {
  svg(
    viewBox := "0 0 24 24",
