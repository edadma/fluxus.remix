...
/**
 * StickyNoteLine icon from the Remix Icon library, Document category.
 */
case class StickyNoteLineProps(
  size: Int = 24,
...
/**
 * StickyNoteLine icon component.
 *
 * @example StickyNoteLine <> StickyNoteLineProps(size = 24, color = "blue")
 */
def StickyNoteLine = (props: StickyNoteLineProps) => {
  svg(
    viewBox := "0 0 24 24",
