...
/**
 * AngularjsLine icon from the Remix Icon library, Logos category.
 */
case class AngularjsLineProps(
  size: Int = 24,
...
/**
 * AngularjsLine icon component.
 *
 * @example AngularjsLine <> AngularjsLineProps(size = 24, color = "blue")
 */
def AngularjsLine = (props: AngularjsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
