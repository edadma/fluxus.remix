...
/**
 * MenFill icon from the Remix Icon library, User & Faces category.
 */
case class MenFillProps(
  size: Int = 24,
...
/**
 * MenFill icon component.
 *
 * @example MenFill <> MenFillProps(size = 24, color = "blue")
 */
def MenFill = (props: MenFillProps) => {
  svg(
    viewBox := "0 0 24 24",
