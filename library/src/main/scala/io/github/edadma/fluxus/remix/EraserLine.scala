...
/**
 * EraserLine icon from the Remix Icon library, Design category.
 */
case class EraserLineProps(
  size: Int = 24,
...
/**
 * EraserLine icon component.
 *
 * @example EraserLine <> EraserLineProps(size = 24, color = "blue")
 */
def EraserLine = (props: EraserLineProps) => {
  svg(
    viewBox := "0 0 24 24",
