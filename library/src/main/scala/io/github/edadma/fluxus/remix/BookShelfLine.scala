...
/**
 * BookShelfLine icon from the Remix Icon library, Others category.
 */
case class BookShelfLineProps(
  size: Int = 24,
...
/**
 * BookShelfLine icon component.
 *
 * @example BookShelfLine <> BookShelfLineProps(size = 24, color = "blue")
 */
def BookShelfLine = (props: BookShelfLineProps) => {
  svg(
    viewBox := "0 0 24 24",
