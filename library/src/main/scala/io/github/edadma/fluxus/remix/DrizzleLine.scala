...
/**
 * DrizzleLine icon from the Remix Icon library, Weather category.
 */
case class DrizzleLineProps(
  size: Int = 24,
...
/**
 * DrizzleLine icon component.
 *
 * @example DrizzleLine <> DrizzleLineProps(size = 24, color = "blue")
 */
def DrizzleLine = (props: DrizzleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
