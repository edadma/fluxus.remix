...
/**
 * VkFill icon from the Remix Icon library, Logos category.
 */
case class VkFillProps(
  size: Int = 24,
...
/**
 * VkFill icon component.
 *
 * @example VkFill <> VkFillProps(size = 24, color = "blue")
 */
def VkFill = (props: VkFillProps) => {
  svg(
    viewBox := "0 0 24 24",
