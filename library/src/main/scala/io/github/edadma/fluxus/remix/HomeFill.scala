...
/**
 * HomeFill icon from the Remix Icon library, Buildings category.
 */
case class HomeFillProps(
  size: Int = 24,
 ...
 *
 * @example HomeFill <> HomeFillProps(size = 24, color = "blue")
 */
def HomeFill = (props: HomeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
