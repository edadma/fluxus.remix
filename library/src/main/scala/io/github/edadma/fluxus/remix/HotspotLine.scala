...
/**
 * HotspotLine icon from the Remix Icon library, Device category.
 */
case class HotspotLineProps(
  size: Int = 24,
...
/**
 * HotspotLine icon component.
 *
 * @example HotspotLine <> HotspotLineProps(size = 24, color = "blue")
 */
def HotspotLine = (props: HotspotLineProps) => {
  svg(
    viewBox := "0 0 24 24",
