...
/**
 * MailFill icon from the Remix Icon library, Business category.
 */
case class MailFillProps(
  size: Int = 24,
...
/**
 * MailFill icon component.
 *
 * @example MailFill <> MailFillProps(size = 24, color = "blue")
 */
def MailFill = (props: MailFillProps) => {
  svg(
    viewBox := "0 0 24 24",
