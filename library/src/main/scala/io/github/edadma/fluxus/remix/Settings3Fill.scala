...
/**
 * Settings3Fill icon from the Remix Icon library, System category.
 */
case class Settings3FillProps(
  size: Int = 24,
...
/**
 * Settings3Fill icon component.
 *
 * @example Settings3Fill <> Settings3FillProps(size = 24, color = "blue")
 */
def Settings3Fill = (props: Settings3FillProps) => {
  svg(
    viewBox := "0 0 24 24",
