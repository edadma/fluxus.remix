...
/**
 * ReplyLine icon from the Remix Icon library, Business category.
 */
case class ReplyLineProps(
  size: Int = 24,
...
/**
 * ReplyLine icon component.
 *
 * @example ReplyLine <> ReplyLineProps(size = 24, color = "blue")
 */
def ReplyLine = (props: ReplyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
