...
/**
 * FolderUnknowFill icon from the Remix Icon library, Document category.
 */
case class FolderUnknowFillProps(
  size: Int = 24,
...
/**
 * FolderUnknowFill icon component.
 *
 * @example FolderUnknowFill <> FolderUnknowFillProps(size = 24, color = "blue")
 */
def FolderUnknowFill = (props: FolderUnknowFillProps) => {
  svg(
    viewBox := "0 0 24 24",
