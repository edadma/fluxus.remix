...
/**
 * BroadcastLine icon from the Remix Icon library, Media category.
 */
case class BroadcastLineProps(
  size: Int = 24,
...
/**
 * BroadcastLine icon component.
 *
 * @example BroadcastLine <> BroadcastLineProps(size = 24, color = "blue")
 */
def BroadcastLine = (props: BroadcastLineProps) => {
  svg(
    viewBox := "0 0 24 24",
