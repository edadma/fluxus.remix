...
/**
 * EjectLine icon from the Remix Icon library, Media category.
 */
case class EjectLineProps(
  size: Int = 24,
...
/**
 * EjectLine icon component.
 *
 * @example EjectLine <> EjectLineProps(size = 24, color = "blue")
 */
def EjectLine = (props: EjectLineProps) => {
  svg(
    viewBox := "0 0 24 24",
