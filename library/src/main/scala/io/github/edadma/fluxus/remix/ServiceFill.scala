...
/**
 * ServiceFill icon from the Remix Icon library, Business category.
 */
case class ServiceFillProps(
  size: Int = 24,
...
/**
 * ServiceFill icon component.
 *
 * @example ServiceFill <> ServiceFillProps(size = 24, color = "blue")
 */
def ServiceFill = (props: ServiceFillProps) => {
  svg(
    viewBox := "0 0 24 24",
