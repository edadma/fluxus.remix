...
/**
 * Vidicon2Line icon from the Remix Icon library, Media category.
 */
case class Vidicon2LineProps(
  size: Int = 24,
...
/**
 * Vidicon2Line icon component.
 *
 * @example Vidicon2Line <> Vidicon2LineProps(size = 24, color = "blue")
 */
def Vidicon2Line = (props: Vidicon2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
