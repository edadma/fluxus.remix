...
/**
 * MicLine icon from the Remix Icon library, Media category.
 */
case class MicLineProps(
  size: Int = 24,
...
/**
 * MicLine icon component.
 *
 * @example MicLine <> MicLineProps(size = 24, color = "blue")
 */
def MicLine = (props: MicLineProps) => {
  svg(
    viewBox := "0 0 24 24",
