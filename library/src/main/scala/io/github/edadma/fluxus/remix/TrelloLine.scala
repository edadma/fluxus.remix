...
/**
 * TrelloLine icon from the Remix Icon library, Logos category.
 */
case class TrelloLineProps(
  size: Int = 24,
...
/**
 * TrelloLine icon component.
 *
 * @example TrelloLine <> TrelloLineProps(size = 24, color = "blue")
 */
def TrelloLine = (props: TrelloLineProps) => {
  svg(
    viewBox := "0 0 24 24",
