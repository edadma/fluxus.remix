...
/**
 * StackshareLine icon from the Remix Icon library, Logos category.
 */
case class StackshareLineProps(
  size: Int = 24,
...
/**
 * StackshareLine icon component.
 *
 * @example StackshareLine <> StackshareLineProps(size = 24, color = "blue")
 */
def StackshareLine = (props: StackshareLineProps) => {
  svg(
    viewBox := "0 0 24 24",
