...
/**
 * TempHotLine icon from the Remix Icon library, Weather category.
 */
case class TempHotLineProps(
  size: Int = 24,
...
/**
 * TempHotLine icon component.
 *
 * @example TempHotLine <> TempHotLineProps(size = 24, color = "blue")
 */
def TempHotLine = (props: TempHotLineProps) => {
  svg(
    viewBox := "0 0 24 24",
