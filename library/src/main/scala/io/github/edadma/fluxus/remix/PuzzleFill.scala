...
/**
 * PuzzleFill icon from the Remix Icon library, Development category.
 */
case class PuzzleFillProps(
  size: Int = 24,
...
/**
 * PuzzleFill icon component.
 *
 * @example PuzzleFill <> PuzzleFillProps(size = 24, color = "blue")
 */
def PuzzleFill = (props: PuzzleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
