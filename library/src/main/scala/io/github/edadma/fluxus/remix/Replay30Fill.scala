...
/**
 * Replay30Fill icon from the Remix Icon library, Media category.
 */
case class Replay30FillProps(
  size: Int = 24,
...
/**
 * Replay30Fill icon component.
 *
 * @example Replay30Fill <> Replay30FillProps(size = 24, color = "blue")
 */
def Replay30Fill = (props: Replay30FillProps) => {
  svg(
    viewBox := "0 0 24 24",
