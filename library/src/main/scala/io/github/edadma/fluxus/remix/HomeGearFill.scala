...
/**
 * HomeGearFill icon from the Remix Icon library, Buildings category.
 */
case class HomeGearFillProps(
  size: Int = 24,
...
/**
 * HomeGearFill icon component.
 *
 * @example HomeGearFill <> HomeGearFillProps(size = 24, color = "blue")
 */
def HomeGearFill = (props: HomeGearFillProps) => {
  svg(
    viewBox := "0 0 24 24",
