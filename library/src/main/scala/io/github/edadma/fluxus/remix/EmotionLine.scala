...
/**
 * EmotionLine icon from the Remix Icon library, User & Faces category.
 */
case class EmotionLineProps(
  size: Int = 24,
...
/**
 * EmotionLine icon component.
 *
 * @example EmotionLine <> EmotionLineProps(size = 24, color = "blue")
 */
def EmotionLine = (props: EmotionLineProps) => {
  svg(
    viewBox := "0 0 24 24",
