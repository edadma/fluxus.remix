...
/**
 * Ghost2Fill icon from the Remix Icon library, User & Faces category.
 */
case class Ghost2FillProps(
  size: Int = 24,
...
/**
 * Ghost2Fill icon component.
 *
 * @example Ghost2Fill <> Ghost2FillProps(size = 24, color = "blue")
 */
def Ghost2Fill = (props: Ghost2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
