...
/**
 * FileVideoFill icon from the Remix Icon library, Document category.
 */
case class FileVideoFillProps(
  size: Int = 24,
 ...
 *
 * @example FileVideoFill <> FileVideoFillProps(size = 24, color = "blue")
 */
def FileVideoFill = (props: FileVideoFillProps) => {
  svg(
    viewBox := "0 0 24 24",
