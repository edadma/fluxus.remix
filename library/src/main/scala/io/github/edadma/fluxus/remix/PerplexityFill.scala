...
/**
 * PerplexityFill icon from the Remix Icon library, Logos category.
 */
case class PerplexityFillProps(
  size: Int = 24,
...
/**
 * PerplexityFill icon component.
 *
 * @example PerplexityFill <> PerplexityFillProps(size = 24, color = "blue")
 */
def PerplexityFill = (props: PerplexityFillProps) => {
  svg(
    viewBox := "0 0 24 24",
