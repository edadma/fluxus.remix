...
/**
 * ChatSmileLine icon from the Remix Icon library, Communication category.
 */
case class ChatSmileLineProps(
  size: Int = 24,
...
/**
 * ChatSmileLine icon component.
 *
 * @example ChatSmileLine <> ChatSmileLineProps(size = 24, color = "blue")
 */
def ChatSmileLine = (props: ChatSmileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
