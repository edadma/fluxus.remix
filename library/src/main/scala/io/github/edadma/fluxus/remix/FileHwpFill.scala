...
/**
 * FileHwpFill icon from the Remix Icon library, Document category.
 */
case class FileHwpFillProps(
  size: Int = 24,
...
/**
 * FileHwpFill icon component.
 *
 * @example FileHwpFill <> FileHwpFillProps(size = 24, color = "blue")
 */
def FileHwpFill = (props: FileHwpFillProps) => {
  svg(
    viewBox := "0 0 24 24",
