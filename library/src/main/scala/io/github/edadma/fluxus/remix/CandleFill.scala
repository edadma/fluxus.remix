...
/**
 * CandleFill icon from the Remix Icon library, Others category.
 */
case class CandleFillProps(
  size: Int = 24,
...
/**
 * CandleFill icon component.
 *
 * @example CandleFill <> CandleFillProps(size = 24, color = "blue")
 */
def CandleFill = (props: CandleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
