...
/**
 * FinderLine icon from the Remix Icon library, Logos category.
 */
case class FinderLineProps(
  size: Int = 24,
...
/**
 * FinderLine icon component.
 *
 * @example FinderLine <> FinderLineProps(size = 24, color = "blue")
 */
def FinderLine = (props: FinderLineProps) => {
  svg(
    viewBox := "0 0 24 24",
