...
/**
 * Coupon5Line icon from the Remix Icon library, Finance category.
 */
case class Coupon5LineProps(
  size: Int = 24,
...
/**
 * Coupon5Line icon component.
 *
 * @example Coupon5Line <> Coupon5LineProps(size = 24, color = "blue")
 */
def Coupon5Line = (props: Coupon5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
