...
/**
 * NetflixFill icon from the Remix Icon library, Logos category.
 */
case class NetflixFillProps(
  size: Int = 24,
...
/**
 * NetflixFill icon component.
 *
 * @example NetflixFill <> NetflixFillProps(size = 24, color = "blue")
 */
def NetflixFill = (props: NetflixFillProps) => {
  svg(
    viewBox := "0 0 24 24",
