...
/**
 * SpeakAiFill icon from the Remix Icon library, Communication category.
 */
case class SpeakAiFillProps(
  size: Int = 24,
...
/**
 * SpeakAiFill icon component.
 *
 * @example SpeakAiFill <> SpeakAiFillProps(size = 24, color = "blue")
 */
def SpeakAiFill = (props: SpeakAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
