...
/**
 * CommandFill icon from the Remix Icon library, Development category.
 */
case class CommandFillProps(
  size: Int = 24,
 ...
 *
 * @example CommandFill <> CommandFillProps(size = 24, color = "blue")
 */
def CommandFill = (props: CommandFillProps) => {
  svg(
    viewBox := "0 0 24 24",
