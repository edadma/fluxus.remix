...
/**
 * SurroundSoundLine icon from the Remix Icon library, Media category.
 */
case class SurroundSoundLineProps(
  size: Int = 24,
...
/**
 * SurroundSoundLine icon component.
 *
 * @example SurroundSoundLine <> SurroundSoundLineProps(size = 24, color = "blue")
 */
def SurroundSoundLine = (props: SurroundSoundLineProps) => {
  svg(
    viewBox := "0 0 24 24",
