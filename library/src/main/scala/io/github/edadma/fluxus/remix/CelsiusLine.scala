...
/**
 * CelsiusLine icon from the Remix Icon library, Weather category.
 */
case class CelsiusLineProps(
  size: Int = 24,
...
/**
 * CelsiusLine icon component.
 *
 * @example CelsiusLine <> CelsiusLineProps(size = 24, color = "blue")
 */
def CelsiusLine = (props: CelsiusLineProps) => {
  svg(
    viewBox := "0 0 24 24",
