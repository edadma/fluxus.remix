...
/**
 * FolderImageLine icon from the Remix Icon library, Document category.
 */
case class FolderImageLineProps(
  size: Int = 24,
...
/**
 * FolderImageLine icon component.
 *
 * @example FolderImageLine <> FolderImageLineProps(size = 24, color = "blue")
 */
def FolderImageLine = (props: FolderImageLineProps) => {
  svg(
    viewBox := "0 0 24 24",
