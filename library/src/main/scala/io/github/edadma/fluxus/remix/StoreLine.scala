...
/**
 * StoreLine icon from the Remix Icon library, Buildings category.
 */
case class StoreLineProps(
  size: Int = 24,
...
/**
 * StoreLine icon component.
 *
 * @example StoreLine <> StoreLineProps(size = 24, color = "blue")
 */
def StoreLine = (props: StoreLineProps) => {
  svg(
    viewBox := "0 0 24 24",
