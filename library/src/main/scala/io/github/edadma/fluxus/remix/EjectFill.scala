...
/**
 * EjectFill icon from the Remix Icon library, Media category.
 */
case class EjectFillProps(
  size: Int = 24,
 ...
 *
 * @example EjectFill <> EjectFillProps(size = 24, color = "blue")
 */
def EjectFill = (props: EjectFillProps) => {
  svg(
    viewBox := "0 0 24 24",
