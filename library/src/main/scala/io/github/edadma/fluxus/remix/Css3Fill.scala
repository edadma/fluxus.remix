...
/**
 * Css3Fill icon from the Remix Icon library, Development category.
 */
case class Css3FillProps(
  size: Int = 24,
...
/**
 * Css3Fill icon component.
 *
 * @example Css3Fill <> Css3FillProps(size = 24, color = "blue")
 */
def Css3Fill = (props: Css3FillProps) => {
  svg(
    viewBox := "0 0 24 24",
