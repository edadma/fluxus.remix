...
/**
 * Puzzle2Line icon from the Remix Icon library, Development category.
 */
case class Puzzle2LineProps(
  size: Int = 24,
...
/**
 * Puzzle2Line icon component.
 *
 * @example Puzzle2Line <> Puzzle2LineProps(size = 24, color = "blue")
 */
def Puzzle2Line = (props: Puzzle2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
