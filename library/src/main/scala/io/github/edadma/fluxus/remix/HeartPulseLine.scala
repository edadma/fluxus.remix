...
/**
 * HeartPulseLine icon from the Remix Icon library, Health & Medical category.
 */
case class HeartPulseLineProps(
  size: Int = 24,
...
/**
 * HeartPulseLine icon component.
 *
 * @example HeartPulseLine <> HeartPulseLineProps(size = 24, color = "blue")
 */
def HeartPulseLine = (props: HeartPulseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
