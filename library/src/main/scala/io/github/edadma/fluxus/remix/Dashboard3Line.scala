...
/**
 * Dashboard3Line icon from the Remix Icon library, Device category.
 */
case class Dashboard3LineProps(
  size: Int = 24,
...
/**
 * Dashboard3Line icon component.
 *
 * @example Dashboard3Line <> Dashboard3LineProps(size = 24, color = "blue")
 */
def Dashboard3Line = (props: Dashboard3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
