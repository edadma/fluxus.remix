...
/**
 * TrainWifiLine icon from the Remix Icon library, Map category.
 */
case class TrainWifiLineProps(
  size: Int = 24,
...
/**
 * TrainWifiLine icon component.
 *
 * @example TrainWifiLine <> TrainWifiLineProps(size = 24, color = "blue")
 */
def TrainWifiLine = (props: TrainWifiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
