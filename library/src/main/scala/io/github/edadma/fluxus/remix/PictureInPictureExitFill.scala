...
/**
 * PictureInPictureExitFill icon from the Remix Icon library, Media category.
 */
case class PictureInPictureExitFillProps(
  size: Int = 24,
...
/**
 * PictureInPictureExitFill icon component.
 *
 * @example PictureInPictureExitFill <> PictureInPictureExitFillProps(size = 24, color = "blue")
 */
def PictureInPictureExitFill = (props: PictureInPictureExitFillProps) => {
  svg(
    viewBox := "0 0 24 24",
