...
/**
 * TrainWifiFill icon from the Remix Icon library, Map category.
 */
case class TrainWifiFillProps(
  size: Int = 24,
...
/**
 * TrainWifiFill icon component.
 *
 * @example TrainWifiFill <> TrainWifiFillProps(size = 24, color = "blue")
 */
def TrainWifiFill = (props: TrainWifiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
