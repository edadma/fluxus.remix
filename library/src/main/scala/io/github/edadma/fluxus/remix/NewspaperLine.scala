...
/**
 * NewspaperLine icon from the Remix Icon library, Document category.
 */
case class NewspaperLineProps(
  size: Int = 24,
...
/**
 * NewspaperLine icon component.
 *
 * @example NewspaperLine <> NewspaperLineProps(size = 24, color = "blue")
 */
def NewspaperLine = (props: NewspaperLineProps) => {
  svg(
    viewBox := "0 0 24 24",
