...
/**
 * FahrenheitFill icon from the Remix Icon library, Weather category.
 */
case class FahrenheitFillProps(
  size: Int = 24,
...
/**
 * FahrenheitFill icon component.
 *
 * @example FahrenheitFill <> FahrenheitFillProps(size = 24, color = "blue")
 */
def FahrenheitFill = (props: FahrenheitFillProps) => {
  svg(
    viewBox := "0 0 24 24",
