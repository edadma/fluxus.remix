...
/**
 * CastLine icon from the Remix Icon library, Device category.
 */
case class CastLineProps(
  size: Int = 24,
...
/**
 * CastLine icon component.
 *
 * @example CastLine <> CastLineProps(size = 24, color = "blue")
 */
def CastLine = (props: CastLineProps) => {
  svg(
    viewBox := "0 0 24 24",
