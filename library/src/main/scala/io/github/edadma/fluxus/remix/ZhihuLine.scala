...
/**
 * ZhihuLine icon from the Remix Icon library, Logos category.
 */
case class ZhihuLineProps(
  size: Int = 24,
...
/**
 * ZhihuLine icon component.
 *
 * @example ZhihuLine <> ZhihuLineProps(size = 24, color = "blue")
 */
def ZhihuLine = (props: ZhihuLineProps) => {
  svg(
    viewBox := "0 0 24 24",
