...
/**
 * MouseLine icon from the Remix Icon library, Device category.
 */
case class MouseLineProps(
  size: Int = 24,
...
/**
 * MouseLine icon component.
 *
 * @example MouseLine <> MouseLineProps(size = 24, color = "blue")
 */
def MouseLine = (props: MouseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
