...
/**
 * MiniProgramLine icon from the Remix Icon library, Logos category.
 */
case class MiniProgramLineProps(
  size: Int = 24,
...
/**
 * MiniProgramLine icon component.
 *
 * @example MiniProgramLine <> MiniProgramLineProps(size = 24, color = "blue")
 */
def MiniProgramLine = (props: MiniProgramLineProps) => {
  svg(
    viewBox := "0 0 24 24",
