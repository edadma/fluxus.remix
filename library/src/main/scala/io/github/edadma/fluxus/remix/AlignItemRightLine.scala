...
/**
 * AlignItemRightLine icon from the Remix Icon library, Design category.
 */
case class AlignItemRightLineProps(
  size: Int = 24,
...
/**
 * AlignItemRightLine icon component.
 *
 * @example AlignItemRightLine <> AlignItemRightLineProps(size = 24, color = "blue")
 */
def AlignItemRightLine = (props: AlignItemRightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
