...
/**
 * VidiconFill icon from the Remix Icon library, Media category.
 */
case class VidiconFillProps(
  size: Int = 24,
...
/**
 * VidiconFill icon component.
 *
 * @example VidiconFill <> VidiconFillProps(size = 24, color = "blue")
 */
def VidiconFill = (props: VidiconFillProps) => {
  svg(
    viewBox := "0 0 24 24",
