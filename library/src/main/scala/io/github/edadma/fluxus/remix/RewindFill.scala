...
/**
 * RewindFill icon from the Remix Icon library, Media category.
 */
case class RewindFillProps(
  size: Int = 24,
 ...
 *
 * @example RewindFill <> RewindFillProps(size = 24, color = "blue")
 */
def RewindFill = (props: RewindFillProps) => {
  svg(
    viewBox := "0 0 24 24",
