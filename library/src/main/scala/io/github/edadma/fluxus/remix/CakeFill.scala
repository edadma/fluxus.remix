...
/**
 * CakeFill icon from the Remix Icon library, Food category.
 */
case class CakeFillProps(
  size: Int = 24,
 ...
 *
 * @example CakeFill <> CakeFillProps(size = 24, color = "blue")
 */
def CakeFill = (props: CakeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
