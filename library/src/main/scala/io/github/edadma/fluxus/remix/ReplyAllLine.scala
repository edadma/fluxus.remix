...
/**
 * ReplyAllLine icon from the Remix Icon library, Business category.
 */
case class ReplyAllLineProps(
  size: Int = 24,
...
/**
 * ReplyAllLine icon component.
 *
 * @example ReplyAllLine <> ReplyAllLineProps(size = 24, color = "blue")
 */
def ReplyAllLine = (props: ReplyAllLineProps) => {
  svg(
    viewBox := "0 0 24 24",
