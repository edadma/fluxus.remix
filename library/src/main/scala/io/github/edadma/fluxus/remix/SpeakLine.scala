...
/**
 * SpeakLine icon from the Remix Icon library, Communication category.
 */
case class SpeakLineProps(
  size: Int = 24,
...
/**
 * SpeakLine icon component.
 *
 * @example SpeakLine <> SpeakLineProps(size = 24, color = "blue")
 */
def SpeakLine = (props: SpeakLineProps) => {
  svg(
    viewBox := "0 0 24 24",
