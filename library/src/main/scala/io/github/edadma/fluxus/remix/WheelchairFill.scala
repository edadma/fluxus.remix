...
/**
 * WheelchairFill icon from the Remix Icon library, Others category.
 */
case class WheelchairFillProps(
  size: Int = 24,
 ...
 *
 * @example WheelchairFill <> WheelchairFillProps(size = 24, color = "blue")
 */
def WheelchairFill = (props: WheelchairFillProps) => {
  svg(
    viewBox := "0 0 24 24",
