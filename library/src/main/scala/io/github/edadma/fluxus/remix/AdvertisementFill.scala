...
/**
 * AdvertisementFill icon from the Remix Icon library, Business category.
 */
case class AdvertisementFillProps(
  size: Int = 24,
...
/**
 * AdvertisementFill icon component.
 *
 * @example AdvertisementFill <> AdvertisementFillProps(size = 24, color = "blue")
 */
def AdvertisementFill = (props: AdvertisementFillProps) => {
  svg(
    viewBox := "0 0 24 24",
