...
/**
 * BarChartBoxAiLine icon from the Remix Icon library, Business category.
 */
case class BarChartBoxAiLineProps(
  size: Int = 24,
...
/**
 * BarChartBoxAiLine icon component.
 *
 * @example BarChartBoxAiLine <> BarChartBoxAiLineProps(size = 24, color = "blue")
 */
def BarChartBoxAiLine = (props: BarChartBoxAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
