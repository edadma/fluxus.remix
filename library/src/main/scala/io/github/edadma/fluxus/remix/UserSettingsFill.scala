...
/**
 * UserSettingsFill icon from the Remix Icon library, User & Faces category.
 */
case class UserSettingsFillProps(
  size: Int = 24,
...
/**
 * UserSettingsFill icon component.
 *
 * @example UserSettingsFill <> UserSettingsFillProps(size = 24, color = "blue")
 */
def UserSettingsFill = (props: UserSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
