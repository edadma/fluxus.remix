...
/**
 * GalleryLine icon from the Remix Icon library, Media category.
 */
case class GalleryLineProps(
  size: Int = 24,
...
/**
 * GalleryLine icon component.
 *
 * @example GalleryLine <> GalleryLineProps(size = 24, color = "blue")
 */
def GalleryLine = (props: GalleryLineProps) => {
  svg(
    viewBox := "0 0 24 24",
