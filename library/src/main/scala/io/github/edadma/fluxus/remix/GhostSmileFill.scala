...
/**
 * GhostSmileFill icon from the Remix Icon library, User & Faces category.
 */
case class GhostSmileFillProps(
  size: Int = 24,
...
/**
 * GhostSmileFill icon component.
 *
 * @example GhostSmileFill <> GhostSmileFillProps(size = 24, color = "blue")
 */
def GhostSmileFill = (props: GhostSmileFillProps) => {
  svg(
    viewBox := "0 0 24 24",
