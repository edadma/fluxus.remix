...
/**
 * CarLine icon from the Remix Icon library, Map category.
 */
case class CarLineProps(
  size: Int = 24,
...
/**
 * CarLine icon component.
 *
 * @example CarLine <> CarLineProps(size = 24, color = "blue")
 */
def CarLine = (props: CarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
