...
/**
 * RotateLockLine icon from the Remix Icon library, Device category.
 */
case class RotateLockLineProps(
  size: Int = 24,
...
/**
 * RotateLockLine icon component.
 *
 * @example RotateLockLine <> RotateLockLineProps(size = 24, color = "blue")
 */
def RotateLockLine = (props: RotateLockLineProps) => {
  svg(
    viewBox := "0 0 24 24",
