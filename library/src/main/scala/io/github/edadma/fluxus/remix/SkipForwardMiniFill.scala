...
/**
 * SkipForwardMiniFill icon from the Remix Icon library, Media category.
 */
case class SkipForwardMiniFillProps(
  size: Int = 24,
...
/**
 * SkipForwardMiniFill icon component.
 *
 * @example SkipForwardMiniFill <> SkipForwardMiniFillProps(size = 24, color = "blue")
 */
def SkipForwardMiniFill = (props: SkipForwardMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
