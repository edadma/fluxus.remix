...
/**
 * DvFill icon from the Remix Icon library, Media category.
 */
case class DvFillProps(
  size: Int = 24,
...
/**
 * DvFill icon component.
 *
 * @example DvFill <> DvFillProps(size = 24, color = "blue")
 */
def DvFill = (props: DvFillProps) => {
  svg(
    viewBox := "0 0 24 24",
