...
/**
 * FolderOpenLine icon from the Remix Icon library, Document category.
 */
case class FolderOpenLineProps(
  size: Int = 24,
...
/**
 * FolderOpenLine icon component.
 *
 * @example FolderOpenLine <> FolderOpenLineProps(size = 24, color = "blue")
 */
def FolderOpenLine = (props: FolderOpenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
