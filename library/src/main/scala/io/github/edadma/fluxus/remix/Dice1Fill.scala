...
/**
 * Dice1Fill icon from the Remix Icon library, Others category.
 */
case class Dice1FillProps(
  size: Int = 24,
...
/**
 * Dice1Fill icon component.
 *
 * @example Dice1Fill <> Dice1FillProps(size = 24, color = "blue")
 */
def Dice1Fill = (props: Dice1FillProps) => {
  svg(
    viewBox := "0 0 24 24",
