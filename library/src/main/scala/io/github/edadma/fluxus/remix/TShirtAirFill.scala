...
/**
 * TShirtAirFill icon from the Remix Icon library, Others category.
 */
case class TShirtAirFillProps(
  size: Int = 24,
...
/**
 * TShirtAirFill icon component.
 *
 * @example TShirtAirFill <> TShirtAirFillProps(size = 24, color = "blue")
 */
def TShirtAirFill = (props: TShirtAirFillProps) => {
  svg(
    viewBox := "0 0 24 24",
