...
/**
 * P2pLine icon from the Remix Icon library, Finance category.
 */
case class P2pLineProps(
  size: Int = 24,
...
/**
 * P2pLine icon component.
 *
 * @example P2pLine <> P2pLineProps(size = 24, color = "blue")
 */
def P2pLine = (props: P2pLineProps) => {
  svg(
    viewBox := "0 0 24 24",
