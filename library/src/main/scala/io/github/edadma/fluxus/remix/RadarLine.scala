...
/**
 * RadarLine icon from the Remix Icon library, Device category.
 */
case class RadarLineProps(
  size: Int = 24,
...
/**
 * RadarLine icon component.
 *
 * @example RadarLine <> RadarLineProps(size = 24, color = "blue")
 */
def RadarLine = (props: RadarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
