...
/**
 * PhoneFindFill icon from the Remix Icon library, Device category.
 */
case class PhoneFindFillProps(
  size: Int = 24,
...
/**
 * PhoneFindFill icon component.
 *
 * @example PhoneFindFill <> PhoneFindFillProps(size = 24, color = "blue")
 */
def PhoneFindFill = (props: PhoneFindFillProps) => {
  svg(
    viewBox := "0 0 24 24",
