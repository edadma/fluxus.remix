...
/**
 * FundsFill icon from the Remix Icon library, Finance category.
 */
case class FundsFillProps(
  size: Int = 24,
...
/**
 * FundsFill icon component.
 *
 * @example FundsFill <> FundsFillProps(size = 24, color = "blue")
 */
def FundsFill = (props: FundsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
