...
/**
 * OrderPlayFill icon from the Remix Icon library, Media category.
 */
case class OrderPlayFillProps(
  size: Int = 24,
...
/**
 * OrderPlayFill icon component.
 *
 * @example OrderPlayFill <> OrderPlayFillProps(size = 24, color = "blue")
 */
def OrderPlayFill = (props: OrderPlayFillProps) => {
  svg(
    viewBox := "0 0 24 24",
