...
/**
 * MedalFill icon from the Remix Icon library, Business category.
 */
case class MedalFillProps(
  size: Int = 24,
 ...
 *
 * @example MedalFill <> MedalFillProps(size = 24, color = "blue")
 */
def MedalFill = (props: MedalFillProps) => {
  svg(
    viewBox := "0 0 24 24",
