...
/**
 * ImageAiLine icon from the Remix Icon library, Media category.
 */
case class ImageAiLineProps(
  size: Int = 24,
...
/**
 * ImageAiLine icon component.
 *
 * @example ImageAiLine <> ImageAiLineProps(size = 24, color = "blue")
 */
def ImageAiLine = (props: ImageAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
