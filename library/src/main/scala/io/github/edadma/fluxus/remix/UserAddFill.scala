...
/**
 * UserAddFill icon from the Remix Icon library, User & Faces category.
 */
case class UserAddFillProps(
  size: Int = 24,
...
/**
 * UserAddFill icon component.
 *
 * @example UserAddFill <> UserAddFillProps(size = 24, color = "blue")
 */
def UserAddFill = (props: UserAddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
