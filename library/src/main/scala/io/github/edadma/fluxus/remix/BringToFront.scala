...
/**
 * BringToFront icon from the Remix Icon library, Editor category.
 */
case class BringToFrontProps(
  size: Int = 24,
 ...
 *
 * @example BringToFront <> BringToFrontProps(size = 24, color = "blue")
 */
def BringToFront = (props: BringToFrontProps) => {
  svg(
    viewBox := "0 0 24 24",
