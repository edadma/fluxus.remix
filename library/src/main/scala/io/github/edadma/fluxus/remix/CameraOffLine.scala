...
/**
 * CameraOffLine icon from the Remix Icon library, Media category.
 */
case class CameraOffLineProps(
  size: Int = 24,
...
/**
 * CameraOffLine icon component.
 *
 * @example CameraOffLine <> CameraOffLineProps(size = 24, color = "blue")
 */
def CameraOffLine = (props: CameraOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
