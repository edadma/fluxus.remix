...
/**
 * DeleteBackFill icon from the Remix Icon library, System category.
 */
case class DeleteBackFillProps(
  size: Int = 24,
...
/**
 * DeleteBackFill icon component.
 *
 * @example DeleteBackFill <> DeleteBackFillProps(size = 24, color = "blue")
 */
def DeleteBackFill = (props: DeleteBackFillProps) => {
  svg(
    viewBox := "0 0 24 24",
