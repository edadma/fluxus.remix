...
/**
 * EyeCloseFill icon from the Remix Icon library, System category.
 */
case class EyeCloseFillProps(
  size: Int = 24,
...
/**
 * EyeCloseFill icon component.
 *
 * @example EyeCloseFill <> EyeCloseFillProps(size = 24, color = "blue")
 */
def EyeCloseFill = (props: EyeCloseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
