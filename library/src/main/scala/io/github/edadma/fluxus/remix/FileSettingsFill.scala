...
/**
 * FileSettingsFill icon from the Remix Icon library, Document category.
 */
case class FileSettingsFillProps(
  size: Int = 24,
...
/**
 * FileSettingsFill icon component.
 *
 * @example FileSettingsFill <> FileSettingsFillProps(size = 24, color = "blue")
 */
def FileSettingsFill = (props: FileSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
