...
/**
 * DeleteBin2Fill icon from the Remix Icon library, System category.
 */
case class DeleteBin2FillProps(
  size: Int = 24,
...
/**
 * DeleteBin2Fill icon component.
 *
 * @example DeleteBin2Fill <> DeleteBin2FillProps(size = 24, color = "blue")
 */
def DeleteBin2Fill = (props: DeleteBin2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
