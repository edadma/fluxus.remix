...
/**
 * GalleryView icon from the Remix Icon library, Editor category.
 */
case class GalleryViewProps(
  size: Int = 24,
...
/**
 * GalleryView icon component.
 *
 * @example GalleryView <> GalleryViewProps(size = 24, color = "blue")
 */
def GalleryView = (props: GalleryViewProps) => {
  svg(
    viewBox := "0 0 24 24",
