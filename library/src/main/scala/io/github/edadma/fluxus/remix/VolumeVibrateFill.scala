...
/**
 * VolumeVibrateFill icon from the Remix Icon library, Media category.
 */
case class VolumeVibrateFillProps(
  size: Int = 24,
...
/**
 * VolumeVibrateFill icon component.
 *
 * @example VolumeVibrateFill <> VolumeVibrateFillProps(size = 24, color = "blue")
 */
def VolumeVibrateFill = (props: VolumeVibrateFillProps) => {
  svg(
    viewBox := "0 0 24 24",
