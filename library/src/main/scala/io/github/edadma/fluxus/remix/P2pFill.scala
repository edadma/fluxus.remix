...
/**
 * P2pFill icon from the Remix Icon library, Finance category.
 */
case class P2pFillProps(
  size: Int = 24,
...
/**
 * P2pFill icon component.
 *
 * @example P2pFill <> P2pFillProps(size = 24, color = "blue")
 */
def P2pFill = (props: P2pFillProps) => {
  svg(
    viewBox := "0 0 24 24",
