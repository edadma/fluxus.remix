...
/**
 * KnifeLine icon from the Remix Icon library, Food category.
 */
case class KnifeLineProps(
  size: Int = 24,
...
/**
 * KnifeLine icon component.
 *
 * @example KnifeLine <> KnifeLineProps(size = 24, color = "blue")
 */
def KnifeLine = (props: KnifeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
