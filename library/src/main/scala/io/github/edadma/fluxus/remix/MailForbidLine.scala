...
/**
 * MailForbidLine icon from the Remix Icon library, Business category.
 */
case class MailForbidLineProps(
  size: Int = 24,
...
/**
 * MailForbidLine icon component.
 *
 * @example MailForbidLine <> MailForbidLineProps(size = 24, color = "blue")
 */
def MailForbidLine = (props: MailForbidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
