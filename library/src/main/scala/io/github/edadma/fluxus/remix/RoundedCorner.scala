...
/**
 * RoundedCorner icon from the Remix Icon library, Editor category.
 */
case class RoundedCornerProps(
  size: Int = 24,
...
/**
 * RoundedCorner icon component.
 *
 * @example RoundedCorner <> RoundedCornerProps(size = 24, color = "blue")
 */
def RoundedCorner = (props: RoundedCornerProps) => {
  svg(
    viewBox := "0 0 24 24",
