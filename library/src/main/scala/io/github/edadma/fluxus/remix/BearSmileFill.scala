...
/**
 * BearSmileFill icon from the Remix Icon library, User & Faces category.
 */
case class BearSmileFillProps(
  size: Int = 24,
...
/**
 * BearSmileFill icon component.
 *
 * @example BearSmileFill <> BearSmileFillProps(size = 24, color = "blue")
 */
def BearSmileFill = (props: BearSmileFillProps) => {
  svg(
    viewBox := "0 0 24 24",
