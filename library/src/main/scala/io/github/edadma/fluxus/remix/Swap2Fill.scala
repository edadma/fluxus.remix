...
/**
 * Swap2Fill icon from the Remix Icon library, Finance category.
 */
case class Swap2FillProps(
  size: Int = 24,
...
/**
 * Swap2Fill icon component.
 *
 * @example Swap2Fill <> Swap2FillProps(size = 24, color = "blue")
 */
def Swap2Fill = (props: Swap2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
