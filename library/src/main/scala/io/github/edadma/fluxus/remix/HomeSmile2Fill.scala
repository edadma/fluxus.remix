...
/**
 * HomeSmile2Fill icon from the Remix Icon library, Buildings category.
 */
case class HomeSmile2FillProps(
  size: Int = 24,
...
/**
 * HomeSmile2Fill icon component.
 *
 * @example HomeSmile2Fill <> HomeSmile2FillProps(size = 24, color = "blue")
 */
def HomeSmile2Fill = (props: HomeSmile2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
