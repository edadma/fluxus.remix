...
/**
 * WechatPayFill icon from the Remix Icon library, Logos category.
 */
case class WechatPayFillProps(
  size: Int = 24,
...
/**
 * WechatPayFill icon component.
 *
 * @example WechatPayFill <> WechatPayFillProps(size = 24, color = "blue")
 */
def WechatPayFill = (props: WechatPayFillProps) => {
  svg(
    viewBox := "0 0 24 24",
