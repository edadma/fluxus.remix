...
/**
 * Superscript icon from the Remix Icon library, Editor category.
 */
case class SuperscriptProps(
  size: Int = 24,
 ...
 *
 * @example Superscript <> SuperscriptProps(size = 24, color = "blue")
 */
def Superscript = (props: SuperscriptProps) => {
  svg(
    viewBox := "0 0 24 24",
