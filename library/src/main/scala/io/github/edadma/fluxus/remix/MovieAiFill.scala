...
/**
 * MovieAiFill icon from the Remix Icon library, Media category.
 */
case class MovieAiFillProps(
  size: Int = 24,
...
/**
 * MovieAiFill icon component.
 *
 * @example MovieAiFill <> MovieAiFillProps(size = 24, color = "blue")
 */
def MovieAiFill = (props: MovieAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
