...
/**
 * Slideshow4Fill icon from the Remix Icon library, Business category.
 */
case class Slideshow4FillProps(
  size: Int = 24,
...
/**
 * Slideshow4Fill icon component.
 *
 * @example Slideshow4Fill <> Slideshow4FillProps(size = 24, color = "blue")
 */
def Slideshow4Fill = (props: Slideshow4FillProps) => {
  svg(
    viewBox := "0 0 24 24",
