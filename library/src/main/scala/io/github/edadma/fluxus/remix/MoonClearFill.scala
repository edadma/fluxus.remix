...
/**
 * MoonClearFill icon from the Remix Icon library, Weather category.
 */
case class MoonClearFillProps(
  size: Int = 24,
...
/**
 * MoonClearFill icon component.
 *
 * @example MoonClearFill <> MoonClearFillProps(size = 24, color = "blue")
 */
def MoonClearFill = (props: MoonClearFillProps) => {
  svg(
    viewBox := "0 0 24 24",
