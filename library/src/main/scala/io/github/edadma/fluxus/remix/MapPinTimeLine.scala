...
/**
 * MapPinTimeLine icon from the Remix Icon library, Map category.
 */
case class MapPinTimeLineProps(
  size: Int = 24,
...
/**
 * MapPinTimeLine icon component.
 *
 * @example MapPinTimeLine <> MapPinTimeLineProps(size = 24, color = "blue")
 */
def MapPinTimeLine = (props: MapPinTimeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
