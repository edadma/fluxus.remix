...
/**
 * GeminiLine icon from the Remix Icon library, Logos category.
 */
case class GeminiLineProps(
  size: Int = 24,
...
/**
 * GeminiLine icon component.
 *
 * @example GeminiLine <> GeminiLineProps(size = 24, color = "blue")
 */
def GeminiLine = (props: GeminiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
