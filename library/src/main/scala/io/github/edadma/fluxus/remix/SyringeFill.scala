...
/**
 * SyringeFill icon from the Remix Icon library, Health & Medical category.
 */
case class SyringeFillProps(
  size: Int = 24,
 ...
 *
 * @example SyringeFill <> SyringeFillProps(size = 24, color = "blue")
 */
def SyringeFill = (props: SyringeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
