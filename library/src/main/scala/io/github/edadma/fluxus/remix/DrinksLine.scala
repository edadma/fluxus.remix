...
/**
 * DrinksLine icon from the Remix Icon library, Food category.
 */
case class DrinksLineProps(
  size: Int = 24,
...
/**
 * DrinksLine icon component.
 *
 * @example DrinksLine <> DrinksLineProps(size = 24, color = "blue")
 */
def DrinksLine = (props: DrinksLineProps) => {
  svg(
    viewBox := "0 0 24 24",
