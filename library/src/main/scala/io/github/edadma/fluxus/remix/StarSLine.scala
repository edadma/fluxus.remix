...
/**
 * StarSLine icon from the Remix Icon library, System category.
 */
case class StarSLineProps(
  size: Int = 24,
...
/**
 * StarSLine icon component.
 *
 * @example StarSLine <> StarSLineProps(size = 24, color = "blue")
 */
def StarSLine = (props: StarSLineProps) => {
  svg(
    viewBox := "0 0 24 24",
