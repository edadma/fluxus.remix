...
/**
 * SunFoggyLine icon from the Remix Icon library, Weather category.
 */
case class SunFoggyLineProps(
  size: Int = 24,
...
/**
 * SunFoggyLine icon component.
 *
 * @example SunFoggyLine <> SunFoggyLineProps(size = 24, color = "blue")
 */
def SunFoggyLine = (props: SunFoggyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
