...
/**
 * BookShelfFill icon from the Remix Icon library, Others category.
 */
case class BookShelfFillProps(
  size: Int = 24,
...
/**
 * BookShelfFill icon component.
 *
 * @example BookShelfFill <> BookShelfFillProps(size = 24, color = "blue")
 */
def BookShelfFill = (props: BookShelfFillProps) => {
  svg(
    viewBox := "0 0 24 24",
