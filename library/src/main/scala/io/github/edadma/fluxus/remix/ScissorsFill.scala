...
/**
 * ScissorsFill icon from the Remix Icon library, Design category.
 */
case class ScissorsFillProps(
  size: Int = 24,
 ...
 *
 * @example ScissorsFill <> ScissorsFillProps(size = 24, color = "blue")
 */
def ScissorsFill = (props: ScissorsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
