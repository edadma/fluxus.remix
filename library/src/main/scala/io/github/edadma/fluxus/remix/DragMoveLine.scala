...
/**
 * DragMoveLine icon from the Remix Icon library, Arrows category.
 */
case class DragMoveLineProps(
  size: Int = 24,
...
/**
 * DragMoveLine icon component.
 *
 * @example DragMoveLine <> DragMoveLineProps(size = 24, color = "blue")
 */
def DragMoveLine = (props: DragMoveLineProps) => {
  svg(
    viewBox := "0 0 24 24",
