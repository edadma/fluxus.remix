...
/**
 * Box1Line icon from the Remix Icon library, Others category.
 */
case class Box1LineProps(
  size: Int = 24,
...
/**
 * Box1Line icon component.
 *
 * @example Box1Line <> Box1LineProps(size = 24, color = "blue")
 */
def Box1Line = (props: Box1LineProps) => {
  svg(
    viewBox := "0 0 24 24",
