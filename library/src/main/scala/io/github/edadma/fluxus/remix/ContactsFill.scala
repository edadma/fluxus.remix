...
/**
 * ContactsFill icon from the Remix Icon library, User & Faces category.
 */
case class ContactsFillProps(
  size: Int = 24,
...
/**
 * ContactsFill icon component.
 *
 * @example ContactsFill <> ContactsFillProps(size = 24, color = "blue")
 */
def ContactsFill = (props: ContactsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
