...
/**
 * CompassLine icon from the Remix Icon library, Map category.
 */
case class CompassLineProps(
  size: Int = 24,
...
/**
 * CompassLine icon component.
 *
 * @example CompassLine <> CompassLineProps(size = 24, color = "blue")
 */
def CompassLine = (props: CompassLineProps) => {
  svg(
    viewBox := "0 0 24 24",
