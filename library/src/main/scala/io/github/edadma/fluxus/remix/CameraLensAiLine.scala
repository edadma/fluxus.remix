...
/**
 * CameraLensAiLine icon from the Remix Icon library, Media category.
 */
case class CameraLensAiLineProps(
  size: Int = 24,
...
/**
 * CameraLensAiLine icon component.
 *
 * @example CameraLensAiLine <> CameraLensAiLineProps(size = 24, color = "blue")
 */
def CameraLensAiLine = (props: CameraLensAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
