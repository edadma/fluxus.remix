...
/**
 * ChatThreadLine icon from the Remix Icon library, Communication category.
 */
case class ChatThreadLineProps(
  size: Int = 24,
...
/**
 * ChatThreadLine icon component.
 *
 * @example ChatThreadLine <> ChatThreadLineProps(size = 24, color = "blue")
 */
def ChatThreadLine = (props: ChatThreadLineProps) => {
  svg(
    viewBox := "0 0 24 24",
