...
/**
 * PictureInPicture2Line icon from the Remix Icon library, Media category.
 */
case class PictureInPicture2LineProps(
  size: Int = 24,
...
/**
 * PictureInPicture2Line icon component.
 *
 * @example PictureInPicture2Line <> PictureInPicture2LineProps(size = 24, color = "blue")
 */
def PictureInPicture2Line = (props: PictureInPicture2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
