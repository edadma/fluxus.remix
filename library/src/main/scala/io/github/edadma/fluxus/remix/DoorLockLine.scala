...
/**
 * DoorLockLine icon from the Remix Icon library, Others category.
 */
case class DoorLockLineProps(
  size: Int = 24,
...
/**
 * DoorLockLine icon component.
 *
 * @example DoorLockLine <> DoorLockLineProps(size = 24, color = "blue")
 */
def DoorLockLine = (props: DoorLockLineProps) => {
  svg(
    viewBox := "0 0 24 24",
