...
/**
 * ChatAiLine icon from the Remix Icon library, Communication category.
 */
case class ChatAiLineProps(
  size: Int = 24,
 ...
 *
 * @example ChatAiLine <> ChatAiLineProps(size = 24, color = "blue")
 */
def ChatAiLine = (props: ChatAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
