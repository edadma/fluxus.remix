...
/**
 * AlipayLine icon from the Remix Icon library, Logos category.
 */
case class AlipayLineProps(
  size: Int = 24,
...
/**
 * AlipayLine icon component.
 *
 * @example AlipayLine <> AlipayLineProps(size = 24, color = "blue")
 */
def AlipayLine = (props: AlipayLineProps) => {
  svg(
    viewBox := "0 0 24 24",
