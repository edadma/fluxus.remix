...
/**
 * BankFill icon from the Remix Icon library, Buildings category.
 */
case class BankFillProps(
  size: Int = 24,
 ...
 *
 * @example BankFill <> BankFillProps(size = 24, color = "blue")
 */
def BankFill = (props: BankFillProps) => {
  svg(
    viewBox := "0 0 24 24",
