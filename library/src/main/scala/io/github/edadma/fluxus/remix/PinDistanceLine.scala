...
/**
 * PinDistanceLine icon from the Remix Icon library, Map category.
 */
case class PinDistanceLineProps(
  size: Int = 24,
...
/**
 * PinDistanceLine icon component.
 *
 * @example PinDistanceLine <> PinDistanceLineProps(size = 24, color = "blue")
 */
def PinDistanceLine = (props: PinDistanceLineProps) => {
  svg(
    viewBox := "0 0 24 24",
