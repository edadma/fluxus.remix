...
/**
 * TempHotFill icon from the Remix Icon library, Weather category.
 */
case class TempHotFillProps(
  size: Int = 24,
...
/**
 * TempHotFill icon component.
 *
 * @example TempHotFill <> TempHotFillProps(size = 24, color = "blue")
 */
def TempHotFill = (props: TempHotFillProps) => {
  svg(
    viewBox := "0 0 24 24",
