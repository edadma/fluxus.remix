...
/**
 * CameraLensLine icon from the Remix Icon library, Media category.
 */
case class CameraLensLineProps(
  size: Int = 24,
...
/**
 * CameraLensLine icon component.
 *
 * @example CameraLensLine <> CameraLensLineProps(size = 24, color = "blue")
 */
def CameraLensLine = (props: CameraLensLineProps) => {
  svg(
    viewBox := "0 0 24 24",
