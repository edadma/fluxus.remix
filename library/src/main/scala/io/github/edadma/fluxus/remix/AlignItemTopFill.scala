...
/**
 * AlignItemTopFill icon from the Remix Icon library, Design category.
 */
case class AlignItemTopFillProps(
  size: Int = 24,
...
/**
 * AlignItemTopFill icon component.
 *
 * @example AlignItemTopFill <> AlignItemTopFillProps(size = 24, color = "blue")
 */
def AlignItemTopFill = (props: AlignItemTopFillProps) => {
  svg(
    viewBox := "0 0 24 24",
