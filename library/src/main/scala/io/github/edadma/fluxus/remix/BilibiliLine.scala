...
/**
 * BilibiliLine icon from the Remix Icon library, Logos category.
 */
case class BilibiliLineProps(
  size: Int = 24,
...
/**
 * BilibiliLine icon component.
 *
 * @example BilibiliLine <> BilibiliLineProps(size = 24, color = "blue")
 */
def BilibiliLine = (props: BilibiliLineProps) => {
  svg(
    viewBox := "0 0 24 24",
