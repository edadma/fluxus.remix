...
/**
 * DownloadCloud2Line icon from the Remix Icon library, System category.
 */
case class DownloadCloud2LineProps(
  size: Int = 24,
...
/**
 * DownloadCloud2Line icon component.
 *
 * @example DownloadCloud2Line <> DownloadCloud2LineProps(size = 24, color = "blue")
 */
def DownloadCloud2Line = (props: DownloadCloud2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
