...
/**
 * SignalTowerFill icon from the Remix Icon library, Map category.
 */
case class SignalTowerFillProps(
  size: Int = 24,
...
/**
 * SignalTowerFill icon component.
 *
 * @example SignalTowerFill <> SignalTowerFillProps(size = 24, color = "blue")
 */
def SignalTowerFill = (props: SignalTowerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
