...
/**
 * Group3Line icon from the Remix Icon library, User & Faces category.
 */
case class Group3LineProps(
  size: Int = 24,
...
/**
 * Group3Line icon component.
 *
 * @example Group3Line <> Group3LineProps(size = 24, color = "blue")
 */
def Group3Line = (props: Group3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
