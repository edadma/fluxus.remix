...
/**
 * MailLockLine icon from the Remix Icon library, Business category.
 */
case class MailLockLineProps(
  size: Int = 24,
...
/**
 * MailLockLine icon component.
 *
 * @example MailLockLine <> MailLockLineProps(size = 24, color = "blue")
 */
def MailLockLine = (props: MailLockLineProps) => {
  svg(
    viewBox := "0 0 24 24",
