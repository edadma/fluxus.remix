...
/**
 * FigmaLine icon from the Remix Icon library, Logos category.
 */
case class FigmaLineProps(
  size: Int = 24,
...
/**
 * FigmaLine icon component.
 *
 * @example FigmaLine <> FigmaLineProps(size = 24, color = "blue")
 */
def FigmaLine = (props: FigmaLineProps) => {
  svg(
    viewBox := "0 0 24 24",
