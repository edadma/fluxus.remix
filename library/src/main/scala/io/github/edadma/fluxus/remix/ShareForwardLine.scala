...
/**
 * ShareForwardLine icon from the Remix Icon library, System category.
 */
case class ShareForwardLineProps(
  size: Int = 24,
...
/**
 * ShareForwardLine icon component.
 *
 * @example ShareForwardLine <> ShareForwardLineProps(size = 24, color = "blue")
 */
def ShareForwardLine = (props: ShareForwardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
