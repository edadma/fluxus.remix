...
/**
 * SubwayLine icon from the Remix Icon library, Map category.
 */
case class SubwayLineProps(
  size: Int = 24,
...
/**
 * SubwayLine icon component.
 *
 * @example SubwayLine <> SubwayLineProps(size = 24, color = "blue")
 */
def SubwayLine = (props: SubwayLineProps) => {
  svg(
    viewBox := "0 0 24 24",
