...
/**
 * ForbidFill icon from the Remix Icon library, System category.
 */
case class ForbidFillProps(
  size: Int = 24,
...
/**
 * ForbidFill icon component.
 *
 * @example ForbidFill <> ForbidFillProps(size = 24, color = "blue")
 */
def ForbidFill = (props: ForbidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
