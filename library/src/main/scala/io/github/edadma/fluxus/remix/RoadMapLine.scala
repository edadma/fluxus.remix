...
/**
 * RoadMapLine icon from the Remix Icon library, Map category.
 */
case class RoadMapLineProps(
  size: Int = 24,
...
/**
 * RoadMapLine icon component.
 *
 * @example RoadMapLine <> RoadMapLineProps(size = 24, color = "blue")
 */
def RoadMapLine = (props: RoadMapLineProps) => {
  svg(
    viewBox := "0 0 24 24",
