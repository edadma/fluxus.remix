...
/**
 * FoggyLine icon from the Remix Icon library, Weather category.
 */
case class FoggyLineProps(
  size: Int = 24,
...
/**
 * FoggyLine icon component.
 *
 * @example FoggyLine <> FoggyLineProps(size = 24, color = "blue")
 */
def FoggyLine = (props: FoggyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
