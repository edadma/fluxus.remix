...
/**
 * SpeedFill icon from the Remix Icon library, Media category.
 */
case class SpeedFillProps(
  size: Int = 24,
...
/**
 * SpeedFill icon component.
 *
 * @example SpeedFill <> SpeedFillProps(size = 24, color = "blue")
 */
def SpeedFill = (props: SpeedFillProps) => {
  svg(
    viewBox := "0 0 24 24",
