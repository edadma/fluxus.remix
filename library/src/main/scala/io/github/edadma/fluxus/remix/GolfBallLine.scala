...
/**
 * GolfBallLine icon from the Remix Icon library, Others category.
 */
case class GolfBallLineProps(
  size: Int = 24,
...
/**
 * GolfBallLine icon component.
 *
 * @example GolfBallLine <> GolfBallLineProps(size = 24, color = "blue")
 */
def GolfBallLine = (props: GolfBallLineProps) => {
  svg(
    viewBox := "0 0 24 24",
