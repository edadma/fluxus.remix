...
/**
 * IdCardLine icon from the Remix Icon library, Business category.
 */
case class IdCardLineProps(
  size: Int = 24,
...
/**
 * IdCardLine icon component.
 *
 * @example IdCardLine <> IdCardLineProps(size = 24, color = "blue")
 */
def IdCardLine = (props: IdCardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
