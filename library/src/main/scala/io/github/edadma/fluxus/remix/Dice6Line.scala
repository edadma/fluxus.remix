...
/**
 * Dice6Line icon from the Remix Icon library, Others category.
 */
case class Dice6LineProps(
  size: Int = 24,
...
/**
 * Dice6Line icon component.
 *
 * @example Dice6Line <> Dice6LineProps(size = 24, color = "blue")
 */
def Dice6Line = (props: Dice6LineProps) => {
  svg(
    viewBox := "0 0 24 24",
