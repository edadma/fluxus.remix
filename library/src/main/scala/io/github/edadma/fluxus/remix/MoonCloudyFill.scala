...
/**
 * MoonCloudyFill icon from the Remix Icon library, Weather category.
 */
case class MoonCloudyFillProps(
  size: Int = 24,
...
/**
 * MoonCloudyFill icon component.
 *
 * @example MoonCloudyFill <> MoonCloudyFillProps(size = 24, color = "blue")
 */
def MoonCloudyFill = (props: MoonCloudyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
