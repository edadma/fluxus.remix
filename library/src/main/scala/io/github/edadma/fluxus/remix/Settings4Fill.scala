...
/**
 * Settings4Fill icon from the Remix Icon library, System category.
 */
case class Settings4FillProps(
  size: Int = 24,
...
/**
 * Settings4Fill icon component.
 *
 * @example Settings4Fill <> Settings4FillProps(size = 24, color = "blue")
 */
def Settings4Fill = (props: Settings4FillProps) => {
  svg(
    viewBox := "0 0 24 24",
