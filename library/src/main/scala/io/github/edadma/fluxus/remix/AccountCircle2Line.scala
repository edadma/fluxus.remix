...
/**
 * AccountCircle2Line icon from the Remix Icon library, User & Faces category.
 */
case class AccountCircle2LineProps(
  size: Int = 24,
...
/**
 * AccountCircle2Line icon component.
 *
 * @example AccountCircle2Line <> AccountCircle2LineProps(size = 24, color = "blue")
 */
def AccountCircle2Line = (props: AccountCircle2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
