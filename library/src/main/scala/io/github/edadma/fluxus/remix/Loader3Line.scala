...
/**
 * Loader3Line icon from the Remix Icon library, System category.
 */
case class Loader3LineProps(
  size: Int = 24,
...
/**
 * Loader3Line icon component.
 *
 * @example Loader3Line <> Loader3LineProps(size = 24, color = "blue")
 */
def Loader3Line = (props: Loader3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
