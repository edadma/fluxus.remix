...
/**
 * Gift2Fill icon from the Remix Icon library, Finance category.
 */
case class Gift2FillProps(
  size: Int = 24,
...
/**
 * Gift2Fill icon component.
 *
 * @example Gift2Fill <> Gift2FillProps(size = 24, color = "blue")
 */
def Gift2Fill = (props: Gift2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
