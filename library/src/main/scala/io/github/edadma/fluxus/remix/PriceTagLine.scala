...
/**
 * PriceTagLine icon from the Remix Icon library, Finance category.
 */
case class PriceTagLineProps(
  size: Int = 24,
...
/**
 * PriceTagLine icon component.
 *
 * @example PriceTagLine <> PriceTagLineProps(size = 24, color = "blue")
 */
def PriceTagLine = (props: PriceTagLineProps) => {
  svg(
    viewBox := "0 0 24 24",
