...
/**
 * MailCloseLine icon from the Remix Icon library, Business category.
 */
case class MailCloseLineProps(
  size: Int = 24,
...
/**
 * MailCloseLine icon component.
 *
 * @example MailCloseLine <> MailCloseLineProps(size = 24, color = "blue")
 */
def MailCloseLine = (props: MailCloseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
