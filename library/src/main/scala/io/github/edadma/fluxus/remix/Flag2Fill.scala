...
/**
 * Flag2Fill icon from the Remix Icon library, Business category.
 */
case class Flag2FillProps(
  size: Int = 24,
...
/**
 * Flag2Fill icon component.
 *
 * @example Flag2Fill <> Flag2FillProps(size = 24, color = "blue")
 */
def Flag2Fill = (props: Flag2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
