...
/**
 * Edit2Line icon from the Remix Icon library, Design category.
 */
case class Edit2LineProps(
  size: Int = 24,
...
/**
 * Edit2Line icon component.
 *
 * @example Edit2Line <> Edit2LineProps(size = 24, color = "blue")
 */
def Edit2Line = (props: Edit2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
