...
/**
 * Information2Line icon from the Remix Icon library, System category.
 */
case class Information2LineProps(
  size: Int = 24,
...
/**
 * Information2Line icon component.
 *
 * @example Information2Line <> Information2LineProps(size = 24, color = "blue")
 */
def Information2Line = (props: Information2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
