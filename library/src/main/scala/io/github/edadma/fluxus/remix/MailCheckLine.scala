...
/**
 * MailCheckLine icon from the Remix Icon library, Business category.
 */
case class MailCheckLineProps(
  size: Int = 24,
...
/**
 * MailCheckLine icon component.
 *
 * @example MailCheckLine <> MailCheckLineProps(size = 24, color = "blue")
 */
def MailCheckLine = (props: MailCheckLineProps) => {
  svg(
    viewBox := "0 0 24 24",
