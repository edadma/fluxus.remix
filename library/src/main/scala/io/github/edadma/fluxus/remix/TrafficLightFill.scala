...
/**
 * TrafficLightFill icon from the Remix Icon library, Map category.
 */
case class TrafficLightFillProps(
  size: Int = 24,
...
/**
 * TrafficLightFill icon component.
 *
 * @example TrafficLightFill <> TrafficLightFillProps(size = 24, color = "blue")
 */
def TrafficLightFill = (props: TrafficLightFillProps) => {
  svg(
    viewBox := "0 0 24 24",
