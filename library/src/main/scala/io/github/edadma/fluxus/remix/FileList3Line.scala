...
/**
 * FileList3Line icon from the Remix Icon library, Document category.
 */
case class FileList3LineProps(
  size: Int = 24,
...
/**
 * FileList3Line icon component.
 *
 * @example FileList3Line <> FileList3LineProps(size = 24, color = "blue")
 */
def FileList3Line = (props: FileList3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
