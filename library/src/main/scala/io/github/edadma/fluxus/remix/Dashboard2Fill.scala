...
/**
 * Dashboard2Fill icon from the Remix Icon library, Device category.
 */
case class Dashboard2FillProps(
  size: Int = 24,
...
/**
 * Dashboard2Fill icon component.
 *
 * @example Dashboard2Fill <> Dashboard2FillProps(size = 24, color = "blue")
 */
def Dashboard2Fill = (props: Dashboard2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
