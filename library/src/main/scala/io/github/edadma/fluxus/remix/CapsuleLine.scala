...
/**
 * CapsuleLine icon from the Remix Icon library, Health & Medical category.
 */
case class CapsuleLineProps(
  size: Int = 24,
...
/**
 * CapsuleLine icon component.
 *
 * @example CapsuleLine <> CapsuleLineProps(size = 24, color = "blue")
 */
def CapsuleLine = (props: CapsuleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
