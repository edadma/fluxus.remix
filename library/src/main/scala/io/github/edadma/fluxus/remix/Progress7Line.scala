...
/**
 * Progress7Line icon from the Remix Icon library, System category.
 */
case class Progress7LineProps(
  size: Int = 24,
...
/**
 * Progress7Line icon component.
 *
 * @example Progress7Line <> Progress7LineProps(size = 24, color = "blue")
 */
def Progress7Line = (props: Progress7LineProps) => {
  svg(
    viewBox := "0 0 24 24",
