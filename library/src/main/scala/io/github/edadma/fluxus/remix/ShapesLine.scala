...
/**
 * ShapesLine icon from the Remix Icon library, Design category.
 */
case class ShapesLineProps(
  size: Int = 24,
...
/**
 * ShapesLine icon component.
 *
 * @example ShapesLine <> ShapesLineProps(size = 24, color = "blue")
 */
def ShapesLine = (props: ShapesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
