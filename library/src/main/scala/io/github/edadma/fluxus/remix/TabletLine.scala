...
/**
 * TabletLine icon from the Remix Icon library, Device category.
 */
case class TabletLineProps(
  size: Int = 24,
...
/**
 * TabletLine icon component.
 *
 * @example TabletLine <> TabletLineProps(size = 24, color = "blue")
 */
def TabletLine = (props: TabletLineProps) => {
  svg(
    viewBox := "0 0 24 24",
