...
/**
 * AlipayFill icon from the Remix Icon library, Logos category.
 */
case class AlipayFillProps(
  size: Int = 24,
...
/**
 * AlipayFill icon component.
 *
 * @example AlipayFill <> AlipayFillProps(size = 24, color = "blue")
 */
def AlipayFill = (props: AlipayFillProps) => {
  svg(
    viewBox := "0 0 24 24",
