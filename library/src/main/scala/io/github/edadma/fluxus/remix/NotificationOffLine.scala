...
/**
 * NotificationOffLine icon from the Remix Icon library, Media category.
 */
case class NotificationOffLineProps(
  size: Int = 24,
...
/**
 * NotificationOffLine icon component.
 *
 * @example NotificationOffLine <> NotificationOffLineProps(size = 24, color = "blue")
 */
def NotificationOffLine = (props: NotificationOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
