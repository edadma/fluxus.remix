...
/**
 * SunCloudyLine icon from the Remix Icon library, Weather category.
 */
case class SunCloudyLineProps(
  size: Int = 24,
...
/**
 * SunCloudyLine icon component.
 *
 * @example SunCloudyLine <> SunCloudyLineProps(size = 24, color = "blue")
 */
def SunCloudyLine = (props: SunCloudyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
