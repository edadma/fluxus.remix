...
/**
 * UserForbidLine icon from the Remix Icon library, User & Faces category.
 */
case class UserForbidLineProps(
  size: Int = 24,
...
/**
 * UserForbidLine icon component.
 *
 * @example UserForbidLine <> UserForbidLineProps(size = 24, color = "blue")
 */
def UserForbidLine = (props: UserForbidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
