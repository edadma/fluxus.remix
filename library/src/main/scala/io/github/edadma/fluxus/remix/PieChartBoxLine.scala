...
/**
 * PieChartBoxLine icon from the Remix Icon library, Business category.
 */
case class PieChartBoxLineProps(
  size: Int = 24,
...
/**
 * PieChartBoxLine icon component.
 *
 * @example PieChartBoxLine <> PieChartBoxLineProps(size = 24, color = "blue")
 */
def PieChartBoxLine = (props: PieChartBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
