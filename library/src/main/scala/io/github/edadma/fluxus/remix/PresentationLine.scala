...
/**
 * PresentationLine icon from the Remix Icon library, Business category.
 */
case class PresentationLineProps(
  size: Int = 24,
...
/**
 * PresentationLine icon component.
 *
 * @example PresentationLine <> PresentationLineProps(size = 24, color = "blue")
 */
def PresentationLine = (props: PresentationLineProps) => {
  svg(
    viewBox := "0 0 24 24",
