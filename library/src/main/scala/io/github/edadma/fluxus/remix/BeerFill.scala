...
/**
 * BeerFill icon from the Remix Icon library, Food category.
 */
case class BeerFillProps(
  size: Int = 24,
...
/**
 * BeerFill icon component.
 *
 * @example BeerFill <> BeerFillProps(size = 24, color = "blue")
 */
def BeerFill = (props: BeerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
