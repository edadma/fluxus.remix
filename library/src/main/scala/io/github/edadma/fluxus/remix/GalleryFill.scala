...
/**
 * GalleryFill icon from the Remix Icon library, Media category.
 */
case class GalleryFillProps(
  size: Int = 24,
...
/**
 * GalleryFill icon component.
 *
 * @example GalleryFill <> GalleryFillProps(size = 24, color = "blue")
 */
def GalleryFill = (props: GalleryFillProps) => {
  svg(
    viewBox := "0 0 24 24",
