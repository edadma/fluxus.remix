...
/**
 * TvFill icon from the Remix Icon library, Device category.
 */
case class TvFillProps(
  size: Int = 24,
...
/**
 * TvFill icon component.
 *
 * @example TvFill <> TvFillProps(size = 24, color = "blue")
 */
def TvFill = (props: TvFillProps) => {
  svg(
    viewBox := "0 0 24 24",
