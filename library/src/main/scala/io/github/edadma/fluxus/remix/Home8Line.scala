...
/**
 * Home8Line icon from the Remix Icon library, Buildings category.
 */
case class Home8LineProps(
  size: Int = 24,
...
/**
 * Home8Line icon component.
 *
 * @example Home8Line <> Home8LineProps(size = 24, color = "blue")
 */
def Home8Line = (props: Home8LineProps) => {
  svg(
    viewBox := "0 0 24 24",
