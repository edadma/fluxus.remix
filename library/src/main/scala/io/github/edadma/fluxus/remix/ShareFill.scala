...
/**
 * ShareFill icon from the Remix Icon library, System category.
 */
case class ShareFillProps(
  size: Int = 24,
 ...
 *
 * @example ShareFill <> ShareFillProps(size = 24, color = "blue")
 */
def ShareFill = (props: ShareFillProps) => {
  svg(
    viewBox := "0 0 24 24",
