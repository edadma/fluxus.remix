...
/**
 * CelsiusFill icon from the Remix Icon library, Weather category.
 */
case class CelsiusFillProps(
  size: Int = 24,
...
/**
 * CelsiusFill icon component.
 *
 * @example CelsiusFill <> CelsiusFillProps(size = 24, color = "blue")
 */
def CelsiusFill = (props: CelsiusFillProps) => {
  svg(
    viewBox := "0 0 24 24",
