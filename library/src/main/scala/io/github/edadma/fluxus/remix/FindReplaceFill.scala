...
/**
 * FindReplaceFill icon from the Remix Icon library, System category.
 */
case class FindReplaceFillProps(
  size: Int = 24,
...
/**
 * FindReplaceFill icon component.
 *
 * @example FindReplaceFill <> FindReplaceFillProps(size = 24, color = "blue")
 */
def FindReplaceFill = (props: FindReplaceFillProps) => {
  svg(
    viewBox := "0 0 24 24",
