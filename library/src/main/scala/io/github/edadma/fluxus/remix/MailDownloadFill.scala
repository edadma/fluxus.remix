...
/**
 * MailDownloadFill icon from the Remix Icon library, Business category.
 */
case class MailDownloadFillProps(
  size: Int = 24,
...
/**
 * MailDownloadFill icon component.
 *
 * @example MailDownloadFill <> MailDownloadFillProps(size = 24, color = "blue")
 */
def MailDownloadFill = (props: MailDownloadFillProps) => {
  svg(
    viewBox := "0 0 24 24",
