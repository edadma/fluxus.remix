...
/**
 * CreativeCommonsNcFill icon from the Remix Icon library, Business category.
 */
case class CreativeCommonsNcFillProps(
  size: Int = 24,
...
/**
 * CreativeCommonsNcFill icon component.
 *
 * @example CreativeCommonsNcFill <> CreativeCommonsNcFillProps(size = 24, color = "blue")
 */
def CreativeCommonsNcFill = (props: CreativeCommonsNcFillProps) => {
  svg(
    viewBox := "0 0 24 24",
