...
/**
 * BankLine icon from the Remix Icon library, Buildings category.
 */
case class BankLineProps(
  size: Int = 24,
...
/**
 * BankLine icon component.
 *
 * @example BankLine <> BankLineProps(size = 24, color = "blue")
 */
def BankLine = (props: BankLineProps) => {
  svg(
    viewBox := "0 0 24 24",
