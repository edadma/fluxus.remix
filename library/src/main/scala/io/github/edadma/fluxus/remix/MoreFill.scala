...
/**
 * MoreFill icon from the Remix Icon library, System category.
 */
case class MoreFillProps(
  size: Int = 24,
...
/**
 * MoreFill icon component.
 *
 * @example MoreFill <> MoreFillProps(size = 24, color = "blue")
 */
def MoreFill = (props: MoreFillProps) => {
  svg(
    viewBox := "0 0 24 24",
