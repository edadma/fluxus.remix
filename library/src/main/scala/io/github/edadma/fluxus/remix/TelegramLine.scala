...
/**
 * TelegramLine icon from the Remix Icon library, Logos category.
 */
case class TelegramLineProps(
  size: Int = 24,
...
/**
 * TelegramLine icon component.
 *
 * @example TelegramLine <> TelegramLineProps(size = 24, color = "blue")
 */
def TelegramLine = (props: TelegramLineProps) => {
  svg(
    viewBox := "0 0 24 24",
