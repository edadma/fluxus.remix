...
/**
 * CodepenLine icon from the Remix Icon library, Logos category.
 */
case class CodepenLineProps(
  size: Int = 24,
...
/**
 * CodepenLine icon component.
 *
 * @example CodepenLine <> CodepenLineProps(size = 24, color = "blue")
 */
def CodepenLine = (props: CodepenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
