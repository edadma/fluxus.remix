...
/**
 * FileVideoLine icon from the Remix Icon library, Document category.
 */
case class FileVideoLineProps(
  size: Int = 24,
...
/**
 * FileVideoLine icon component.
 *
 * @example FileVideoLine <> FileVideoLineProps(size = 24, color = "blue")
 */
def FileVideoLine = (props: FileVideoLineProps) => {
  svg(
    viewBox := "0 0 24 24",
