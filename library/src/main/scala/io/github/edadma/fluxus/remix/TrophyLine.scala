...
/**
 * TrophyLine icon from the Remix Icon library, Finance category.
 */
case class TrophyLineProps(
  size: Int = 24,
...
/**
 * TrophyLine icon component.
 *
 * @example TrophyLine <> TrophyLineProps(size = 24, color = "blue")
 */
def TrophyLine = (props: TrophyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
