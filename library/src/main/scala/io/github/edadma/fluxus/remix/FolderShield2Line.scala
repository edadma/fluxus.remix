...
/**
 * FolderShield2Line icon from the Remix Icon library, Document category.
 */
case class FolderShield2LineProps(
  size: Int = 24,
...
/**
 * FolderShield2Line icon component.
 *
 * @example FolderShield2Line <> FolderShield2LineProps(size = 24, color = "blue")
 */
def FolderShield2Line = (props: FolderShield2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
