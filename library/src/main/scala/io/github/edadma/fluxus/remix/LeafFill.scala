...
/**
 * LeafFill icon from the Remix Icon library, Others category.
 */
case class LeafFillProps(
  size: Int = 24,
 ...
 *
 * @example LeafFill <> LeafFillProps(size = 24, color = "blue")
 */
def LeafFill = (props: LeafFillProps) => {
  svg(
    viewBox := "0 0 24 24",
