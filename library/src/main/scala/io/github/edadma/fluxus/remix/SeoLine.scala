...
/**
 * SeoLine icon from the Remix Icon library, Business category.
 */
case class SeoLineProps(
  size: Int = 24,
...
/**
 * SeoLine icon component.
 *
 * @example SeoLine <> SeoLineProps(size = 24, color = "blue")
 */
def SeoLine = (props: SeoLineProps) => {
  svg(
    viewBox := "0 0 24 24",
