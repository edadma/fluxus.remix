...
/**
 * XboxFill icon from the Remix Icon library, Logos category.
 */
case class XboxFillProps(
  size: Int = 24,
...
/**
 * XboxFill icon component.
 *
 * @example XboxFill <> XboxFillProps(size = 24, color = "blue")
 */
def XboxFill = (props: XboxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
