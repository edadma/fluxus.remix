...
/**
 * FolderForbidLine icon from the Remix Icon library, Document category.
 */
case class FolderForbidLineProps(
  size: Int = 24,
...
/**
 * FolderForbidLine icon component.
 *
 * @example FolderForbidLine <> FolderForbidLineProps(size = 24, color = "blue")
 */
def FolderForbidLine = (props: FolderForbidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
