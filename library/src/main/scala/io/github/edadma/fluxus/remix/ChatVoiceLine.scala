...
/**
 * ChatVoiceLine icon from the Remix Icon library, Communication category.
 */
case class ChatVoiceLineProps(
  size: Int = 24,
...
/**
 * ChatVoiceLine icon component.
 *
 * @example ChatVoiceLine <> ChatVoiceLineProps(size = 24, color = "blue")
 */
def ChatVoiceLine = (props: ChatVoiceLineProps) => {
  svg(
    viewBox := "0 0 24 24",
