...
/**
 * Number3 icon from the Remix Icon library, Editor category.
 */
case class Number3Props(
  size: Int = 24,
...
/**
 * Number3 icon component.
 *
 * @example Number3 <> Number3Props(size = 24, color = "blue")
 */
def Number3 = (props: Number3Props) => {
  svg(
    viewBox := "0 0 24 24",
