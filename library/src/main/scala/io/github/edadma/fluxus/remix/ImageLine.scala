...
/**
 * ImageLine icon from the Remix Icon library, Media category.
 */
case class ImageLineProps(
  size: Int = 24,
...
/**
 * ImageLine icon component.
 *
 * @example ImageLine <> ImageLineProps(size = 24, color = "blue")
 */
def ImageLine = (props: ImageLineProps) => {
  svg(
    viewBox := "0 0 24 24",
