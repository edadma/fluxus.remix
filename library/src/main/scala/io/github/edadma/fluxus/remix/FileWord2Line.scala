...
/**
 * FileWord2Line icon from the Remix Icon library, Document category.
 */
case class FileWord2LineProps(
  size: Int = 24,
...
/**
 * FileWord2Line icon component.
 *
 * @example FileWord2Line <> FileWord2LineProps(size = 24, color = "blue")
 */
def FileWord2Line = (props: FileWord2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
