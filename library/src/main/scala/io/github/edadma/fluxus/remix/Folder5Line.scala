...
/**
 * Folder5Line icon from the Remix Icon library, Document category.
 */
case class Folder5LineProps(
  size: Int = 24,
...
/**
 * Folder5Line icon component.
 *
 * @example Folder5Line <> Folder5LineProps(size = 24, color = "blue")
 */
def Folder5Line = (props: Folder5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
