...
/**
 * Number8 icon from the Remix Icon library, Editor category.
 */
case class Number8Props(
  size: Int = 24,
...
/**
 * Number8 icon component.
 *
 * @example Number8 <> Number8Props(size = 24, color = "blue")
 */
def Number8 = (props: Number8Props) => {
  svg(
    viewBox := "0 0 24 24",
