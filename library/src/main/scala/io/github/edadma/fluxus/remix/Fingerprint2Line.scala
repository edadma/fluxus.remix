...
/**
 * Fingerprint2Line icon from the Remix Icon library, Device category.
 */
case class Fingerprint2LineProps(
  size: Int = 24,
...
/**
 * Fingerprint2Line icon component.
 *
 * @example Fingerprint2Line <> Fingerprint2LineProps(size = 24, color = "blue")
 */
def Fingerprint2Line = (props: Fingerprint2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
