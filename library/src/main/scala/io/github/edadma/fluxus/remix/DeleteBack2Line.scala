...
/**
 * DeleteBack2Line icon from the Remix Icon library, System category.
 */
case class DeleteBack2LineProps(
  size: Int = 24,
...
/**
 * DeleteBack2Line icon component.
 *
 * @example DeleteBack2Line <> DeleteBack2LineProps(size = 24, color = "blue")
 */
def DeleteBack2Line = (props: DeleteBack2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
