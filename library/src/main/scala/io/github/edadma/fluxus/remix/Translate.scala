...
/**
 * Translate icon from the Remix Icon library, Editor category.
 */
case class TranslateProps(
  size: Int = 24,
 ...
 *
 * @example Translate <> TranslateProps(size = 24, color = "blue")
 */
def Translate = (props: TranslateProps) => {
  svg(
    viewBox := "0 0 24 24",
