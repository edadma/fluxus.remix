...
/**
 * CalendarCheckFill icon from the Remix Icon library, Business category.
 */
case class CalendarCheckFillProps(
  size: Int = 24,
 ...
 *
 * @example CalendarCheckFill <> CalendarCheckFillProps(size = 24, color = "blue")
 */
def CalendarCheckFill = (props: CalendarCheckFillProps) => {
  svg(
    viewBox := "0 0 24 24",
