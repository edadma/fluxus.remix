...
/**
 * RainbowFill icon from the Remix Icon library, Weather category.
 */
case class RainbowFillProps(
  size: Int = 24,
 ...
 *
 * @example RainbowFill <> RainbowFillProps(size = 24, color = "blue")
 */
def RainbowFill = (props: RainbowFillProps) => {
  svg(
    viewBox := "0 0 24 24",
