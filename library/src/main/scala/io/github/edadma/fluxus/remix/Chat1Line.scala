...
/**
 * Chat1Line icon from the Remix Icon library, Communication category.
 */
case class Chat1LineProps(
  size: Int = 24,
...
/**
 * Chat1Line icon component.
 *
 * @example Chat1Line <> Chat1LineProps(size = 24, color = "blue")
 */
def Chat1Line = (props: Chat1LineProps) => {
  svg(
    viewBox := "0 0 24 24",
