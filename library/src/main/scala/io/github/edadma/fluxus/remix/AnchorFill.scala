...
/**
 * AnchorFill icon from the Remix Icon library, Map category.
 */
case class AnchorFillProps(
  size: Int = 24,
 ...
 *
 * @example AnchorFill <> AnchorFillProps(size = 24, color = "blue")
 */
def AnchorFill = (props: AnchorFillProps) => {
  svg(
    viewBox := "0 0 24 24",
