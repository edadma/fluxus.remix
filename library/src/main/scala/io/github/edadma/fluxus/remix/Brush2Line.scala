...
/**
 * Brush2Line icon from the Remix Icon library, Design category.
 */
case class Brush2LineProps(
  size: Int = 24,
...
/**
 * Brush2Line icon component.
 *
 * @example Brush2Line <> Brush2LineProps(size = 24, color = "blue")
 */
def Brush2Line = (props: Brush2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
