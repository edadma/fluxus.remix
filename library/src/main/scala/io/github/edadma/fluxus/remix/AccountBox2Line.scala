...
/**
 * AccountBox2Line icon from the Remix Icon library, User & Faces category.
 */
case class AccountBox2LineProps(
  size: Int = 24,
...
/**
 * AccountBox2Line icon component.
 *
 * @example AccountBox2Line <> AccountBox2LineProps(size = 24, color = "blue")
 */
def AccountBox2Line = (props: AccountBox2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
