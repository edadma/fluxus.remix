...
/**
 * PhoneFindLine icon from the Remix Icon library, Device category.
 */
case class PhoneFindLineProps(
  size: Int = 24,
...
/**
 * PhoneFindLine icon component.
 *
 * @example PhoneFindLine <> PhoneFindLineProps(size = 24, color = "blue")
 */
def PhoneFindLine = (props: PhoneFindLineProps) => {
  svg(
    viewBox := "0 0 24 24",
