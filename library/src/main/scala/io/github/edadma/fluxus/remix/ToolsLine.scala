...
/**
 * ToolsLine icon from the Remix Icon library, Design category.
 */
case class ToolsLineProps(
  size: Int = 24,
...
/**
 * ToolsLine icon component.
 *
 * @example ToolsLine <> ToolsLineProps(size = 24, color = "blue")
 */
def ToolsLine = (props: ToolsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
