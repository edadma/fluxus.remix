...
/**
 * AppStoreFill icon from the Remix Icon library, Logos category.
 */
case class AppStoreFillProps(
  size: Int = 24,
...
/**
 * AppStoreFill icon component.
 *
 * @example AppStoreFill <> AppStoreFillProps(size = 24, color = "blue")
 */
def AppStoreFill = (props: AppStoreFillProps) => {
  svg(
    viewBox := "0 0 24 24",
