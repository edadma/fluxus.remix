...
/**
 * ShapeLine icon from the Remix Icon library, Design category.
 */
case class ShapeLineProps(
  size: Int = 24,
...
/**
 * ShapeLine icon component.
 *
 * @example ShapeLine <> ShapeLineProps(size = 24, color = "blue")
 */
def ShapeLine = (props: ShapeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
