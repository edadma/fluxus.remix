...
/**
 * DiscussFill icon from the Remix Icon library, Communication category.
 */
case class DiscussFillProps(
  size: Int = 24,
...
/**
 * DiscussFill icon component.
 *
 * @example DiscussFill <> DiscussFillProps(size = 24, color = "blue")
 */
def DiscussFill = (props: DiscussFillProps) => {
  svg(
    viewBox := "0 0 24 24",
