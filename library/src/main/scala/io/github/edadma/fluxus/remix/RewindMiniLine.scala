...
/**
 * RewindMiniLine icon from the Remix Icon library, Media category.
 */
case class RewindMiniLineProps(
  size: Int = 24,
...
/**
 * RewindMiniLine icon component.
 *
 * @example RewindMiniLine <> RewindMiniLineProps(size = 24, color = "blue")
 */
def RewindMiniLine = (props: RewindMiniLineProps) => {
  svg(
    viewBox := "0 0 24 24",
