...
/**
 * Html5Line icon from the Remix Icon library, Development category.
 */
case class Html5LineProps(
  size: Int = 24,
...
/**
 * Html5Line icon component.
 *
 * @example Html5Line <> Html5LineProps(size = 24, color = "blue")
 */
def Html5Line = (props: Html5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
