...
/**
 * SofaFill icon from the Remix Icon library, Others category.
 */
case class SofaFillProps(
  size: Int = 24,
...
/**
 * SofaFill icon component.
 *
 * @example SofaFill <> SofaFillProps(size = 24, color = "blue")
 */
def SofaFill = (props: SofaFillProps) => {
  svg(
    viewBox := "0 0 24 24",
