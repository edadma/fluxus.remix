...
/**
 * ShieldStarFill icon from the Remix Icon library, System category.
 */
case class ShieldStarFillProps(
  size: Int = 24,
 ...
 *
 * @example ShieldStarFill <> ShieldStarFillProps(size = 24, color = "blue")
 */
def ShieldStarFill = (props: ShieldStarFillProps) => {
  svg(
    viewBox := "0 0 24 24",
