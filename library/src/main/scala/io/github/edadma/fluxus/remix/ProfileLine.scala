...
/**
 * ProfileLine icon from the Remix Icon library, Business category.
 */
case class ProfileLineProps(
  size: Int = 24,
...
/**
 * ProfileLine icon component.
 *
 * @example ProfileLine <> ProfileLineProps(size = 24, color = "blue")
 */
def ProfileLine = (props: ProfileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
