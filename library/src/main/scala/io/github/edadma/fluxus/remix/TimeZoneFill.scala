...
/**
 * TimeZoneFill icon from the Remix Icon library, Map category.
 */
case class TimeZoneFillProps(
  size: Int = 24,
...
/**
 * TimeZoneFill icon component.
 *
 * @example TimeZoneFill <> TimeZoneFillProps(size = 24, color = "blue")
 */
def TimeZoneFill = (props: TimeZoneFillProps) => {
  svg(
    viewBox := "0 0 24 24",
