...
/**
 * AlertLine icon from the Remix Icon library, System category.
 */
case class AlertLineProps(
  size: Int = 24,
...
/**
 * AlertLine icon component.
 *
 * @example AlertLine <> AlertLineProps(size = 24, color = "blue")
 */
def AlertLine = (props: AlertLineProps) => {
  svg(
    viewBox := "0 0 24 24",
