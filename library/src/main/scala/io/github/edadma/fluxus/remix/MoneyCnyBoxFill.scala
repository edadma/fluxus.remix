...
/**
 * MoneyCnyBoxFill icon from the Remix Icon library, Finance category.
 */
case class MoneyCnyBoxFillProps(
  size: Int = 24,
...
/**
 * MoneyCnyBoxFill icon component.
 *
 * @example MoneyCnyBoxFill <> MoneyCnyBoxFillProps(size = 24, color = "blue")
 */
def MoneyCnyBoxFill = (props: MoneyCnyBoxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
