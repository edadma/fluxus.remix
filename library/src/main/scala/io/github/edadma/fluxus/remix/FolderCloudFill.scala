...
/**
 * FolderCloudFill icon from the Remix Icon library, Document category.
 */
case class FolderCloudFillProps(
  size: Int = 24,
...
/**
 * FolderCloudFill icon component.
 *
 * @example FolderCloudFill <> FolderCloudFillProps(size = 24, color = "blue")
 */
def FolderCloudFill = (props: FolderCloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
