...
/**
 * HeavyShowersLine icon from the Remix Icon library, Weather category.
 */
case class HeavyShowersLineProps(
  size: Int = 24,
...
/**
 * HeavyShowersLine icon component.
 *
 * @example HeavyShowersLine <> HeavyShowersLineProps(size = 24, color = "blue")
 */
def HeavyShowersLine = (props: HeavyShowersLineProps) => {
  svg(
    viewBox := "0 0 24 24",
