...
/**
 * NewsLine icon from the Remix Icon library, Document category.
 */
case class NewsLineProps(
  size: Int = 24,
...
/**
 * NewsLine icon component.
 *
 * @example NewsLine <> NewsLineProps(size = 24, color = "blue")
 */
def NewsLine = (props: NewsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
