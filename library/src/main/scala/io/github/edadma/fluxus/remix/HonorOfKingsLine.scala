...
/**
 * HonorOfKingsLine icon from the Remix Icon library, Logos category.
 */
case class HonorOfKingsLineProps(
  size: Int = 24,
...
/**
 * HonorOfKingsLine icon component.
 *
 * @example HonorOfKingsLine <> HonorOfKingsLineProps(size = 24, color = "blue")
 */
def HonorOfKingsLine = (props: HonorOfKingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
