...
/**
 * BriefcaseLine icon from the Remix Icon library, Business category.
 */
case class BriefcaseLineProps(
  size: Int = 24,
...
/**
 * BriefcaseLine icon component.
 *
 * @example BriefcaseLine <> BriefcaseLineProps(size = 24, color = "blue")
 */
def BriefcaseLine = (props: BriefcaseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
