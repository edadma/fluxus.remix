...
/**
 * EBikeLine icon from the Remix Icon library, Map category.
 */
case class EBikeLineProps(
  size: Int = 24,
...
/**
 * EBikeLine icon component.
 *
 * @example EBikeLine <> EBikeLineProps(size = 24, color = "blue")
 */
def EBikeLine = (props: EBikeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
