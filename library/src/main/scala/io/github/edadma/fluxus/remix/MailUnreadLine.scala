...
/**
 * MailUnreadLine icon from the Remix Icon library, Business category.
 */
case class MailUnreadLineProps(
  size: Int = 24,
...
/**
 * MailUnreadLine icon component.
 *
 * @example MailUnreadLine <> MailUnreadLineProps(size = 24, color = "blue")
 */
def MailUnreadLine = (props: MailUnreadLineProps) => {
  svg(
    viewBox := "0 0 24 24",
