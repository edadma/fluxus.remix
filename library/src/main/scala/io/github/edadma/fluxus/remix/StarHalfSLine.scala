...
/**
 * StarHalfSLine icon from the Remix Icon library, System category.
 */
case class StarHalfSLineProps(
  size: Int = 24,
...
/**
 * StarHalfSLine icon component.
 *
 * @example StarHalfSLine <> StarHalfSLineProps(size = 24, color = "blue")
 */
def StarHalfSLine = (props: StarHalfSLineProps) => {
  svg(
    viewBox := "0 0 24 24",
