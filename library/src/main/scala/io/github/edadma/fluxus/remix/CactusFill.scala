...
/**
 * CactusFill icon from the Remix Icon library, Others category.
 */
case class CactusFillProps(
  size: Int = 24,
 ...
 *
 * @example CactusFill <> CactusFillProps(size = 24, color = "blue")
 */
def CactusFill = (props: CactusFillProps) => {
  svg(
    viewBox := "0 0 24 24",
