...
/**
 * FolderForbidFill icon from the Remix Icon library, Document category.
 */
case class FolderForbidFillProps(
  size: Int = 24,
...
/**
 * FolderForbidFill icon component.
 *
 * @example FolderForbidFill <> FolderForbidFillProps(size = 24, color = "blue")
 */
def FolderForbidFill = (props: FolderForbidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
