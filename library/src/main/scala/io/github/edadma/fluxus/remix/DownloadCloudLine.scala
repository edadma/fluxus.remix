...
/**
 * DownloadCloudLine icon from the Remix Icon library, System category.
 */
case class DownloadCloudLineProps(
  size: Int = 24,
...
/**
 * DownloadCloudLine icon component.
 *
 * @example DownloadCloudLine <> DownloadCloudLineProps(size = 24, color = "blue")
 */
def DownloadCloudLine = (props: DownloadCloudLineProps) => {
  svg(
    viewBox := "0 0 24 24",
