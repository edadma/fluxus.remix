...
/**
 * ImageCircleLine icon from the Remix Icon library, Media category.
 */
case class ImageCircleLineProps(
  size: Int = 24,
...
/**
 * ImageCircleLine icon component.
 *
 * @example ImageCircleLine <> ImageCircleLineProps(size = 24, color = "blue")
 */
def ImageCircleLine = (props: ImageCircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
