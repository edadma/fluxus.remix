...
/**
 * SpotifyFill icon from the Remix Icon library, Logos category.
 */
case class SpotifyFillProps(
  size: Int = 24,
...
/**
 * SpotifyFill icon component.
 *
 * @example SpotifyFill <> SpotifyFillProps(size = 24, color = "blue")
 */
def SpotifyFill = (props: SpotifyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
