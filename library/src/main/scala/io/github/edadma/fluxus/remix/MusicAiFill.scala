...
/**
 * MusicAiFill icon from the Remix Icon library, Media category.
 */
case class MusicAiFillProps(
  size: Int = 24,
...
/**
 * MusicAiFill icon component.
 *
 * @example MusicAiFill <> MusicAiFillProps(size = 24, color = "blue")
 */
def MusicAiFill = (props: MusicAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
