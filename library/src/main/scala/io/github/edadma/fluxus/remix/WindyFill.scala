...
/**
 * WindyFill icon from the Remix Icon library, Weather category.
 */
case class WindyFillProps(
  size: Int = 24,
...
/**
 * WindyFill icon component.
 *
 * @example WindyFill <> WindyFillProps(size = 24, color = "blue")
 */
def WindyFill = (props: WindyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
