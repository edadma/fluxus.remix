...
/**
 * HomeWifiFill icon from the Remix Icon library, Buildings category.
 */
case class HomeWifiFillProps(
  size: Int = 24,
...
/**
 * HomeWifiFill icon component.
 *
 * @example HomeWifiFill <> HomeWifiFillProps(size = 24, color = "blue")
 */
def HomeWifiFill = (props: HomeWifiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
