...
/**
 * NotionLine icon from the Remix Icon library, Logos category.
 */
case class NotionLineProps(
  size: Int = 24,
...
/**
 * NotionLine icon component.
 *
 * @example NotionLine <> NotionLineProps(size = 24, color = "blue")
 */
def NotionLine = (props: NotionLineProps) => {
  svg(
    viewBox := "0 0 24 24",
