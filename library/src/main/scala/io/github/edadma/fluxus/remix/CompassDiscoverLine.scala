...
/**
 * CompassDiscoverLine icon from the Remix Icon library, Map category.
 */
case class CompassDiscoverLineProps(
  size: Int = 24,
...
/**
 * CompassDiscoverLine icon component.
 *
 * @example CompassDiscoverLine <> CompassDiscoverLineProps(size = 24, color = "blue")
 */
def CompassDiscoverLine = (props: CompassDiscoverLineProps) => {
  svg(
    viewBox := "0 0 24 24",
