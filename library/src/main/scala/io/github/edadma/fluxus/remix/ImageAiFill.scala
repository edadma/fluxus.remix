...
/**
 * ImageAiFill icon from the Remix Icon library, Media category.
 */
case class ImageAiFillProps(
  size: Int = 24,
...
/**
 * ImageAiFill icon component.
 *
 * @example ImageAiFill <> ImageAiFillProps(size = 24, color = "blue")
 */
def ImageAiFill = (props: ImageAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
