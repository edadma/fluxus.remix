...
/**
 * HandHeartFill icon from the Remix Icon library, Finance category.
 */
case class HandHeartFillProps(
  size: Int = 24,
 ...
 *
 * @example HandHeartFill <> HandHeartFillProps(size = 24, color = "blue")
 */
def HandHeartFill = (props: HandHeartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
