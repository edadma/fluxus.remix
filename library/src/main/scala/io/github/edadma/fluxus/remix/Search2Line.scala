...
/**
 * Search2Line icon from the Remix Icon library, System category.
 */
case class Search2LineProps(
  size: Int = 24,
...
/**
 * Search2Line icon component.
 *
 * @example Search2Line <> Search2LineProps(size = 24, color = "blue")
 */
def Search2Line = (props: Search2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
