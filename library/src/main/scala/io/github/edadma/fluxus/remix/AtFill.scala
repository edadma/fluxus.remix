...
/**
 * AtFill icon from the Remix Icon library, Business category.
 */
case class AtFillProps(
  size: Int = 24,
 ...
 *
 * @example AtFill <> AtFillProps(size = 24, color = "blue")
 */
def AtFill = (props: AtFillProps) => {
  svg(
    viewBox := "0 0 24 24",
