...
/**
 * Home7Line icon from the Remix Icon library, Buildings category.
 */
case class Home7LineProps(
  size: Int = 24,
...
/**
 * Home7Line icon component.
 *
 * @example Home7Line <> Home7LineProps(size = 24, color = "blue")
 */
def Home7Line = (props: Home7LineProps) => {
  svg(
    viewBox := "0 0 24 24",
