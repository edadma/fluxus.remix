...
/**
 * ClosedCaptioningAiLine icon from the Remix Icon library, Media category.
 */
case class ClosedCaptioningAiLineProps(
  size: Int = 24,
...
/**
 * ClosedCaptioningAiLine icon component.
 *
 * @example ClosedCaptioningAiLine <> ClosedCaptioningAiLineProps(size = 24, color = "blue")
 */
def ClosedCaptioningAiLine = (props: ClosedCaptioningAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
