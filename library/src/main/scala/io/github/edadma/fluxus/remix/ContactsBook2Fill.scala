...
/**
 * ContactsBook2Fill icon from the Remix Icon library, Document category.
 */
case class ContactsBook2FillProps(
  size: Int = 24,
...
/**
 * ContactsBook2Fill icon component.
 *
 * @example ContactsBook2Fill <> ContactsBook2FillProps(size = 24, color = "blue")
 */
def ContactsBook2Fill = (props: ContactsBook2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
