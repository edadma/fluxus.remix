...
/**
 * DropperFill icon from the Remix Icon library, Health & Medical category.
 */
case class DropperFillProps(
  size: Int = 24,
...
/**
 * DropperFill icon component.
 *
 * @example DropperFill <> DropperFillProps(size = 24, color = "blue")
 */
def DropperFill = (props: DropperFillProps) => {
  svg(
    viewBox := "0 0 24 24",
