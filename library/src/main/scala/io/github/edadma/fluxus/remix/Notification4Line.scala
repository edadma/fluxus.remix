...
/**
 * Notification4Line icon from the Remix Icon library, Media category.
 */
case class Notification4LineProps(
  size: Int = 24,
...
/**
 * Notification4Line icon component.
 *
 * @example Notification4Line <> Notification4LineProps(size = 24, color = "blue")
 */
def Notification4Line = (props: Notification4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
