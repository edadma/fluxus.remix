...
/**
 * MapPinRangeFill icon from the Remix Icon library, Map category.
 */
case class MapPinRangeFillProps(
  size: Int = 24,
...
/**
 * MapPinRangeFill icon component.
 *
 * @example MapPinRangeFill <> MapPinRangeFillProps(size = 24, color = "blue")
 */
def MapPinRangeFill = (props: MapPinRangeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
