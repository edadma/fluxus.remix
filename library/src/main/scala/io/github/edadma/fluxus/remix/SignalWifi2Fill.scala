...
/**
 * SignalWifi2Fill icon from the Remix Icon library, Device category.
 */
case class SignalWifi2FillProps(
  size: Int = 24,
...
/**
 * SignalWifi2Fill icon component.
 *
 * @example SignalWifi2Fill <> SignalWifi2FillProps(size = 24, color = "blue")
 */
def SignalWifi2Fill = (props: SignalWifi2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
