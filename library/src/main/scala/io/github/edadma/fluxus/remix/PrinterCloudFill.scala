...
/**
 * PrinterCloudFill icon from the Remix Icon library, Business category.
 */
case class PrinterCloudFillProps(
  size: Int = 24,
...
/**
 * PrinterCloudFill icon component.
 *
 * @example PrinterCloudFill <> PrinterCloudFillProps(size = 24, color = "blue")
 */
def PrinterCloudFill = (props: PrinterCloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
