...
/**
 * TrafficLightLine icon from the Remix Icon library, Map category.
 */
case class TrafficLightLineProps(
  size: Int = 24,
...
/**
 * TrafficLightLine icon component.
 *
 * @example TrafficLightLine <> TrafficLightLineProps(size = 24, color = "blue")
 */
def TrafficLightLine = (props: TrafficLightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
