...
/**
 * NodeTree icon from the Remix Icon library, Editor category.
 */
case class NodeTreeProps(
  size: Int = 24,
...
/**
 * NodeTree icon component.
 *
 * @example NodeTree <> NodeTreeProps(size = 24, color = "blue")
 */
def NodeTree = (props: NodeTreeProps) => {
  svg(
    viewBox := "0 0 24 24",
