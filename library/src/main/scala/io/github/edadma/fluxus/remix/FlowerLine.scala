...
/**
 * FlowerLine icon from the Remix Icon library, Others category.
 */
case class FlowerLineProps(
  size: Int = 24,
...
/**
 * FlowerLine icon component.
 *
 * @example FlowerLine <> FlowerLineProps(size = 24, color = "blue")
 */
def FlowerLine = (props: FlowerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
