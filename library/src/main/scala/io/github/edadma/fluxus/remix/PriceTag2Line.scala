...
/**
 * PriceTag2Line icon from the Remix Icon library, Finance category.
 */
case class PriceTag2LineProps(
  size: Int = 24,
...
/**
 * PriceTag2Line icon component.
 *
 * @example PriceTag2Line <> PriceTag2LineProps(size = 24, color = "blue")
 */
def PriceTag2Line = (props: PriceTag2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
