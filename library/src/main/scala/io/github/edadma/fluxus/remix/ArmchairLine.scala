...
/**
 * ArmchairLine icon from the Remix Icon library, Others category.
 */
case class ArmchairLineProps(
  size: Int = 24,
...
/**
 * ArmchairLine icon component.
 *
 * @example ArmchairLine <> ArmchairLineProps(size = 24, color = "blue")
 */
def ArmchairLine = (props: ArmchairLineProps) => {
  svg(
    viewBox := "0 0 24 24",
