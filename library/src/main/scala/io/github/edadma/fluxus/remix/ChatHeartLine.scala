...
/**
 * ChatHeartLine icon from the Remix Icon library, Communication category.
 */
case class ChatHeartLineProps(
  size: Int = 24,
...
/**
 * ChatHeartLine icon component.
 *
 * @example ChatHeartLine <> ChatHeartLineProps(size = 24, color = "blue")
 */
def ChatHeartLine = (props: ChatHeartLineProps) => {
  svg(
    viewBox := "0 0 24 24",
