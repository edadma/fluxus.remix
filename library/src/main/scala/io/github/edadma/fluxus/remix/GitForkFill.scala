...
/**
 * GitForkFill icon from the Remix Icon library, Development category.
 */
case class GitForkFillProps(
  size: Int = 24,
 ...
 *
 * @example GitForkFill <> GitForkFillProps(size = 24, color = "blue")
 */
def GitForkFill = (props: GitForkFillProps) => {
  svg(
    viewBox := "0 0 24 24",
