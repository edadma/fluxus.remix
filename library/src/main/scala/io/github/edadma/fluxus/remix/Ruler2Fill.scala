...
/**
 * Ruler2Fill icon from the Remix Icon library, Design category.
 */
case class Ruler2FillProps(
  size: Int = 24,
...
/**
 * Ruler2Fill icon component.
 *
 * @example Ruler2Fill <> Ruler2FillProps(size = 24, color = "blue")
 */
def Ruler2Fill = (props: Ruler2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
