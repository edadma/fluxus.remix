...
/**
 * HeartPulseFill icon from the Remix Icon library, Health & Medical category.
 */
case class HeartPulseFillProps(
  size: Int = 24,
...
/**
 * HeartPulseFill icon component.
 *
 * @example HeartPulseFill <> HeartPulseFillProps(size = 24, color = "blue")
 */
def HeartPulseFill = (props: HeartPulseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
