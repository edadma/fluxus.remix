...
/**
 * LockStarLine icon from the Remix Icon library, System category.
 */
case class LockStarLineProps(
  size: Int = 24,
...
/**
 * LockStarLine icon component.
 *
 * @example LockStarLine <> LockStarLineProps(size = 24, color = "blue")
 */
def LockStarLine = (props: LockStarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
