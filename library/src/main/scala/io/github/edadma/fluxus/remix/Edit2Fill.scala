...
/**
 * Edit2Fill icon from the Remix Icon library, Design category.
 */
case class Edit2FillProps(
  size: Int = 24,
...
/**
 * Edit2Fill icon component.
 *
 * @example Edit2Fill <> Edit2FillProps(size = 24, color = "blue")
 */
def Edit2Fill = (props: Edit2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
