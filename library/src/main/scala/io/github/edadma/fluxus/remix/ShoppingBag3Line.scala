...
/**
 * ShoppingBag3Line icon from the Remix Icon library, Finance category.
 */
case class ShoppingBag3LineProps(
  size: Int = 24,
...
/**
 * ShoppingBag3Line icon component.
 *
 * @example ShoppingBag3Line <> ShoppingBag3LineProps(size = 24, color = "blue")
 */
def ShoppingBag3Line = (props: ShoppingBag3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
