...
/**
 * RedPacketLine icon from the Remix Icon library, Finance category.
 */
case class RedPacketLineProps(
  size: Int = 24,
...
/**
 * RedPacketLine icon component.
 *
 * @example RedPacketLine <> RedPacketLineProps(size = 24, color = "blue")
 */
def RedPacketLine = (props: RedPacketLineProps) => {
  svg(
    viewBox := "0 0 24 24",
