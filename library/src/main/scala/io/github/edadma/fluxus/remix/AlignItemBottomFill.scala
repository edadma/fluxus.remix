...
/**
 * AlignItemBottomFill icon from the Remix Icon library, Design category.
 */
case class AlignItemBottomFillProps(
  size: Int = 24,
...
/**
 * AlignItemBottomFill icon component.
 *
 * @example AlignItemBottomFill <> AlignItemBottomFillProps(size = 24, color = "blue")
 */
def AlignItemBottomFill = (props: AlignItemBottomFillProps) => {
  svg(
    viewBox := "0 0 24 24",
