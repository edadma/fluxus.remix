...
/**
 * FontSizeAi icon from the Remix Icon library, Editor category.
 */
case class FontSizeAiProps(
  size: Int = 24,
...
/**
 * FontSizeAi icon component.
 *
 * @example FontSizeAi <> FontSizeAiProps(size = 24, color = "blue")
 */
def FontSizeAi = (props: FontSizeAiProps) => {
  svg(
    viewBox := "0 0 24 24",
