...
/**
 * AccountPinCircleLine icon from the Remix Icon library, User & Faces category.
 */
case class AccountPinCircleLineProps(
  size: Int = 24,
...
/**
 * AccountPinCircleLine icon component.
 *
 * @example AccountPinCircleLine <> AccountPinCircleLineProps(size = 24, color = "blue")
 */
def AccountPinCircleLine = (props: AccountPinCircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
