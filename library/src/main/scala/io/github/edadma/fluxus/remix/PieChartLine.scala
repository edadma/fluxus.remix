...
/**
 * PieChartLine icon from the Remix Icon library, Business category.
 */
case class PieChartLineProps(
  size: Int = 24,
...
/**
 * PieChartLine icon component.
 *
 * @example PieChartLine <> PieChartLineProps(size = 24, color = "blue")
 */
def PieChartLine = (props: PieChartLineProps) => {
  svg(
    viewBox := "0 0 24 24",
