...
/**
 * PencilRuler2Fill icon from the Remix Icon library, Design category.
 */
case class PencilRuler2FillProps(
  size: Int = 24,
...
/**
 * PencilRuler2Fill icon component.
 *
 * @example PencilRuler2Fill <> PencilRuler2FillProps(size = 24, color = "blue")
 */
def PencilRuler2Fill = (props: PencilRuler2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
