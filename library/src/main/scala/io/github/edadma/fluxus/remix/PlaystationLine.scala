...
/**
 * PlaystationLine icon from the Remix Icon library, Logos category.
 */
case class PlaystationLineProps(
  size: Int = 24,
...
/**
 * PlaystationLine icon component.
 *
 * @example PlaystationLine <> PlaystationLineProps(size = 24, color = "blue")
 */
def PlaystationLine = (props: PlaystationLineProps) => {
  svg(
    viewBox := "0 0 24 24",
