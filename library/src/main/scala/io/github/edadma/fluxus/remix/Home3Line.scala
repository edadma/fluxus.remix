...
/**
 * Home3Line icon from the Remix Icon library, Buildings category.
 */
case class Home3LineProps(
  size: Int = 24,
...
/**
 * Home3Line icon component.
 *
 * @example Home3Line <> Home3LineProps(size = 24, color = "blue")
 */
def Home3Line = (props: Home3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
