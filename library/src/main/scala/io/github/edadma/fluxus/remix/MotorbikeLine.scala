...
/**
 * MotorbikeLine icon from the Remix Icon library, Map category.
 */
case class MotorbikeLineProps(
  size: Int = 24,
...
/**
 * MotorbikeLine icon component.
 *
 * @example MotorbikeLine <> MotorbikeLineProps(size = 24, color = "blue")
 */
def MotorbikeLine = (props: MotorbikeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
