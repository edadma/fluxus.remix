...
/**
 * VolumeUpFill icon from the Remix Icon library, Media category.
 */
case class VolumeUpFillProps(
  size: Int = 24,
...
/**
 * VolumeUpFill icon component.
 *
 * @example VolumeUpFill <> VolumeUpFillProps(size = 24, color = "blue")
 */
def VolumeUpFill = (props: VolumeUpFillProps) => {
  svg(
    viewBox := "0 0 24 24",
