...
/**
 * PassValidFill icon from the Remix Icon library, Business category.
 */
case class PassValidFillProps(
  size: Int = 24,
...
/**
 * PassValidFill icon component.
 *
 * @example PassValidFill <> PassValidFillProps(size = 24, color = "blue")
 */
def PassValidFill = (props: PassValidFillProps) => {
  svg(
    viewBox := "0 0 24 24",
