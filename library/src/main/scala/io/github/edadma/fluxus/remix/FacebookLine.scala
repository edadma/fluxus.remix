...
/**
 * FacebookLine icon from the Remix Icon library, Logos category.
 */
case class FacebookLineProps(
  size: Int = 24,
...
/**
 * FacebookLine icon component.
 *
 * @example FacebookLine <> FacebookLineProps(size = 24, color = "blue")
 */
def FacebookLine = (props: FacebookLineProps) => {
  svg(
    viewBox := "0 0 24 24",
