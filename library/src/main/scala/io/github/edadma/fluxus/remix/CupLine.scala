...
/**
 * CupLine icon from the Remix Icon library, Food category.
 */
case class CupLineProps(
  size: Int = 24,
...
/**
 * CupLine icon component.
 *
 * @example CupLine <> CupLineProps(size = 24, color = "blue")
 */
def CupLine = (props: CupLineProps) => {
  svg(
    viewBox := "0 0 24 24",
