...
/**
 * VipLine icon from the Remix Icon library, Finance category.
 */
case class VipLineProps(
  size: Int = 24,
...
/**
 * VipLine icon component.
 *
 * @example VipLine <> VipLineProps(size = 24, color = "blue")
 */
def VipLine = (props: VipLineProps) => {
  svg(
    viewBox := "0 0 24 24",
