...
/**
 * Skull2Line icon from the Remix Icon library, User & Faces category.
 */
case class Skull2LineProps(
  size: Int = 24,
...
/**
 * Skull2Line icon component.
 *
 * @example Skull2Line <> Skull2LineProps(size = 24, color = "blue")
 */
def Skull2Line = (props: Skull2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
