...
/**
 * KnifeBloodFill icon from the Remix Icon library, Food category.
 */
case class KnifeBloodFillProps(
  size: Int = 24,
...
/**
 * KnifeBloodFill icon component.
 *
 * @example KnifeBloodFill <> KnifeBloodFillProps(size = 24, color = "blue")
 */
def KnifeBloodFill = (props: KnifeBloodFillProps) => {
  svg(
    viewBox := "0 0 24 24",
