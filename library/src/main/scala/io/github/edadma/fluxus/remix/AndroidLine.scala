...
/**
 * AndroidLine icon from the Remix Icon library, Logos category.
 */
case class AndroidLineProps(
  size: Int = 24,
...
/**
 * AndroidLine icon component.
 *
 * @example AndroidLine <> AndroidLineProps(size = 24, color = "blue")
 */
def AndroidLine = (props: AndroidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
