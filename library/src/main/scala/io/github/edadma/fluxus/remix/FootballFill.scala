...
/**
 * FootballFill icon from the Remix Icon library, Others category.
 */
case class FootballFillProps(
  size: Int = 24,
 ...
 *
 * @example FootballFill <> FootballFillProps(size = 24, color = "blue")
 */
def FootballFill = (props: FootballFillProps) => {
  svg(
    viewBox := "0 0 24 24",
