...
/**
 * Loader4Fill icon from the Remix Icon library, System category.
 */
case class Loader4FillProps(
  size: Int = 24,
...
/**
 * Loader4Fill icon component.
 *
 * @example Loader4Fill <> Loader4FillProps(size = 24, color = "blue")
 */
def Loader4Fill = (props: Loader4FillProps) => {
  svg(
    viewBox := "0 0 24 24",
