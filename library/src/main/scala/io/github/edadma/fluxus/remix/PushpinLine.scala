...
/**
 * PushpinLine icon from the Remix Icon library, Map category.
 */
case class PushpinLineProps(
  size: Int = 24,
...
/**
 * PushpinLine icon component.
 *
 * @example PushpinLine <> PushpinLineProps(size = 24, color = "blue")
 */
def PushpinLine = (props: PushpinLineProps) => {
  svg(
    viewBox := "0 0 24 24",
