...
/**
 * PoliceCarLine icon from the Remix Icon library, Map category.
 */
case class PoliceCarLineProps(
  size: Int = 24,
...
/**
 * PoliceCarLine icon component.
 *
 * @example PoliceCarLine <> PoliceCarLineProps(size = 24, color = "blue")
 */
def PoliceCarLine = (props: PoliceCarLineProps) => {
  svg(
    viewBox := "0 0 24 24",
