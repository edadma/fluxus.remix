...
/**
 * CharacterRecognitionLine icon from the Remix Icon library, Others category.
 */
case class CharacterRecognitionLineProps(
  size: Int = 24,
...
/**
 * CharacterRecognitionLine icon component.
 *
 * @example CharacterRecognitionLine <> CharacterRecognitionLineProps(size = 24, color = "blue")
 */
def CharacterRecognitionLine = (props: CharacterRecognitionLineProps) => {
  svg(
    viewBox := "0 0 24 24",
