...
/**
 * RewindStartFill icon from the Remix Icon library, Media category.
 */
case class RewindStartFillProps(
  size: Int = 24,
...
/**
 * RewindStartFill icon component.
 *
 * @example RewindStartFill <> RewindStartFillProps(size = 24, color = "blue")
 */
def RewindStartFill = (props: RewindStartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
