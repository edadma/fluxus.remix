...
/**
 * WifiOffFill icon from the Remix Icon library, Device category.
 */
case class WifiOffFillProps(
  size: Int = 24,
...
/**
 * WifiOffFill icon component.
 *
 * @example WifiOffFill <> WifiOffFillProps(size = 24, color = "blue")
 */
def WifiOffFill = (props: WifiOffFillProps) => {
  svg(
    viewBox := "0 0 24 24",
