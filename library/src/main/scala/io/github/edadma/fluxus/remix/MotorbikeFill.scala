...
/**
 * MotorbikeFill icon from the Remix Icon library, Map category.
 */
case class MotorbikeFillProps(
  size: Int = 24,
...
/**
 * MotorbikeFill icon component.
 *
 * @example MotorbikeFill <> MotorbikeFillProps(size = 24, color = "blue")
 */
def MotorbikeFill = (props: MotorbikeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
