...
/**
 * Haze2Line icon from the Remix Icon library, Weather category.
 */
case class Haze2LineProps(
  size: Int = 24,
...
/**
 * Haze2Line icon component.
 *
 * @example Haze2Line <> Haze2LineProps(size = 24, color = "blue")
 */
def Haze2Line = (props: Haze2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
