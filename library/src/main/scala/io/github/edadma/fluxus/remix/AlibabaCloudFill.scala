...
/**
 * AlibabaCloudFill icon from the Remix Icon library, Logos category.
 */
case class AlibabaCloudFillProps(
  size: Int = 24,
...
/**
 * AlibabaCloudFill icon component.
 *
 * @example AlibabaCloudFill <> AlibabaCloudFillProps(size = 24, color = "blue")
 */
def AlibabaCloudFill = (props: AlibabaCloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
