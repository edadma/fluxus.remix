...
/**
 * CashFill icon from the Remix Icon library, Finance category.
 */
case class CashFillProps(
  size: Int = 24,
...
/**
 * CashFill icon component.
 *
 * @example CashFill <> CashFillProps(size = 24, color = "blue")
 */
def CashFill = (props: CashFillProps) => {
  svg(
    viewBox := "0 0 24 24",
