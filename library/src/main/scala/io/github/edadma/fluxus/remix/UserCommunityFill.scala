...
/**
 * UserCommunityFill icon from the Remix Icon library, User & Faces category.
 */
case class UserCommunityFillProps(
  size: Int = 24,
...
/**
 * UserCommunityFill icon component.
 *
 * @example UserCommunityFill <> UserCommunityFillProps(size = 24, color = "blue")
 */
def UserCommunityFill = (props: UserCommunityFillProps) => {
  svg(
    viewBox := "0 0 24 24",
