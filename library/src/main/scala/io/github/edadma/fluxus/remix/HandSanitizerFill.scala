...
/**
 * HandSanitizerFill icon from the Remix Icon library, Health & Medical category.
 */
case class HandSanitizerFillProps(
  size: Int = 24,
...
/**
 * HandSanitizerFill icon component.
 *
 * @example HandSanitizerFill <> HandSanitizerFillProps(size = 24, color = "blue")
 */
def HandSanitizerFill = (props: HandSanitizerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
