...
/**
 * NavigationLine icon from the Remix Icon library, Map category.
 */
case class NavigationLineProps(
  size: Int = 24,
...
/**
 * NavigationLine icon component.
 *
 * @example NavigationLine <> NavigationLineProps(size = 24, color = "blue")
 */
def NavigationLine = (props: NavigationLineProps) => {
  svg(
    viewBox := "0 0 24 24",
