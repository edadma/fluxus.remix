...
/**
 * BookMarkedFill icon from the Remix Icon library, Document category.
 */
case class BookMarkedFillProps(
  size: Int = 24,
...
/**
 * BookMarkedFill icon component.
 *
 * @example BookMarkedFill <> BookMarkedFillProps(size = 24, color = "blue")
 */
def BookMarkedFill = (props: BookMarkedFillProps) => {
  svg(
    viewBox := "0 0 24 24",
