...
/**
 * MentalHealthLine icon from the Remix Icon library, Health & Medical category.
 */
case class MentalHealthLineProps(
  size: Int = 24,
...
/**
 * MentalHealthLine icon component.
 *
 * @example MentalHealthLine <> MentalHealthLineProps(size = 24, color = "blue")
 */
def MentalHealthLine = (props: MentalHealthLineProps) => {
  svg(
    viewBox := "0 0 24 24",
