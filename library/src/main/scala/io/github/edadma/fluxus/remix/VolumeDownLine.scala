...
/**
 * VolumeDownLine icon from the Remix Icon library, Media category.
 */
case class VolumeDownLineProps(
  size: Int = 24,
...
/**
 * VolumeDownLine icon component.
 *
 * @example VolumeDownLine <> VolumeDownLineProps(size = 24, color = "blue")
 */
def VolumeDownLine = (props: VolumeDownLineProps) => {
  svg(
    viewBox := "0 0 24 24",
