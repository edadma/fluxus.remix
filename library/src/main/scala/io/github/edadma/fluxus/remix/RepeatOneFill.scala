...
/**
 * RepeatOneFill icon from the Remix Icon library, Media category.
 */
case class RepeatOneFillProps(
  size: Int = 24,
...
/**
 * RepeatOneFill icon component.
 *
 * @example RepeatOneFill <> RepeatOneFillProps(size = 24, color = "blue")
 */
def RepeatOneFill = (props: RepeatOneFillProps) => {
  svg(
    viewBox := "0 0 24 24",
