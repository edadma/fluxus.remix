...
/**
 * ForwardEndMiniLine icon from the Remix Icon library, Media category.
 */
case class ForwardEndMiniLineProps(
  size: Int = 24,
...
/**
 * ForwardEndMiniLine icon component.
 *
 * @example ForwardEndMiniLine <> ForwardEndMiniLineProps(size = 24, color = "blue")
 */
def ForwardEndMiniLine = (props: ForwardEndMiniLineProps) => {
  svg(
    viewBox := "0 0 24 24",
