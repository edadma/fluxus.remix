...
/**
 * Refund2Line icon from the Remix Icon library, Finance category.
 */
case class Refund2LineProps(
  size: Int = 24,
...
/**
 * Refund2Line icon component.
 *
 * @example Refund2Line <> Refund2LineProps(size = 24, color = "blue")
 */
def Refund2Line = (props: Refund2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
