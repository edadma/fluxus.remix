...
/**
 * Home8Fill icon from the Remix Icon library, Buildings category.
 */
case class Home8FillProps(
  size: Int = 24,
...
/**
 * Home8Fill icon component.
 *
 * @example Home8Fill <> Home8FillProps(size = 24, color = "blue")
 */
def Home8Fill = (props: Home8FillProps) => {
  svg(
    viewBox := "0 0 24 24",
