...
/**
 * TimerLine icon from the Remix Icon library, System category.
 */
case class TimerLineProps(
  size: Int = 24,
...
/**
 * TimerLine icon component.
 *
 * @example TimerLine <> TimerLineProps(size = 24, color = "blue")
 */
def TimerLine = (props: TimerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
