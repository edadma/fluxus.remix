...
/**
 * BilibiliFill icon from the Remix Icon library, Logos category.
 */
case class BilibiliFillProps(
  size: Int = 24,
...
/**
 * BilibiliFill icon component.
 *
 * @example BilibiliFill <> BilibiliFillProps(size = 24, color = "blue")
 */
def BilibiliFill = (props: BilibiliFillProps) => {
  svg(
    viewBox := "0 0 24 24",
