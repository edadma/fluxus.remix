...
/**
 * TerminalBoxLine icon from the Remix Icon library, Development category.
 */
case class TerminalBoxLineProps(
  size: Int = 24,
...
/**
 * TerminalBoxLine icon component.
 *
 * @example TerminalBoxLine <> TerminalBoxLineProps(size = 24, color = "blue")
 */
def TerminalBoxLine = (props: TerminalBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
