...
/**
 * ScrollToBottomLine icon from the Remix Icon library, Arrows category.
 */
case class ScrollToBottomLineProps(
  size: Int = 24,
...
/**
 * ScrollToBottomLine icon component.
 *
 * @example ScrollToBottomLine <> ScrollToBottomLineProps(size = 24, color = "blue")
 */
def ScrollToBottomLine = (props: ScrollToBottomLineProps) => {
  svg(
    viewBox := "0 0 24 24",
