...
/**
 * CreativeCommonsZeroLine icon from the Remix Icon library, Business category.
 */
case class CreativeCommonsZeroLineProps(
  size: Int = 24,
...
/**
 * CreativeCommonsZeroLine icon component.
 *
 * @example CreativeCommonsZeroLine <> CreativeCommonsZeroLineProps(size = 24, color = "blue")
 */
def CreativeCommonsZeroLine = (props: CreativeCommonsZeroLineProps) => {
  svg(
    viewBox := "0 0 24 24",
