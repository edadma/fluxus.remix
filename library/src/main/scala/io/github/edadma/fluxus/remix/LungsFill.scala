...
/**
 * LungsFill icon from the Remix Icon library, Health & Medical category.
 */
case class LungsFillProps(
  size: Int = 24,
...
/**
 * LungsFill icon component.
 *
 * @example LungsFill <> LungsFillProps(size = 24, color = "blue")
 */
def LungsFill = (props: LungsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
