...
/**
 * Table3 icon from the Remix Icon library, Editor category.
 */
case class Table3Props(
  size: Int = 24,
...
/**
 * Table3 icon component.
 *
 * @example Table3 <> Table3Props(size = 24, color = "blue")
 */
def Table3 = (props: Table3Props) => {
  svg(
    viewBox := "0 0 24 24",
