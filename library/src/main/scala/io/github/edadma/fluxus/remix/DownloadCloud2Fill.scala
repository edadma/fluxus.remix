...
/**
 * DownloadCloud2Fill icon from the Remix Icon library, System category.
 */
case class DownloadCloud2FillProps(
  size: Int = 24,
...
/**
 * DownloadCloud2Fill icon component.
 *
 * @example DownloadCloud2Fill <> DownloadCloud2FillProps(size = 24, color = "blue")
 */
def DownloadCloud2Fill = (props: DownloadCloud2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
