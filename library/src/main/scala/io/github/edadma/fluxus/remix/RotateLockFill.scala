...
/**
 * RotateLockFill icon from the Remix Icon library, Device category.
 */
case class RotateLockFillProps(
  size: Int = 24,
...
/**
 * RotateLockFill icon component.
 *
 * @example RotateLockFill <> RotateLockFillProps(size = 24, color = "blue")
 */
def RotateLockFill = (props: RotateLockFillProps) => {
  svg(
    viewBox := "0 0 24 24",
