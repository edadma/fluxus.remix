...
/**
 * EmotionNormalLine icon from the Remix Icon library, User & Faces category.
 */
case class EmotionNormalLineProps(
  size: Int = 24,
...
/**
 * EmotionNormalLine icon component.
 *
 * @example EmotionNormalLine <> EmotionNormalLineProps(size = 24, color = "blue")
 */
def EmotionNormalLine = (props: EmotionNormalLineProps) => {
  svg(
    viewBox := "0 0 24 24",
