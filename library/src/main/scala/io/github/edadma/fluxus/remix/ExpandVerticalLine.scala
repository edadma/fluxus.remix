...
/**
 * ExpandVerticalLine icon from the Remix Icon library, Arrows category.
 */
case class ExpandVerticalLineProps(
  size: Int = 24,
...
/**
 * ExpandVerticalLine icon component.
 *
 * @example ExpandVerticalLine <> ExpandVerticalLineProps(size = 24, color = "blue")
 */
def ExpandVerticalLine = (props: ExpandVerticalLineProps) => {
  svg(
    viewBox := "0 0 24 24",
