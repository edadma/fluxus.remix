...
/**
 * DragMove2Line icon from the Remix Icon library, Arrows category.
 */
case class DragMove2LineProps(
  size: Int = 24,
...
/**
 * DragMove2Line icon component.
 *
 * @example DragMove2Line <> DragMove2LineProps(size = 24, color = "blue")
 */
def DragMove2Line = (props: DragMove2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
