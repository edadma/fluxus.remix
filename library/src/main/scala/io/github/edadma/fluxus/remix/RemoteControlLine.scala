...
/**
 * RemoteControlLine icon from the Remix Icon library, Device category.
 */
case class RemoteControlLineProps(
  size: Int = 24,
...
/**
 * RemoteControlLine icon component.
 *
 * @example RemoteControlLine <> RemoteControlLineProps(size = 24, color = "blue")
 */
def RemoteControlLine = (props: RemoteControlLineProps) => {
  svg(
    viewBox := "0 0 24 24",
