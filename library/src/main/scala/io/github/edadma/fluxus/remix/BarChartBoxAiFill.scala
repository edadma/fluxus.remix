...
/**
 * BarChartBoxAiFill icon from the Remix Icon library, Business category.
 */
case class BarChartBoxAiFillProps(
  size: Int = 24,
...
/**
 * BarChartBoxAiFill icon component.
 *
 * @example BarChartBoxAiFill <> BarChartBoxAiFillProps(size = 24, color = "blue")
 */
def BarChartBoxAiFill = (props: BarChartBoxAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
