...
/**
 * Coupon2Fill icon from the Remix Icon library, Finance category.
 */
case class Coupon2FillProps(
  size: Int = 24,
...
/**
 * Coupon2Fill icon component.
 *
 * @example Coupon2Fill <> Coupon2FillProps(size = 24, color = "blue")
 */
def Coupon2Fill = (props: Coupon2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
