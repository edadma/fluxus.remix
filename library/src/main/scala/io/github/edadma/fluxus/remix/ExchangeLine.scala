...
/**
 * ExchangeLine icon from the Remix Icon library, Finance category.
 */
case class ExchangeLineProps(
  size: Int = 24,
...
/**
 * ExchangeLine icon component.
 *
 * @example ExchangeLine <> ExchangeLineProps(size = 24, color = "blue")
 */
def ExchangeLine = (props: ExchangeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
