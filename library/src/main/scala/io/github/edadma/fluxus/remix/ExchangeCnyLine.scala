...
/**
 * ExchangeCnyLine icon from the Remix Icon library, Finance category.
 */
case class ExchangeCnyLineProps(
  size: Int = 24,
...
/**
 * ExchangeCnyLine icon component.
 *
 * @example ExchangeCnyLine <> ExchangeCnyLineProps(size = 24, color = "blue")
 */
def ExchangeCnyLine = (props: ExchangeCnyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
