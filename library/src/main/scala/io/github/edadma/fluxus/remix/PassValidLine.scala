...
/**
 * PassValidLine icon from the Remix Icon library, Business category.
 */
case class PassValidLineProps(
  size: Int = 24,
...
/**
 * PassValidLine icon component.
 *
 * @example PassValidLine <> PassValidLineProps(size = 24, color = "blue")
 */
def PassValidLine = (props: PassValidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
