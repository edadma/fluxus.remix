...
/**
 * PaletteFill icon from the Remix Icon library, Design category.
 */
case class PaletteFillProps(
  size: Int = 24,
 ...
 *
 * @example PaletteFill <> PaletteFillProps(size = 24, color = "blue")
 */
def PaletteFill = (props: PaletteFillProps) => {
  svg(
    viewBox := "0 0 24 24",
