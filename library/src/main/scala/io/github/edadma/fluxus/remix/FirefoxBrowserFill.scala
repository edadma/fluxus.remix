...
/**
 * FirefoxBrowserFill icon from the Remix Icon library, Logos category.
 */
case class FirefoxBrowserFillProps(
  size: Int = 24,
...
/**
 * FirefoxBrowserFill icon component.
 *
 * @example FirefoxBrowserFill <> FirefoxBrowserFillProps(size = 24, color = "blue")
 */
def FirefoxBrowserFill = (props: FirefoxBrowserFillProps) => {
  svg(
    viewBox := "0 0 24 24",
