...
/**
 * FoldersFill icon from the Remix Icon library, Document category.
 */
case class FoldersFillProps(
  size: Int = 24,
 ...
 *
 * @example FoldersFill <> FoldersFillProps(size = 24, color = "blue")
 */
def FoldersFill = (props: FoldersFillProps) => {
  svg(
    viewBox := "0 0 24 24",
