...
/**
 * AccountPinBoxLine icon from the Remix Icon library, User & Faces category.
 */
case class AccountPinBoxLineProps(
  size: Int = 24,
...
/**
 * AccountPinBoxLine icon component.
 *
 * @example AccountPinBoxLine <> AccountPinBoxLineProps(size = 24, color = "blue")
 */
def AccountPinBoxLine = (props: AccountPinBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
