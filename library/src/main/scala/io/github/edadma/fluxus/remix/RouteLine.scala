...
/**
 * RouteLine icon from the Remix Icon library, Map category.
 */
case class RouteLineProps(
  size: Int = 24,
...
/**
 * RouteLine icon component.
 *
 * @example RouteLine <> RouteLineProps(size = 24, color = "blue")
 */
def RouteLine = (props: RouteLineProps) => {
  svg(
    viewBox := "0 0 24 24",
