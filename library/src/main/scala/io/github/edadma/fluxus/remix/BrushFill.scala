...
/**
 * BrushFill icon from the Remix Icon library, Design category.
 */
case class BrushFillProps(
  size: Int = 24,
...
/**
 * BrushFill icon component.
 *
 * @example BrushFill <> BrushFillProps(size = 24, color = "blue")
 */
def BrushFill = (props: BrushFillProps) => {
  svg(
    viewBox := "0 0 24 24",
