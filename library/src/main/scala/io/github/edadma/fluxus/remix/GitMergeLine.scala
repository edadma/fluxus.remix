...
/**
 * GitMergeLine icon from the Remix Icon library, Development category.
 */
case class GitMergeLineProps(
  size: Int = 24,
...
/**
 * GitMergeLine icon component.
 *
 * @example GitMergeLine <> GitMergeLineProps(size = 24, color = "blue")
 */
def GitMergeLine = (props: GitMergeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
