...
/**
 * PassExpiredFill icon from the Remix Icon library, Business category.
 */
case class PassExpiredFillProps(
  size: Int = 24,
...
/**
 * PassExpiredFill icon component.
 *
 * @example PassExpiredFill <> PassExpiredFillProps(size = 24, color = "blue")
 */
def PassExpiredFill = (props: PassExpiredFillProps) => {
  svg(
    viewBox := "0 0 24 24",
