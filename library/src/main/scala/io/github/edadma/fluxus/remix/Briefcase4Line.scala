...
/**
 * Briefcase4Line icon from the Remix Icon library, Business category.
 */
case class Briefcase4LineProps(
  size: Int = 24,
...
/**
 * Briefcase4Line icon component.
 *
 * @example Briefcase4Line <> Briefcase4LineProps(size = 24, color = "blue")
 */
def Briefcase4Line = (props: Briefcase4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
