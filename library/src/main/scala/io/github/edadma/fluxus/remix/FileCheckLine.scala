...
/**
 * FileCheckLine icon from the Remix Icon library, Document category.
 */
case class FileCheckLineProps(
  size: Int = 24,
...
/**
 * FileCheckLine icon component.
 *
 * @example FileCheckLine <> FileCheckLineProps(size = 24, color = "blue")
 */
def FileCheckLine = (props: FileCheckLineProps) => {
  svg(
    viewBox := "0 0 24 24",
