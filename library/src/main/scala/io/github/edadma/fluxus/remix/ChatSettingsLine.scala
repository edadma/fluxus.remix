...
/**
 * ChatSettingsLine icon from the Remix Icon library, Communication category.
 */
case class ChatSettingsLineProps(
  size: Int = 24,
...
/**
 * ChatSettingsLine icon component.
 *
 * @example ChatSettingsLine <> ChatSettingsLineProps(size = 24, color = "blue")
 */
def ChatSettingsLine = (props: ChatSettingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
