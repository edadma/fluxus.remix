...
/**
 * FlagOffLine icon from the Remix Icon library, Business category.
 */
case class FlagOffLineProps(
  size: Int = 24,
...
/**
 * FlagOffLine icon component.
 *
 * @example FlagOffLine <> FlagOffLineProps(size = 24, color = "blue")
 */
def FlagOffLine = (props: FlagOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
