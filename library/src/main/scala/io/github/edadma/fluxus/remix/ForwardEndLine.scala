...
/**
 * ForwardEndLine icon from the Remix Icon library, Media category.
 */
case class ForwardEndLineProps(
  size: Int = 24,
...
/**
 * ForwardEndLine icon component.
 *
 * @example ForwardEndLine <> ForwardEndLineProps(size = 24, color = "blue")
 */
def ForwardEndLine = (props: ForwardEndLineProps) => {
  svg(
    viewBox := "0 0 24 24",
