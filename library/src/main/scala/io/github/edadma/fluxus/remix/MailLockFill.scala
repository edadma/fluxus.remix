...
/**
 * MailLockFill icon from the Remix Icon library, Business category.
 */
case class MailLockFillProps(
  size: Int = 24,
...
/**
 * MailLockFill icon component.
 *
 * @example MailLockFill <> MailLockFillProps(size = 24, color = "blue")
 */
def MailLockFill = (props: MailLockFillProps) => {
  svg(
    viewBox := "0 0 24 24",
