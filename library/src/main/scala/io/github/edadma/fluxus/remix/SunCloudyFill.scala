...
/**
 * SunCloudyFill icon from the Remix Icon library, Weather category.
 */
case class SunCloudyFillProps(
  size: Int = 24,
...
/**
 * SunCloudyFill icon component.
 *
 * @example SunCloudyFill <> SunCloudyFillProps(size = 24, color = "blue")
 */
def SunCloudyFill = (props: SunCloudyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
