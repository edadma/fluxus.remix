...
/**
 * BriefcaseFill icon from the Remix Icon library, Business category.
 */
case class BriefcaseFillProps(
  size: Int = 24,
 ...
 *
 * @example BriefcaseFill <> BriefcaseFillProps(size = 24, color = "blue")
 */
def BriefcaseFill = (props: BriefcaseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
