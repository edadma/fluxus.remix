...
/**
 * UploadCloudFill icon from the Remix Icon library, System category.
 */
case class UploadCloudFillProps(
  size: Int = 24,
...
/**
 * UploadCloudFill icon component.
 *
 * @example UploadCloudFill <> UploadCloudFillProps(size = 24, color = "blue")
 */
def UploadCloudFill = (props: UploadCloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
