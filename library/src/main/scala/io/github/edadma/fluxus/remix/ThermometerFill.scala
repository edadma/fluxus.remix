...
/**
 * ThermometerFill icon from the Remix Icon library, Health & Medical category.
 */
case class ThermometerFillProps(
  size: Int = 24,
...
/**
 * ThermometerFill icon component.
 *
 * @example ThermometerFill <> ThermometerFillProps(size = 24, color = "blue")
 */
def ThermometerFill = (props: ThermometerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
