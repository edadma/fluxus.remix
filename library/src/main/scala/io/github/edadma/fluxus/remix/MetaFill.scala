...
/**
 * MetaFill icon from the Remix Icon library, Logos category.
 */
case class MetaFillProps(
  size: Int = 24,
...
/**
 * MetaFill icon component.
 *
 * @example MetaFill <> MetaFillProps(size = 24, color = "blue")
 */
def MetaFill = (props: MetaFillProps) => {
  svg(
    viewBox := "0 0 24 24",
