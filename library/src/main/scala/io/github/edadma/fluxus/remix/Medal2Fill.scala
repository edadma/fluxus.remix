...
/**
 * Medal2Fill icon from the Remix Icon library, Business category.
 */
case class Medal2FillProps(
  size: Int = 24,
...
/**
 * Medal2Fill icon component.
 *
 * @example Medal2Fill <> Medal2FillProps(size = 24, color = "blue")
 */
def Medal2Fill = (props: Medal2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
