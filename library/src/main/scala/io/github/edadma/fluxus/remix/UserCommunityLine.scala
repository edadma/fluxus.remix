...
/**
 * UserCommunityLine icon from the Remix Icon library, User & Faces category.
 */
case class UserCommunityLineProps(
  size: Int = 24,
...
/**
 * UserCommunityLine icon component.
 *
 * @example UserCommunityLine <> UserCommunityLineProps(size = 24, color = "blue")
 */
def UserCommunityLine = (props: UserCommunityLineProps) => {
  svg(
    viewBox := "0 0 24 24",
