...
/**
 * SuitcaseFill icon from the Remix Icon library, Map category.
 */
case class SuitcaseFillProps(
  size: Int = 24,
 ...
 *
 * @example SuitcaseFill <> SuitcaseFillProps(size = 24, color = "blue")
 */
def SuitcaseFill = (props: SuitcaseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
