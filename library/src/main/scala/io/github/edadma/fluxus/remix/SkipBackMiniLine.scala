...
/**
 * SkipBackMiniLine icon from the Remix Icon library, Media category.
 */
case class SkipBackMiniLineProps(
  size: Int = 24,
...
/**
 * SkipBackMiniLine icon component.
 *
 * @example SkipBackMiniLine <> SkipBackMiniLineProps(size = 24, color = "blue")
 */
def SkipBackMiniLine = (props: SkipBackMiniLineProps) => {
  svg(
    viewBox := "0 0 24 24",
