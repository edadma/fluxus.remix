...
/**
 * Number0 icon from the Remix Icon library, Editor category.
 */
case class Number0Props(
  size: Int = 24,
...
/**
 * Number0 icon component.
 *
 * @example Number0 <> Number0Props(size = 24, color = "blue")
 */
def Number0 = (props: Number0Props) => {
  svg(
    viewBox := "0 0 24 24",
