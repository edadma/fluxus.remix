...
/**
 * ClosedCaptioningFill icon from the Remix Icon library, Media category.
 */
case class ClosedCaptioningFillProps(
  size: Int = 24,
 ...
 *
 * @example ClosedCaptioningFill <> ClosedCaptioningFillProps(size = 24, color = "blue")
 */
def ClosedCaptioningFill = (props: ClosedCaptioningFillProps) => {
  svg(
    viewBox := "0 0 24 24",
