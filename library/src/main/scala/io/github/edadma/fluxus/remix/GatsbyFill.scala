...
/**
 * GatsbyFill icon from the Remix Icon library, Logos category.
 */
case class GatsbyFillProps(
  size: Int = 24,
...
/**
 * GatsbyFill icon component.
 *
 * @example GatsbyFill <> GatsbyFillProps(size = 24, color = "blue")
 */
def GatsbyFill = (props: GatsbyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
