...
/**
 * TriangleLine icon from the Remix Icon library, Design category.
 */
case class TriangleLineProps(
  size: Int = 24,
...
/**
 * TriangleLine icon component.
 *
 * @example TriangleLine <> TriangleLineProps(size = 24, color = "blue")
 */
def TriangleLine = (props: TriangleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
