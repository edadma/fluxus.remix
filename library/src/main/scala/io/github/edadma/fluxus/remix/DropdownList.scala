...
/**
 * DropdownList icon from the Remix Icon library, Editor category.
 */
case class DropdownListProps(
  size: Int = 24,
...
/**
 * DropdownList icon component.
 *
 * @example DropdownList <> DropdownListProps(size = 24, color = "blue")
 */
def DropdownList = (props: DropdownListProps) => {
  svg(
    viewBox := "0 0 24 24",
