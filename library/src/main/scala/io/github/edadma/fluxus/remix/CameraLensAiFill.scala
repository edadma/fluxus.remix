...
/**
 * CameraLensAiFill icon from the Remix Icon library, Media category.
 */
case class CameraLensAiFillProps(
  size: Int = 24,
...
/**
 * CameraLensAiFill icon component.
 *
 * @example CameraLensAiFill <> CameraLensAiFillProps(size = 24, color = "blue")
 */
def CameraLensAiFill = (props: CameraLensAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
