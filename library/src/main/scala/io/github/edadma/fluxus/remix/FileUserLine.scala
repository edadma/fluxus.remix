...
/**
 * FileUserLine icon from the Remix Icon library, Document category.
 */
case class FileUserLineProps(
  size: Int = 24,
...
/**
 * FileUserLine icon component.
 *
 * @example FileUserLine <> FileUserLineProps(size = 24, color = "blue")
 */
def FileUserLine = (props: FileUserLineProps) => {
  svg(
    viewBox := "0 0 24 24",
