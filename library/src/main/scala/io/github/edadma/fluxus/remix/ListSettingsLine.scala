...
/**
 * ListSettingsLine icon from the Remix Icon library, System category.
 */
case class ListSettingsLineProps(
  size: Int = 24,
...
/**
 * ListSettingsLine icon component.
 *
 * @example ListSettingsLine <> ListSettingsLineProps(size = 24, color = "blue")
 */
def ListSettingsLine = (props: ListSettingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
