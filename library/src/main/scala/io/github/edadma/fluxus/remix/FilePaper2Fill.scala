...
/**
 * FilePaper2Fill icon from the Remix Icon library, Document category.
 */
case class FilePaper2FillProps(
  size: Int = 24,
...
/**
 * FilePaper2Fill icon component.
 *
 * @example FilePaper2Fill <> FilePaper2FillProps(size = 24, color = "blue")
 */
def FilePaper2Fill = (props: FilePaper2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
