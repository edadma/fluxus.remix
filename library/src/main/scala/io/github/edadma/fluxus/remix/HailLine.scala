...
/**
 * HailLine icon from the Remix Icon library, Weather category.
 */
case class HailLineProps(
  size: Int = 24,
...
/**
 * HailLine icon component.
 *
 * @example HailLine <> HailLineProps(size = 24, color = "blue")
 */
def HailLine = (props: HailLineProps) => {
  svg(
    viewBox := "0 0 24 24",
