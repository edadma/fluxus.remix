...
/**
 * ChatSmileAiLine icon from the Remix Icon library, Communication category.
 */
case class ChatSmileAiLineProps(
  size: Int = 24,
...
/**
 * ChatSmileAiLine icon component.
 *
 * @example ChatSmileAiLine <> ChatSmileAiLineProps(size = 24, color = "blue")
 */
def ChatSmileAiLine = (props: ChatSmileAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
