...
/**
 * ShieldUserLine icon from the Remix Icon library, System category.
 */
case class ShieldUserLineProps(
  size: Int = 24,
...
/**
 * ShieldUserLine icon component.
 *
 * @example ShieldUserLine <> ShieldUserLineProps(size = 24, color = "blue")
 */
def ShieldUserLine = (props: ShieldUserLineProps) => {
  svg(
    viewBox := "0 0 24 24",
