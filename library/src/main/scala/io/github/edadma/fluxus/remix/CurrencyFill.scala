...
/**
 * CurrencyFill icon from the Remix Icon library, Finance category.
 */
case class CurrencyFillProps(
  size: Int = 24,
...
/**
 * CurrencyFill icon component.
 *
 * @example CurrencyFill <> CurrencyFillProps(size = 24, color = "blue")
 */
def CurrencyFill = (props: CurrencyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
