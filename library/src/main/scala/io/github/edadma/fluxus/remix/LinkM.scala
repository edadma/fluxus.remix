...
/**
 * LinkM icon from the Remix Icon library, Editor category.
 */
case class LinkMProps(
  size: Int = 24,
...
/**
 * LinkM icon component.
 *
 * @example LinkM <> LinkMProps(size = 24, color = "blue")
 */
def LinkM = (props: LinkMProps) => {
  svg(
    viewBox := "0 0 24 24",
