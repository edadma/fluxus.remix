...
/**
 * Progress5Fill icon from the Remix Icon library, System category.
 */
case class Progress5FillProps(
  size: Int = 24,
...
/**
 * Progress5Fill icon component.
 *
 * @example Progress5Fill <> Progress5FillProps(size = 24, color = "blue")
 */
def Progress5Fill = (props: Progress5FillProps) => {
  svg(
    viewBox := "0 0 24 24",
