...
/**
 * EditLine icon from the Remix Icon library, Design category.
 */
case class EditLineProps(
  size: Int = 24,
...
/**
 * EditLine icon component.
 *
 * @example EditLine <> EditLineProps(size = 24, color = "blue")
 */
def EditLine = (props: EditLineProps) => {
  svg(
    viewBox := "0 0 24 24",
