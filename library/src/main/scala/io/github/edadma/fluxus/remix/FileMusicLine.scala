...
/**
 * FileMusicLine icon from the Remix Icon library, Document category.
 */
case class FileMusicLineProps(
  size: Int = 24,
...
/**
 * FileMusicLine icon component.
 *
 * @example FileMusicLine <> FileMusicLineProps(size = 24, color = "blue")
 */
def FileMusicLine = (props: FileMusicLineProps) => {
  svg(
    viewBox := "0 0 24 24",
