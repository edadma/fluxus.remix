...
/**
 * SearchEyeFill icon from the Remix Icon library, System category.
 */
case class SearchEyeFillProps(
  size: Int = 24,
...
/**
 * SearchEyeFill icon component.
 *
 * @example SearchEyeFill <> SearchEyeFillProps(size = 24, color = "blue")
 */
def SearchEyeFill = (props: SearchEyeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
