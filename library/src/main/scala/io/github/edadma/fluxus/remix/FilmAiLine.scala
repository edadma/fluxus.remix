...
/**
 * FilmAiLine icon from the Remix Icon library, Media category.
 */
case class FilmAiLineProps(
  size: Int = 24,
...
/**
 * FilmAiLine icon component.
 *
 * @example FilmAiLine <> FilmAiLineProps(size = 24, color = "blue")
 */
def FilmAiLine = (props: FilmAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
