...
/**
 * HomeHeartFill icon from the Remix Icon library, Buildings category.
 */
case class HomeHeartFillProps(
  size: Int = 24,
...
/**
 * HomeHeartFill icon component.
 *
 * @example HomeHeartFill <> HomeHeartFillProps(size = 24, color = "blue")
 */
def HomeHeartFill = (props: HomeHeartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
