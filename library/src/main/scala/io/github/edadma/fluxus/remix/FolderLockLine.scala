...
/**
 * FolderLockLine icon from the Remix Icon library, Document category.
 */
case class FolderLockLineProps(
  size: Int = 24,
...
/**
 * FolderLockLine icon component.
 *
 * @example FolderLockLine <> FolderLockLineProps(size = 24, color = "blue")
 */
def FolderLockLine = (props: FolderLockLineProps) => {
  svg(
    viewBox := "0 0 24 24",
