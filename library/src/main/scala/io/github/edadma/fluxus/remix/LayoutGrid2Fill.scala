...
/**
 * LayoutGrid2Fill icon from the Remix Icon library, Design category.
 */
case class LayoutGrid2FillProps(
  size: Int = 24,
...
/**
 * LayoutGrid2Fill icon component.
 *
 * @example LayoutGrid2Fill <> LayoutGrid2FillProps(size = 24, color = "blue")
 */
def LayoutGrid2Fill = (props: LayoutGrid2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
