...
/**
 * PriceTag2Fill icon from the Remix Icon library, Finance category.
 */
case class PriceTag2FillProps(
  size: Int = 24,
...
/**
 * PriceTag2Fill icon component.
 *
 * @example PriceTag2Fill <> PriceTag2FillProps(size = 24, color = "blue")
 */
def PriceTag2Fill = (props: PriceTag2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
