...
/**
 * ClosedCaptioningLine icon from the Remix Icon library, Media category.
 */
case class ClosedCaptioningLineProps(
  size: Int = 24,
...
/**
 * ClosedCaptioningLine icon component.
 *
 * @example ClosedCaptioningLine <> ClosedCaptioningLineProps(size = 24, color = "blue")
 */
def ClosedCaptioningLine = (props: ClosedCaptioningLineProps) => {
  svg(
    viewBox := "0 0 24 24",
