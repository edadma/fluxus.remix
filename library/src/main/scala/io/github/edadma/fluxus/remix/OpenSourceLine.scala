...
/**
 * OpenSourceLine icon from the Remix Icon library, Logos category.
 */
case class OpenSourceLineProps(
  size: Int = 24,
...
/**
 * OpenSourceLine icon component.
 *
 * @example OpenSourceLine <> OpenSourceLineProps(size = 24, color = "blue")
 */
def OpenSourceLine = (props: OpenSourceLineProps) => {
  svg(
    viewBox := "0 0 24 24",
