...
/**
 * ChatDeleteFill icon from the Remix Icon library, Communication category.
 */
case class ChatDeleteFillProps(
  size: Int = 24,
...
/**
 * ChatDeleteFill icon component.
 *
 * @example ChatDeleteFill <> ChatDeleteFillProps(size = 24, color = "blue")
 */
def ChatDeleteFill = (props: ChatDeleteFillProps) => {
  svg(
    viewBox := "0 0 24 24",
