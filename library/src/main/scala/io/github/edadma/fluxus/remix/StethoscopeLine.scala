...
/**
 * StethoscopeLine icon from the Remix Icon library, Health & Medical category.
 */
case class StethoscopeLineProps(
  size: Int = 24,
...
/**
 * StethoscopeLine icon component.
 *
 * @example StethoscopeLine <> StethoscopeLineProps(size = 24, color = "blue")
 */
def StethoscopeLine = (props: StethoscopeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
