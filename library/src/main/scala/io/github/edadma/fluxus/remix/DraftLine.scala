...
/**
 * DraftLine icon from the Remix Icon library, Document category.
 */
case class DraftLineProps(
  size: Int = 24,
...
/**
 * DraftLine icon component.
 *
 * @example DraftLine <> DraftLineProps(size = 24, color = "blue")
 */
def DraftLine = (props: DraftLineProps) => {
  svg(
    viewBox := "0 0 24 24",
