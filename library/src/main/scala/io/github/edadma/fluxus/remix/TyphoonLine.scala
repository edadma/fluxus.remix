...
/**
 * TyphoonLine icon from the Remix Icon library, Weather category.
 */
case class TyphoonLineProps(
  size: Int = 24,
...
/**
 * TyphoonLine icon component.
 *
 * @example TyphoonLine <> TyphoonLineProps(size = 24, color = "blue")
 */
def TyphoonLine = (props: TyphoonLineProps) => {
  svg(
    viewBox := "0 0 24 24",
