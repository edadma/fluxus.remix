...
/**
 * CloudOffFill icon from the Remix Icon library, Business category.
 */
case class CloudOffFillProps(
  size: Int = 24,
...
/**
 * CloudOffFill icon component.
 *
 * @example CloudOffFill <> CloudOffFillProps(size = 24, color = "blue")
 */
def CloudOffFill = (props: CloudOffFillProps) => {
  svg(
    viewBox := "0 0 24 24",
