...
/**
 * GooglePlayLine icon from the Remix Icon library, Logos category.
 */
case class GooglePlayLineProps(
  size: Int = 24,
...
/**
 * GooglePlayLine icon component.
 *
 * @example GooglePlayLine <> GooglePlayLineProps(size = 24, color = "blue")
 */
def GooglePlayLine = (props: GooglePlayLineProps) => {
  svg(
    viewBox := "0 0 24 24",
