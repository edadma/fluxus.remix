...
/**
 * QuillPenLine icon from the Remix Icon library, Design category.
 */
case class QuillPenLineProps(
  size: Int = 24,
...
/**
 * QuillPenLine icon component.
 *
 * @example QuillPenLine <> QuillPenLineProps(size = 24, color = "blue")
 */
def QuillPenLine = (props: QuillPenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
