...
/**
 * FileSearchFill icon from the Remix Icon library, Document category.
 */
case class FileSearchFillProps(
  size: Int = 24,
...
/**
 * FileSearchFill icon component.
 *
 * @example FileSearchFill <> FileSearchFillProps(size = 24, color = "blue")
 */
def FileSearchFill = (props: FileSearchFillProps) => {
  svg(
    viewBox := "0 0 24 24",
