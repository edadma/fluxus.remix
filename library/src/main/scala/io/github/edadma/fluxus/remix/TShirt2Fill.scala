...
/**
 * TShirt2Fill icon from the Remix Icon library, Others category.
 */
case class TShirt2FillProps(
  size: Int = 24,
...
/**
 * TShirt2Fill icon component.
 *
 * @example TShirt2Fill <> TShirt2FillProps(size = 24, color = "blue")
 */
def TShirt2Fill = (props: TShirt2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
