...
/**
 * UserSettingsLine icon from the Remix Icon library, User & Faces category.
 */
case class UserSettingsLineProps(
  size: Int = 24,
...
/**
 * UserSettingsLine icon component.
 *
 * @example UserSettingsLine <> UserSettingsLineProps(size = 24, color = "blue")
 */
def UserSettingsLine = (props: UserSettingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
