...
/**
 * RemixiconLine icon from the Remix Icon library, Logos category.
 */
case class RemixiconLineProps(
  size: Int = 24,
...
/**
 * RemixiconLine icon component.
 *
 * @example RemixiconLine <> RemixiconLineProps(size = 24, color = "blue")
 */
def RemixiconLine = (props: RemixiconLineProps) => {
  svg(
    viewBox := "0 0 24 24",
