...
/**
 * SeedlingLine icon from the Remix Icon library, Others category.
 */
case class SeedlingLineProps(
  size: Int = 24,
...
/**
 * SeedlingLine icon component.
 *
 * @example SeedlingLine <> SeedlingLineProps(size = 24, color = "blue")
 */
def SeedlingLine = (props: SeedlingLineProps) => {
  svg(
    viewBox := "0 0 24 24",
