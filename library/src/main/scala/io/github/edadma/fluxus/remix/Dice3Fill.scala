...
/**
 * Dice3Fill icon from the Remix Icon library, Others category.
 */
case class Dice3FillProps(
  size: Int = 24,
...
/**
 * Dice3Fill icon component.
 *
 * @example Dice3Fill <> Dice3FillProps(size = 24, color = "blue")
 */
def Dice3Fill = (props: Dice3FillProps) => {
  svg(
    viewBox := "0 0 24 24",
