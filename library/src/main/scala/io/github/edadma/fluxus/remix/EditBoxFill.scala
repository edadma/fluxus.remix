...
/**
 * EditBoxFill icon from the Remix Icon library, Design category.
 */
case class EditBoxFillProps(
  size: Int = 24,
...
/**
 * EditBoxFill icon component.
 *
 * @example EditBoxFill <> EditBoxFillProps(size = 24, color = "blue")
 */
def EditBoxFill = (props: EditBoxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
