...
/**
 * FunctionAddFill icon from the Remix Icon library, System category.
 */
case class FunctionAddFillProps(
  size: Int = 24,
...
/**
 * FunctionAddFill icon component.
 *
 * @example FunctionAddFill <> FunctionAddFillProps(size = 24, color = "blue")
 */
def FunctionAddFill = (props: FunctionAddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
