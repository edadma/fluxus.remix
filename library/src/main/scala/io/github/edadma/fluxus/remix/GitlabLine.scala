...
/**
 * GitlabLine icon from the Remix Icon library, Logos category.
 */
case class GitlabLineProps(
  size: Int = 24,
...
/**
 * GitlabLine icon component.
 *
 * @example GitlabLine <> GitlabLineProps(size = 24, color = "blue")
 */
def GitlabLine = (props: GitlabLineProps) => {
  svg(
    viewBox := "0 0 24 24",
