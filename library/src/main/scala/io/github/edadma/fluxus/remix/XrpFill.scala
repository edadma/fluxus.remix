...
/**
 * XrpFill icon from the Remix Icon library, Finance category.
 */
case class XrpFillProps(
  size: Int = 24,
...
/**
 * XrpFill icon component.
 *
 * @example XrpFill <> XrpFillProps(size = 24, color = "blue")
 */
def XrpFill = (props: XrpFillProps) => {
  svg(
    viewBox := "0 0 24 24",
