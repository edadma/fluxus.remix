...
/**
 * GitPrDraftFill icon from the Remix Icon library, Development category.
 */
case class GitPrDraftFillProps(
  size: Int = 24,
...
/**
 * GitPrDraftFill icon component.
 *
 * @example GitPrDraftFill <> GitPrDraftFillProps(size = 24, color = "blue")
 */
def GitPrDraftFill = (props: GitPrDraftFillProps) => {
  svg(
    viewBox := "0 0 24 24",
