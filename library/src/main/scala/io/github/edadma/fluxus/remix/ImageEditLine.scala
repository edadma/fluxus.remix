...
/**
 * ImageEditLine icon from the Remix Icon library, Media category.
 */
case class ImageEditLineProps(
  size: Int = 24,
...
/**
 * ImageEditLine icon component.
 *
 * @example ImageEditLine <> ImageEditLineProps(size = 24, color = "blue")
 */
def ImageEditLine = (props: ImageEditLineProps) => {
  svg(
    viewBox := "0 0 24 24",
