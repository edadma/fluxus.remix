...
/**
 * DiamondFill icon from the Remix Icon library, Finance category.
 */
case class DiamondFillProps(
  size: Int = 24,
...
/**
 * DiamondFill icon component.
 *
 * @example DiamondFill <> DiamondFillProps(size = 24, color = "blue")
 */
def DiamondFill = (props: DiamondFillProps) => {
  svg(
    viewBox := "0 0 24 24",
