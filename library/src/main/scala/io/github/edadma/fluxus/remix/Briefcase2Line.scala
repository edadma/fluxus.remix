...
/**
 * Briefcase2Line icon from the Remix Icon library, Business category.
 */
case class Briefcase2LineProps(
  size: Int = 24,
...
/**
 * Briefcase2Line icon component.
 *
 * @example Briefcase2Line <> Briefcase2LineProps(size = 24, color = "blue")
 */
def Briefcase2Line = (props: Briefcase2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
