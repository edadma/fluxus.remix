...
/**
 * FocusFill icon from the Remix Icon library, Design category.
 */
case class FocusFillProps(
  size: Int = 24,
...
/**
 * FocusFill icon component.
 *
 * @example FocusFill <> FocusFillProps(size = 24, color = "blue")
 */
def FocusFill = (props: FocusFillProps) => {
  svg(
    viewBox := "0 0 24 24",
