...
/**
 * Puzzle2Fill icon from the Remix Icon library, Development category.
 */
case class Puzzle2FillProps(
  size: Int = 24,
...
/**
 * Puzzle2Fill icon component.
 *
 * @example Puzzle2Fill <> Puzzle2FillProps(size = 24, color = "blue")
 */
def Puzzle2Fill = (props: Puzzle2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
