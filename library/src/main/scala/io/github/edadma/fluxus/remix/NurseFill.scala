...
/**
 * NurseFill icon from the Remix Icon library, Health & Medical category.
 */
case class NurseFillProps(
  size: Int = 24,
...
/**
 * NurseFill icon component.
 *
 * @example NurseFill <> NurseFillProps(size = 24, color = "blue")
 */
def NurseFill = (props: NurseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
