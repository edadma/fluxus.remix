...
/**
 * AlbumLine icon from the Remix Icon library, Media category.
 */
case class AlbumLineProps(
  size: Int = 24,
...
/**
 * AlbumLine icon component.
 *
 * @example AlbumLine <> AlbumLineProps(size = 24, color = "blue")
 */
def AlbumLine = (props: AlbumLineProps) => {
  svg(
    viewBox := "0 0 24 24",
