...
/**
 * FileCheckFill icon from the Remix Icon library, Document category.
 */
case class FileCheckFillProps(
  size: Int = 24,
...
/**
 * FileCheckFill icon component.
 *
 * @example FileCheckFill <> FileCheckFillProps(size = 24, color = "blue")
 */
def FileCheckFill = (props: FileCheckFillProps) => {
  svg(
    viewBox := "0 0 24 24",
