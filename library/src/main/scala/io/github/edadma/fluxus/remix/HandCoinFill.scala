...
/**
 * HandCoinFill icon from the Remix Icon library, Finance category.
 */
case class HandCoinFillProps(
  size: Int = 24,
...
/**
 * HandCoinFill icon component.
 *
 * @example HandCoinFill <> HandCoinFillProps(size = 24, color = "blue")
 */
def HandCoinFill = (props: HandCoinFillProps) => {
  svg(
    viewBox := "0 0 24 24",
