...
/**
 * PlayReverseMiniLine icon from the Remix Icon library, Media category.
 */
case class PlayReverseMiniLineProps(
  size: Int = 24,
...
/**
 * PlayReverseMiniLine icon component.
 *
 * @example PlayReverseMiniLine <> PlayReverseMiniLineProps(size = 24, color = "blue")
 */
def PlayReverseMiniLine = (props: PlayReverseMiniLineProps) => {
  svg(
    viewBox := "0 0 24 24",
