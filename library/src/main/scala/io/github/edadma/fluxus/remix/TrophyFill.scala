...
/**
 * TrophyFill icon from the Remix Icon library, Finance category.
 */
case class TrophyFillProps(
  size: Int = 24,
 ...
 *
 * @example TrophyFill <> TrophyFillProps(size = 24, color = "blue")
 */
def TrophyFill = (props: TrophyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
