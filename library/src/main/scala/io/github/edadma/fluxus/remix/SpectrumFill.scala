...
/**
 * SpectrumFill icon from the Remix Icon library, Logos category.
 */
case class SpectrumFillProps(
  size: Int = 24,
...
/**
 * SpectrumFill icon component.
 *
 * @example SpectrumFill <> SpectrumFillProps(size = 24, color = "blue")
 */
def SpectrumFill = (props: SpectrumFillProps) => {
  svg(
    viewBox := "0 0 24 24",
