...
/**
 * FolderSettingsLine icon from the Remix Icon library, Document category.
 */
case class FolderSettingsLineProps(
  size: Int = 24,
...
/**
 * FolderSettingsLine icon component.
 *
 * @example FolderSettingsLine <> FolderSettingsLineProps(size = 24, color = "blue")
 */
def FolderSettingsLine = (props: FolderSettingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
