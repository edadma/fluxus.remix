...
/**
 * Ticket2Fill icon from the Remix Icon library, Finance category.
 */
case class Ticket2FillProps(
  size: Int = 24,
...
/**
 * Ticket2Fill icon component.
 *
 * @example Ticket2Fill <> Ticket2FillProps(size = 24, color = "blue")
 */
def Ticket2Fill = (props: Ticket2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
