...
/**
 * FlaskLine icon from the Remix Icon library, Health & Medical category.
 */
case class FlaskLineProps(
  size: Int = 24,
...
/**
 * FlaskLine icon component.
 *
 * @example FlaskLine <> FlaskLineProps(size = 24, color = "blue")
 */
def FlaskLine = (props: FlaskLineProps) => {
  svg(
    viewBox := "0 0 24 24",
