...
/**
 * LuggageCartFill icon from the Remix Icon library, Map category.
 */
case class LuggageCartFillProps(
  size: Int = 24,
...
/**
 * LuggageCartFill icon component.
 *
 * @example LuggageCartFill <> LuggageCartFillProps(size = 24, color = "blue")
 */
def LuggageCartFill = (props: LuggageCartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
