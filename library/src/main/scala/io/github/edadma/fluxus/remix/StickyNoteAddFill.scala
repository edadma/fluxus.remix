...
/**
 * StickyNoteAddFill icon from the Remix Icon library, Document category.
 */
case class StickyNoteAddFillProps(
  size: Int = 24,
...
/**
 * StickyNoteAddFill icon component.
 *
 * @example StickyNoteAddFill <> StickyNoteAddFillProps(size = 24, color = "blue")
 */
def StickyNoteAddFill = (props: StickyNoteAddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
