...
/**
 * FloodLine icon from the Remix Icon library, Weather category.
 */
case class FloodLineProps(
  size: Int = 24,
...
/**
 * FloodLine icon component.
 *
 * @example FloodLine <> FloodLineProps(size = 24, color = "blue")
 */
def FloodLine = (props: FloodLineProps) => {
  svg(
    viewBox := "0 0 24 24",
