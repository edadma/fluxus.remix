...
/**
 * ImportLine icon from the Remix Icon library, System category.
 */
case class ImportLineProps(
  size: Int = 24,
...
/**
 * ImportLine icon component.
 *
 * @example ImportLine <> ImportLineProps(size = 24, color = "blue")
 */
def ImportLine = (props: ImportLineProps) => {
  svg(
    viewBox := "0 0 24 24",
