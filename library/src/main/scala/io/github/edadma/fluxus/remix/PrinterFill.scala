...
/**
 * PrinterFill icon from the Remix Icon library, Business category.
 */
case class PrinterFillProps(
  size: Int = 24,
 ...
 *
 * @example PrinterFill <> PrinterFillProps(size = 24, color = "blue")
 */
def PrinterFill = (props: PrinterFillProps) => {
  svg(
    viewBox := "0 0 24 24",
