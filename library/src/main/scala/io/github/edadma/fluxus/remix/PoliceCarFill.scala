...
/**
 * PoliceCarFill icon from the Remix Icon library, Map category.
 */
case class PoliceCarFillProps(
  size: Int = 24,
 ...
 *
 * @example PoliceCarFill <> PoliceCarFillProps(size = 24, color = "blue")
 */
def PoliceCarFill = (props: PoliceCarFillProps) => {
  svg(
    viewBox := "0 0 24 24",
