...
/**
 * SpectrumLine icon from the Remix Icon library, Logos category.
 */
case class SpectrumLineProps(
  size: Int = 24,
...
/**
 * SpectrumLine icon component.
 *
 * @example SpectrumLine <> SpectrumLineProps(size = 24, color = "blue")
 */
def SpectrumLine = (props: SpectrumLineProps) => {
  svg(
    viewBox := "0 0 24 24",
