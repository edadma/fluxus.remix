...
/**
 * RewindStartMiniFill icon from the Remix Icon library, Media category.
 */
case class RewindStartMiniFillProps(
  size: Int = 24,
...
/**
 * RewindStartMiniFill icon component.
 *
 * @example RewindStartMiniFill <> RewindStartMiniFillProps(size = 24, color = "blue")
 */
def RewindStartMiniFill = (props: RewindStartMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
