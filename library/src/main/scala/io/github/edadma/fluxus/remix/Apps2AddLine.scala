...
/**
 * Apps2AddLine icon from the Remix Icon library, System category.
 */
case class Apps2AddLineProps(
  size: Int = 24,
...
/**
 * Apps2AddLine icon component.
 *
 * @example Apps2AddLine <> Apps2AddLineProps(size = 24, color = "blue")
 */
def Apps2AddLine = (props: Apps2AddLineProps) => {
  svg(
    viewBox := "0 0 24 24",
