...
/**
 * WheelchairLine icon from the Remix Icon library, Others category.
 */
case class WheelchairLineProps(
  size: Int = 24,
...
/**
 * WheelchairLine icon component.
 *
 * @example WheelchairLine <> WheelchairLineProps(size = 24, color = "blue")
 */
def WheelchairLine = (props: WheelchairLineProps) => {
  svg(
    viewBox := "0 0 24 24",
