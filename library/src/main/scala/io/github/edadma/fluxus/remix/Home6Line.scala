...
/**
 * Home6Line icon from the Remix Icon library, Buildings category.
 */
case class Home6LineProps(
  size: Int = 24,
...
/**
 * Home6Line icon component.
 *
 * @example Home6Line <> Home6LineProps(size = 24, color = "blue")
 */
def Home6Line = (props: Home6LineProps) => {
  svg(
    viewBox := "0 0 24 24",
