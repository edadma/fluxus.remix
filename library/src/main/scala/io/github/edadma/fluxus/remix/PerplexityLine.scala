...
/**
 * PerplexityLine icon from the Remix Icon library, Logos category.
 */
case class PerplexityLineProps(
  size: Int = 24,
...
/**
 * PerplexityLine icon component.
 *
 * @example PerplexityLine <> PerplexityLineProps(size = 24, color = "blue")
 */
def PerplexityLine = (props: PerplexityLineProps) => {
  svg(
    viewBox := "0 0 24 24",
