...
/**
 * ChessLine icon from the Remix Icon library, Others category.
 */
case class ChessLineProps(
  size: Int = 24,
...
/**
 * ChessLine icon component.
 *
 * @example ChessLine <> ChessLineProps(size = 24, color = "blue")
 */
def ChessLine = (props: ChessLineProps) => {
  svg(
    viewBox := "0 0 24 24",
