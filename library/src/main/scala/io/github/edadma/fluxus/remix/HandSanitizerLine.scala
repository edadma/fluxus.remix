...
/**
 * HandSanitizerLine icon from the Remix Icon library, Health & Medical category.
 */
case class HandSanitizerLineProps(
  size: Int = 24,
...
/**
 * HandSanitizerLine icon component.
 *
 * @example HandSanitizerLine <> HandSanitizerLineProps(size = 24, color = "blue")
 */
def HandSanitizerLine = (props: HandSanitizerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
