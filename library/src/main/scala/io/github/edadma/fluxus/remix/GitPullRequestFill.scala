...
/**
 * GitPullRequestFill icon from the Remix Icon library, Development category.
 */
case class GitPullRequestFillProps(
  size: Int = 24,
 ...
 *
 * @example GitPullRequestFill <> GitPullRequestFillProps(size = 24, color = "blue")
 */
def GitPullRequestFill = (props: GitPullRequestFillProps) => {
  svg(
    viewBox := "0 0 24 24",
