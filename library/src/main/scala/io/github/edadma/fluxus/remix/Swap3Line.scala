...
/**
 * Swap3Line icon from the Remix Icon library, Finance category.
 */
case class Swap3LineProps(
  size: Int = 24,
...
/**
 * Swap3Line icon component.
 *
 * @example Swap3Line <> Swap3LineProps(size = 24, color = "blue")
 */
def Swap3Line = (props: Swap3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
