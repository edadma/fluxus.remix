...
/**
 * ChatSmileFill icon from the Remix Icon library, Communication category.
 */
case class ChatSmileFillProps(
  size: Int = 24,
...
/**
 * ChatSmileFill icon component.
 *
 * @example ChatSmileFill <> ChatSmileFillProps(size = 24, color = "blue")
 */
def ChatSmileFill = (props: ChatSmileFillProps) => {
  svg(
    viewBox := "0 0 24 24",
