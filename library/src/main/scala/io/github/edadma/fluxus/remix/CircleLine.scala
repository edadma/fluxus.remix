...
/**
 * CircleLine icon from the Remix Icon library, Design category.
 */
case class CircleLineProps(
  size: Int = 24,
...
/**
 * CircleLine icon component.
 *
 * @example CircleLine <> CircleLineProps(size = 24, color = "blue")
 */
def CircleLine = (props: CircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
