...
/**
 * CaravanLine icon from the Remix Icon library, Map category.
 */
case class CaravanLineProps(
  size: Int = 24,
...
/**
 * CaravanLine icon component.
 *
 * @example CaravanLine <> CaravanLineProps(size = 24, color = "blue")
 */
def CaravanLine = (props: CaravanLineProps) => {
  svg(
    viewBox := "0 0 24 24",
