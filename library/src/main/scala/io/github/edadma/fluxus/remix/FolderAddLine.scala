...
/**
 * FolderAddLine icon from the Remix Icon library, Document category.
 */
case class FolderAddLineProps(
  size: Int = 24,
...
/**
 * FolderAddLine icon component.
 *
 * @example FolderAddLine <> FolderAddLineProps(size = 24, color = "blue")
 */
def FolderAddLine = (props: FolderAddLineProps) => {
  svg(
    viewBox := "0 0 24 24",
