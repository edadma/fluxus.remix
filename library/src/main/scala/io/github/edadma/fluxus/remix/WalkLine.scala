...
/**
 * WalkLine icon from the Remix Icon library, Map category.
 */
case class WalkLineProps(
  size: Int = 24,
...
/**
 * WalkLine icon component.
 *
 * @example WalkLine <> WalkLineProps(size = 24, color = "blue")
 */
def WalkLine = (props: WalkLineProps) => {
  svg(
    viewBox := "0 0 24 24",
