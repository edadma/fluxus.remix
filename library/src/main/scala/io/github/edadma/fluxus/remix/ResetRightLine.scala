...
/**
 * ResetRightLine icon from the Remix Icon library, System category.
 */
case class ResetRightLineProps(
  size: Int = 24,
...
/**
 * ResetRightLine icon component.
 *
 * @example ResetRightLine <> ResetRightLineProps(size = 24, color = "blue")
 */
def ResetRightLine = (props: ResetRightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
