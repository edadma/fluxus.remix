...
/**
 * MastercardFill icon from the Remix Icon library, Logos category.
 */
case class MastercardFillProps(
  size: Int = 24,
...
/**
 * MastercardFill icon component.
 *
 * @example MastercardFill <> MastercardFillProps(size = 24, color = "blue")
 */
def MastercardFill = (props: MastercardFillProps) => {
  svg(
    viewBox := "0 0 24 24",
