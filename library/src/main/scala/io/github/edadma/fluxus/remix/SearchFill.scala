...
/**
 * SearchFill icon from the Remix Icon library, System category.
 */
case class SearchFillProps(
  size: Int = 24,
...
/**
 * SearchFill icon component.
 *
 * @example SearchFill <> SearchFillProps(size = 24, color = "blue")
 */
def SearchFill = (props: SearchFillProps) => {
  svg(
    viewBox := "0 0 24 24",
