...
/**
 * VoiceAiFill icon from the Remix Icon library, Media category.
 */
case class VoiceAiFillProps(
  size: Int = 24,
...
/**
 * VoiceAiFill icon component.
 *
 * @example VoiceAiFill <> VoiceAiFillProps(size = 24, color = "blue")
 */
def VoiceAiFill = (props: VoiceAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
