...
/**
 * AncientGateLine icon from the Remix Icon library, Buildings category.
 */
case class AncientGateLineProps(
  size: Int = 24,
...
/**
 * AncientGateLine icon component.
 *
 * @example AncientGateLine <> AncientGateLineProps(size = 24, color = "blue")
 */
def AncientGateLine = (props: AncientGateLineProps) => {
  svg(
    viewBox := "0 0 24 24",
