...
/**
 * Cloudy2Line icon from the Remix Icon library, Weather category.
 */
case class Cloudy2LineProps(
  size: Int = 24,
...
/**
 * Cloudy2Line icon component.
 *
 * @example Cloudy2Line <> Cloudy2LineProps(size = 24, color = "blue")
 */
def Cloudy2Line = (props: Cloudy2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
