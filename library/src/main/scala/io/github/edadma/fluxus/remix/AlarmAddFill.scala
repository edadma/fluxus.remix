...
/**
 * AlarmAddFill icon from the Remix Icon library, System category.
 */
case class AlarmAddFillProps(
  size: Int = 24,
...
/**
 * AlarmAddFill icon component.
 *
 * @example AlarmAddFill <> AlarmAddFillProps(size = 24, color = "blue")
 */
def AlarmAddFill = (props: AlarmAddFillProps) => {
  svg(
    viewBox := "0 0 24 24",
