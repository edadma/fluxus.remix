...
/**
 * FediverseLine icon from the Remix Icon library, Logos category.
 */
case class FediverseLineProps(
  size: Int = 24,
...
/**
 * FediverseLine icon component.
 *
 * @example FediverseLine <> FediverseLineProps(size = 24, color = "blue")
 */
def FediverseLine = (props: FediverseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
