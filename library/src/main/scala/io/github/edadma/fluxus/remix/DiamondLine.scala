...
/**
 * DiamondLine icon from the Remix Icon library, Finance category.
 */
case class DiamondLineProps(
  size: Int = 24,
...
/**
 * DiamondLine icon component.
 *
 * @example DiamondLine <> DiamondLineProps(size = 24, color = "blue")
 */
def DiamondLine = (props: DiamondLineProps) => {
  svg(
    viewBox := "0 0 24 24",
