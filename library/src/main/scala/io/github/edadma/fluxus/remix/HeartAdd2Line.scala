...
/**
 * HeartAdd2Line icon from the Remix Icon library, Health & Medical category.
 */
case class HeartAdd2LineProps(
  size: Int = 24,
...
/**
 * HeartAdd2Line icon component.
 *
 * @example HeartAdd2Line <> HeartAdd2LineProps(size = 24, color = "blue")
 */
def HeartAdd2Line = (props: HeartAdd2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
