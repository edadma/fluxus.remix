...
/**
 * UserStarFill icon from the Remix Icon library, User & Faces category.
 */
case class UserStarFillProps(
  size: Int = 24,
...
/**
 * UserStarFill icon component.
 *
 * @example UserStarFill <> UserStarFillProps(size = 24, color = "blue")
 */
def UserStarFill = (props: UserStarFillProps) => {
  svg(
    viewBox := "0 0 24 24",
