...
/**
 * RecordMailFill icon from the Remix Icon library, Business category.
 */
case class RecordMailFillProps(
  size: Int = 24,
...
/**
 * RecordMailFill icon component.
 *
 * @example RecordMailFill <> RecordMailFillProps(size = 24, color = "blue")
 */
def RecordMailFill = (props: RecordMailFillProps) => {
  svg(
    viewBox := "0 0 24 24",
