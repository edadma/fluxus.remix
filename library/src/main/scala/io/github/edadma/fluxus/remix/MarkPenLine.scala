...
/**
 * MarkPenLine icon from the Remix Icon library, Design category.
 */
case class MarkPenLineProps(
  size: Int = 24,
...
/**
 * MarkPenLine icon component.
 *
 * @example MarkPenLine <> MarkPenLineProps(size = 24, color = "blue")
 */
def MarkPenLine = (props: MarkPenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
