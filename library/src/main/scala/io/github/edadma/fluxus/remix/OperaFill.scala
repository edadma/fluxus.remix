...
/**
 * OperaFill icon from the Remix Icon library, Logos category.
 */
case class OperaFillProps(
  size: Int = 24,
...
/**
 * OperaFill icon component.
 *
 * @example OperaFill <> OperaFillProps(size = 24, color = "blue")
 */
def OperaFill = (props: OperaFillProps) => {
  svg(
    viewBox := "0 0 24 24",
