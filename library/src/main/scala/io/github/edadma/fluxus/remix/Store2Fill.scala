...
/**
 * Store2Fill icon from the Remix Icon library, Buildings category.
 */
case class Store2FillProps(
  size: Int = 24,
...
/**
 * Store2Fill icon component.
 *
 * @example Store2Fill <> Store2FillProps(size = 24, color = "blue")
 */
def Store2Fill = (props: Store2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
