...
/**
 * LungsLine icon from the Remix Icon library, Health & Medical category.
 */
case class LungsLineProps(
  size: Int = 24,
...
/**
 * LungsLine icon component.
 *
 * @example LungsLine <> LungsLineProps(size = 24, color = "blue")
 */
def LungsLine = (props: LungsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
