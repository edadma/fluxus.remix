...
/**
 * RidingFill icon from the Remix Icon library, Map category.
 */
case class RidingFillProps(
  size: Int = 24,
...
/**
 * RidingFill icon component.
 *
 * @example RidingFill <> RidingFillProps(size = 24, color = "blue")
 */
def RidingFill = (props: RidingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
