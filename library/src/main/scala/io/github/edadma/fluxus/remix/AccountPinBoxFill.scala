...
/**
 * AccountPinBoxFill icon from the Remix Icon library, User & Faces category.
 */
case class AccountPinBoxFillProps(
  size: Int = 24,
...
/**
 * AccountPinBoxFill icon component.
 *
 * @example AccountPinBoxFill <> AccountPinBoxFillProps(size = 24, color = "blue")
 */
def AccountPinBoxFill = (props: AccountPinBoxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
