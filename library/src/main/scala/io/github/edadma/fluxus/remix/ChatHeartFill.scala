...
/**
 * ChatHeartFill icon from the Remix Icon library, Communication category.
 */
case class ChatHeartFillProps(
  size: Int = 24,
...
/**
 * ChatHeartFill icon component.
 *
 * @example ChatHeartFill <> ChatHeartFillProps(size = 24, color = "blue")
 */
def ChatHeartFill = (props: ChatHeartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
