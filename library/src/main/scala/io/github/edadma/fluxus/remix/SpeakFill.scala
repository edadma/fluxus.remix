...
/**
 * SpeakFill icon from the Remix Icon library, Communication category.
 */
case class SpeakFillProps(
  size: Int = 24,
...
/**
 * SpeakFill icon component.
 *
 * @example SpeakFill <> SpeakFillProps(size = 24, color = "blue")
 */
def SpeakFill = (props: SpeakFillProps) => {
  svg(
    viewBox := "0 0 24 24",
