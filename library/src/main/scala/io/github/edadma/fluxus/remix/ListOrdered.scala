...
/**
 * ListOrdered icon from the Remix Icon library, Editor category.
 */
case class ListOrderedProps(
  size: Int = 24,
 ...
 *
 * @example ListOrdered <> ListOrderedProps(size = 24, color = "blue")
 */
def ListOrdered = (props: ListOrderedProps) => {
  svg(
    viewBox := "0 0 24 24",
