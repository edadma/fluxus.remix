...
/**
 * ClapperboardAiFill icon from the Remix Icon library, Media category.
 */
case class ClapperboardAiFillProps(
  size: Int = 24,
...
/**
 * ClapperboardAiFill icon component.
 *
 * @example ClapperboardAiFill <> ClapperboardAiFillProps(size = 24, color = "blue")
 */
def ClapperboardAiFill = (props: ClapperboardAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
