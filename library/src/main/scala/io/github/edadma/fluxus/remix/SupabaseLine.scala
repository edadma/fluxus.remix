...
/**
 * SupabaseLine icon from the Remix Icon library, Logos category.
 */
case class SupabaseLineProps(
  size: Int = 24,
...
/**
 * SupabaseLine icon component.
 *
 * @example SupabaseLine <> SupabaseLineProps(size = 24, color = "blue")
 */
def SupabaseLine = (props: SupabaseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
