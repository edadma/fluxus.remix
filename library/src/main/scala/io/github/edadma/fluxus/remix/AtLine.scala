...
/**
 * AtLine icon from the Remix Icon library, Business category.
 */
case class AtLineProps(
  size: Int = 24,
...
/**
 * AtLine icon component.
 *
 * @example AtLine <> AtLineProps(size = 24, color = "blue")
 */
def AtLine = (props: AtLineProps) => {
  svg(
    viewBox := "0 0 24 24",
