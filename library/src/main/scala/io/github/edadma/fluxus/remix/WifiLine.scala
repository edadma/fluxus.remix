...
/**
 * WifiLine icon from the Remix Icon library, Device category.
 */
case class WifiLineProps(
  size: Int = 24,
...
/**
 * WifiLine icon component.
 *
 * @example WifiLine <> WifiLineProps(size = 24, color = "blue")
 */
def WifiLine = (props: WifiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
