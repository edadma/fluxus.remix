...
/**
 * ArrowDownBoxLine icon from the Remix Icon library, Arrows category.
 */
case class ArrowDownBoxLineProps(
  size: Int = 24,
...
/**
 * ArrowDownBoxLine icon component.
 *
 * @example ArrowDownBoxLine <> ArrowDownBoxLineProps(size = 24, color = "blue")
 */
def ArrowDownBoxLine = (props: ArrowDownBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
