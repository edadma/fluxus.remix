...
/**
 * PingPongLine icon from the Remix Icon library, Others category.
 */
case class PingPongLineProps(
  size: Int = 24,
...
/**
 * PingPongLine icon component.
 *
 * @example PingPongLine <> PingPongLineProps(size = 24, color = "blue")
 */
def PingPongLine = (props: PingPongLineProps) => {
  svg(
    viewBox := "0 0 24 24",
