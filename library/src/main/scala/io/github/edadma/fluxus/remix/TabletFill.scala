...
/**
 * TabletFill icon from the Remix Icon library, Device category.
 */
case class TabletFillProps(
  size: Int = 24,
...
/**
 * TabletFill icon component.
 *
 * @example TabletFill <> TabletFillProps(size = 24, color = "blue")
 */
def TabletFill = (props: TabletFillProps) => {
  svg(
    viewBox := "0 0 24 24",
