...
/**
 * FileImageLine icon from the Remix Icon library, Document category.
 */
case class FileImageLineProps(
  size: Int = 24,
...
/**
 * FileImageLine icon component.
 *
 * @example FileImageLine <> FileImageLineProps(size = 24, color = "blue")
 */
def FileImageLine = (props: FileImageLineProps) => {
  svg(
    viewBox := "0 0 24 24",
