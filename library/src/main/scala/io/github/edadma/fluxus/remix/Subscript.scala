...
/**
 * Subscript icon from the Remix Icon library, Editor category.
 */
case class SubscriptProps(
  size: Int = 24,
 ...
 *
 * @example Subscript <> SubscriptProps(size = 24, color = "blue")
 */
def Subscript = (props: SubscriptProps) => {
  svg(
    viewBox := "0 0 24 24",
