...
/**
 * IdCardFill icon from the Remix Icon library, Business category.
 */
case class IdCardFillProps(
  size: Int = 24,
...
/**
 * IdCardFill icon component.
 *
 * @example IdCardFill <> IdCardFillProps(size = 24, color = "blue")
 */
def IdCardFill = (props: IdCardFillProps) => {
  svg(
    viewBox := "0 0 24 24",
