...
/**
 * Home9Line icon from the Remix Icon library, Buildings category.
 */
case class Home9LineProps(
  size: Int = 24,
...
/**
 * Home9Line icon component.
 *
 * @example Home9Line <> Home9LineProps(size = 24, color = "blue")
 */
def Home9Line = (props: Home9LineProps) => {
  svg(
    viewBox := "0 0 24 24",
