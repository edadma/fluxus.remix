...
/**
 * ResetLeftLine icon from the Remix Icon library, System category.
 */
case class ResetLeftLineProps(
  size: Int = 24,
...
/**
 * ResetLeftLine icon component.
 *
 * @example ResetLeftLine <> ResetLeftLineProps(size = 24, color = "blue")
 */
def ResetLeftLine = (props: ResetLeftLineProps) => {
  svg(
    viewBox := "0 0 24 24",
