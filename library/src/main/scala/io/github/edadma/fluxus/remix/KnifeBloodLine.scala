...
/**
 * KnifeBloodLine icon from the Remix Icon library, Food category.
 */
case class KnifeBloodLineProps(
  size: Int = 24,
...
/**
 * KnifeBloodLine icon component.
 *
 * @example KnifeBloodLine <> KnifeBloodLineProps(size = 24, color = "blue")
 */
def KnifeBloodLine = (props: KnifeBloodLineProps) => {
  svg(
    viewBox := "0 0 24 24",
