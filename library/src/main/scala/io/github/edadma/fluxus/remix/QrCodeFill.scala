...
/**
 * QrCodeFill icon from the Remix Icon library, Device category.
 */
case class QrCodeFillProps(
  size: Int = 24,
 ...
 *
 * @example QrCodeFill <> QrCodeFillProps(size = 24, color = "blue")
 */
def QrCodeFill = (props: QrCodeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
