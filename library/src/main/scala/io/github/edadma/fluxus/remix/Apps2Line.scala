...
/**
 * Apps2Line icon from the Remix Icon library, System category.
 */
case class Apps2LineProps(
  size: Int = 24,
...
/**
 * Apps2Line icon component.
 *
 * @example Apps2Line <> Apps2LineProps(size = 24, color = "blue")
 */
def Apps2Line = (props: Apps2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
