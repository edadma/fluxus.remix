...
/**
 * ArrowGoBackLine icon from the Remix Icon library, Arrows category.
 */
case class ArrowGoBackLineProps(
  size: Int = 24,
...
/**
 * ArrowGoBackLine icon component.
 *
 * @example ArrowGoBackLine <> ArrowGoBackLineProps(size = 24, color = "blue")
 */
def ArrowGoBackLine = (props: ArrowGoBackLineProps) => {
  svg(
    viewBox := "0 0 24 24",
