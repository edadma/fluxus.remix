...
/**
 * Number2 icon from the Remix Icon library, Editor category.
 */
case class Number2Props(
  size: Int = 24,
...
/**
 * Number2 icon component.
 *
 * @example Number2 <> Number2Props(size = 24, color = "blue")
 */
def Number2 = (props: Number2Props) => {
  svg(
    viewBox := "0 0 24 24",
