...
/**
 * DislikeLine icon from the Remix Icon library, Health & Medical category.
 */
case class DislikeLineProps(
  size: Int = 24,
...
/**
 * DislikeLine icon component.
 *
 * @example DislikeLine <> DislikeLineProps(size = 24, color = "blue")
 */
def DislikeLine = (props: DislikeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
