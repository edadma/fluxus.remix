...
/**
 * Dice5Line icon from the Remix Icon library, Others category.
 */
case class Dice5LineProps(
  size: Int = 24,
...
/**
 * Dice5Line icon component.
 *
 * @example Dice5Line <> Dice5LineProps(size = 24, color = "blue")
 */
def Dice5Line = (props: Dice5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
