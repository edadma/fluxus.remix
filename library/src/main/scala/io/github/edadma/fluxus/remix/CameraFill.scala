...
/**
 * CameraFill icon from the Remix Icon library, Media category.
 */
case class CameraFillProps(
  size: Int = 24,
 ...
 *
 * @example CameraFill <> CameraFillProps(size = 24, color = "blue")
 */
def CameraFill = (props: CameraFillProps) => {
  svg(
    viewBox := "0 0 24 24",
