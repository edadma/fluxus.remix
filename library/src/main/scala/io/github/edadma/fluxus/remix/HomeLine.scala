...
/**
 * HomeLine icon from the Remix Icon library, Buildings category.
 */
case class HomeLineProps(
  size: Int = 24,
...
/**
 * HomeLine icon component.
 *
 * @example HomeLine <> HomeLineProps(size = 24, color = "blue")
 */
def HomeLine = (props: HomeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
