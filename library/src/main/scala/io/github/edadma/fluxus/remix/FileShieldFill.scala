...
/**
 * FileShieldFill icon from the Remix Icon library, Document category.
 */
case class FileShieldFillProps(
  size: Int = 24,
...
/**
 * FileShieldFill icon component.
 *
 * @example FileShieldFill <> FileShieldFillProps(size = 24, color = "blue")
 */
def FileShieldFill = (props: FileShieldFillProps) => {
  svg(
    viewBox := "0 0 24 24",
