...
/**
 * AedLine icon from the Remix Icon library, Health & Medical category.
 */
case class AedLineProps(
  size: Int = 24,
...
/**
 * AedLine icon component.
 *
 * @example AedLine <> AedLineProps(size = 24, color = "blue")
 */
def AedLine = (props: AedLineProps) => {
  svg(
    viewBox := "0 0 24 24",
