...
/**
 * CloudyLine icon from the Remix Icon library, Weather category.
 */
case class CloudyLineProps(
  size: Int = 24,
...
/**
 * CloudyLine icon component.
 *
 * @example CloudyLine <> CloudyLineProps(size = 24, color = "blue")
 */
def CloudyLine = (props: CloudyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
