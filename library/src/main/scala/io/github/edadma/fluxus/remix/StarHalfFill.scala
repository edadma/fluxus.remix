...
/**
 * StarHalfFill icon from the Remix Icon library, System category.
 */
case class StarHalfFillProps(
  size: Int = 24,
 ...
 *
 * @example StarHalfFill <> StarHalfFillProps(size = 24, color = "blue")
 */
def StarHalfFill = (props: StarHalfFillProps) => {
  svg(
    viewBox := "0 0 24 24",
