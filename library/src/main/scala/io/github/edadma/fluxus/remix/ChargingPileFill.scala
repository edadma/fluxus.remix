...
/**
 * ChargingPileFill icon from the Remix Icon library, Map category.
 */
case class ChargingPileFillProps(
  size: Int = 24,
...
/**
 * ChargingPileFill icon component.
 *
 * @example ChargingPileFill <> ChargingPileFillProps(size = 24, color = "blue")
 */
def ChargingPileFill = (props: ChargingPileFillProps) => {
  svg(
    viewBox := "0 0 24 24",
