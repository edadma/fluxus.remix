...
/**
 * HeartAddLine icon from the Remix Icon library, Health & Medical category.
 */
case class HeartAddLineProps(
  size: Int = 24,
...
/**
 * HeartAddLine icon component.
 *
 * @example HeartAddLine <> HeartAddLineProps(size = 24, color = "blue")
 */
def HeartAddLine = (props: HeartAddLineProps) => {
  svg(
    viewBox := "0 0 24 24",
