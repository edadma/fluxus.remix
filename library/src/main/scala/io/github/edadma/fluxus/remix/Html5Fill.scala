...
/**
 * Html5Fill icon from the Remix Icon library, Development category.
 */
case class Html5FillProps(
  size: Int = 24,
...
/**
 * Html5Fill icon component.
 *
 * @example Html5Fill <> Html5FillProps(size = 24, color = "blue")
 */
def Html5Fill = (props: Html5FillProps) => {
  svg(
    viewBox := "0 0 24 24",
