...
/**
 * Forward10Line icon from the Remix Icon library, Media category.
 */
case class Forward10LineProps(
  size: Int = 24,
...
/**
 * Forward10Line icon component.
 *
 * @example Forward10Line <> Forward10LineProps(size = 24, color = "blue")
 */
def Forward10Line = (props: Forward10LineProps) => {
  svg(
    viewBox := "0 0 24 24",
