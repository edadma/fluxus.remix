...
/**
 * BugLine icon from the Remix Icon library, Development category.
 */
case class BugLineProps(
  size: Int = 24,
...
/**
 * BugLine icon component.
 *
 * @example BugLine <> BugLineProps(size = 24, color = "blue")
 */
def BugLine = (props: BugLineProps) => {
  svg(
    viewBox := "0 0 24 24",
