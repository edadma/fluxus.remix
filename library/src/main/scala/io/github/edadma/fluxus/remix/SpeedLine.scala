...
/**
 * SpeedLine icon from the Remix Icon library, Media category.
 */
case class SpeedLineProps(
  size: Int = 24,
...
/**
 * SpeedLine icon component.
 *
 * @example SpeedLine <> SpeedLineProps(size = 24, color = "blue")
 */
def SpeedLine = (props: SpeedLineProps) => {
  svg(
    viewBox := "0 0 24 24",
