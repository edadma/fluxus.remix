...
/**
 * VoiceAiLine icon from the Remix Icon library, Media category.
 */
case class VoiceAiLineProps(
  size: Int = 24,
...
/**
 * VoiceAiLine icon component.
 *
 * @example VoiceAiLine <> VoiceAiLineProps(size = 24, color = "blue")
 */
def VoiceAiLine = (props: VoiceAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
