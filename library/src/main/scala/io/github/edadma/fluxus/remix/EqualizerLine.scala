...
/**
 * EqualizerLine icon from the Remix Icon library, Media category.
 */
case class EqualizerLineProps(
  size: Int = 24,
...
/**
 * EqualizerLine icon component.
 *
 * @example EqualizerLine <> EqualizerLineProps(size = 24, color = "blue")
 */
def EqualizerLine = (props: EqualizerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
