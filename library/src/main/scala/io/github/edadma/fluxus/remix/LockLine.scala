...
/**
 * LockLine icon from the Remix Icon library, System category.
 */
case class LockLineProps(
  size: Int = 24,
...
/**
 * LockLine icon component.
 *
 * @example LockLine <> LockLineProps(size = 24, color = "blue")
 */
def LockLine = (props: LockLineProps) => {
  svg(
    viewBox := "0 0 24 24",
