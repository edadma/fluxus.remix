...
/**
 * RemixRunFill icon from the Remix Icon library, Logos category.
 */
case class RemixRunFillProps(
  size: Int = 24,
...
/**
 * RemixRunFill icon component.
 *
 * @example RemixRunFill <> RemixRunFillProps(size = 24, color = "blue")
 */
def RemixRunFill = (props: RemixRunFillProps) => {
  svg(
    viewBox := "0 0 24 24",
