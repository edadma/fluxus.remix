...
/**
 * ScissorsCutLine icon from the Remix Icon library, Design category.
 */
case class ScissorsCutLineProps(
  size: Int = 24,
...
/**
 * ScissorsCutLine icon component.
 *
 * @example ScissorsCutLine <> ScissorsCutLineProps(size = 24, color = "blue")
 */
def ScissorsCutLine = (props: ScissorsCutLineProps) => {
  svg(
    viewBox := "0 0 24 24",
