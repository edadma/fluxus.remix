...
/**
 * Progress8Fill icon from the Remix Icon library, System category.
 */
case class Progress8FillProps(
  size: Int = 24,
...
/**
 * Progress8Fill icon component.
 *
 * @example Progress8Fill <> Progress8FillProps(size = 24, color = "blue")
 */
def Progress8Fill = (props: Progress8FillProps) => {
  svg(
    viewBox := "0 0 24 24",
