...
/** 24HoursFill icon from the Remix Icon library, Finance category.
  */
case class TwentyFourHoursFillProps(
    size: Int = 24,
    color: String = "currentColor",
    className: String = "",
)

/** 24HoursFill icon component.
  *
  * @example
  *   24HoursFill <> 24HoursFillProps(size = 24, color = "blue")
  */
def TwentyFourHoursFill = (props: TwentyFourHoursFillProps) => {
  svg(
    viewBox := "0 0 24 24",
