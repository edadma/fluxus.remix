...
/**
 * SlackLine icon from the Remix Icon library, Logos category.
 */
case class SlackLineProps(
  size: Int = 24,
...
/**
 * SlackLine icon component.
 *
 * @example SlackLine <> SlackLineProps(size = 24, color = "blue")
 */
def SlackLine = (props: SlackLineProps) => {
  svg(
    viewBox := "0 0 24 24",
