...
/**
 * ScrollToBottomFill icon from the Remix Icon library, Arrows category.
 */
case class ScrollToBottomFillProps(
  size: Int = 24,
...
/**
 * ScrollToBottomFill icon component.
 *
 * @example ScrollToBottomFill <> ScrollToBottomFillProps(size = 24, color = "blue")
 */
def ScrollToBottomFill = (props: ScrollToBottomFillProps) => {
  svg(
    viewBox := "0 0 24 24",
