...
/**
 * SafeLine icon from the Remix Icon library, Finance category.
 */
case class SafeLineProps(
  size: Int = 24,
...
/**
 * SafeLine icon component.
 *
 * @example SafeLine <> SafeLineProps(size = 24, color = "blue")
 */
def SafeLine = (props: SafeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
