...
/**
 * Progress8Line icon from the Remix Icon library, System category.
 */
case class Progress8LineProps(
  size: Int = 24,
...
/**
 * Progress8Line icon component.
 *
 * @example Progress8Line <> Progress8LineProps(size = 24, color = "blue")
 */
def Progress8Line = (props: Progress8LineProps) => {
  svg(
    viewBox := "0 0 24 24",
