...
/**
 * DivideLine icon from the Remix Icon library, System category.
 */
case class DivideLineProps(
  size: Int = 24,
...
/**
 * DivideLine icon component.
 *
 * @example DivideLine <> DivideLineProps(size = 24, color = "blue")
 */
def DivideLine = (props: DivideLineProps) => {
  svg(
    viewBox := "0 0 24 24",
