...
/**
 * Key2Fill icon from the Remix Icon library, Others category.
 */
case class Key2FillProps(
  size: Int = 24,
...
/**
 * Key2Fill icon component.
 *
 * @example Key2Fill <> Key2FillProps(size = 24, color = "blue")
 */
def Key2Fill = (props: Key2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
