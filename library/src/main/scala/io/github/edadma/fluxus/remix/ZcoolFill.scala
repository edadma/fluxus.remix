...
/**
 * ZcoolFill icon from the Remix Icon library, Logos category.
 */
case class ZcoolFillProps(
  size: Int = 24,
...
/**
 * ZcoolFill icon component.
 *
 * @example ZcoolFill <> ZcoolFillProps(size = 24, color = "blue")
 */
def ZcoolFill = (props: ZcoolFillProps) => {
  svg(
    viewBox := "0 0 24 24",
