...
/**
 * TokenSwapFill icon from the Remix Icon library, Finance category.
 */
case class TokenSwapFillProps(
  size: Int = 24,
...
/**
 * TokenSwapFill icon component.
 *
 * @example TokenSwapFill <> TokenSwapFillProps(size = 24, color = "blue")
 */
def TokenSwapFill = (props: TokenSwapFillProps) => {
  svg(
    viewBox := "0 0 24 24",
