...
/**
 * ChatPrivateLine icon from the Remix Icon library, Communication category.
 */
case class ChatPrivateLineProps(
  size: Int = 24,
...
/**
 * ChatPrivateLine icon component.
 *
 * @example ChatPrivateLine <> ChatPrivateLineProps(size = 24, color = "blue")
 */
def ChatPrivateLine = (props: ChatPrivateLineProps) => {
  svg(
    viewBox := "0 0 24 24",
