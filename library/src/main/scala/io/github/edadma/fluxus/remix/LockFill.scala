...
/**
 * LockFill icon from the Remix Icon library, System category.
 */
case class LockFillProps(
  size: Int = 24,
 ...
 *
 * @example LockFill <> LockFillProps(size = 24, color = "blue")
 */
def LockFill = (props: LockFillProps) => {
  svg(
    viewBox := "0 0 24 24",
