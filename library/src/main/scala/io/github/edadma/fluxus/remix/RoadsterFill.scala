...
/**
 * RoadsterFill icon from the Remix Icon library, Map category.
 */
case class RoadsterFillProps(
  size: Int = 24,
...
/**
 * RoadsterFill icon component.
 *
 * @example RoadsterFill <> RoadsterFillProps(size = 24, color = "blue")
 */
def RoadsterFill = (props: RoadsterFillProps) => {
  svg(
    viewBox := "0 0 24 24",
