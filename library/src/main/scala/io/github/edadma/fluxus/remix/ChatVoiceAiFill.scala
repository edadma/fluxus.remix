...
/**
 * ChatVoiceAiFill icon from the Remix Icon library, Communication category.
 */
case class ChatVoiceAiFillProps(
  size: Int = 24,
...
/**
 * ChatVoiceAiFill icon component.
 *
 * @example ChatVoiceAiFill <> ChatVoiceAiFillProps(size = 24, color = "blue")
 */
def ChatVoiceAiFill = (props: ChatVoiceAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
