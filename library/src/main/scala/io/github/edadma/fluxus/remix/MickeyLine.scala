...
/**
 * MickeyLine icon from the Remix Icon library, User & Faces category.
 */
case class MickeyLineProps(
  size: Int = 24,
...
/**
 * MickeyLine icon component.
 *
 * @example MickeyLine <> MickeyLineProps(size = 24, color = "blue")
 */
def MickeyLine = (props: MickeyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
