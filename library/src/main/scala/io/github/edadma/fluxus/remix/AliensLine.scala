...
/**
 * AliensLine icon from the Remix Icon library, User & Faces category.
 */
case class AliensLineProps(
  size: Int = 24,
...
/**
 * AliensLine icon component.
 *
 * @example AliensLine <> AliensLineProps(size = 24, color = "blue")
 */
def AliensLine = (props: AliensLineProps) => {
  svg(
    viewBox := "0 0 24 24",
