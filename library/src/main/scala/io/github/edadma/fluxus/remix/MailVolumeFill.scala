...
/**
 * MailVolumeFill icon from the Remix Icon library, Business category.
 */
case class MailVolumeFillProps(
  size: Int = 24,
...
/**
 * MailVolumeFill icon component.
 *
 * @example MailVolumeFill <> MailVolumeFillProps(size = 24, color = "blue")
 */
def MailVolumeFill = (props: MailVolumeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
