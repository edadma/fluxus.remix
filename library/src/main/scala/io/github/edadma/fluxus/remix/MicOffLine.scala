...
/**
 * MicOffLine icon from the Remix Icon library, Media category.
 */
case class MicOffLineProps(
  size: Int = 24,
...
/**
 * MicOffLine icon component.
 *
 * @example MicOffLine <> MicOffLineProps(size = 24, color = "blue")
 */
def MicOffLine = (props: MicOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
