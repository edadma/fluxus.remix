...
/**
 * BlurOffLine icon from the Remix Icon library, Design category.
 */
case class BlurOffLineProps(
  size: Int = 24,
...
/**
 * BlurOffLine icon component.
 *
 * @example BlurOffLine <> BlurOffLineProps(size = 24, color = "blue")
 */
def BlurOffLine = (props: BlurOffLineProps) => {
  svg(
    viewBox := "0 0 24 24",
