...
/**
 * Dice3Line icon from the Remix Icon library, Others category.
 */
case class Dice3LineProps(
  size: Int = 24,
...
/**
 * Dice3Line icon component.
 *
 * @example Dice3Line <> Dice3LineProps(size = 24, color = "blue")
 */
def Dice3Line = (props: Dice3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
