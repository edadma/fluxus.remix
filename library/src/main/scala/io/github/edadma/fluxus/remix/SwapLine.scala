...
/**
 * SwapLine icon from the Remix Icon library, Finance category.
 */
case class SwapLineProps(
  size: Int = 24,
...
/**
 * SwapLine icon component.
 *
 * @example SwapLine <> SwapLineProps(size = 24, color = "blue")
 */
def SwapLine = (props: SwapLineProps) => {
  svg(
    viewBox := "0 0 24 24",
