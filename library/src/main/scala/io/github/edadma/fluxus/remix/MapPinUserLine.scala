...
/**
 * MapPinUserLine icon from the Remix Icon library, Map category.
 */
case class MapPinUserLineProps(
  size: Int = 24,
...
/**
 * MapPinUserLine icon component.
 *
 * @example MapPinUserLine <> MapPinUserLineProps(size = 24, color = "blue")
 */
def MapPinUserLine = (props: MapPinUserLineProps) => {
  svg(
    viewBox := "0 0 24 24",
