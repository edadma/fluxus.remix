...
/**
 * HammerLine icon from the Remix Icon library, Design category.
 */
case class HammerLineProps(
  size: Int = 24,
...
/**
 * HammerLine icon component.
 *
 * @example HammerLine <> HammerLineProps(size = 24, color = "blue")
 */
def HammerLine = (props: HammerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
