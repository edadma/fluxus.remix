...
/**
 * LiveFill icon from the Remix Icon library, Media category.
 */
case class LiveFillProps(
  size: Int = 24,
...
/**
 * LiveFill icon component.
 *
 * @example LiveFill <> LiveFillProps(size = 24, color = "blue")
 */
def LiveFill = (props: LiveFillProps) => {
  svg(
    viewBox := "0 0 24 24",
