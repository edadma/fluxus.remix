...
/**
 * Box3Line icon from the Remix Icon library, Others category.
 */
case class Box3LineProps(
  size: Int = 24,
...
/**
 * Box3Line icon component.
 *
 * @example Box3Line <> Box3LineProps(size = 24, color = "blue")
 */
def Box3Line = (props: Box3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
