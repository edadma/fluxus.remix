...
/**
 * GhostFill icon from the Remix Icon library, User & Faces category.
 */
case class GhostFillProps(
  size: Int = 24,
 ...
 *
 * @example GhostFill <> GhostFillProps(size = 24, color = "blue")
 */
def GhostFill = (props: GhostFillProps) => {
  svg(
    viewBox := "0 0 24 24",
