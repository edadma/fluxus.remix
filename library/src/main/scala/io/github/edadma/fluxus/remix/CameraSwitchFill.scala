...
/**
 * CameraSwitchFill icon from the Remix Icon library, Media category.
 */
case class CameraSwitchFillProps(
  size: Int = 24,
...
/**
 * CameraSwitchFill icon component.
 *
 * @example CameraSwitchFill <> CameraSwitchFillProps(size = 24, color = "blue")
 */
def CameraSwitchFill = (props: CameraSwitchFillProps) => {
  svg(
    viewBox := "0 0 24 24",
