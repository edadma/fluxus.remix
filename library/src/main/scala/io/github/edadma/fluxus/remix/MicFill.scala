...
/**
 * MicFill icon from the Remix Icon library, Media category.
 */
case class MicFillProps(
  size: Int = 24,
...
/**
 * MicFill icon component.
 *
 * @example MicFill <> MicFillProps(size = 24, color = "blue")
 */
def MicFill = (props: MicFillProps) => {
  svg(
    viewBox := "0 0 24 24",
