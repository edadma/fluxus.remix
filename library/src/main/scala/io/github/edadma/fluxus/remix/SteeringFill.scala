...
/**
 * SteeringFill icon from the Remix Icon library, Map category.
 */
case class SteeringFillProps(
  size: Int = 24,
...
/**
 * SteeringFill icon component.
 *
 * @example SteeringFill <> SteeringFillProps(size = 24, color = "blue")
 */
def SteeringFill = (props: SteeringFillProps) => {
  svg(
    viewBox := "0 0 24 24",
