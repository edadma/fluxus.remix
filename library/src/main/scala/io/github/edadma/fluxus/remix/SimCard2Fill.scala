...
/**
 * SimCard2Fill icon from the Remix Icon library, Device category.
 */
case class SimCard2FillProps(
  size: Int = 24,
...
/**
 * SimCard2Fill icon component.
 *
 * @example SimCard2Fill <> SimCard2FillProps(size = 24, color = "blue")
 */
def SimCard2Fill = (props: SimCard2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
