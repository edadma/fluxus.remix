...
/**
 * BnbLine icon from the Remix Icon library, Finance category.
 */
case class BnbLineProps(
  size: Int = 24,
...
/**
 * BnbLine icon component.
 *
 * @example BnbLine <> BnbLineProps(size = 24, color = "blue")
 */
def BnbLine = (props: BnbLineProps) => {
  svg(
    viewBox := "0 0 24 24",
