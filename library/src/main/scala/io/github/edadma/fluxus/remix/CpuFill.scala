...
/**
 * CpuFill icon from the Remix Icon library, Device category.
 */
case class CpuFillProps(
  size: Int = 24,
 ...
 *
 * @example CpuFill <> CpuFillProps(size = 24, color = "blue")
 */
def CpuFill = (props: CpuFillProps) => {
  svg(
    viewBox := "0 0 24 24",
