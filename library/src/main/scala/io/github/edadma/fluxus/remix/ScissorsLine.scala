...
/**
 * ScissorsLine icon from the Remix Icon library, Design category.
 */
case class ScissorsLineProps(
  size: Int = 24,
...
/**
 * ScissorsLine icon component.
 *
 * @example ScissorsLine <> ScissorsLineProps(size = 24, color = "blue")
 */
def ScissorsLine = (props: ScissorsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
