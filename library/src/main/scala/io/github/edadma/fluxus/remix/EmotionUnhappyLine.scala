...
/**
 * EmotionUnhappyLine icon from the Remix Icon library, User & Faces category.
 */
case class EmotionUnhappyLineProps(
  size: Int = 24,
...
/**
 * EmotionUnhappyLine icon component.
 *
 * @example EmotionUnhappyLine <> EmotionUnhappyLineProps(size = 24, color = "blue")
 */
def EmotionUnhappyLine = (props: EmotionUnhappyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
