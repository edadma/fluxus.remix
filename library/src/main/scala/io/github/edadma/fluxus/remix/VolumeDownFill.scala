...
/**
 * VolumeDownFill icon from the Remix Icon library, Media category.
 */
case class VolumeDownFillProps(
  size: Int = 24,
...
/**
 * VolumeDownFill icon component.
 *
 * @example VolumeDownFill <> VolumeDownFillProps(size = 24, color = "blue")
 */
def VolumeDownFill = (props: VolumeDownFillProps) => {
  svg(
    viewBox := "0 0 24 24",
