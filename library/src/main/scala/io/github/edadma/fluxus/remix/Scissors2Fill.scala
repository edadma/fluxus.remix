...
/**
 * Scissors2Fill icon from the Remix Icon library, Design category.
 */
case class Scissors2FillProps(
  size: Int = 24,
...
/**
 * Scissors2Fill icon component.
 *
 * @example Scissors2Fill <> Scissors2FillProps(size = 24, color = "blue")
 */
def Scissors2Fill = (props: Scissors2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
