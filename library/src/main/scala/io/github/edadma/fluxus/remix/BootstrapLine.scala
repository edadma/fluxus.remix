...
/**
 * BootstrapLine icon from the Remix Icon library, Logos category.
 */
case class BootstrapLineProps(
  size: Int = 24,
...
/**
 * BootstrapLine icon component.
 *
 * @example BootstrapLine <> BootstrapLineProps(size = 24, color = "blue")
 */
def BootstrapLine = (props: BootstrapLineProps) => {
  svg(
    viewBox := "0 0 24 24",
