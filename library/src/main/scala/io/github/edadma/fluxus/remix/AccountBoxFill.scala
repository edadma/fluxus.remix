...
/**
 * AccountBoxFill icon from the Remix Icon library, User & Faces category.
 */
case class AccountBoxFillProps(
  size: Int = 24,
...
/**
 * AccountBoxFill icon component.
 *
 * @example AccountBoxFill <> AccountBoxFillProps(size = 24, color = "blue")
 */
def AccountBoxFill = (props: AccountBoxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
