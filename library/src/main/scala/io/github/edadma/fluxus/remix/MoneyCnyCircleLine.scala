...
/**
 * MoneyCnyCircleLine icon from the Remix Icon library, Finance category.
 */
case class MoneyCnyCircleLineProps(
  size: Int = 24,
...
/**
 * MoneyCnyCircleLine icon component.
 *
 * @example MoneyCnyCircleLine <> MoneyCnyCircleLineProps(size = 24, color = "blue")
 */
def MoneyCnyCircleLine = (props: MoneyCnyCircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
