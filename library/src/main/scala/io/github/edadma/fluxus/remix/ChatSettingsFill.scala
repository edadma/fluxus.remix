...
/**
 * ChatSettingsFill icon from the Remix Icon library, Communication category.
 */
case class ChatSettingsFillProps(
  size: Int = 24,
...
/**
 * ChatSettingsFill icon component.
 *
 * @example ChatSettingsFill <> ChatSettingsFillProps(size = 24, color = "blue")
 */
def ChatSettingsFill = (props: ChatSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
