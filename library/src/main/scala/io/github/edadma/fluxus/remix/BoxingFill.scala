...
/**
 * BoxingFill icon from the Remix Icon library, Others category.
 */
case class BoxingFillProps(
  size: Int = 24,
...
/**
 * BoxingFill icon component.
 *
 * @example BoxingFill <> BoxingFillProps(size = 24, color = "blue")
 */
def BoxingFill = (props: BoxingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
