...
/**
 * UploadCloudLine icon from the Remix Icon library, System category.
 */
case class UploadCloudLineProps(
  size: Int = 24,
...
/**
 * UploadCloudLine icon component.
 *
 * @example UploadCloudLine <> UploadCloudLineProps(size = 24, color = "blue")
 */
def UploadCloudLine = (props: UploadCloudLineProps) => {
  svg(
    viewBox := "0 0 24 24",
