...
/**
 * Refund2Fill icon from the Remix Icon library, Finance category.
 */
case class Refund2FillProps(
  size: Int = 24,
...
/**
 * Refund2Fill icon component.
 *
 * @example Refund2Fill <> Refund2FillProps(size = 24, color = "blue")
 */
def Refund2Fill = (props: Refund2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
