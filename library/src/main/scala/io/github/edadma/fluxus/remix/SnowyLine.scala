...
/**
 * SnowyLine icon from the Remix Icon library, Weather category.
 */
case class SnowyLineProps(
  size: Int = 24,
...
/**
 * SnowyLine icon component.
 *
 * @example SnowyLine <> SnowyLineProps(size = 24, color = "blue")
 */
def SnowyLine = (props: SnowyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
