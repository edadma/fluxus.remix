...
/**
 * AiGenerateText icon from the Remix Icon library, Editor category.
 */
case class AiGenerateTextProps(
  size: Int = 24,
...
/**
 * AiGenerateText icon component.
 *
 * @example AiGenerateText <> AiGenerateTextProps(size = 24, color = "blue")
 */
def AiGenerateText = (props: AiGenerateTextProps) => {
  svg(
    viewBox := "0 0 24 24",
