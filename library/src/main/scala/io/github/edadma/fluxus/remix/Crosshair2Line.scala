...
/**
 * Crosshair2Line icon from the Remix Icon library, Design category.
 */
case class Crosshair2LineProps(
  size: Int = 24,
...
/**
 * Crosshair2Line icon component.
 *
 * @example Crosshair2Line <> Crosshair2LineProps(size = 24, color = "blue")
 */
def Crosshair2Line = (props: Crosshair2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
