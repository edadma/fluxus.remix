...
/**
 * CalendarCloseLine icon from the Remix Icon library, Business category.
 */
case class CalendarCloseLineProps(
  size: Int = 24,
...
/**
 * CalendarCloseLine icon component.
 *
 * @example CalendarCloseLine <> CalendarCloseLineProps(size = 24, color = "blue")
 */
def CalendarCloseLine = (props: CalendarCloseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
