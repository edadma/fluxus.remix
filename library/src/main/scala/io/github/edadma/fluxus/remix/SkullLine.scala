...
/**
 * SkullLine icon from the Remix Icon library, User & Faces category.
 */
case class SkullLineProps(
  size: Int = 24,
...
/**
 * SkullLine icon component.
 *
 * @example SkullLine <> SkullLineProps(size = 24, color = "blue")
 */
def SkullLine = (props: SkullLineProps) => {
  svg(
    viewBox := "0 0 24 24",
