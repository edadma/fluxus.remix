...
/**
 * CameraLensFill icon from the Remix Icon library, Media category.
 */
case class CameraLensFillProps(
  size: Int = 24,
...
/**
 * CameraLensFill icon component.
 *
 * @example CameraLensFill <> CameraLensFillProps(size = 24, color = "blue")
 */
def CameraLensFill = (props: CameraLensFillProps) => {
  svg(
    viewBox := "0 0 24 24",
