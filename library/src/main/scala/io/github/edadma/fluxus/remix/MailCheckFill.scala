...
/**
 * MailCheckFill icon from the Remix Icon library, Business category.
 */
case class MailCheckFillProps(
  size: Int = 24,
...
/**
 * MailCheckFill icon component.
 *
 * @example MailCheckFill <> MailCheckFillProps(size = 24, color = "blue")
 */
def MailCheckFill = (props: MailCheckFillProps) => {
  svg(
    viewBox := "0 0 24 24",
