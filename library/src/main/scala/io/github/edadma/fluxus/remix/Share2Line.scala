...
/**
 * Share2Line icon from the Remix Icon library, System category.
 */
case class Share2LineProps(
  size: Int = 24,
...
/**
 * Share2Line icon component.
 *
 * @example Share2Line <> Share2LineProps(size = 24, color = "blue")
 */
def Share2Line = (props: Share2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
