...
/**
 * SurgicalMaskLine icon from the Remix Icon library, Health & Medical category.
 */
case class SurgicalMaskLineProps(
  size: Int = 24,
...
/**
 * SurgicalMaskLine icon component.
 *
 * @example SurgicalMaskLine <> SurgicalMaskLineProps(size = 24, color = "blue")
 */
def SurgicalMaskLine = (props: SurgicalMaskLineProps) => {
  svg(
    viewBox := "0 0 24 24",
