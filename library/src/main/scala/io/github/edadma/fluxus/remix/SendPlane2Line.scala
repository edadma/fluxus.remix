...
/**
 * SendPlane2Line icon from the Remix Icon library, Business category.
 */
case class SendPlane2LineProps(
  size: Int = 24,
...
/**
 * SendPlane2Line icon component.
 *
 * @example SendPlane2Line <> SendPlane2LineProps(size = 24, color = "blue")
 */
def SendPlane2Line = (props: SendPlane2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
