...
/**
 * NextjsLine icon from the Remix Icon library, Logos category.
 */
case class NextjsLineProps(
  size: Int = 24,
...
/**
 * NextjsLine icon component.
 *
 * @example NextjsLine <> NextjsLineProps(size = 24, color = "blue")
 */
def NextjsLine = (props: NextjsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
