...
/**
 * Glasses2Fill icon from the Remix Icon library, Others category.
 */
case class Glasses2FillProps(
  size: Int = 24,
...
/**
 * Glasses2Fill icon component.
 *
 * @example Glasses2Fill <> Glasses2FillProps(size = 24, color = "blue")
 */
def Glasses2Fill = (props: Glasses2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
