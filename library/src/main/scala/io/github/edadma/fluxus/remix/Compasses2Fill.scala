...
/**
 * Compasses2Fill icon from the Remix Icon library, Design category.
 */
case class Compasses2FillProps(
  size: Int = 24,
...
/**
 * Compasses2Fill icon component.
 *
 * @example Compasses2Fill <> Compasses2FillProps(size = 24, color = "blue")
 */
def Compasses2Fill = (props: Compasses2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
