...
/**
 * CloudFill icon from the Remix Icon library, Business category.
 */
case class CloudFillProps(
  size: Int = 24,
 ...
 *
 * @example CloudFill <> CloudFillProps(size = 24, color = "blue")
 */
def CloudFill = (props: CloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
