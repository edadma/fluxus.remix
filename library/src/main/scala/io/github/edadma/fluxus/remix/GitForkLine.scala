...
/**
 * GitForkLine icon from the Remix Icon library, Development category.
 */
case class GitForkLineProps(
  size: Int = 24,
...
/**
 * GitForkLine icon component.
 *
 * @example GitForkLine <> GitForkLineProps(size = 24, color = "blue")
 */
def GitForkLine = (props: GitForkLineProps) => {
  svg(
    viewBox := "0 0 24 24",
