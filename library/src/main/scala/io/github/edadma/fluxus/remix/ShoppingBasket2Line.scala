...
/**
 * ShoppingBasket2Line icon from the Remix Icon library, Finance category.
 */
case class ShoppingBasket2LineProps(
  size: Int = 24,
...
/**
 * ShoppingBasket2Line icon component.
 *
 * @example ShoppingBasket2Line <> ShoppingBasket2LineProps(size = 24, color = "blue")
 */
def ShoppingBasket2Line = (props: ShoppingBasket2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
