...
/**
 * ShieldUserFill icon from the Remix Icon library, System category.
 */
case class ShieldUserFillProps(
  size: Int = 24,
...
/**
 * ShieldUserFill icon component.
 *
 * @example ShieldUserFill <> ShieldUserFillProps(size = 24, color = "blue")
 */
def ShieldUserFill = (props: ShieldUserFillProps) => {
  svg(
    viewBox := "0 0 24 24",
