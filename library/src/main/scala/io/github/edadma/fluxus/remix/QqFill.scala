...
/**
 * QqFill icon from the Remix Icon library, Logos category.
 */
case class QqFillProps(
  size: Int = 24,
...
/**
 * QqFill icon component.
 *
 * @example QqFill <> QqFillProps(size = 24, color = "blue")
 */
def QqFill = (props: QqFillProps) => {
  svg(
    viewBox := "0 0 24 24",
