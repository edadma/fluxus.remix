...
/**
 * MessengerLine icon from the Remix Icon library, Logos category.
 */
case class MessengerLineProps(
  size: Int = 24,
...
/**
 * MessengerLine icon component.
 *
 * @example MessengerLine <> MessengerLineProps(size = 24, color = "blue")
 */
def MessengerLine = (props: MessengerLineProps) => {
  svg(
    viewBox := "0 0 24 24",
