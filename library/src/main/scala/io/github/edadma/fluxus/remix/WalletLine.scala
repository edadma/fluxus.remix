...
/**
 * WalletLine icon from the Remix Icon library, Finance category.
 */
case class WalletLineProps(
  size: Int = 24,
...
/**
 * WalletLine icon component.
 *
 * @example WalletLine <> WalletLineProps(size = 24, color = "blue")
 */
def WalletLine = (props: WalletLineProps) => {
  svg(
    viewBox := "0 0 24 24",
