...
/**
 * MedalLine icon from the Remix Icon library, Business category.
 */
case class MedalLineProps(
  size: Int = 24,
...
/**
 * MedalLine icon component.
 *
 * @example MedalLine <> MedalLineProps(size = 24, color = "blue")
 */
def MedalLine = (props: MedalLineProps) => {
  svg(
    viewBox := "0 0 24 24",
