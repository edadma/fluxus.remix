...
/**
 * SpeedMiniFill icon from the Remix Icon library, Media category.
 */
case class SpeedMiniFillProps(
  size: Int = 24,
...
/**
 * SpeedMiniFill icon component.
 *
 * @example SpeedMiniFill <> SpeedMiniFillProps(size = 24, color = "blue")
 */
def SpeedMiniFill = (props: SpeedMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
