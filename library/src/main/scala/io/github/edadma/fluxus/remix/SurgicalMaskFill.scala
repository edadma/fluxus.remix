...
/**
 * SurgicalMaskFill icon from the Remix Icon library, Health & Medical category.
 */
case class SurgicalMaskFillProps(
  size: Int = 24,
...
/**
 * SurgicalMaskFill icon component.
 *
 * @example SurgicalMaskFill <> SurgicalMaskFillProps(size = 24, color = "blue")
 */
def SurgicalMaskFill = (props: SurgicalMaskFillProps) => {
  svg(
    viewBox := "0 0 24 24",
