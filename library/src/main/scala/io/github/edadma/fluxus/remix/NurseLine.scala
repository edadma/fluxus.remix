...
/**
 * NurseLine icon from the Remix Icon library, Health & Medical category.
 */
case class NurseLineProps(
  size: Int = 24,
...
/**
 * NurseLine icon component.
 *
 * @example NurseLine <> NurseLineProps(size = 24, color = "blue")
 */
def NurseLine = (props: NurseLineProps) => {
  svg(
    viewBox := "0 0 24 24",
