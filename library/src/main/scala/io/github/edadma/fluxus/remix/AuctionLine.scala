...
/**
 * AuctionLine icon from the Remix Icon library, Finance category.
 */
case class AuctionLineProps(
  size: Int = 24,
...
/**
 * AuctionLine icon component.
 *
 * @example AuctionLine <> AuctionLineProps(size = 24, color = "blue")
 */
def AuctionLine = (props: AuctionLineProps) => {
  svg(
    viewBox := "0 0 24 24",
