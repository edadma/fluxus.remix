...
/**
 * CommunityFill icon from the Remix Icon library, Buildings category.
 */
case class CommunityFillProps(
  size: Int = 24,
...
/**
 * CommunityFill icon component.
 *
 * @example CommunityFill <> CommunityFillProps(size = 24, color = "blue")
 */
def CommunityFill = (props: CommunityFillProps) => {
  svg(
    viewBox := "0 0 24 24",
