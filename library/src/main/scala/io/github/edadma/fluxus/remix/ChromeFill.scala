...
/**
 * ChromeFill icon from the Remix Icon library, Logos category.
 */
case class ChromeFillProps(
  size: Int = 24,
...
/**
 * ChromeFill icon component.
 *
 * @example ChromeFill <> ChromeFillProps(size = 24, color = "blue")
 */
def ChromeFill = (props: ChromeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
