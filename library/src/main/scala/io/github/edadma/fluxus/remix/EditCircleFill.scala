...
/**
 * EditCircleFill icon from the Remix Icon library, Design category.
 */
case class EditCircleFillProps(
  size: Int = 24,
...
/**
 * EditCircleFill icon component.
 *
 * @example EditCircleFill <> EditCircleFillProps(size = 24, color = "blue")
 */
def EditCircleFill = (props: EditCircleFillProps) => {
  svg(
    viewBox := "0 0 24 24",
