...
/**
 * HdLine icon from the Remix Icon library, Media category.
 */
case class HdLineProps(
  size: Int = 24,
...
/**
 * HdLine icon component.
 *
 * @example HdLine <> HdLineProps(size = 24, color = "blue")
 */
def HdLine = (props: HdLineProps) => {
  svg(
    viewBox := "0 0 24 24",
