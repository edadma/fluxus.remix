...
/**
 * FindReplaceLine icon from the Remix Icon library, System category.
 */
case class FindReplaceLineProps(
  size: Int = 24,
...
/**
 * FindReplaceLine icon component.
 *
 * @example FindReplaceLine <> FindReplaceLineProps(size = 24, color = "blue")
 */
def FindReplaceLine = (props: FindReplaceLineProps) => {
  svg(
    viewBox := "0 0 24 24",
