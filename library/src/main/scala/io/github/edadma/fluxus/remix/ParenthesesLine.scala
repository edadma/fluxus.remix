...
/**
 * ParenthesesLine icon from the Remix Icon library, Development category.
 */
case class ParenthesesLineProps(
  size: Int = 24,
...
/**
 * ParenthesesLine icon component.
 *
 * @example ParenthesesLine <> ParenthesesLineProps(size = 24, color = "blue")
 */
def ParenthesesLine = (props: ParenthesesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
