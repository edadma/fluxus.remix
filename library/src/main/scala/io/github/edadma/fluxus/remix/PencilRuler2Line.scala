...
/**
 * PencilRuler2Line icon from the Remix Icon library, Design category.
 */
case class PencilRuler2LineProps(
  size: Int = 24,
...
/**
 * PencilRuler2Line icon component.
 *
 * @example PencilRuler2Line <> PencilRuler2LineProps(size = 24, color = "blue")
 */
def PencilRuler2Line = (props: PencilRuler2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
