...
/**
 * CameraSwitchLine icon from the Remix Icon library, Media category.
 */
case class CameraSwitchLineProps(
  size: Int = 24,
...
/**
 * CameraSwitchLine icon component.
 *
 * @example CameraSwitchLine <> CameraSwitchLineProps(size = 24, color = "blue")
 */
def CameraSwitchLine = (props: CameraSwitchLineProps) => {
  svg(
    viewBox := "0 0 24 24",
