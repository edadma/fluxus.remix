...
/**
 * FileLine icon from the Remix Icon library, Document category.
 */
case class FileLineProps(
  size: Int = 24,
...
/**
 * FileLine icon component.
 *
 * @example FileLine <> FileLineProps(size = 24, color = "blue")
 */
def FileLine = (props: FileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
