...
/**
 * TShirt2Line icon from the Remix Icon library, Others category.
 */
case class TShirt2LineProps(
  size: Int = 24,
...
/**
 * TShirt2Line icon component.
 *
 * @example TShirt2Line <> TShirt2LineProps(size = 24, color = "blue")
 */
def TShirt2Line = (props: TShirt2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
