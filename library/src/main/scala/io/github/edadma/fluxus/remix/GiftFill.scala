...
/**
 * GiftFill icon from the Remix Icon library, Finance category.
 */
case class GiftFillProps(
  size: Int = 24,
 ...
 *
 * @example GiftFill <> GiftFillProps(size = 24, color = "blue")
 */
def GiftFill = (props: GiftFillProps) => {
  svg(
    viewBox := "0 0 24 24",
