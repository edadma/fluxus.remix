...
/**
 * FileHwpLine icon from the Remix Icon library, Document category.
 */
case class FileHwpLineProps(
  size: Int = 24,
...
/**
 * FileHwpLine icon component.
 *
 * @example FileHwpLine <> FileHwpLineProps(size = 24, color = "blue")
 */
def FileHwpLine = (props: FileHwpLineProps) => {
  svg(
    viewBox := "0 0 24 24",
