...
/**
 * Home5Line icon from the Remix Icon library, Buildings category.
 */
case class Home5LineProps(
  size: Int = 24,
...
/**
 * Home5Line icon component.
 *
 * @example Home5Line <> Home5LineProps(size = 24, color = "blue")
 */
def Home5Line = (props: Home5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
