...
/**
 * PlaystationFill icon from the Remix Icon library, Logos category.
 */
case class PlaystationFillProps(
  size: Int = 24,
...
/**
 * PlaystationFill icon component.
 *
 * @example PlaystationFill <> PlaystationFillProps(size = 24, color = "blue")
 */
def PlaystationFill = (props: PlaystationFillProps) => {
  svg(
    viewBox := "0 0 24 24",
