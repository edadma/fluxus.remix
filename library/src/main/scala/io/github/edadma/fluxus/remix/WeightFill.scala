...
/**
 * WeightFill icon from the Remix Icon library, Others category.
 */
case class WeightFillProps(
  size: Int = 24,
...
/**
 * WeightFill icon component.
 *
 * @example WeightFill <> WeightFillProps(size = 24, color = "blue")
 */
def WeightFill = (props: WeightFillProps) => {
  svg(
    viewBox := "0 0 24 24",
