...
/**
 * SkipForwardFill icon from the Remix Icon library, Media category.
 */
case class SkipForwardFillProps(
  size: Int = 24,
 ...
 *
 * @example SkipForwardFill <> SkipForwardFillProps(size = 24, color = "blue")
 */
def SkipForwardFill = (props: SkipForwardFillProps) => {
  svg(
    viewBox := "0 0 24 24",
