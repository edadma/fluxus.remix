...
/**
 * SnowflakeFill icon from the Remix Icon library, Weather category.
 */
case class SnowflakeFillProps(
  size: Int = 24,
 ...
 *
 * @example SnowflakeFill <> SnowflakeFillProps(size = 24, color = "blue")
 */
def SnowflakeFill = (props: SnowflakeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
