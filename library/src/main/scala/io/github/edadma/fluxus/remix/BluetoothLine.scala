...
/**
 * BluetoothLine icon from the Remix Icon library, Device category.
 */
case class BluetoothLineProps(
  size: Int = 24,
...
/**
 * BluetoothLine icon component.
 *
 * @example BluetoothLine <> BluetoothLineProps(size = 24, color = "blue")
 */
def BluetoothLine = (props: BluetoothLineProps) => {
  svg(
    viewBox := "0 0 24 24",
