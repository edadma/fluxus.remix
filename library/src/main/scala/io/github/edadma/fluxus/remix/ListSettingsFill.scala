...
/**
 * ListSettingsFill icon from the Remix Icon library, System category.
 */
case class ListSettingsFillProps(
  size: Int = 24,
...
/**
 * ListSettingsFill icon component.
 *
 * @example ListSettingsFill <> ListSettingsFillProps(size = 24, color = "blue")
 */
def ListSettingsFill = (props: ListSettingsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
