...
/**
 * Notification4Fill icon from the Remix Icon library, Media category.
 */
case class Notification4FillProps(
  size: Int = 24,
...
/**
 * Notification4Fill icon component.
 *
 * @example Notification4Fill <> Notification4FillProps(size = 24, color = "blue")
 */
def Notification4Fill = (props: Notification4FillProps) => {
  svg(
    viewBox := "0 0 24 24",
