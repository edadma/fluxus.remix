...
/**
 * Home4Line icon from the Remix Icon library, Buildings category.
 */
case class Home4LineProps(
  size: Int = 24,
...
/**
 * Home4Line icon component.
 *
 * @example Home4Line <> Home4LineProps(size = 24, color = "blue")
 */
def Home4Line = (props: Home4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
