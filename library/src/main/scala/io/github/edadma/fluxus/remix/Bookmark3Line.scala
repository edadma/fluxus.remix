...
/**
 * Bookmark3Line icon from the Remix Icon library, Business category.
 */
case class Bookmark3LineProps(
  size: Int = 24,
...
/**
 * Bookmark3Line icon component.
 *
 * @example Bookmark3Line <> Bookmark3LineProps(size = 24, color = "blue")
 */
def Bookmark3Line = (props: Bookmark3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
