...
/**
 * PlayReverseMiniFill icon from the Remix Icon library, Media category.
 */
case class PlayReverseMiniFillProps(
  size: Int = 24,
...
/**
 * PlayReverseMiniFill icon component.
 *
 * @example PlayReverseMiniFill <> PlayReverseMiniFillProps(size = 24, color = "blue")
 */
def PlayReverseMiniFill = (props: PlayReverseMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
