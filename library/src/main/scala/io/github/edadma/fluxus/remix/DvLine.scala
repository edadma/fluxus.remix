...
/**
 * DvLine icon from the Remix Icon library, Media category.
 */
case class DvLineProps(
  size: Int = 24,
...
/**
 * DvLine icon component.
 *
 * @example DvLine <> DvLineProps(size = 24, color = "blue")
 */
def DvLine = (props: DvLineProps) => {
  svg(
    viewBox := "0 0 24 24",
