...
/**
 * BloggerFill icon from the Remix Icon library, Logos category.
 */
case class BloggerFillProps(
  size: Int = 24,
...
/**
 * BloggerFill icon component.
 *
 * @example BloggerFill <> BloggerFillProps(size = 24, color = "blue")
 */
def BloggerFill = (props: BloggerFillProps) => {
  svg(
    viewBox := "0 0 24 24",
