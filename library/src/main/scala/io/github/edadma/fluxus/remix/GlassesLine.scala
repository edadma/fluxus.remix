...
/**
 * GlassesLine icon from the Remix Icon library, Others category.
 */
case class GlassesLineProps(
  size: Int = 24,
...
/**
 * GlassesLine icon component.
 *
 * @example GlassesLine <> GlassesLineProps(size = 24, color = "blue")
 */
def GlassesLine = (props: GlassesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
