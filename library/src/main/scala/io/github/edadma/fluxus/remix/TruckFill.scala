...
/**
 * TruckFill icon from the Remix Icon library, Map category.
 */
case class TruckFillProps(
  size: Int = 24,
 ...
 *
 * @example TruckFill <> TruckFillProps(size = 24, color = "blue")
 */
def TruckFill = (props: TruckFillProps) => {
  svg(
    viewBox := "0 0 24 24",
