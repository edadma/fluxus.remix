...
/**
 * EmotionSadLine icon from the Remix Icon library, User & Faces category.
 */
case class EmotionSadLineProps(
  size: Int = 24,
...
/**
 * EmotionSadLine icon component.
 *
 * @example EmotionSadLine <> EmotionSadLineProps(size = 24, color = "blue")
 */
def EmotionSadLine = (props: EmotionSadLineProps) => {
  svg(
    viewBox := "0 0 24 24",
