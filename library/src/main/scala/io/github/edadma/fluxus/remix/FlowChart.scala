...
/**
 * FlowChart icon from the Remix Icon library, Editor category.
 */
case class FlowChartProps(
  size: Int = 24,
...
/**
 * FlowChart icon component.
 *
 * @example FlowChart <> FlowChartProps(size = 24, color = "blue")
 */
def FlowChart = (props: FlowChartProps) => {
  svg(
    viewBox := "0 0 24 24",
