...
/**
 * EditCircleLine icon from the Remix Icon library, Design category.
 */
case class EditCircleLineProps(
  size: Int = 24,
...
/**
 * EditCircleLine icon component.
 *
 * @example EditCircleLine <> EditCircleLineProps(size = 24, color = "blue")
 */
def EditCircleLine = (props: EditCircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
