...
/**
 * RemoteControlFill icon from the Remix Icon library, Device category.
 */
case class RemoteControlFillProps(
  size: Int = 24,
...
/**
 * RemoteControlFill icon component.
 *
 * @example RemoteControlFill <> RemoteControlFillProps(size = 24, color = "blue")
 */
def RemoteControlFill = (props: RemoteControlFillProps) => {
  svg(
    viewBox := "0 0 24 24",
