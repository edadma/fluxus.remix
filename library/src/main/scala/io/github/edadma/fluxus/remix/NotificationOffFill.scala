...
/**
 * NotificationOffFill icon from the Remix Icon library, Media category.
 */
case class NotificationOffFillProps(
  size: Int = 24,
...
/**
 * NotificationOffFill icon component.
 *
 * @example NotificationOffFill <> NotificationOffFillProps(size = 24, color = "blue")
 */
def NotificationOffFill = (props: NotificationOffFillProps) => {
  svg(
    viewBox := "0 0 24 24",
