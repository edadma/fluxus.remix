...
/**
 * TyphoonFill icon from the Remix Icon library, Weather category.
 */
case class TyphoonFillProps(
  size: Int = 24,
...
/**
 * TyphoonFill icon component.
 *
 * @example TyphoonFill <> TyphoonFillProps(size = 24, color = "blue")
 */
def TyphoonFill = (props: TyphoonFillProps) => {
  svg(
    viewBox := "0 0 24 24",
