...
/**
 * TaskFill icon from the Remix Icon library, Document category.
 */
case class TaskFillProps(
  size: Int = 24,
...
/**
 * TaskFill icon component.
 *
 * @example TaskFill <> TaskFillProps(size = 24, color = "blue")
 */
def TaskFill = (props: TaskFillProps) => {
  svg(
    viewBox := "0 0 24 24",
