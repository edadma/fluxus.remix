...
/**
 * FolderVideoFill icon from the Remix Icon library, Document category.
 */
case class FolderVideoFillProps(
  size: Int = 24,
...
/**
 * FolderVideoFill icon component.
 *
 * @example FolderVideoFill <> FolderVideoFillProps(size = 24, color = "blue")
 */
def FolderVideoFill = (props: FolderVideoFillProps) => {
  svg(
    viewBox := "0 0 24 24",
