...
/**
 * AirplayLine icon from the Remix Icon library, Device category.
 */
case class AirplayLineProps(
  size: Int = 24,
...
/**
 * AirplayLine icon component.
 *
 * @example AirplayLine <> AirplayLineProps(size = 24, color = "blue")
 */
def AirplayLine = (props: AirplayLineProps) => {
  svg(
    viewBox := "0 0 24 24",
