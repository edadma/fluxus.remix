...
/**
 * RoadsterLine icon from the Remix Icon library, Map category.
 */
case class RoadsterLineProps(
  size: Int = 24,
...
/**
 * RoadsterLine icon component.
 *
 * @example RoadsterLine <> RoadsterLineProps(size = 24, color = "blue")
 */
def RoadsterLine = (props: RoadsterLineProps) => {
  svg(
    viewBox := "0 0 24 24",
