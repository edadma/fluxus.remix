...
/**
 * ExportFill icon from the Remix Icon library, System category.
 */
case class ExportFillProps(
  size: Int = 24,
 ...
 *
 * @example ExportFill <> ExportFillProps(size = 24, color = "blue")
 */
def ExportFill = (props: ExportFillProps) => {
  svg(
    viewBox := "0 0 24 24",
