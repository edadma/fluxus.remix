...
/**
 * BnbFill icon from the Remix Icon library, Finance category.
 */
case class BnbFillProps(
  size: Int = 24,
...
/**
 * BnbFill icon component.
 *
 * @example BnbFill <> BnbFillProps(size = 24, color = "blue")
 */
def BnbFill = (props: BnbFillProps) => {
  svg(
    viewBox := "0 0 24 24",
