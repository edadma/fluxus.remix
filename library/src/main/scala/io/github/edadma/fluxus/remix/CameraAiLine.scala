...
/**
 * CameraAiLine icon from the Remix Icon library, Media category.
 */
case class CameraAiLineProps(
  size: Int = 24,
...
/**
 * CameraAiLine icon component.
 *
 * @example CameraAiLine <> CameraAiLineProps(size = 24, color = "blue")
 */
def CameraAiLine = (props: CameraAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
