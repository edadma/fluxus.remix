...
/**
 * GolfBallFill icon from the Remix Icon library, Others category.
 */
case class GolfBallFillProps(
  size: Int = 24,
...
/**
 * GolfBallFill icon component.
 *
 * @example GolfBallFill <> GolfBallFillProps(size = 24, color = "blue")
 */
def GolfBallFill = (props: GolfBallFillProps) => {
  svg(
    viewBox := "0 0 24 24",
