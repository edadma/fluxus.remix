...
/**
 * MailAiFill icon from the Remix Icon library, Business category.
 */
case class MailAiFillProps(
  size: Int = 24,
...
/**
 * MailAiFill icon component.
 *
 * @example MailAiFill <> MailAiFillProps(size = 24, color = "blue")
 */
def MailAiFill = (props: MailAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
