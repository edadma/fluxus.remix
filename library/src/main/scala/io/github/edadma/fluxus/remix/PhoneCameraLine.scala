...
/**
 * PhoneCameraLine icon from the Remix Icon library, Media category.
 */
case class PhoneCameraLineProps(
  size: Int = 24,
...
/**
 * PhoneCameraLine icon component.
 *
 * @example PhoneCameraLine <> PhoneCameraLineProps(size = 24, color = "blue")
 */
def PhoneCameraLine = (props: PhoneCameraLineProps) => {
  svg(
    viewBox := "0 0 24 24",
