...
/**
 * ListIndefinite icon from the Remix Icon library, Editor category.
 */
case class ListIndefiniteProps(
  size: Int = 24,
...
/**
 * ListIndefinite icon component.
 *
 * @example ListIndefinite <> ListIndefiniteProps(size = 24, color = "blue")
 */
def ListIndefinite = (props: ListIndefiniteProps) => {
  svg(
    viewBox := "0 0 24 24",
