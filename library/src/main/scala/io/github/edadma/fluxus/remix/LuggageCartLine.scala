...
/**
 * LuggageCartLine icon from the Remix Icon library, Map category.
 */
case class LuggageCartLineProps(
  size: Int = 24,
...
/**
 * LuggageCartLine icon component.
 *
 * @example LuggageCartLine <> LuggageCartLineProps(size = 24, color = "blue")
 */
def LuggageCartLine = (props: LuggageCartLineProps) => {
  svg(
    viewBox := "0 0 24 24",
