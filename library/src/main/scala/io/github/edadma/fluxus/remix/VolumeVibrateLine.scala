...
/**
 * VolumeVibrateLine icon from the Remix Icon library, Media category.
 */
case class VolumeVibrateLineProps(
  size: Int = 24,
...
/**
 * VolumeVibrateLine icon component.
 *
 * @example VolumeVibrateLine <> VolumeVibrateLineProps(size = 24, color = "blue")
 */
def VolumeVibrateLine = (props: VolumeVibrateLineProps) => {
  svg(
    viewBox := "0 0 24 24",
