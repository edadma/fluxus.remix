...
/**
 * VolumeOffVibrateLine icon from the Remix Icon library, Media category.
 */
case class VolumeOffVibrateLineProps(
  size: Int = 24,
...
/**
 * VolumeOffVibrateLine icon component.
 *
 * @example VolumeOffVibrateLine <> VolumeOffVibrateLineProps(size = 24, color = "blue")
 */
def VolumeOffVibrateLine = (props: VolumeOffVibrateLineProps) => {
  svg(
    viewBox := "0 0 24 24",
