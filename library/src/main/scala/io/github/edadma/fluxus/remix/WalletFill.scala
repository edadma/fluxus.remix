...
/**
 * WalletFill icon from the Remix Icon library, Finance category.
 */
case class WalletFillProps(
  size: Int = 24,
 ...
 *
 * @example WalletFill <> WalletFillProps(size = 24, color = "blue")
 */
def WalletFill = (props: WalletFillProps) => {
  svg(
    viewBox := "0 0 24 24",
