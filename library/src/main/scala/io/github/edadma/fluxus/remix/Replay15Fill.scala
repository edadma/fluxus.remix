...
/**
 * Replay15Fill icon from the Remix Icon library, Media category.
 */
case class Replay15FillProps(
  size: Int = 24,
...
/**
 * Replay15Fill icon component.
 *
 * @example Replay15Fill <> Replay15FillProps(size = 24, color = "blue")
 */
def Replay15Fill = (props: Replay15FillProps) => {
  svg(
    viewBox := "0 0 24 24",
