...
/**
 * Home9Fill icon from the Remix Icon library, Buildings category.
 */
case class Home9FillProps(
  size: Int = 24,
...
/**
 * Home9Fill icon component.
 *
 * @example Home9Fill <> Home9FillProps(size = 24, color = "blue")
 */
def Home9Fill = (props: Home9FillProps) => {
  svg(
    viewBox := "0 0 24 24",
