...
/**
 * ListView icon from the Remix Icon library, Editor category.
 */
case class ListViewProps(
  size: Int = 24,
...
/**
 * ListView icon component.
 *
 * @example ListView <> ListViewProps(size = 24, color = "blue")
 */
def ListView = (props: ListViewProps) => {
  svg(
    viewBox := "0 0 24 24",
