...
/**
 * RestartFill icon from the Remix Icon library, Device category.
 */
case class RestartFillProps(
  size: Int = 24,
...
/**
 * RestartFill icon component.
 *
 * @example RestartFill <> RestartFillProps(size = 24, color = "blue")
 */
def RestartFill = (props: RestartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
