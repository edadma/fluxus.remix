...
/**
 * PauseMiniFill icon from the Remix Icon library, Media category.
 */
case class PauseMiniFillProps(
  size: Int = 24,
...
/**
 * PauseMiniFill icon component.
 *
 * @example PauseMiniFill <> PauseMiniFillProps(size = 24, color = "blue")
 */
def PauseMiniFill = (props: PauseMiniFillProps) => {
  svg(
    viewBox := "0 0 24 24",
