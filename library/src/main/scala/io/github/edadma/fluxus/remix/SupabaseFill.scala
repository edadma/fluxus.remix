...
/**
 * SupabaseFill icon from the Remix Icon library, Logos category.
 */
case class SupabaseFillProps(
  size: Int = 24,
...
/**
 * SupabaseFill icon component.
 *
 * @example SupabaseFill <> SupabaseFillProps(size = 24, color = "blue")
 */
def SupabaseFill = (props: SupabaseFillProps) => {
  svg(
    viewBox := "0 0 24 24",
