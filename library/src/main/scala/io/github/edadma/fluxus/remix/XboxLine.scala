...
/**
 * XboxLine icon from the Remix Icon library, Logos category.
 */
case class XboxLineProps(
  size: Int = 24,
...
/**
 * XboxLine icon component.
 *
 * @example XboxLine <> XboxLineProps(size = 24, color = "blue")
 */
def XboxLine = (props: XboxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
