...
/**
 * AlignItemVerticalCenterLine icon from the Remix Icon library, Design category.
 */
case class AlignItemVerticalCenterLineProps(
  size: Int = 24,
...
/**
 * AlignItemVerticalCenterLine icon component.
 *
 * @example AlignItemVerticalCenterLine <> AlignItemVerticalCenterLineProps(size = 24, color = "blue")
 */
def AlignItemVerticalCenterLine = (props: AlignItemVerticalCenterLineProps) => {
  svg(
    viewBox := "0 0 24 24",
