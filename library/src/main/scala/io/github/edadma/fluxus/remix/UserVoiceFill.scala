...
/**
 * UserVoiceFill icon from the Remix Icon library, User & Faces category.
 */
case class UserVoiceFillProps(
  size: Int = 24,
...
/**
 * UserVoiceFill icon component.
 *
 * @example UserVoiceFill <> UserVoiceFillProps(size = 24, color = "blue")
 */
def UserVoiceFill = (props: UserVoiceFillProps) => {
  svg(
    viewBox := "0 0 24 24",
