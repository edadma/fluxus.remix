...
/**
 * AttachmentFill icon from the Remix Icon library, Business category.
 */
case class AttachmentFillProps(
  size: Int = 24,
...
/**
 * AttachmentFill icon component.
 *
 * @example AttachmentFill <> AttachmentFillProps(size = 24, color = "blue")
 */
def AttachmentFill = (props: AttachmentFillProps) => {
  svg(
    viewBox := "0 0 24 24",
