...
/**
 * FileCloudFill icon from the Remix Icon library, Document category.
 */
case class FileCloudFillProps(
  size: Int = 24,
 ...
 *
 * @example FileCloudFill <> FileCloudFillProps(size = 24, color = "blue")
 */
def FileCloudFill = (props: FileCloudFillProps) => {
  svg(
    viewBox := "0 0 24 24",
