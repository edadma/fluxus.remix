...
/**
 * MoonClearLine icon from the Remix Icon library, Weather category.
 */
case class MoonClearLineProps(
  size: Int = 24,
...
/**
 * MoonClearLine icon component.
 *
 * @example MoonClearLine <> MoonClearLineProps(size = 24, color = "blue")
 */
def MoonClearLine = (props: MoonClearLineProps) => {
  svg(
    viewBox := "0 0 24 24",
