...
/**
 * MailAiLine icon from the Remix Icon library, Business category.
 */
case class MailAiLineProps(
  size: Int = 24,
...
/**
 * MailAiLine icon component.
 *
 * @example MailAiLine <> MailAiLineProps(size = 24, color = "blue")
 */
def MailAiLine = (props: MailAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
