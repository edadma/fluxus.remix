...
/**
 * Scan2Fill icon from the Remix Icon library, Device category.
 */
case class Scan2FillProps(
  size: Int = 24,
...
/**
 * Scan2Fill icon component.
 *
 * @example Scan2Fill <> Scan2FillProps(size = 24, color = "blue")
 */
def Scan2Fill = (props: Scan2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
