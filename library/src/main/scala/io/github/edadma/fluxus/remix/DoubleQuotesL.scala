...
/**
 * DoubleQuotesL icon from the Remix Icon library, Editor category.
 */
case class DoubleQuotesLProps(
  size: Int = 24,
...
/**
 * DoubleQuotesL icon component.
 *
 * @example DoubleQuotesL <> DoubleQuotesLProps(size = 24, color = "blue")
 */
def DoubleQuotesL = (props: DoubleQuotesLProps) => {
  svg(
    viewBox := "0 0 24 24",
