...
/**
 * SpyLine icon from the Remix Icon library, User & Faces category.
 */
case class SpyLineProps(
  size: Int = 24,
...
/**
 * SpyLine icon component.
 *
 * @example SpyLine <> SpyLineProps(size = 24, color = "blue")
 */
def SpyLine = (props: SpyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
