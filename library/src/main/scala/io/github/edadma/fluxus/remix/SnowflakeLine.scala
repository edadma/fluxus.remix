...
/**
 * SnowflakeLine icon from the Remix Icon library, Weather category.
 */
case class SnowflakeLineProps(
  size: Int = 24,
...
/**
 * SnowflakeLine icon component.
 *
 * @example SnowflakeLine <> SnowflakeLineProps(size = 24, color = "blue")
 */
def SnowflakeLine = (props: SnowflakeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
