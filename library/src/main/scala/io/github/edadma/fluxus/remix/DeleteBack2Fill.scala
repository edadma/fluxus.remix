...
/**
 * DeleteBack2Fill icon from the Remix Icon library, System category.
 */
case class DeleteBack2FillProps(
  size: Int = 24,
...
/**
 * DeleteBack2Fill icon component.
 *
 * @example DeleteBack2Fill <> DeleteBack2FillProps(size = 24, color = "blue")
 */
def DeleteBack2Fill = (props: DeleteBack2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
