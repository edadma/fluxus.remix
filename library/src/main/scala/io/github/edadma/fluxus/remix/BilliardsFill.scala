...
/**
 * BilliardsFill icon from the Remix Icon library, Others category.
 */
case class BilliardsFillProps(
  size: Int = 24,
...
/**
 * BilliardsFill icon component.
 *
 * @example BilliardsFill <> BilliardsFillProps(size = 24, color = "blue")
 */
def BilliardsFill = (props: BilliardsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
