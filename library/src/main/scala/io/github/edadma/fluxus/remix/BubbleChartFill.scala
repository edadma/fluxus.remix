...
/**
 * BubbleChartFill icon from the Remix Icon library, Business category.
 */
case class BubbleChartFillProps(
  size: Int = 24,
...
/**
 * BubbleChartFill icon component.
 *
 * @example BubbleChartFill <> BubbleChartFillProps(size = 24, color = "blue")
 */
def BubbleChartFill = (props: BubbleChartFillProps) => {
  svg(
    viewBox := "0 0 24 24",
