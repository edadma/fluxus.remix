...
/**
 * Apps2AiLine icon from the Remix Icon library, System category.
 */
case class Apps2AiLineProps(
  size: Int = 24,
...
/**
 * Apps2AiLine icon component.
 *
 * @example Apps2AiLine <> Apps2AiLineProps(size = 24, color = "blue")
 */
def Apps2AiLine = (props: Apps2AiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
