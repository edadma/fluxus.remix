...
/**
 * MastercardLine icon from the Remix Icon library, Logos category.
 */
case class MastercardLineProps(
  size: Int = 24,
...
/**
 * MastercardLine icon component.
 *
 * @example MastercardLine <> MastercardLineProps(size = 24, color = "blue")
 */
def MastercardLine = (props: MastercardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
