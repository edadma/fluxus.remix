...
/**
 * Home5Fill icon from the Remix Icon library, Buildings category.
 */
case class Home5FillProps(
  size: Int = 24,
...
/**
 * Home5Fill icon component.
 *
 * @example Home5Fill <> Home5FillProps(size = 24, color = "blue")
 */
def Home5Fill = (props: Home5FillProps) => {
  svg(
    viewBox := "0 0 24 24",
