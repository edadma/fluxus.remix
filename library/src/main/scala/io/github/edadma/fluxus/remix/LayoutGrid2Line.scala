...
/**
 * LayoutGrid2Line icon from the Remix Icon library, Design category.
 */
case class LayoutGrid2LineProps(
  size: Int = 24,
...
/**
 * LayoutGrid2Line icon component.
 *
 * @example LayoutGrid2Line <> LayoutGrid2LineProps(size = 24, color = "blue")
 */
def LayoutGrid2Line = (props: LayoutGrid2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
