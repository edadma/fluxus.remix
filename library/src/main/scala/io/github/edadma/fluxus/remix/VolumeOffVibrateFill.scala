...
/**
 * VolumeOffVibrateFill icon from the Remix Icon library, Media category.
 */
case class VolumeOffVibrateFillProps(
  size: Int = 24,
...
/**
 * VolumeOffVibrateFill icon component.
 *
 * @example VolumeOffVibrateFill <> VolumeOffVibrateFillProps(size = 24, color = "blue")
 */
def VolumeOffVibrateFill = (props: VolumeOffVibrateFillProps) => {
  svg(
    viewBox := "0 0 24 24",
