...
/**
 * Scan2Line icon from the Remix Icon library, Device category.
 */
case class Scan2LineProps(
  size: Int = 24,
...
/**
 * Scan2Line icon component.
 *
 * @example Scan2Line <> Scan2LineProps(size = 24, color = "blue")
 */
def Scan2Line = (props: Scan2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
