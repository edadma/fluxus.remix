...
/**
 * DisqusFill icon from the Remix Icon library, Logos category.
 */
case class DisqusFillProps(
  size: Int = 24,
...
/**
 * DisqusFill icon component.
 *
 * @example DisqusFill <> DisqusFillProps(size = 24, color = "blue")
 */
def DisqusFill = (props: DisqusFillProps) => {
  svg(
    viewBox := "0 0 24 24",
