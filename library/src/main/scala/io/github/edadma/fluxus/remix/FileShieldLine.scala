...
/**
 * FileShieldLine icon from the Remix Icon library, Document category.
 */
case class FileShieldLineProps(
  size: Int = 24,
...
/**
 * FileShieldLine icon component.
 *
 * @example FileShieldLine <> FileShieldLineProps(size = 24, color = "blue")
 */
def FileShieldLine = (props: FileShieldLineProps) => {
  svg(
    viewBox := "0 0 24 24",
