...
/**
 * WaterPercentLine icon from the Remix Icon library, Weather category.
 */
case class WaterPercentLineProps(
  size: Int = 24,
...
/**
 * WaterPercentLine icon component.
 *
 * @example WaterPercentLine <> WaterPercentLineProps(size = 24, color = "blue")
 */
def WaterPercentLine = (props: WaterPercentLineProps) => {
  svg(
    viewBox := "0 0 24 24",
