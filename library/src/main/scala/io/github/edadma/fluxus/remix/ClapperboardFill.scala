...
/**
 * ClapperboardFill icon from the Remix Icon library, Media category.
 */
case class ClapperboardFillProps(
  size: Int = 24,
...
/**
 * ClapperboardFill icon component.
 *
 * @example ClapperboardFill <> ClapperboardFillProps(size = 24, color = "blue")
 */
def ClapperboardFill = (props: ClapperboardFillProps) => {
  svg(
    viewBox := "0 0 24 24",
