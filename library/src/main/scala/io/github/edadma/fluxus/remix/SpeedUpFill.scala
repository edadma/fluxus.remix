...
/**
 * SpeedUpFill icon from the Remix Icon library, Media category.
 */
case class SpeedUpFillProps(
  size: Int = 24,
...
/**
 * SpeedUpFill icon component.
 *
 * @example SpeedUpFill <> SpeedUpFillProps(size = 24, color = "blue")
 */
def SpeedUpFill = (props: SpeedUpFillProps) => {
  svg(
    viewBox := "0 0 24 24",
