...
/**
 * SkullFill icon from the Remix Icon library, User & Faces category.
 */
case class SkullFillProps(
  size: Int = 24,
 ...
 *
 * @example SkullFill <> SkullFillProps(size = 24, color = "blue")
 */
def SkullFill = (props: SkullFillProps) => {
  svg(
    viewBox := "0 0 24 24",
