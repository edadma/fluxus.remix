...
/**
 * RunLine icon from the Remix Icon library, Map category.
 */
case class RunLineProps(
  size: Int = 24,
...
/**
 * RunLine icon component.
 *
 * @example RunLine <> RunLineProps(size = 24, color = "blue")
 */
def RunLine = (props: RunLineProps) => {
  svg(
    viewBox := "0 0 24 24",
