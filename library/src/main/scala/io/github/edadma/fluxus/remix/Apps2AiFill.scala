...
/**
 * Apps2AiFill icon from the Remix Icon library, System category.
 */
case class Apps2AiFillProps(
  size: Int = 24,
...
/**
 * Apps2AiFill icon component.
 *
 * @example Apps2AiFill <> Apps2AiFillProps(size = 24, color = "blue")
 */
def Apps2AiFill = (props: Apps2AiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
