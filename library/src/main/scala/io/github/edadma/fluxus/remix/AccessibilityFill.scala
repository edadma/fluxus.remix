...
/**
 * AccessibilityFill icon from the Remix Icon library, Others category.
 */
case class AccessibilityFillProps(
  size: Int = 24,
...
/**
 * AccessibilityFill icon component.
 *
 * @example AccessibilityFill <> AccessibilityFillProps(size = 24, color = "blue")
 */
def AccessibilityFill = (props: AccessibilityFillProps) => {
  svg(
    viewBox := "0 0 24 24",
