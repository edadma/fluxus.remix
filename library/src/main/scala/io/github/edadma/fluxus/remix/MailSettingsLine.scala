...
/**
 * MailSettingsLine icon from the Remix Icon library, Business category.
 */
case class MailSettingsLineProps(
  size: Int = 24,
...
/**
 * MailSettingsLine icon component.
 *
 * @example MailSettingsLine <> MailSettingsLineProps(size = 24, color = "blue")
 */
def MailSettingsLine = (props: MailSettingsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
