...
/**
 * EdgeFill icon from the Remix Icon library, Logos category.
 */
case class EdgeFillProps(
  size: Int = 24,
...
/**
 * EdgeFill icon component.
 *
 * @example EdgeFill <> EdgeFillProps(size = 24, color = "blue")
 */
def EdgeFill = (props: EdgeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
