...
/**
 * AppStoreLine icon from the Remix Icon library, Logos category.
 */
case class AppStoreLineProps(
  size: Int = 24,
...
/**
 * AppStoreLine icon component.
 *
 * @example AppStoreLine <> AppStoreLineProps(size = 24, color = "blue")
 */
def AppStoreLine = (props: AppStoreLineProps) => {
  svg(
    viewBox := "0 0 24 24",
