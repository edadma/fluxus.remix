...
/**
 * VideoOnLine icon from the Remix Icon library, Media category.
 */
case class VideoOnLineProps(
  size: Int = 24,
...
/**
 * VideoOnLine icon component.
 *
 * @example VideoOnLine <> VideoOnLineProps(size = 24, color = "blue")
 */
def VideoOnLine = (props: VideoOnLineProps) => {
  svg(
    viewBox := "0 0 24 24",
