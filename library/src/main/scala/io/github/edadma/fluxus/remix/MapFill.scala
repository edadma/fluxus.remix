...
/**
 * MapFill icon from the Remix Icon library, Map category.
 */
case class MapFillProps(
  size: Int = 24,
...
/**
 * MapFill icon component.
 *
 * @example MapFill <> MapFillProps(size = 24, color = "blue")
 */
def MapFill = (props: MapFillProps) => {
  svg(
    viewBox := "0 0 24 24",
