...
/**
 * RegisteredFill icon from the Remix Icon library, Business category.
 */
case class RegisteredFillProps(
  size: Int = 24,
...
/**
 * RegisteredFill icon component.
 *
 * @example RegisteredFill <> RegisteredFillProps(size = 24, color = "blue")
 */
def RegisteredFill = (props: RegisteredFillProps) => {
  svg(
    viewBox := "0 0 24 24",
