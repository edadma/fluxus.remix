...
/**
 * CastFill icon from the Remix Icon library, Device category.
 */
case class CastFillProps(
  size: Int = 24,
...
/**
 * CastFill icon component.
 *
 * @example CastFill <> CastFillProps(size = 24, color = "blue")
 */
def CastFill = (props: CastFillProps) => {
  svg(
    viewBox := "0 0 24 24",
