...
/**
 * Progress2Line icon from the Remix Icon library, System category.
 */
case class Progress2LineProps(
  size: Int = 24,
...
/**
 * Progress2Line icon component.
 *
 * @example Progress2Line <> Progress2LineProps(size = 24, color = "blue")
 */
def Progress2Line = (props: Progress2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
