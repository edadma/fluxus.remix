...
/**
 * Forward30Fill icon from the Remix Icon library, Media category.
 */
case class Forward30FillProps(
  size: Int = 24,
...
/**
 * Forward30Fill icon component.
 *
 * @example Forward30Fill <> Forward30FillProps(size = 24, color = "blue")
 */
def Forward30Fill = (props: Forward30FillProps) => {
  svg(
    viewBox := "0 0 24 24",
