...
/**
 * User5Line icon from the Remix Icon library, User & Faces category.
 */
case class User5LineProps(
  size: Int = 24,
...
/**
 * User5Line icon component.
 *
 * @example User5Line <> User5LineProps(size = 24, color = "blue")
 */
def User5Line = (props: User5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
