...
/**
 * NoCreditCardLine icon from the Remix Icon library, Finance category.
 */
case class NoCreditCardLineProps(
  size: Int = 24,
...
/**
 * NoCreditCardLine icon component.
 *
 * @example NoCreditCardLine <> NoCreditCardLineProps(size = 24, color = "blue")
 */
def NoCreditCardLine = (props: NoCreditCardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
