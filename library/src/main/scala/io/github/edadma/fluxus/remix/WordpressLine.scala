...
/**
 * WordpressLine icon from the Remix Icon library, Logos category.
 */
case class WordpressLineProps(
  size: Int = 24,
...
/**
 * WordpressLine icon component.
 *
 * @example WordpressLine <> WordpressLineProps(size = 24, color = "blue")
 */
def WordpressLine = (props: WordpressLineProps) => {
  svg(
    viewBox := "0 0 24 24",
