...
/**
 * PlugLine icon from the Remix Icon library, Others category.
 */
case class PlugLineProps(
  size: Int = 24,
...
/**
 * PlugLine icon component.
 *
 * @example PlugLine <> PlugLineProps(size = 24, color = "blue")
 */
def PlugLine = (props: PlugLineProps) => {
  svg(
    viewBox := "0 0 24 24",
