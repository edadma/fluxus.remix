...
/**
 * ShieldFill icon from the Remix Icon library, System category.
 */
case class ShieldFillProps(
  size: Int = 24,
 ...
 *
 * @example ShieldFill <> ShieldFillProps(size = 24, color = "blue")
 */
def ShieldFill = (props: ShieldFillProps) => {
  svg(
    viewBox := "0 0 24 24",
