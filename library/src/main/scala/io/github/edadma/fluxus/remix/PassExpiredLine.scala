...
/**
 * PassExpiredLine icon from the Remix Icon library, Business category.
 */
case class PassExpiredLineProps(
  size: Int = 24,
...
/**
 * PassExpiredLine icon component.
 *
 * @example PassExpiredLine <> PassExpiredLineProps(size = 24, color = "blue")
 */
def PassExpiredLine = (props: PassExpiredLineProps) => {
  svg(
    viewBox := "0 0 24 24",
