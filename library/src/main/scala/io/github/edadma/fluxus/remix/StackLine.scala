...
/**
 * StackLine icon from the Remix Icon library, Business category.
 */
case class StackLineProps(
  size: Int = 24,
...
/**
 * StackLine icon component.
 *
 * @example StackLine <> StackLineProps(size = 24, color = "blue")
 */
def StackLine = (props: StackLineProps) => {
  svg(
    viewBox := "0 0 24 24",
