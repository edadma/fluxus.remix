...
/**
 * ChatVoiceAiLine icon from the Remix Icon library, Communication category.
 */
case class ChatVoiceAiLineProps(
  size: Int = 24,
...
/**
 * ChatVoiceAiLine icon component.
 *
 * @example ChatVoiceAiLine <> ChatVoiceAiLineProps(size = 24, color = "blue")
 */
def ChatVoiceAiLine = (props: ChatVoiceAiLineProps) => {
  svg(
    viewBox := "0 0 24 24",
