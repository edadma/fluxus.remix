...
/**
 * BookMarkedLine icon from the Remix Icon library, Document category.
 */
case class BookMarkedLineProps(
  size: Int = 24,
...
/**
 * BookMarkedLine icon component.
 *
 * @example BookMarkedLine <> BookMarkedLineProps(size = 24, color = "blue")
 */
def BookMarkedLine = (props: BookMarkedLineProps) => {
  svg(
    viewBox := "0 0 24 24",
