...
/**
 * LinksLine icon from the Remix Icon library, Business category.
 */
case class LinksLineProps(
  size: Int = 24,
...
/**
 * LinksLine icon component.
 *
 * @example LinksLine <> LinksLineProps(size = 24, color = "blue")
 */
def LinksLine = (props: LinksLineProps) => {
  svg(
    viewBox := "0 0 24 24",
