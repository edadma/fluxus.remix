...
/**
 * NotificationBadgeLine icon from the Remix Icon library, System category.
 */
case class NotificationBadgeLineProps(
  size: Int = 24,
...
/**
 * NotificationBadgeLine icon component.
 *
 * @example NotificationBadgeLine <> NotificationBadgeLineProps(size = 24, color = "blue")
 */
def NotificationBadgeLine = (props: NotificationBadgeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
