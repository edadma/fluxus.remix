...
/**
 * CurrencyLine icon from the Remix Icon library, Finance category.
 */
case class CurrencyLineProps(
  size: Int = 24,
...
/**
 * CurrencyLine icon component.
 *
 * @example CurrencyLine <> CurrencyLineProps(size = 24, color = "blue")
 */
def CurrencyLine = (props: CurrencyLineProps) => {
  svg(
    viewBox := "0 0 24 24",
