...
/**
 * Robot3Line icon from the Remix Icon library, User & Faces category.
 */
case class Robot3LineProps(
  size: Int = 24,
...
/**
 * Robot3Line icon component.
 *
 * @example Robot3Line <> Robot3LineProps(size = 24, color = "blue")
 */
def Robot3Line = (props: Robot3LineProps) => {
  svg(
    viewBox := "0 0 24 24",
