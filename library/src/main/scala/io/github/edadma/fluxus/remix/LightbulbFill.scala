...
/**
 * LightbulbFill icon from the Remix Icon library, Others category.
 */
case class LightbulbFillProps(
  size: Int = 24,
 ...
 *
 * @example LightbulbFill <> LightbulbFillProps(size = 24, color = "blue")
 */
def LightbulbFill = (props: LightbulbFillProps) => {
  svg(
    viewBox := "0 0 24 24",
