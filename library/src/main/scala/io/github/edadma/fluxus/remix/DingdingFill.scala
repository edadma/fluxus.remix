...
/**
 * DingdingFill icon from the Remix Icon library, Logos category.
 */
case class DingdingFillProps(
  size: Int = 24,
...
/**
 * DingdingFill icon component.
 *
 * @example DingdingFill <> DingdingFillProps(size = 24, color = "blue")
 */
def DingdingFill = (props: DingdingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
