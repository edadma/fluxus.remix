...
/**
 * UsbFill icon from the Remix Icon library, Device category.
 */
case class UsbFillProps(
  size: Int = 24,
 ...
 *
 * @example UsbFill <> UsbFillProps(size = 24, color = "blue")
 */
def UsbFill = (props: UsbFillProps) => {
  svg(
    viewBox := "0 0 24 24",
