...
/**
 * ToothFill icon from the Remix Icon library, Others category.
 */
case class ToothFillProps(
  size: Int = 24,
 ...
 *
 * @example ToothFill <> ToothFillProps(size = 24, color = "blue")
 */
def ToothFill = (props: ToothFillProps) => {
  svg(
    viewBox := "0 0 24 24",
