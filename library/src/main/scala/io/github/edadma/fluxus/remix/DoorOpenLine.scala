...
/**
 * DoorOpenLine icon from the Remix Icon library, Others category.
 */
case class DoorOpenLineProps(
  size: Int = 24,
...
/**
 * DoorOpenLine icon component.
 *
 * @example DoorOpenLine <> DoorOpenLineProps(size = 24, color = "blue")
 */
def DoorOpenLine = (props: DoorOpenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
