...
/**
 * BookmarkFill icon from the Remix Icon library, Business category.
 */
case class BookmarkFillProps(
  size: Int = 24,
 ...
 *
 * @example BookmarkFill <> BookmarkFillProps(size = 24, color = "blue")
 */
def BookmarkFill = (props: BookmarkFillProps) => {
  svg(
    viewBox := "0 0 24 24",
