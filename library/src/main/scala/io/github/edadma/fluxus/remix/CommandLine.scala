...
/**
 * CommandLine icon from the Remix Icon library, Development category.
 */
case class CommandLineProps(
  size: Int = 24,
...
/**
 * CommandLine icon component.
 *
 * @example CommandLine <> CommandLineProps(size = 24, color = "blue")
 */
def CommandLine = (props: CommandLineProps) => {
  svg(
    viewBox := "0 0 24 24",
