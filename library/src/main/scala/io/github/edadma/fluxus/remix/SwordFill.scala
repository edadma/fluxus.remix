...
/**
 * SwordFill icon from the Remix Icon library, Others category.
 */
case class SwordFillProps(
  size: Int = 24,
 ...
 *
 * @example SwordFill <> SwordFillProps(size = 24, color = "blue")
 */
def SwordFill = (props: SwordFillProps) => {
  svg(
    viewBox := "0 0 24 24",
