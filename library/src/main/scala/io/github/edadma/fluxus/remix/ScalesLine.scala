...
/**
 * ScalesLine icon from the Remix Icon library, Others category.
 */
case class ScalesLineProps(
  size: Int = 24,
...
/**
 * ScalesLine icon component.
 *
 * @example ScalesLine <> ScalesLineProps(size = 24, color = "blue")
 */
def ScalesLine = (props: ScalesLineProps) => {
  svg(
    viewBox := "0 0 24 24",
