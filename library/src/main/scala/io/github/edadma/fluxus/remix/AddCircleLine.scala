...
/**
 * AddCircleLine icon from the Remix Icon library, System category.
 */
case class AddCircleLineProps(
  size: Int = 24,
...
/**
 * AddCircleLine icon component.
 *
 * @example AddCircleLine <> AddCircleLineProps(size = 24, color = "blue")
 */
def AddCircleLine = (props: AddCircleLineProps) => {
  svg(
    viewBox := "0 0 24 24",
