...
/**
 * SendPlane2Fill icon from the Remix Icon library, Business category.
 */
case class SendPlane2FillProps(
  size: Int = 24,
...
/**
 * SendPlane2Fill icon component.
 *
 * @example SendPlane2Fill <> SendPlane2FillProps(size = 24, color = "blue")
 */
def SendPlane2Fill = (props: SendPlane2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
