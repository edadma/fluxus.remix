...
/**
 * Progress6Line icon from the Remix Icon library, System category.
 */
case class Progress6LineProps(
  size: Int = 24,
...
/**
 * Progress6Line icon component.
 *
 * @example Progress6Line <> Progress6LineProps(size = 24, color = "blue")
 */
def Progress6Line = (props: Progress6LineProps) => {
  svg(
    viewBox := "0 0 24 24",
