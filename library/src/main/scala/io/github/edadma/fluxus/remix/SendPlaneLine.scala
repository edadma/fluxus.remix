...
/**
 * SendPlaneLine icon from the Remix Icon library, Business category.
 */
case class SendPlaneLineProps(
  size: Int = 24,
...
/**
 * SendPlaneLine icon component.
 *
 * @example SendPlaneLine <> SendPlaneLineProps(size = 24, color = "blue")
 */
def SendPlaneLine = (props: SendPlaneLineProps) => {
  svg(
    viewBox := "0 0 24 24",
