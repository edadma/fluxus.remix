...
/**
 * Brush2Fill icon from the Remix Icon library, Design category.
 */
case class Brush2FillProps(
  size: Int = 24,
...
/**
 * Brush2Fill icon component.
 *
 * @example Brush2Fill <> Brush2FillProps(size = 24, color = "blue")
 */
def Brush2Fill = (props: Brush2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
