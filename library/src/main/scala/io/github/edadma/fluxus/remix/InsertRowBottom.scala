...
/**
 * InsertRowBottom icon from the Remix Icon library, Editor category.
 */
case class InsertRowBottomProps(
  size: Int = 24,
...
/**
 * InsertRowBottom icon component.
 *
 * @example InsertRowBottom <> InsertRowBottomProps(size = 24, color = "blue")
 */
def InsertRowBottom = (props: InsertRowBottomProps) => {
  svg(
    viewBox := "0 0 24 24",
