...
/**
 * Inbox2Fill icon from the Remix Icon library, Business category.
 */
case class Inbox2FillProps(
  size: Int = 24,
...
/**
 * Inbox2Fill icon component.
 *
 * @example Inbox2Fill <> Inbox2FillProps(size = 24, color = "blue")
 */
def Inbox2Fill = (props: Inbox2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
