...
/**
 * CodepenFill icon from the Remix Icon library, Logos category.
 */
case class CodepenFillProps(
  size: Int = 24,
...
/**
 * CodepenFill icon component.
 *
 * @example CodepenFill <> CodepenFillProps(size = 24, color = "blue")
 */
def CodepenFill = (props: CodepenFillProps) => {
  svg(
    viewBox := "0 0 24 24",
