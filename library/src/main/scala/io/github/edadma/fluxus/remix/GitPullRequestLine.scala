...
/**
 * GitPullRequestLine icon from the Remix Icon library, Development category.
 */
case class GitPullRequestLineProps(
  size: Int = 24,
...
/**
 * GitPullRequestLine icon component.
 *
 * @example GitPullRequestLine <> GitPullRequestLineProps(size = 24, color = "blue")
 */
def GitPullRequestLine = (props: GitPullRequestLineProps) => {
  svg(
    viewBox := "0 0 24 24",
