...
/**
 * MoneyDollarBoxLine icon from the Remix Icon library, Finance category.
 */
case class MoneyDollarBoxLineProps(
  size: Int = 24,
...
/**
 * MoneyDollarBoxLine icon component.
 *
 * @example MoneyDollarBoxLine <> MoneyDollarBoxLineProps(size = 24, color = "blue")
 */
def MoneyDollarBoxLine = (props: MoneyDollarBoxLineProps) => {
  svg(
    viewBox := "0 0 24 24",
