...
/**
 * ColorFilterFill icon from the Remix Icon library, Design category.
 */
case class ColorFilterFillProps(
  size: Int = 24,
...
/**
 * ColorFilterFill icon component.
 *
 * @example ColorFilterFill <> ColorFilterFillProps(size = 24, color = "blue")
 */
def ColorFilterFill = (props: ColorFilterFillProps) => {
  svg(
    viewBox := "0 0 24 24",
