...
/**
 * SurroundSoundFill icon from the Remix Icon library, Media category.
 */
case class SurroundSoundFillProps(
  size: Int = 24,
...
/**
 * SurroundSoundFill icon component.
 *
 * @example SurroundSoundFill <> SurroundSoundFillProps(size = 24, color = "blue")
 */
def SurroundSoundFill = (props: SurroundSoundFillProps) => {
  svg(
    viewBox := "0 0 24 24",
