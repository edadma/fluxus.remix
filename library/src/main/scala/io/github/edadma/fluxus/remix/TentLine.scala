...
/**
 * TentLine icon from the Remix Icon library, Buildings category.
 */
case class TentLineProps(
  size: Int = 24,
...
/**
 * TentLine icon component.
 *
 * @example TentLine <> TentLineProps(size = 24, color = "blue")
 */
def TentLine = (props: TentLineProps) => {
  svg(
    viewBox := "0 0 24 24",
