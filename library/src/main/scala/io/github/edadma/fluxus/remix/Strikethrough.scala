...
/**
 * Strikethrough icon from the Remix Icon library, Editor category.
 */
case class StrikethroughProps(
  size: Int = 24,
 ...
 *
 * @example Strikethrough <> StrikethroughProps(size = 24, color = "blue")
 */
def Strikethrough = (props: StrikethroughProps) => {
  svg(
    viewBox := "0 0 24 24",
