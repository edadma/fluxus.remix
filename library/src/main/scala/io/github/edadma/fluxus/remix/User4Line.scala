...
/**
 * User4Line icon from the Remix Icon library, User & Faces category.
 */
case class User4LineProps(
  size: Int = 24,
...
/**
 * User4Line icon component.
 *
 * @example User4Line <> User4LineProps(size = 24, color = "blue")
 */
def User4Line = (props: User4LineProps) => {
  svg(
    viewBox := "0 0 24 24",
