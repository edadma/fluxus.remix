...
/**
 * PinyinInput icon from the Remix Icon library, Editor category.
 */
case class PinyinInputProps(
  size: Int = 24,
...
/**
 * PinyinInput icon component.
 *
 * @example PinyinInput <> PinyinInputProps(size = 24, color = "blue")
 */
def PinyinInput = (props: PinyinInputProps) => {
  svg(
    viewBox := "0 0 24 24",
