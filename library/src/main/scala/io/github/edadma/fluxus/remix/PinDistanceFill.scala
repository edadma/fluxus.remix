...
/**
 * PinDistanceFill icon from the Remix Icon library, Map category.
 */
case class PinDistanceFillProps(
  size: Int = 24,
...
/**
 * PinDistanceFill icon component.
 *
 * @example PinDistanceFill <> PinDistanceFillProps(size = 24, color = "blue")
 */
def PinDistanceFill = (props: PinDistanceFillProps) => {
  svg(
    viewBox := "0 0 24 24",
