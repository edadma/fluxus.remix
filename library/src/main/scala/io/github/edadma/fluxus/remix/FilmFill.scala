...
/**
 * FilmFill icon from the Remix Icon library, Media category.
 */
case class FilmFillProps(
  size: Int = 24,
...
/**
 * FilmFill icon component.
 *
 * @example FilmFill <> FilmFillProps(size = 24, color = "blue")
 */
def FilmFill = (props: FilmFillProps) => {
  svg(
    viewBox := "0 0 24 24",
