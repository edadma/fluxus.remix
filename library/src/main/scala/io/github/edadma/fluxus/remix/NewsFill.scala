...
/**
 * NewsFill icon from the Remix Icon library, Document category.
 */
case class NewsFillProps(
  size: Int = 24,
...
/**
 * NewsFill icon component.
 *
 * @example NewsFill <> NewsFillProps(size = 24, color = "blue")
 */
def NewsFill = (props: NewsFillProps) => {
  svg(
    viewBox := "0 0 24 24",
