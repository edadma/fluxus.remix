...
/**
 * OpenArmLine icon from the Remix Icon library, User & Faces category.
 */
case class OpenArmLineProps(
  size: Int = 24,
...
/**
 * OpenArmLine icon component.
 *
 * @example OpenArmLine <> OpenArmLineProps(size = 24, color = "blue")
 */
def OpenArmLine = (props: OpenArmLineProps) => {
  svg(
    viewBox := "0 0 24 24",
