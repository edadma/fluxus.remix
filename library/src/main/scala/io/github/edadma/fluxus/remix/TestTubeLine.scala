...
/**
 * TestTubeLine icon from the Remix Icon library, Health & Medical category.
 */
case class TestTubeLineProps(
  size: Int = 24,
...
/**
 * TestTubeLine icon component.
 *
 * @example TestTubeLine <> TestTubeLineProps(size = 24, color = "blue")
 */
def TestTubeLine = (props: TestTubeLineProps) => {
  svg(
    viewBox := "0 0 24 24",
