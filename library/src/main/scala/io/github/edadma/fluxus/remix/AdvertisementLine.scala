...
/**
 * AdvertisementLine icon from the Remix Icon library, Business category.
 */
case class AdvertisementLineProps(
  size: Int = 24,
...
/**
 * AdvertisementLine icon component.
 *
 * @example AdvertisementLine <> AdvertisementLineProps(size = 24, color = "blue")
 */
def AdvertisementLine = (props: AdvertisementLineProps) => {
  svg(
    viewBox := "0 0 24 24",
