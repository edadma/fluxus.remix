...
/**
 * FirefoxFill icon from the Remix Icon library, Logos category.
 */
case class FirefoxFillProps(
  size: Int = 24,
...
/**
 * FirefoxFill icon component.
 *
 * @example FirefoxFill <> FirefoxFillProps(size = 24, color = "blue")
 */
def FirefoxFill = (props: FirefoxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
