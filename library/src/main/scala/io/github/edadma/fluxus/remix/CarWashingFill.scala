...
/**
 * CarWashingFill icon from the Remix Icon library, Map category.
 */
case class CarWashingFillProps(
  size: Int = 24,
...
/**
 * CarWashingFill icon component.
 *
 * @example CarWashingFill <> CarWashingFillProps(size = 24, color = "blue")
 */
def CarWashingFill = (props: CarWashingFillProps) => {
  svg(
    viewBox := "0 0 24 24",
