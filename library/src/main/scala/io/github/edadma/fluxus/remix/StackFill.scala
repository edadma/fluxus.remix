...
/**
 * StackFill icon from the Remix Icon library, Business category.
 */
case class StackFillProps(
  size: Int = 24,
 ...
 *
 * @example StackFill <> StackFillProps(size = 24, color = "blue")
 */
def StackFill = (props: StackFillProps) => {
  svg(
    viewBox := "0 0 24 24",
