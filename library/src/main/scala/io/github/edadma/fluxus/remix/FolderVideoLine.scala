...
/**
 * FolderVideoLine icon from the Remix Icon library, Document category.
 */
case class FolderVideoLineProps(
  size: Int = 24,
...
/**
 * FolderVideoLine icon component.
 *
 * @example FolderVideoLine <> FolderVideoLineProps(size = 24, color = "blue")
 */
def FolderVideoLine = (props: FolderVideoLineProps) => {
  svg(
    viewBox := "0 0 24 24",
