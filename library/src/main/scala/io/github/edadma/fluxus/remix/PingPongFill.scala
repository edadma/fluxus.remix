...
/**
 * PingPongFill icon from the Remix Icon library, Others category.
 */
case class PingPongFillProps(
  size: Int = 24,
 ...
 *
 * @example PingPongFill <> PingPongFillProps(size = 24, color = "blue")
 */
def PingPongFill = (props: PingPongFillProps) => {
  svg(
    viewBox := "0 0 24 24",
