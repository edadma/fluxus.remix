...
/**
 * BrushLine icon from the Remix Icon library, Design category.
 */
case class BrushLineProps(
  size: Int = 24,
...
/**
 * BrushLine icon component.
 *
 * @example BrushLine <> BrushLineProps(size = 24, color = "blue")
 */
def BrushLine = (props: BrushLineProps) => {
  svg(
    viewBox := "0 0 24 24",
