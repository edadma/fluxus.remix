...
/**
 * RadarFill icon from the Remix Icon library, Device category.
 */
case class RadarFillProps(
  size: Int = 24,
...
/**
 * RadarFill icon component.
 *
 * @example RadarFill <> RadarFillProps(size = 24, color = "blue")
 */
def RadarFill = (props: RadarFillProps) => {
  svg(
    viewBox := "0 0 24 24",
