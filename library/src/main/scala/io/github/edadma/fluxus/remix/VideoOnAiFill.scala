...
/**
 * VideoOnAiFill icon from the Remix Icon library, Media category.
 */
case class VideoOnAiFillProps(
  size: Int = 24,
...
/**
 * VideoOnAiFill icon component.
 *
 * @example VideoOnAiFill <> VideoOnAiFillProps(size = 24, color = "blue")
 */
def VideoOnAiFill = (props: VideoOnAiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
