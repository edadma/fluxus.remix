...
/**
 * HomeSmileLine icon from the Remix Icon library, Buildings category.
 */
case class HomeSmileLineProps(
  size: Int = 24,
...
/**
 * HomeSmileLine icon component.
 *
 * @example HomeSmileLine <> HomeSmileLineProps(size = 24, color = "blue")
 */
def HomeSmileLine = (props: HomeSmileLineProps) => {
  svg(
    viewBox := "0 0 24 24",
