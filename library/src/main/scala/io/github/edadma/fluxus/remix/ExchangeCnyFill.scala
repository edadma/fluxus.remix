...
/**
 * ExchangeCnyFill icon from the Remix Icon library, Finance category.
 */
case class ExchangeCnyFillProps(
  size: Int = 24,
...
/**
 * ExchangeCnyFill icon component.
 *
 * @example ExchangeCnyFill <> ExchangeCnyFillProps(size = 24, color = "blue")
 */
def ExchangeCnyFill = (props: ExchangeCnyFillProps) => {
  svg(
    viewBox := "0 0 24 24",
