...
/**
 * Progress5Line icon from the Remix Icon library, System category.
 */
case class Progress5LineProps(
  size: Int = 24,
...
/**
 * Progress5Line icon component.
 *
 * @example Progress5Line <> Progress5LineProps(size = 24, color = "blue")
 */
def Progress5Line = (props: Progress5LineProps) => {
  svg(
    viewBox := "0 0 24 24",
