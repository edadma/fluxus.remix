...
/**
 * ResetLeftFill icon from the Remix Icon library, System category.
 */
case class ResetLeftFillProps(
  size: Int = 24,
...
/**
 * ResetLeftFill icon component.
 *
 * @example ResetLeftFill <> ResetLeftFillProps(size = 24, color = "blue")
 */
def ResetLeftFill = (props: ResetLeftFillProps) => {
  svg(
    viewBox := "0 0 24 24",
