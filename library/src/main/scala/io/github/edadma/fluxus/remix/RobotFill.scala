...
/**
 * RobotFill icon from the Remix Icon library, User & Faces category.
 */
case class RobotFillProps(
  size: Int = 24,
 ...
 *
 * @example RobotFill <> RobotFillProps(size = 24, color = "blue")
 */
def RobotFill = (props: RobotFillProps) => {
  svg(
    viewBox := "0 0 24 24",
