...
/**
 * CopyrightLine icon from the Remix Icon library, Business category.
 */
case class CopyrightLineProps(
  size: Int = 24,
...
/**
 * CopyrightLine icon component.
 *
 * @example CopyrightLine <> CopyrightLineProps(size = 24, color = "blue")
 */
def CopyrightLine = (props: CopyrightLineProps) => {
  svg(
    viewBox := "0 0 24 24",
