...
/**
 * VideoLine icon from the Remix Icon library, Media category.
 */
case class VideoLineProps(
  size: Int = 24,
...
/**
 * VideoLine icon component.
 *
 * @example VideoLine <> VideoLineProps(size = 24, color = "blue")
 */
def VideoLine = (props: VideoLineProps) => {
  svg(
    viewBox := "0 0 24 24",
