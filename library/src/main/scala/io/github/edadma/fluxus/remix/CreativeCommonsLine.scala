...
/**
 * CreativeCommonsLine icon from the Remix Icon library, Business category.
 */
case class CreativeCommonsLineProps(
  size: Int = 24,
...
/**
 * CreativeCommonsLine icon component.
 *
 * @example CreativeCommonsLine <> CreativeCommonsLineProps(size = 24, color = "blue")
 */
def CreativeCommonsLine = (props: CreativeCommonsLineProps) => {
  svg(
    viewBox := "0 0 24 24",
