...
/**
 * BookOpenLine icon from the Remix Icon library, Document category.
 */
case class BookOpenLineProps(
  size: Int = 24,
...
/**
 * BookOpenLine icon component.
 *
 * @example BookOpenLine <> BookOpenLineProps(size = 24, color = "blue")
 */
def BookOpenLine = (props: BookOpenLineProps) => {
  svg(
    viewBox := "0 0 24 24",
