...
/**
 * CentosLine icon from the Remix Icon library, Logos category.
 */
case class CentosLineProps(
  size: Int = 24,
...
/**
 * CentosLine icon component.
 *
 * @example CentosLine <> CentosLineProps(size = 24, color = "blue")
 */
def CentosLine = (props: CentosLineProps) => {
  svg(
    viewBox := "0 0 24 24",
