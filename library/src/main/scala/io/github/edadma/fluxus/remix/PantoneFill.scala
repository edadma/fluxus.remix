...
/**
 * PantoneFill icon from the Remix Icon library, Design category.
 */
case class PantoneFillProps(
  size: Int = 24,
...
/**
 * PantoneFill icon component.
 *
 * @example PantoneFill <> PantoneFillProps(size = 24, color = "blue")
 */
def PantoneFill = (props: PantoneFillProps) => {
  svg(
    viewBox := "0 0 24 24",
