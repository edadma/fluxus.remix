...
/**
 * HomeGearLine icon from the Remix Icon library, Buildings category.
 */
case class HomeGearLineProps(
  size: Int = 24,
...
/**
 * HomeGearLine icon component.
 *
 * @example HomeGearLine <> HomeGearLineProps(size = 24, color = "blue")
 */
def HomeGearLine = (props: HomeGearLineProps) => {
  svg(
    viewBox := "0 0 24 24",
