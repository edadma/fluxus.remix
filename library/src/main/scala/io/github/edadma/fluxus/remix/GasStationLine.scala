...
/**
 * GasStationLine icon from the Remix Icon library, Map category.
 */
case class GasStationLineProps(
  size: Int = 24,
...
/**
 * GasStationLine icon component.
 *
 * @example GasStationLine <> GasStationLineProps(size = 24, color = "blue")
 */
def GasStationLine = (props: GasStationLineProps) => {
  svg(
    viewBox := "0 0 24 24",
