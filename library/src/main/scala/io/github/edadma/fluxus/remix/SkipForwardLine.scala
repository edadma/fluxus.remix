...
/**
 * SkipForwardLine icon from the Remix Icon library, Media category.
 */
case class SkipForwardLineProps(
  size: Int = 24,
...
/**
 * SkipForwardLine icon component.
 *
 * @example SkipForwardLine <> SkipForwardLineProps(size = 24, color = "blue")
 */
def SkipForwardLine = (props: SkipForwardLineProps) => {
  svg(
    viewBox := "0 0 24 24",
