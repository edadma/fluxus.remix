...
/**
 * BusWifiFill icon from the Remix Icon library, Map category.
 */
case class BusWifiFillProps(
  size: Int = 24,
...
/**
 * BusWifiFill icon component.
 *
 * @example BusWifiFill <> BusWifiFillProps(size = 24, color = "blue")
 */
def BusWifiFill = (props: BusWifiFillProps) => {
  svg(
    viewBox := "0 0 24 24",
