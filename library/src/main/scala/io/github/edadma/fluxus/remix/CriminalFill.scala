...
/**
 * CriminalFill icon from the Remix Icon library, User & Faces category.
 */
case class CriminalFillProps(
  size: Int = 24,
...
/**
 * CriminalFill icon component.
 *
 * @example CriminalFill <> CriminalFillProps(size = 24, color = "blue")
 */
def CriminalFill = (props: CriminalFillProps) => {
  svg(
    viewBox := "0 0 24 24",
