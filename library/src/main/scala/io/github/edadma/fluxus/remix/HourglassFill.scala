...
/**
 * HourglassFill icon from the Remix Icon library, System category.
 */
case class HourglassFillProps(
  size: Int = 24,
 ...
 *
 * @example HourglassFill <> HourglassFillProps(size = 24, color = "blue")
 */
def HourglassFill = (props: HourglassFillProps) => {
  svg(
    viewBox := "0 0 24 24",
