...
/**
 * CheckboxMultipleBlankLine icon from the Remix Icon library, System category.
 */
case class CheckboxMultipleBlankLineProps(
  size: Int = 24,
...
/**
 * CheckboxMultipleBlankLine icon component.
 *
 * @example CheckboxMultipleBlankLine <> CheckboxMultipleBlankLineProps(size = 24, color = "blue")
 */
def CheckboxMultipleBlankLine = (props: CheckboxMultipleBlankLineProps) => {
  svg(
    viewBox := "0 0 24 24",
