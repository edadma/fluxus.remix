...
/**
 * ScissorsCutFill icon from the Remix Icon library, Design category.
 */
case class ScissorsCutFillProps(
  size: Int = 24,
...
/**
 * ScissorsCutFill icon component.
 *
 * @example ScissorsCutFill <> ScissorsCutFillProps(size = 24, color = "blue")
 */
def ScissorsCutFill = (props: ScissorsCutFillProps) => {
  svg(
    viewBox := "0 0 24 24",
