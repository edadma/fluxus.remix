...
/**
 * YuqueFill icon from the Remix Icon library, Logos category.
 */
case class YuqueFillProps(
  size: Int = 24,
...
/**
 * YuqueFill icon component.
 *
 * @example YuqueFill <> YuqueFillProps(size = 24, color = "blue")
 */
def YuqueFill = (props: YuqueFillProps) => {
  svg(
    viewBox := "0 0 24 24",
