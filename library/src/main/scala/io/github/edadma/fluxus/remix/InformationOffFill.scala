...
/**
 * InformationOffFill icon from the Remix Icon library, System category.
 */
case class InformationOffFillProps(
  size: Int = 24,
...
/**
 * InformationOffFill icon component.
 *
 * @example InformationOffFill <> InformationOffFillProps(size = 24, color = "blue")
 */
def InformationOffFill = (props: InformationOffFillProps) => {
  svg(
    viewBox := "0 0 24 24",
