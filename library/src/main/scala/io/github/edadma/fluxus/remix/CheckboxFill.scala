...
/**
 * CheckboxFill icon from the Remix Icon library, System category.
 */
case class CheckboxFillProps(
  size: Int = 24,
...
/**
 * CheckboxFill icon component.
 *
 * @example CheckboxFill <> CheckboxFillProps(size = 24, color = "blue")
 */
def CheckboxFill = (props: CheckboxFillProps) => {
  svg(
    viewBox := "0 0 24 24",
