...
/**
 * CreativeCommonsNcLine icon from the Remix Icon library, Business category.
 */
case class CreativeCommonsNcLineProps(
  size: Int = 24,
...
/**
 * CreativeCommonsNcLine icon component.
 *
 * @example CreativeCommonsNcLine <> CreativeCommonsNcLineProps(size = 24, color = "blue")
 */
def CreativeCommonsNcLine = (props: CreativeCommonsNcLineProps) => {
  svg(
    viewBox := "0 0 24 24",
