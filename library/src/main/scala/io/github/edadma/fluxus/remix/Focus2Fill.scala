...
/**
 * Focus2Fill icon from the Remix Icon library, Design category.
 */
case class Focus2FillProps(
  size: Int = 24,
...
/**
 * Focus2Fill icon component.
 *
 * @example Focus2Fill <> Focus2FillProps(size = 24, color = "blue")
 */
def Focus2Fill = (props: Focus2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
