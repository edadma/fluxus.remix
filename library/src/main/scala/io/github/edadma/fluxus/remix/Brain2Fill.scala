...
/**
 * Brain2Fill icon from the Remix Icon library, Health & Medical category.
 */
case class Brain2FillProps(
  size: Int = 24,
...
/**
 * Brain2Fill icon component.
 *
 * @example Brain2Fill <> Brain2FillProps(size = 24, color = "blue")
 */
def Brain2Fill = (props: Brain2FillProps) => {
  svg(
    viewBox := "0 0 24 24",
