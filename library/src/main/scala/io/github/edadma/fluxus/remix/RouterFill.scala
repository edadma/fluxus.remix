...
/**
 * RouterFill icon from the Remix Icon library, Device category.
 */
case class RouterFillProps(
  size: Int = 24,
...
/**
 * RouterFill icon component.
 *
 * @example RouterFill <> RouterFillProps(size = 24, color = "blue")
 */
def RouterFill = (props: RouterFillProps) => {
  svg(
    viewBox := "0 0 24 24",
