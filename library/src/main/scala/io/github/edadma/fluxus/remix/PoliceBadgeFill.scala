...
/**
 * PoliceBadgeFill icon from the Remix Icon library, Others category.
 */
case class PoliceBadgeFillProps(
  size: Int = 24,
...
/**
 * PoliceBadgeFill icon component.
 *
 * @example PoliceBadgeFill <> PoliceBadgeFillProps(size = 24, color = "blue")
 */
def PoliceBadgeFill = (props: PoliceBadgeFillProps) => {
  svg(
    viewBox := "0 0 24 24",
