...
/**
 * Coupon2Line icon from the Remix Icon library, Finance category.
 */
case class Coupon2LineProps(
  size: Int = 24,
...
/**
 * Coupon2Line icon component.
 *
 * @example Coupon2Line <> Coupon2LineProps(size = 24, color = "blue")
 */
def Coupon2Line = (props: Coupon2LineProps) => {
  svg(
    viewBox := "0 0 24 24",
