...
/**
 * FileForbidLine icon from the Remix Icon library, Document category.
 */
case class FileForbidLineProps(
  size: Int = 24,
...
/**
 * FileForbidLine icon component.
 *
 * @example FileForbidLine <> FileForbidLineProps(size = 24, color = "blue")
 */
def FileForbidLine = (props: FileForbidLineProps) => {
  svg(
    viewBox := "0 0 24 24",
