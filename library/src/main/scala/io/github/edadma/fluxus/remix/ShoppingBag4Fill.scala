...
/**
 * ShoppingBag4Fill icon from the Remix Icon library, Finance category.
 */
case class ShoppingBag4FillProps(
  size: Int = 24,
...
/**
 * ShoppingBag4Fill icon component.
 *
 * @example ShoppingBag4Fill <> ShoppingBag4FillProps(size = 24, color = "blue")
 */
def ShoppingBag4Fill = (props: ShoppingBag4FillProps) => {
  svg(
    viewBox := "0 0 24 24",
