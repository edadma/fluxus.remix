...
/**
 * FootprintFill icon from the Remix Icon library, Map category.
 */
case class FootprintFillProps(
  size: Int = 24,
...
/**
 * FootprintFill icon component.
 *
 * @example FootprintFill <> FootprintFillProps(size = 24, color = "blue")
 */
def FootprintFill = (props: FootprintFillProps) => {
  svg(
    viewBox := "0 0 24 24",
