...
/**
 * MenuSearchFill icon from the Remix Icon library, System category.
 */
case class MenuSearchFillProps(
  size: Int = 24,
...
/**
 * MenuSearchFill icon component.
 *
 * @example MenuSearchFill <> MenuSearchFillProps(size = 24, color = "blue")
 */
def MenuSearchFill = (props: MenuSearchFillProps) => {
  svg(
    viewBox := "0 0 24 24",
